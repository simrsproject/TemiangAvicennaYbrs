...
namespace Temiang.Avicenna.ReportLibrary.RSMP.RLib_Slip.Assessment
{
    using System;
    ...
    txtHeight);
        ...
        private void PopulatePsikologis(PatientHealthRecordLineCollection phrlColl)
        {
            ...
            // Curiga Penganiyayaan
            questionID = "ST.SO.002"; 
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkCu_Ya.Value = ent.QuestionAnswerSelectionLineID.Equals("UM.YN1");
                chkCu_Tidak.Value = ent.QuestionAnswerSelectionLineID.Equals("UM.YN2");
            }
            ...
            if (ent != null)
            {
                chkKgt_Memb.Value = ent.QuestionAnswerSelectionLineID.Equals("ADL.ID2");
            ...
            if (ent != null)
            {
                ...
                chkSe_Tdk.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkSe_Rasa.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                ...
                chkSe_Sulit.Value = ent.QuestionAnswerSelectionLineID.Equals("6");
                chkSe_Cepat.Value = ent.QuestionAnswerSelectionLineID.Equals("7");
                chkSe_Konsentrasi.Value = ent.QuestionAnswerSelectionLineID.Equals("8");
                chkSe_Merasa.Value = ent.QuestionAnswerSelectionLineID.Equals("9");
            }
            ...
            {
                //ADATDKSBT
                // ADATDKSBT01 : Tidak Ada
                // ADATDKSBT02 : Ada sebutkan

                chkKe_Tidak.Value = ent.QuestionAnswerSelectionLineID.Equals("ADATDKSBT01");
                if (ent.QuestionAnswerSelectionLineID.Equals("ADATDKSBT02"))
                {
                    var values = ent.QuestionAnswerText.Split('|');
                    chkKe_YaSebutkan.Value = true;
                    txtKeyakinan.Value = values[1];
                }
            }
            ...
            if (ent != null)
            {
                ...
                chkBy_Umum.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkBy_Bpjs.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkBy_Asuransi.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                if (ent.QuestionAnswerSelectionLineID.Equals("4"))
                {
                    var values = ent.QuestionAnswerText.Split('|');
                    chkBy_Lainnya.Value = true;
                    txtCbLainnya.Value = values[1];
                }
            }
