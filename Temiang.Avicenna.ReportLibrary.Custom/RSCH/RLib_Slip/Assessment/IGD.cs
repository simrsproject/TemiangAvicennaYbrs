...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment
{
    ...
    public partial class IGD : Telerik.Reporting.Report
    {
        public IGD(string programID, PrintJobParameterCollection printJobParameters)
        {
            ...
            //chkTidak.Value = !asses.IsAutoAnamnesis ?? false;
            //chkYa.Value = asses.IsAutoAnamnesis ?? false;
            //txtSUBJEKTIF.Value = asses.Hpi;
            ...
            //txtAsesmen.Value = asses.Medikamentosa;
