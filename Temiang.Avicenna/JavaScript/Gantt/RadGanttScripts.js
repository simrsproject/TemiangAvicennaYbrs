...
},initializeCustomFields:function(){var n=function(r){var s=c.GanttTask;
s.prototype["get_"+r]=function(){return this._data[r];
};
s.prototype["set_"+r]=function(u){var t={};
t[r]=u;
this._data[r]=u;
this._update(t);
};
...
},postback:function(n){var o=this.get_postBackReference().replace("arguments",Sys.Serialization.JavaScriptSerializer.serialize(n).replace(/\\/g,"\\\\").replace(/'/g,"\\'"));
eval(o);
...
},_raiseNavigationCommand:function(p){if(!p.view){return;
}var n={view:p.view};
