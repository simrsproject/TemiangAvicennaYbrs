...
{
    public partial class ReturnDistributionDetailItem : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            if (DataItem is GridInsertionObject)
            {
                ...
                var coll = (LaundryReturnDistributionItemCollection)Session["collLaundryReturnDistributionItem" + Request.UserHostName];
                if (coll.Count == 0)
                    txtSeqNo.Text = "001";
                else
                {
            ...
            txtSeqNo.Text = (String)DataBinder.Eval(DataItem, LaundryReturnDistributionItemMetadata.ColumnNames.SeqNo);
            ...
            cboItemID.SelectedValue = (String)DataBinder.Eval(DataItem, LaundryReturnDistributionItemMetadata.ColumnNames.ItemID);
            txtQty.Value = Convert.ToDouble(DataBinder.Eval(DataItem, LaundryReturnDistributionItemMetadata.ColumnNames.Qty));
            ...
            cboSRItemUnit.SelectedValue = (String)DataBinder.Eval(DataItem, LaundryReturnDistributionItemMetadata.ColumnNames.SRItemUnit);
        }
