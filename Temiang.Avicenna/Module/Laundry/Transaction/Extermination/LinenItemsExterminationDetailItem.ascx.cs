...
{
    public partial class LinenItemsExterminationDetailItem : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            if (DataItem is GridInsertionObject)
            {
                ...
                var collitem = (ItemTransactionItemCollection)Session["collLinenDestructionItems" + Request.UserHostName];
                if (collitem.Count == 0)
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (ItemTransactionItemCollection)Session["collLinenDestructionItems" + Request.UserHostName];
        ...
        private void PopulateItemID(RadComboBox comboBox, string textSearch)
        {
            ...
            query.InnerJoin(prod).On(query.ItemID == prod.ItemID && prod.IsNeedToBeLaundered == true);
