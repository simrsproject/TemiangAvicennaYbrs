<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="LinenItemsRepairingDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Laundry.Transaction.LinenItemsRepairingDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="ItemID">
            ...
            <EditFormSettings UserControlName="LinenItemsRepairingItemDetail.ascx" EditFormType="WebUserControl">
                <EditColumn UniqueName="LinenItemsRepairingItemDetailEditCommand">
                </EditColumn>
            </EditFormSettings>
        </MasterTableView>
        <FilterMenu>
