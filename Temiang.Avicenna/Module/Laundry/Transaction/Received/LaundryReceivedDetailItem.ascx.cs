...
{
    public partial class LaundryReceivedDetailItem : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            if (DataItem is GridInsertionObject)
            {
                ...
                var coll = (LaundryReceivedItemCollection)Session["collLaundryReceivedItem" + Request.UserHostName];
                if (coll.Count == 0)
            ...
            txtReceivedSeqNo.Text = (String)DataBinder.Eval(DataItem, LaundryReceivedItemMetadata.ColumnNames.ReceivedSeqNo);
            ...
            cboItemID.SelectedValue = (String)DataBinder.Eval(DataItem, LaundryReceivedItemMetadata.ColumnNames.ItemID);
            txtQty.Value = Convert.ToDouble(DataBinder.Eval(DataItem, LaundryReceivedItemMetadata.ColumnNames.Qty));
            ...
            cboSRItemUnit.SelectedValue = (String)DataBinder.Eval(DataItem, LaundryReceivedItemMetadata.ColumnNames.SRItemUnit);
            txtNotes.Text = (String)DataBinder.Eval(DataItem, LaundryReceivedItemMetadata.ColumnNames.Notes);
        }
