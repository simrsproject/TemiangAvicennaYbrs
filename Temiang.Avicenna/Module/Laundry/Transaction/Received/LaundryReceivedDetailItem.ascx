<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LaundryReceivedDetailItem.ascx.cs" Inherits="Temiang.Avicenna.Module.Laundry.Transaction.LaundryReceivedDetailItem" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumLaundryReceivedItem" runat="server" ValidationGroup="LaundryReceivedItem" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="LaundryReceivedItem"
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvReceivedSeqNo" runat="server" ErrorMessage="Sequence No required."
                            ControlToValidate="txtReceivedSeqNo" SetFocusOnError="True" ValidationGroup="LaundryReceivedItem"
                            Width="100%">
                ...
                <tr height="30">
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvQuantity" runat="server" ErrorMessage="Quantity required."
                            ControlToValidate="txtQty" SetFocusOnError="True" ValidationGroup="LaundryReceivedItem"
                            Width="100%">
                            <asp:Image ID="Image2" runat="server" SkinID="rfvImage" />
                        </asp:RequiredFieldValidator>
                        <asp:RequiredFieldValidator ID="rfvSRItemUnit" runat="server" ErrorMessage="Unit required."
                            ControlToValidate="cboSRItemUnit" SetFocusOnError="True" ValidationGroup="LaundryReceivedItem"
                            Width="100%">
                ...
                <tr>
                    <td align="right" colspan="2" style="height: 26px">
                        <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="LaundryReceivedItem"
                            Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
                        <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                            ValidationGroup="LaundryReceivedItem" Visible='<%# DataItem is GridInsertionObject %>'>
                        </asp:Button>
                        &nbsp;
