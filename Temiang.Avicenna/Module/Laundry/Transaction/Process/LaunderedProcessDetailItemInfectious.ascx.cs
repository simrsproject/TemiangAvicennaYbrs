...
{
    public partial class LaunderedProcessDetailItemInfectious : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            txtProcessSeqNo.Text = (String)DataBinder.Eval(DataItem, LaunderedProcessItemInfectiousMetadata.ColumnNames.ProcessSeqNo);
            txtReceivedNo.Text =
                (String)DataBinder.Eval(DataItem, LaunderedProcessItemInfectiousMetadata.ColumnNames.ReceivedNo);
            txtReceivedSeqNo.Text =
                (String)DataBinder.Eval(DataItem, LaunderedProcessItemInfectiousMetadata.ColumnNames.ReceivedSeqNo);
            ...
            var ri = new LaundryReceivedItemInfectious();
            ...
            txtQty.Value = Convert.ToDouble(DataBinder.Eval(DataItem, LaunderedProcessItemInfectiousMetadata.ColumnNames.Qty));
        ...
        {
            var received = new LaundryReceivedItemInfectious();
            double qtyReceived = received.LoadByPrimaryKey(receivedNo, receivedSeqNo) ? Convert.ToDouble(received.Qty ?? 0) : 0;

            DataTable dtb = (new LaunderedProcessItemInfectiousCollection()).GetQtyProcessed(processNo, processSeqNo, receivedNo, receivedSeqNo);
