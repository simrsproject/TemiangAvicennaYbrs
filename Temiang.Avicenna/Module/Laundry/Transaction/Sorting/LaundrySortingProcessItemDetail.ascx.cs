...
{
    public partial class LaundrySortingProcessItemDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            cboItemID.SelectedValue = (String)DataBinder.Eval(DataItem, LaundrySortingProcessItemMetadata.ColumnNames.ItemID);
            txtQty.Value = Convert.ToDouble(DataBinder.Eval(DataItem, LaundrySortingProcessItemMetadata.ColumnNames.Qty));
            ...
            cboSRItemUnit.SelectedValue = (String)DataBinder.Eval(DataItem, LaundrySortingProcessItemMetadata.ColumnNames.SRItemUnit);
        }
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (LaundrySortingProcessItemCollection)Session["collLaundrySortingProcessItem" + Request.UserHostName]; ;
