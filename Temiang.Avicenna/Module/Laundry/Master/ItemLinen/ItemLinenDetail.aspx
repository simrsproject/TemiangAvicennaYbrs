<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="ItemLinenDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Laundry.Master.ItemLinenDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="ItemDetailID" AllowPaging="true"
            PageSize="10">
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="ItemDetailID" HeaderText="Item ID"
                    UniqueName="ItemDetailID" SortExpression="ItemDetailID" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn DataField="ItemDetailName" HeaderText="Item Name" UniqueName="ItemDetailName"
                    SortExpression="ItemDetailName" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                <telerik:GridNumericColumn HeaderStyle-Width="65px" DataField="QtyDetail" HeaderText="Qty"
                    UniqueName="QtyDetail" SortExpression="QtyDetail" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="SRItemUnit" HeaderText="Unit"
                    UniqueName="SRItemUnit" SortExpression="SRItemUnit" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="Qty" HeaderText="/ Qty (Kg)"
            ...
            <EditFormSettings UserControlName="ItemLinenItemDetail.ascx" EditFormType="WebUserControl">
                <EditColumn UniqueName="ItemLinenItemEditCommand">
                </EditColumn>
            </EditFormSettings>
        </MasterTableView>
        <FilterMenu>
