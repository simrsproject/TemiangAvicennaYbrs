...
{
    public partial class WashingProgramTypeItemConsumption : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            cboItemID.SelectedValue = (String)DataBinder.Eval(DataItem, LaundryWashingProgramTypeItemConsumptionMetadata.ColumnNames.ItemID);
            txtQty.Value = Convert.ToDouble(DataBinder.Eval(DataItem, LaundryWashingProgramTypeItemConsumptionMetadata.ColumnNames.Qty));
            ...
            cboSRItemUnit.SelectedValue = (String)DataBinder.Eval(DataItem, LaundryWashingProgramTypeItemConsumptionMetadata.ColumnNames.SRItemUnit);
        }
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            if (ViewState["IsNewRecord"].Equals(true))
            {
                var coll = (LaundryWashingProgramTypeItemConsumptionCollection)Session["collLaundryWashingProgramTypeItemConsumption" + Request.UserHostName];
