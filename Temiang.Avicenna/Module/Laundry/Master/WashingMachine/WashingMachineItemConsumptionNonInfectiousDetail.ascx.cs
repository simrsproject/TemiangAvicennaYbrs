...
{
    public partial class WashingMachineItemConsumptionNonInfectiousDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            cboItemID.SelectedValue = (String)DataBinder.Eval(DataItem, LaundryWashingMachineItemConsumptionMetadata.ColumnNames.ItemID);
            txtQty.Value = Convert.ToDouble(DataBinder.Eval(DataItem, LaundryWashingMachineItemConsumptionMetadata.ColumnNames.Qty));
            ...
            cboSRItemUnit.SelectedValue = (String)DataBinder.Eval(DataItem, LaundryWashingMachineItemConsumptionMetadata.ColumnNames.SRItemUnit);
        }
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            if (ViewState["IsNewRecord"].Equals(true))
            {
                var coll = (LaundryWashingMachineItemConsumptionCollection)Session["collLaundryWashingMachineItemConsumptionNonInfectious" + Request.UserHostName];
