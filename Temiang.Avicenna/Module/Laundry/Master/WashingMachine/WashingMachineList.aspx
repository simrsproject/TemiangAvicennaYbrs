<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true" CodeBehind="WashingMachineList.aspx.cs" Inherits="Temiang.Avicenna.Module.Laundry.Master.WashingMachine.WashingMachineList" %>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource">
        <MasterTableView DataKeyNames="MachineID">
            <Columns>
                ...
                <telerik:GridNumericColumn HeaderStyle-Width="80px" DataField="Volume" HeaderText="Volume (Kg)"
