<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemDetailItem.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Cssd.Master.ItemDetailItem" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="CssdItemDetail" runat="server" ValidationGroup="CssdItemDetail" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="CssdItemDetail"
    ErrorMessage="" OnServerValidate="customValidator_ServerValidate">&nbsp;</asp:CustomValidator>
<table width="100%">
    <tr>
        <td class="label">
            <asp:Label ID="lblItemDetailID" runat="server" Text="Item Detail"></asp:Label>
        </td>
        <td class="entry">
            ...
            <telerik:RadComboBox ID="cboItemID" runat="server" Width="300px" EmptyMessage="Select a Item"
                ...
                <WebServiceSettings Method="CssdItemPackageSelection" Path="~/WebService/ComboBoxDataService.asmx" />
            </telerik:RadComboBox>

        </td>
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvItemDetailID" runat="server" ErrorMessage="Item Detail required."
                ControlToValidate="cboItemID" SetFocusOnError="True" ValidationGroup="CssdItemDetail"
                Width="100%">
    ...
    <tr height="30">
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvQuantity" runat="server" ErrorMessage="Quantity required."
                ControlToValidate="txtQty" SetFocusOnError="True" ValidationGroup="CssdItemDetail"
                Width="100%">
    ...
    <tr>
        <td align="right" colspan="2" style="height: 26px">
            <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="CssdItemDetail"
                Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
            <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                ValidationGroup="CssdItemDetail" Visible='<%# DataItem is GridInsertionObject %>'></asp:Button>
            &nbsp;
