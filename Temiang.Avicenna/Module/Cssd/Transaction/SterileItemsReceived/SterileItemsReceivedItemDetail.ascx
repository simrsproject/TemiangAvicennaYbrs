<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SterileItemsReceivedItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Cssd.Transaction.SterileItemsReceivedItemDetail" %>
...
<table width="100%">
    <tr>
        ...
        <td style="width: 50%; vertical-align: top">
            <table width="100%">
                <asp:Panel runat="server" ID="pnlAddInfo">
                    <tr runat="server" id="trExpiredDate">
                        ...
                        <td width="20px">
                            <asp:RequiredFieldValidator ID="rfvExpiredDate" runat="server" ErrorMessage="Expired Date required."
                                ControlToValidate="txtExpiredDate" SetFocusOnError="True" ValidationGroup="CssdSterileItemsReceivedItem"
                                Width="100%">
