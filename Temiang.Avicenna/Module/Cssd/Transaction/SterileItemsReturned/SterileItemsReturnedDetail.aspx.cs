...
{
    public partial class SterileItemsReturnedDetail : BasePageDetail
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            UrlPageList = "SterileItemsReturnedList.aspx";
        ...
        {
            OnPopulateEntryControl(new CssdSterileItemsReturned());
        ...
        {
            //var entity = new CssdSterileItemsReturned();
        ...
        {
            if (CssdSterileItemsReturnedItems.Count == 0)
            {
        ...
        protected override void OnMenuAuditLogClick(AuditLogFilter auditLogFilter)
        {
            ...
            auditLogFilter.TableName = "CssdSterileItemsReturned";
        }
        ...
        private bool IsApprovedOrVoid(CssdSterileItemsReturned entity, ValidateArgs args)
        {
        ...
        {
            var ret = (CssdSterileItemsReturned)entity;
        ...
        protected override void OnMenuUnApprovalClick(ValidateArgs args)
        {
            ...
            {
                args.MessageText = "This data has been closed.";
                args.IsCancel = true;
                return;
            }
        ...
        private void SetApproval(CssdSterileItemsReturned entity, bool isApproval, ValidateArgs args)
        {
            using (var trans = new esTransactionScope())
            {
                ...
                CssdItemBalance.PrepareItemBalanceReturn(entity.ReturnNo, AppSession.Parameter.ServiceUnitCssdID, entity.ToServiceUnitID, AppSession.UserLogin.UserID, isApproval,
                    ref balancesFrom, ref balancesTo);
        ...
        private void SetVoid(CssdSterileItemsReturned entity, bool isVoid)
        {
            using (var trans = new esTransactionScope())
            {
                //header
        ...
        private void SetEntityValue(CssdSterileItemsReturned entity)
        {
            ...
            foreach (var item in CssdSterileItemsReturnedItems)
            {
        ...
        private void SaveEntity(CssdSterileItemsReturned entity)
        {
            using (var trans = new esTransactionScope())
            {
                entity.Save();
        ...
        {
            var que = new CssdSterileItemsReturnedQuery();
        ...
        #region Record Detail Method Function of CssdSterileItemsReturnedItem

        private CssdSterileItemsReturnedItemCollection CssdSterileItemsReturnedItems
        {
            get
            {
                if (IsPostBack)
                {
                    object obj = Session["collCssdSterileItemsReturnedItem" + Request.UserHostName];
                    if (obj != null)
                    {
                        return ((CssdSterileItemsReturnedItemCollection)(obj));
                    }
                }

                var coll = new CssdSterileItemsReturnedItemCollection();
                var query = new CssdSterileItemsReturnedItemQuery("a");
                var procees = new CssdSterilizationProcessItemQuery("b");
                ...
                query.Select
                    (
                        query,
                        procees.Weight.As("refToCssdSterilizationProcessItem_Weight"),
                        received.CssdItemNo.As("refToCssdSterileItemsReceivedItem_CssdItemNo"),
                        @"<CAST(c.CssdItemNo  AS VARCHAR) AS 'refTo_CssdItemNo'>",
                ...
                query.InnerJoin(procees).On(procees.ProcessNo == query.ProcessNo &&
                                            procees.ProcessSeqNo == query.ProcessSeqNo);
                query.InnerJoin(received).On(received.ReceivedNo == procees.ReceivedNo &&
                                         received.ReceivedSeqNo == procees.ReceivedSeqNo);
                ...
                Session["collCssdSterileItemsReturnedItem" + Request.UserHostName] = coll;
                return coll;
            }
            set
            {
                Session["collCssdSterileItemsReturnedItem" + Request.UserHostName] = value;
            }
        }
        ...
        {
            //Display Data Detail
            CssdSterileItemsReturnedItems = null; //Reset Record Detail
            grdItem.DataSource = CssdSterileItemsReturnedItems; //Requery
            grdItem.MasterTableView.IsItemInserted = false;
            grdItem.MasterTableView.ClearEditItems();
            grdItem.DataBind();
        }

        private CssdSterileItemsReturnedItem FindItem(String seqNo)
        {
            CssdSterileItemsReturnedItemCollection coll = CssdSterileItemsReturnedItems;
            CssdSterileItemsReturnedItem retEntity = null;
            foreach (CssdSterileItemsReturnedItem rec in coll)
            {
        ...
        {
            grdItem.DataSource = CssdSterileItemsReturnedItems;
        }
        ...
        protected void grdItem_DeleteCommand(object source, GridCommandEventArgs e)
        {
            ...
            String seqNo =
                Convert.ToString(item.OwnerTableView.DataKeyValues[item.ItemIndex][CssdSterileItemsReturnedItemMetadata.ColumnNames.ReturnSeqNo]);
            CssdSterileItemsReturnedItem entity = FindItem(seqNo);
            if (entity != null)
                entity.MarkAsDeleted();
        }
        ...
        {
            _autoNumber = Helper.GetNewAutoNumber((new DateTime()).NowAtSqlServer().Date, AppEnum.AutoNumber.CssdReturnNo);
