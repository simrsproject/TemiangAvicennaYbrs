<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="SterilizationProcessDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Cssd.Transaction.SterilizationProcessDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function openWinPickList() {
                ...
                oWnd.setUrl('SterilizationProcessDetailItemPicklist.aspx?dtt=<%= Request.QueryString["dtt"] %>');
                oWnd.show();
                //oWnd.maximize();
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="vertical-align: top">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadDatePicker ID="txtProcessDate" runat="server" Width="100px" DateInput-ReadOnly="true"
                    ...
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblProcessTime" runat="server" Text="Time"></asp:Label>
                        </td>
                        <td class="entry">
                            <table cellpadding="0" cellspacing="">
                                <tr>
                                    <td>
                                        <telerik:RadMaskedTextBox ID="txtProcessStartTime" runat="server" Mask="<00..23>:<00..59>"
                                    ...
                                    <td>
                                        <telerik:RadMaskedTextBox ID="txtProcessEndTime" runat="server" Mask="<00..23>:<00..59>"
                                            PromptChar="_" RoundNumericRanges="false" Width="50px">
                                        </telerik:RadMaskedTextBox>
                                    </td>
                                </tr>
                        ...
                        <td width="20">
                            <asp:RequiredFieldValidator ID="rfvProcessStartTime" runat="server" ErrorMessage="Process Time required."
                                ValidationGroup="entry" ControlToValidate="txtProcessStartTime" SetFocusOnError="True"
                                Width="100%">
                    ...
                    <asp:Panel runat="server" ID="pnlProcessType">
                        <tr>
                            ...
                            <td class="entry">
                                <telerik:RadComboBox ID="cboSRCssdProcessType" runat="server" Width="300px" AllowCustomText="true"
                                    Filter="Contains" AutoPostBack="True" OnSelectedIndexChanged="cboSRCssdProcessType_SelectedIndexChanged">
                                </telerik:RadComboBox>
                            </td>
                            <td width="20">
                                <asp:RequiredFieldValidator ID="rfvSRCssdProcessType" runat="server" ErrorMessage="Process Type required."
                                    ValidationGroup="entry" ControlToValidate="cboSRCssdProcessType" SetFocusOnError="True"
                                    Width="100%">
                        ...
                        <tr>
                            <td class="label">
                                <asp:Label ID="lblMachineID" runat="server" Text="Machine"></asp:Label>
                            </td>
                            <td class="entry">
                    ...
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblOperatorByUserID" runat="server" Text="Operator By"></asp:Label>
                        </td>
                        <td class="entry">
                            <telerik:RadComboBox runat="server" ID="cboOperatorByUserID" Width="300px" EnableLoadOnDemand="true"
                                HighlightTemplatedItems="true" OnItemDataBound="cboOperatorByUserID_ItemDataBound"
                                OnItemsRequested="cboOperatorByUserID_ItemsRequested">
                                <ItemTemplate>
                                    <b>
                        ...
                        <td width="20px">
                            <asp:RequiredFieldValidator ID="rfvOperatorByUserID" runat="server" ErrorMessage="Operator By required."
                                ValidationGroup="entry" ControlToValidate="cboOperatorByUserID" SetFocusOnError="True"
                                Width="100%">
            ...
            <td style="vertical-align: top">
                <table>
                    <asp:Panel runat="server" ID="pnlProcessTo">
                        <tr>
                            <td class="label">
                                <asp:Label ID="lblProcessTo" runat="server" Text="Process #"></asp:Label>
                            </td>
                            <td class="entry">
                                <asp:Button ID="btnProcessTo" runat="server" CommandName="Pick" CssClass="minimal"
                                    Width="80px" />
                                <telerik:RadTextBox ID="txtProcessTo" runat="server" Visible="False" />
                            </td>
                            <td width="20"></td>
                            <td></td>
                        </tr>
                    </asp:Panel>
                    <tr runat="server" id="trExpiredDate">
                        <td class="label">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" ShowFooter="False" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="ProcessSeqNo">
            ...
            <EditFormSettings UserControlName="SterilizationProcessItemDetail.ascx" EditFormType="WebUserControl">
                <EditColumn UniqueName="CssdSterilizationProcessItemEditCommand">
                </EditColumn>
            </EditFormSettings>
        </MasterTableView>
        <FilterMenu>
