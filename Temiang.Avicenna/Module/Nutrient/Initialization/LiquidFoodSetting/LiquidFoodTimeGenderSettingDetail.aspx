<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master"
    AutoEventWireup="true" CodeBehind="LiquidFoodTimeGenderSettingDetail.aspx.cs"
    Inherits="Temiang.Avicenna.Module.Nutrient.Initialization.LiquidFoodTimeGenderSettingDetail" %>
            ...
            <td colspan="2">
                <telerik:RadGrid ID="grdDetail" runat="server" OnNeedDataSource="grdDetail_NeedDataSource"
                    ...
                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="Gender">
                        ...
                        <EditFormSettings UserControlName="LiquidFoodTimeGenderSettingItemDetail.ascx" EditFormType="WebUserControl">
                            <EditColumn UniqueName="EditCommandLiquidFoodTimeGenderSettingItem">
                            </EditColumn>
                        </EditFormSettings>
                    </MasterTableView>
                    <FilterMenu>
