<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="LiquidFoodSettingSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Nutrient.Initialization.LiquidFoodSettingSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            ...
            <td class="entry">
                <telerik:RadTextBox ID="txtStandardReferenceID" runat="server" Width="300px" MaxLength="10" />
            </td>
            <td>
            </td>
        </tr>
