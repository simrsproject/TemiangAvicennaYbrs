...
{
    public partial class LiquidFoodDietTimeGenderSettingItemDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            cboGender.SelectedValue = (String)DataBinder.Eval(DataItem, LiquidFoodDietTimeGenderMetadata.ColumnNames.Time);

            var foodId = Convert.ToString(DataBinder.Eval(DataItem, LiquidFoodDietTimeGenderMetadata.ColumnNames.FoodID));
            ...
            foodId = Convert.ToString(DataBinder.Eval(DataItem, LiquidFoodDietTimeGenderMetadata.ColumnNames.ChildrenFoodID));
            if (!string.IsNullOrEmpty(foodId))
            {
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (LiquidFoodDietTimeGenderCollection)Session["collLiquidFoodDietTimeGender" + Request.UserHostName];

                string g = cboGender.SelectedValue;

                bool isExist = false;
                foreach (LiquidFoodDietTimeGender item in coll)
                {
