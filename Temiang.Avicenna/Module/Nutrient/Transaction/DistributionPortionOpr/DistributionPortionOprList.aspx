<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="DistributionPortionOprList.aspx.cs" Inherits="Temiang.Avicenna.Module.Nutrient.Transaction.DistributionPortionOprList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadToolBar ID="RadToolBar2" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
        <Items>
            ...
            <telerik:RadToolBarButton runat="server" Text="Print Menu" Value="print"
        ...
        <MasterTableView DataKeyNames="OrderNo" ClientDataKeyNames="OrderNo" GroupLoadMode="Client">
            ...
            <Columns>
                <telerik:GridTemplateColumn Groupable="false" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                        <%# ((DataBinder.Eval(Container.DataItem, "IsDistributed").Equals(true) || DataBinder.Eval(Container.DataItem, "IsVoid").Equals(true)) ? string.Empty :
                ...
                <telerik:GridBoundColumn DataField="OrderNo" HeaderText="Order No"
                    UniqueName="OrderNo" SortExpression="OrderNo">
