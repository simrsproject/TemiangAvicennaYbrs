<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EventMealOrderItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Nutrient.Transaction.EventMealOrderItemDetail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumEventMealOrderItem" runat="server" ValidationGroup="EventMealOrderItem" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="EventMealOrderItem"
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvFoodID" runat="server" ErrorMessage="Food required."
                            ControlToValidate="cboFoodID" SetFocusOnError="True" ValidationGroup="EventMealOrderItem"
                            Width="100%">
                ...
                <tr>
                    <td align="right" colspan="2" style="height: 26px">
                        <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="EventMealOrderItem"
                            CausesValidation="true" Visible='<%# !(DataItem is GridInsertionObject) %>'>
                        </asp:Button>
                        <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                            ValidationGroup="EventMealOrderItem" CausesValidation="true" Visible='<%# DataItem is GridInsertionObject %>'>
                        </asp:Button>
                        &nbsp;
