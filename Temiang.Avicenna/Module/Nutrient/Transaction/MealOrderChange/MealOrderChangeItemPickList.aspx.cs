...
{
    public partial class MealOrderChangeItemPickList : BasePageDialog
    {
        ...
        protected void grdList_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            ...
            query.Where(query.MenuItemID == m.MenuItemID, query.SRMealSet == srMealSet, query.IsOptional == true);
