<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="MealOrderChangeItemPickListDietChange.aspx.cs" Inherits="Temiang.Avicenna.Module.Nutrient.Transaction.MealOrderChangeItemPickListDietChange" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="cboDietID">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="txtMenuID" />
                    <telerik:AjaxUpdatedControl ControlID="txtMenu" />
                    <telerik:AjaxUpdatedControl ControlID="txtMenuItemID" />
            ...
            <td width="50%" style="vertical-align: top">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadComboBox runat="server" ID="cboDietID" Width="300px"
        ...
        <tr>
            <td valign="top" width="50%">
                <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
                    AutoGenerateColumns="False" GridLines="None" AllowSorting="true" AllowPaging="true"
                    PageSize="30" OnItemCommand="grdList_ItemCommand">
                    <HeaderContextMenu>
                    </HeaderContextMenu>
            ...
            <td valign="top" width="50%">
                <telerik:RadGrid ID="grdSelected" runat="server" AutoGenerateColumns="False" GridLines="None"
                    AllowSorting="true" AllowPaging="true" PageSize="30" OnItemCommand="grdSelected_ItemCommand"
                    ...
                    <MasterTableView CommandItemDisplay="None" DataKeyNames="FoodID">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderStyle-Width="150px" DataField="FoodGroupName" HeaderText="Group"
                                UniqueName="FoodGroupName" SortExpression="FoodGroupName" HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-HorizontalAlign="Left" AllowSorting="false" />
                            <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="SRFoodGroup1" HeaderText="FoodGroupID"
                                UniqueName="SRFoodGroup1" SortExpression="SRFoodGroup1" HeaderStyle-HorizontalAlign="Left"
