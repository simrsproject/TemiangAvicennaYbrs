<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="MedicalRecordFileReceiveList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.MedicalRecordFileReceiveList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function rowReceived(regNo) {
                __doPostBack("<%= grdRegisteredList.UniqueID %>", 'received|' + regNo);
            }
                            ...
                            <td class="entry">
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadMaskedTextBox ID="txtReceiveTime" runat="server" Mask="<00..23>:<00..59>"
    ...
    <telerik:RadGrid ID="grdRegisteredList" runat="server" OnNeedDataSource="grdRegisteredList_NeedDataSource"
        OnItemDataBound="grdRegisteredList_ItemDataBound"
        AutoGenerateColumns="False" AllowPaging="True" PageSize="15" AllowSorting="true"  AllowMultiRowSelection="true">
        <MasterTableView DataKeyNames="RegistrationNo" GroupLoadMode="Client" Name="MainTable">
            <Columns>
