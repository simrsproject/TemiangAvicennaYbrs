...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord
{
    public partial class RlReport3_14 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport314Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport314Collection();
        ...
        {
            grdRlReport3_14.DataSource = RlTxReport314S;
        }

        private RlTxReport314Collection RlTxReport314S
        {
            get
            {
                var obj = ViewState["collRlTxReport314"];
                if (obj != null)
                    return ((RlTxReport314Collection)(obj));

                var collection = new RlTxReport314Collection();

                var query = new RlTxReport314Query("a");
                ...
                ViewState["collRlTxReport314"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport314"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL3_14);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport314S)
            {
                ...
                {
                    RlTxReport314.Process(fromMonth, toMonth, year, paramedicRl1, out rujukanPuskesmas, out rujukanFasKesLain, out rujukanRsLain, out dirujukKePuskesmasAsal,
