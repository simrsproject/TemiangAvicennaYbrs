<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport4BSebab.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport4BSebab" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport4BSebab.UniqueID %>", "process");
            }
            
            function onPrint() {
                __doPostBack("<%= grdRlReport4BSebab.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport4BSebab" runat="server" OnNeedDataSource="grdRlReport4BSebab_NeedDataSource"
            ...
            <MasterTableView CommandItemDisplay="None" DataKeyNames="RlMasterReportItemID">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="60px" HeaderText="Kasus Baru Lk" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtKasusBaruL" runat="server" Width="35px" DbValue='<%#Eval("KasusBaruL")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="60px" HeaderText="Kasus Baru Pr" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtKasusBaruP" runat="server" Width="35px" DbValue='<%#Eval("KasusBaruP")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="60px" HeaderText="Total Kasus Baru"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtTotalKasusBaru" runat="server" Width="35px" DbValue='<%#Eval("TotalKasusBaru")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="60px" HeaderText="Total Kunjungan"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtTotalKunjungan" runat="server" Width="35px" DbValue='<%#Eval("TotalKunjungan")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                </Columns>
