<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport2.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport2.UniqueID %>", "process");
            }
            function onPrint() {
                __doPostBack("<%= grdRlReport2.UniqueID %>", "print");
            }
        </script>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td class="entry">
                <telerik:RadTextBox ID="txtRlTxReportNo" runat="server" Width="100px" MaxLength="10" />
            </td>
            <td>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport2" runat="server" OnNeedDataSource="grdRlReport2_NeedDataSource"
            ...
            <MasterTableView CommandItemDisplay="None" DataKeyNames="RlMasterReportItemID">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="RlMasterReportItemName" HeaderText="Kualifikasi Pendidikan"
                        UniqueName="RlMasterReportItemName" SortExpression="ItemName">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </telerik:GridBoundColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Keadaan Laki-Laki"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtKeadaanLakiLaki" runat="server" Width="55px" DbValue='<%#Eval("KeadaanLakiLaki")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Keadaan Perempuan"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtKeadaanPerempuan" runat="server" Width="55px" DbValue='<%#Eval("KeadaanPerempuan")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Kebutuhan Laki-Laki"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtKebutuhanLakiLaki" runat="server" Width="55px"
                                DbValue='<%#Eval("KebutuhanLakiLaki")%>' NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Kebutuhan Perempuan"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtKebutuhanPerempuan" runat="server" Width="55px"
                                DbValue='<%#Eval("KebutuhanPerempuan")%>' NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Kekurangan Laki-Laki"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtKekuranganLakiLaki" runat="server" Width="55px"
                                DbValue='<%#Eval("KekuranganLakiLaki")%>' NumberFormat-DecimalDigits="0" Enabled="False" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Kekurangan Perempuan"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtKekuranganPerempuan" runat="server" Width="55px"
                                DbValue='<%#Eval("KekuranganPerempuan")%>' NumberFormat-DecimalDigits="0" Enabled="False" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                </Columns>
            </MasterTableView>
