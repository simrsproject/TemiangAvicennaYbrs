...
{
    public partial class RlReport4B : BasePageDetail
    {
        ...
        private void SaveEntity(RlTxReport entity)
        {
            ...
            var coll = new RlTxReport4BCollection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            //var newcoll = RlTxReport4Bs;

            //RlTxReport4B.Process(fromMonth, toMonth, year, AppSession.UserLogin.UserID, newcoll, out newcoll);
            ...
            int result = RlTxReport.ProcessRlTxReport4B(entity.RlTxReportNo, fromMonth, toMonth, year, AppSession.UserLogin.UserID);
        }
        ...
        protected void grdRlReport4B_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            //grdRlReport4B.DataSource = RlTxReport4Bs;
        }

        private RlTxReport4BCollection RlTxReport4Bs
        {
            get
            {
                var obj = ViewState["collRlTxReport4B"];
                if (obj != null)
                    return ((RlTxReport4BCollection)(obj));

                var collection = new RlTxReport4BCollection();
                ...
                ViewState["collRlTxReport4B"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport4B"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport4B.Rebind();
                    break;
                case "print":
                    Print(AppConstant.Report.RL4B);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            epidiagq.InnerJoin(diagq).On(
                ...
                diagq.DtdNo.In(RlTxReport4Bs.Select(r => r.RlMasterReportItemCode).ToArray())
                );
            ...
            {
                var item = RlTxReport4Bs.Where(r => r.RlMasterReportItemCode == row["DtdNo"].ToString()).Single();
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport4B.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;
