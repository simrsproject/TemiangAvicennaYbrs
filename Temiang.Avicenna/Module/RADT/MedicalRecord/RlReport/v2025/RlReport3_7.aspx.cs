...
{
    public partial class RlReport3_7 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport37v2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport37v2025Collection();

            foreach (GridDataItem dataItem in grdRlReport3_7v2025.MasterTableView.Items)
            {
        ...
        protected void grdRlReport3_7v2025_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport3_7v2025.DataSource = RlTxReport37v2025S;
        }

        private RlTxReport37v2025Collection RlTxReport37v2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport37v2025"];
                if (obj != null)
                    return ((RlTxReport37v2025Collection)(obj));

                var collection = new RlTxReport37v2025Collection();

                var query = new RlTxReport37v2025Query("a");
                ...
                ViewState["collRlTxReport37v2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport37v2025"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport3_7v2025.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL3_7V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport37v2025S)
            {
                RlTxReport37v2025.Process(fromMonth, toMonth, year, item.RlMasterReportItemID ?? 0, out int pRmRumahSakit, out int pRmBidan, out int pRmPuskesmas, out int pRmFasKesLain,
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport3_7v2025.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;

            //Reset Detail
            if (oldVal != AppEnum.DataMode.Read)
                RlTxReport37v2025S = null;
