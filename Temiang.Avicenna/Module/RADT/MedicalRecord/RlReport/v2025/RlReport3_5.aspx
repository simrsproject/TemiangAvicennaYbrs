<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport3_5.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.v2025.RlReport3_5" %>
        ...
        <telerik:RadGrid ID="grdRlReport3_5" runat="server" OnNeedDataSource="grdRlReport3_5_NeedDataSource"
            ...
            <MasterTableView CommandItemDisplay="None" DataKeyNames="RlMasterReportItemID">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Kunjungan Pasien
Dalam Kab/Kota <br> Jumlah Laki Laki" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtJumlahLaki" runat="server" Width="55px" DbValue='<%#Eval("JumlahLaki")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>

                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Kunjungan Pasien
Dalam Kab/Kota <br> Jumlah Perempuan" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtJumlahPerempuan" runat="server" Width="55px" DbValue='<%#Eval("JumlahPerempuan")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Kunjungan Pasien
Luar Kab/Kota <br> Jumlah Laki Laki" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtJumlahLaki2" runat="server" Width="55px" DbValue='<%#Eval("JumlahLaki2")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>

                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Kunjungan Pasien
Luar Kab/Kota <br> Jumlah Perempuan" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtJumlahPerempuan2" runat="server" Width="55px" DbValue='<%#Eval("JumlahPerempuan2")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Jumlah" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtJumlah" runat="server" Width="55px" DbValue='<%#Eval("Jumlah")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                </Columns>
