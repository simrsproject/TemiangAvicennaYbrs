...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord.v2025
{
    public partial class RlReport5_3 : BasePageDetail
    {
        ...
        {
            foreach (RlTxReport53V2025 item in RlTxReport53V2025s)
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport5_3V2025.Columns[0].Visible = isVisible;
            grdRlReport5_3V2025.Columns[grdRlReport5_3V2025.Columns.Count - 1].Visible = isVisible;

            grdRlReport5_3V2025.MasterTableView.CommandItemDisplay = isVisible
                ? GridCommandItemDisplay.Top
                : GridCommandItemDisplay.None;
            //Reset Detail
            if (oldVal != AppEnum.DataMode.Read)
                RlTxReport53V2025s = null;

            //Perbaharui tampilan dan data
            grdRlReport5_3V2025.Rebind();
        }

        private RlTxReport53V2025Collection RlTxReport53V2025s
        {
            get
            {
                if (IsPostBack)
                {
                    object obj = Session["collRlTxReport53V2025"];
                    if (obj != null)
                        return ((RlTxReport53V2025Collection)(obj));
                }

                var coll = new RlTxReport53V2025Collection();
                var query = new RlTxReport53V2025Query("a");
                ...
                Session["collRlTxReport53V2025"] = coll;
                return coll;
            }
            set
            {
                Session["collRlTxReport53V2025"] = value;
            }
        }
        ...
        {
            //Display Data Detail
            RlTxReport53V2025s = null; //Reset Record Detail
            grdRlReport5_3V2025.DataSource = RlTxReport53V2025s;
            grdRlReport5_3V2025.DataBind();
        }

        protected void grdRlReport5_3V2025_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport5_3V2025.DataSource = RlTxReport53V2025s;
        }

        protected void grdRlReport5_3V2025_UpdateCommand(object source, GridCommandEventArgs e)
        {
            var editedItem = e.Item as GridEditableItem;
            if (editedItem == null) return;

            String diagId = Convert.ToString(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex][RlTxReport53V2025Metadata.ColumnNames.DiagnosaID]);
            RlTxReport53V2025 entity = FindRlTxReport53V2025(diagId);
            if (entity != null)
                SetEntityValue(entity, e);
        }

        protected void grdRlReport5_3V2025_DeleteCommand(object source, GridCommandEventArgs e)
        {
            var item = e.Item as GridDataItem;
            if (item == null) return;

            String diagId = Convert.ToString(item.OwnerTableView.DataKeyValues[item.ItemIndex][RlTxReport53V2025Metadata.ColumnNames.DiagnosaID]);
            RlTxReport53V2025 entity = FindRlTxReport53V2025(diagId);
            if (entity != null)
                entity.MarkAsDeleted();
        }

        protected void grdRlReport5_3V2025_InsertCommand(object source, GridCommandEventArgs e)
        {
            RlTxReport53V2025 entity = RlTxReport53V2025s.AddNew();
            SetEntityValue(entity, e);
        }

        private RlTxReport53V2025 FindRlTxReport53V2025(String diagNo)
        {
            RlTxReport53V2025Collection coll = RlTxReport53V2025s;
            RlTxReport53V2025 retEntity = null;
            foreach (RlTxReport53V2025 rec in coll)
            {
        ...
        private void SetEntityValue(RlTxReport53V2025 entity, GridCommandEventArgs e)
        {
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL5_3V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            RlTxReport53V2025s.MarkAllAsDeleted();
            ...
            {
                var entity = RlTxReport53V2025s.AddNew();
