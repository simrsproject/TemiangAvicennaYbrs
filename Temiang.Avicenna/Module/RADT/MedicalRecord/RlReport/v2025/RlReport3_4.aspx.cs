...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord.v2025
{
    public partial class RlReport3_4 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport34V2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport34V2025Collection();

            foreach (GridDataItem dataItem in grdRlReport3_4V2025.MasterTableView.Items)
            {
        ...
        {
            grdRlReport3_4V2025.DataSource = RlTxReport34V2025S;
        }

        private RlTxReport34V2025Collection RlTxReport34V2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport34V2025"];
                if (obj != null)
                    return ((RlTxReport34V2025Collection)(obj));

                var collection = new RlTxReport34V2025Collection();

                var query = new RlTxReport34V2025Query("a");
                ...
                ViewState["collRlTxReport34V2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport34V2025"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport3_4V2025.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL3_4_V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport34V2025S)
            {
                var mri = new RlMasterReportItemV2025();
                mri.LoadByPrimaryKey(item.RlMasterReportItemID ?? 0);

                RlTxReport34V2025.Process(fromMonth, toMonth, year, mri.RlMasterReportItemCode, out int jml);
                ...
                //if (mri.RlMasterReportItemCode == "1")
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport3_4V2025.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;

            //Reset Detail
            if (oldVal != AppEnum.DataMode.Read)
                RlTxReport34V2025S = null;
