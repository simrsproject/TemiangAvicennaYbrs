...
{
    public partial class RlReport3_5 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport35V2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport35V2025Collection();

            foreach (GridDataItem dataItem in  grdRlReport3_5.MasterTableView.Items)
            {
                var reportItemId = dataItem.GetDataKeyValue("RlMasterReportItemID").ToInt();
                var txtJumlahLaki = (dataItem.FindControl("txtJumlahLaki") as RadNumericTextBox);
                var txtJumlahPerempuan = (dataItem.FindControl("txtJumlahPerempuan") as RadNumericTextBox);


                var txtJumlahLaki2 = (dataItem.FindControl("txtJumlahLaki2") as RadNumericTextBox);
                var txtJumlahPerempuan2 = (dataItem.FindControl("txtJumlahPerempuan2") as RadNumericTextBox);
                ...
                rpt.JumlahLaki = txtJumlahLaki.Value.ToInt();
                rpt.JumlahPerempuan = txtJumlahPerempuan.Value.ToInt();


                rpt.JumlahLaki2 = txtJumlahLaki2.Value.ToInt();
                rpt.JumlahPerempuan2 = txtJumlahPerempuan2.Value.ToInt();
            }
        ...
        protected void  grdRlReport3_5_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
             grdRlReport3_5.DataSource = RlTxReport35V2025S;
        }

        private RlTxReport35V2025Collection RlTxReport35V2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport35V2025"];
                if (obj != null)
                    return ((RlTxReport35V2025Collection)(obj));

                var collection = new RlTxReport35V2025Collection();

                var query = new RlTxReport35V2025Query("a");
                ...
                if (collection.Count == 0)
                {
                    ...
                    foreach (var item in mric)
                    {
                        ...
                        coll.JumlahLaki = 0;
                        coll.JumlahPerempuan = 0;
                        coll.JumlahLaki2 = 0;
                        coll.JumlahPerempuan2 = 0;
                    }
                }

                ViewState["collRlTxReport35V2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport35V2025"] = value; }
        }
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    Process();
                     ...
                     grdRlReport3_5.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL3_5_V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport35V2025S)
            {
                int jml = 0;
                int jmllk = 0;
                int jmlpr = 0;
                ...
                if (item.RlMasterReportItemID == 206) //TOTAL
                {
                    jml = total;
                    jmllk = totallk;
                    jmlpr = totalpr;
                ...
                {
                    RlTxReport35V2025.Process(fromMonth, toMonth, year, mri.RlMasterReportItemID ?? 0, parValue, AppSession.Parameter.AssasmentObgynPoliKebidanan, AppSession.Parameter.AssasmentObgynPenyKandungan,
                        out jml, out jmllk, out jmlpr,out jmllk2, out jmlpr2);
                    total += jml;
                    totallk += jmllk;
                    totalpr += jmlpr;
                ...
                item.JumlahLaki = jmllk;
                item.JumlahPerempuan = jmlpr;

                item.JumlahLaki2 = jmllk2;
                item.JumlahPerempuan2 = jmlpr2;
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            bool isVisible = (newVal != AppEnum.DataMode.Read);
             ...
             grdRlReport3_5.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;

            //Reset Detail
            if (oldVal != AppEnum.DataMode.Read)
                RlTxReport35V2025S = null;
