...
{
    public partial class RlReport4_2 : BasePageDetail
    {
        ...
        {
            foreach (RlTxReport42V2025 item in RlTxReport42V2025s)
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport4_2V2025.Columns[0].Visible = isVisible;
            grdRlReport4_2V2025.Columns[grdRlReport4_2V2025.Columns.Count - 1].Visible = isVisible;

            grdRlReport4_2V2025.MasterTableView.CommandItemDisplay = isVisible
                ? GridCommandItemDisplay.Top
                : GridCommandItemDisplay.None;
            //Reset Detail
            if (oldVal != AppEnum.DataMode.Read)
                RlTxReport42V2025s = null;

            //Perbaharui tampilan dan data
            grdRlReport4_2V2025.Rebind();
        }

        private RlTxReport42V2025Collection RlTxReport42V2025s
        {
            get
            {
                if (IsPostBack)
                {
                    object obj = Session["collRlTxReport42V2025"];
                    if (obj != null)
                        return ((RlTxReport42V2025Collection)(obj));
                }

                var coll = new RlTxReport42V2025Collection();
                var query = new RlTxReport42V2025Query("a");
                ...
                Session["collRlTxReport42V2025"] = coll;
                return coll;
            }
            set
            {
                Session["collRlTxReport42V2025"] = value;
            }
        }
        ...
        {
            //Display Data Detail
            RlTxReport42V2025s = null; //Reset Record Detail
            grdRlReport4_2V2025.DataSource = RlTxReport42V2025s;
            grdRlReport4_2V2025.DataBind();
        }

        protected void grdRlReport4_2V2025_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport4_2V2025.DataSource = RlTxReport42V2025s;
        }

        protected void grdRlReport4_2V2025_UpdateCommand(object source, GridCommandEventArgs e)
        {
            var editedItem = e.Item as GridEditableItem;
            if (editedItem == null) return;

            String diagId = Convert.ToString(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex][RlTxReport42V2025Metadata.ColumnNames.DiagnosaID]);
            RlTxReport42V2025 entity = FindRlTxReport42V2025(diagId);
            if (entity != null)
                SetEntityValue(entity, e);
        }

        protected void grdRlReport4_2V2025_DeleteCommand(object source, GridCommandEventArgs e)
        {
            var item = e.Item as GridDataItem;
            if (item == null) return;

            String diagId = Convert.ToString(item.OwnerTableView.DataKeyValues[item.ItemIndex][RlTxReport42V2025Metadata.ColumnNames.DiagnosaID]);
            RlTxReport42V2025 entity = FindRlTxReport42V2025(diagId);
            if (entity != null)
                entity.MarkAsDeleted();
        }

        protected void grdRlReport4_2V2025_InsertCommand(object source, GridCommandEventArgs e)
        {
            RlTxReport42V2025 entity = RlTxReport42V2025s.AddNew();
            SetEntityValue(entity, e);
        }

        private RlTxReport42V2025 FindRlTxReport42V2025(String diagNo)
        {
            RlTxReport42V2025Collection coll = RlTxReport42V2025s;
            RlTxReport42V2025 retEntity = null;
            foreach (RlTxReport42V2025 rec in coll)
            {
        ...
        private void SetEntityValue(RlTxReport42V2025 entity, GridCommandEventArgs e)
        {
            var userControl = (RlReport4_2Detail)e.Item.FindControl(GridEditFormItem.EditFormUserControlID);
            if (userControl != null)
            {
                entity.RlTxReportNo = txtRlTxReportNo.Text;
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL4_2V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            RlTxReport42V2025s.MarkAllAsDeleted();

            //RlTxReport42V2025.Process(fromMonth, toMonth, year, txtRlTxReportNo.Text, AppSession.Parameter.DischargeConditionDieLessThen48, AppSession.Parameter.DischargeConditionDieMoreThen48,
            //        AppSession.UserLogin.UserID, RlTxReport42V2025s, out RlTxReport42V2025s);
            ...
            {
                var entity = RlTxReport42V2025s.AddNew();
