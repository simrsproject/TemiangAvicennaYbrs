<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport4_2.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport.v2025.RlReport4_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport4_2V2025.UniqueID %>", "process");
            }

            function onPrint() {
                __doPostBack("<%= grdRlReport4_2V2025.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport4_2V2025" runat="server" OnNeedDataSource="grdRlReport4_2V2025_NeedDataSource"
            AutoGenerateColumns="False" GridLines="None" OnUpdateCommand="grdRlReport4_2V2025_UpdateCommand"
            OnDeleteCommand="grdRlReport4_2V2025_DeleteCommand" OnInsertCommand="grdRlReport4_2V2025_InsertCommand">
            <HeaderContextMenu>
            </HeaderContextMenu>
            <MasterTableView CommandItemDisplay="None" DataKeyNames="DiagnosaID">
                <CommandItemTemplate>
                    &nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="lbInsert" runat="server" CommandName="InitInsert" Visible='<%# !grdRlReport4_2V2025.MasterTableView.IsItemInserted %>'>
                    ...
                    &nbsp;&nbsp;
                    <asp:LinkButton ID="lbPickList" runat="server" Visible='<%# !grdRlReport4_2V2025.MasterTableView.IsItemInserted %>'
                ...
                <Columns>
                    ...
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="KeluarHidupL" HeaderText="Pasien Keluar Hidup Lk"
                        UniqueName="KeluarHidupL" SortExpression="KeluarHidupL" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="KeluarHidupP" HeaderText="Pasien Keluar Hidup Pr"
                        UniqueName="KeluarHidupP" SortExpression="KeluarHidupP" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="KeluarMatiL" HeaderText="Pasien Keluar Mati Lk"
                        UniqueName="KeluarMatiL" SortExpression="KeluarMatiL" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="KeluarMatiP" HeaderText="Pasien Keluar Mati Pr"
                ...
                <EditFormSettings UserControlName="RlReport4_2Detail.ascx" EditFormType="WebUserControl">
                    <EditColumn UniqueName="RlReport4_2DetailCommand">
                    </EditColumn>
                </EditFormSettings>
            </MasterTableView>
            <FilterMenu>
