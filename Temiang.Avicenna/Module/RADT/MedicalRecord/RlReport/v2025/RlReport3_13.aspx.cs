...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord.v2025
{
    public partial class RlReport3_13 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport313V2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport313V2025Collection();
        ...
        {
            grdRlReport3_13.DataSource = RlTxReport313V2025S;
        }

        private RlTxReport313V2025Collection RlTxReport313V2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport313V2025"];
                if (obj != null)
                    return ((RlTxReport313V2025Collection)(obj));

                var collection = new RlTxReport313V2025Collection();

                var query = new RlTxReport313V2025Query("a");
                ...
                ViewState["collRlTxReport313V2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport313V2025"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL3_13V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport313V2025S)
            {
                RlTxReport313V2025.Process(fromMonth, toMonth, year, item.RlMasterReportItemID ?? 0, out int jml);
