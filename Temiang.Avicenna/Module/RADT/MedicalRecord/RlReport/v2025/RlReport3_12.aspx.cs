...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord.v2025
{
    public partial class RlReport3_12 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport312V2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport312V2025Collection();
        ...
        {
            grdRlReport3_12.DataSource = RlTxReport312V2025S;
        }

        private RlTxReport312V2025Collection RlTxReport312V2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport312V2025"];
                if (obj != null)
                    return ((RlTxReport312V2025Collection)(obj));

                var collection = new RlTxReport312V2025Collection();

                var query = new RlTxReport312V2025Query("a");
                ...
                ViewState["collRlTxReport312V2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport312V2025"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL3_12V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport312V2025S)
            {
                ...
                {
                    RlTxReport312V2025.Process(fromMonth, toMonth, year, surgerySpecialty, out khusus, out besar, out sedang, out kecil, out lain);
                }
