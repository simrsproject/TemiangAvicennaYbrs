...
{
    public partial class RlReport3_15 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport315V2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport315V2025Collection();

            foreach (GridDataItem dataItem in grdRlReport3_15.MasterTableView.Items)
            {
        ...
        protected void grdRlReport3_15_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport3_15.DataSource = RlTxReport315V2025S;
        }

        private RlTxReport315V2025Collection RlTxReport315V2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport315V2025"];
                if (obj != null)
                    return ((RlTxReport315V2025Collection)(obj));

                var collection = new RlTxReport315V2025Collection();

                var query = new RlTxReport315V2025Query("a");
                ...
                ViewState["collRlTxReport315V2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport315V2025"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport3_15.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL3_15V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport315V2025S)
            {
                RlTxReport315V2025.Process(fromMonth, toMonth, year, item.RlMasterReportItemID ?? 0, out int jml, out int jmllk, out int jmlpr);
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport3_15.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;

            //Reset Detail
            if (oldVal != AppEnum.DataMode.Read)
                RlTxReport315V2025S = null;
