...
{
    public partial class RlReport3_6v2025 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport36v2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport36v2025Collection();

            foreach (GridDataItem dataItem in grdRlReport3_6v2025.MasterTableView.Items)
            {
        ...
        protected void grdRlReport3_6v2025_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport3_6v2025.DataSource = RlTxReport36v2025S;
        }

        private RlTxReport36v2025Collection RlTxReport36v2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport36v2025"];
                if (obj != null)
                    return ((RlTxReport36v2025Collection)(obj));

                var collection = new RlTxReport36v2025Collection();

                var query = new RlTxReport36v2025Query("a");
                ...
                ViewState["collRlTxReport36v2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport36v2025"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport3_6v2025.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL3_6V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport36v2025S)
            {
                RlTxReport36v2025.Process(fromMonth, toMonth, year, item.RlMasterReportItemID ?? 0,
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport3_6v2025.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;

            //Reset Detail
            if (oldVal != AppEnum.DataMode.Read)
                RlTxReport36v2025S = null;
