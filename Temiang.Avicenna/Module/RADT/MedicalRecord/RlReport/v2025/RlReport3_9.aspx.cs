...
{
    public partial class RlReport3_9 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport39v2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport39v2025Collection();

            foreach (GridDataItem dataItem in grdRlReport3_9.MasterTableView.Items)
            {
        ...
        protected void grdRlReport3_9_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport3_9.DataSource = RlTxReport39v2025S;
        }

        private RlTxReport39v2025Collection RlTxReport39v2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport39v2025"];
                if (obj != null)
                    return ((RlTxReport39v2025Collection)(obj));

                var collection = new RlTxReport39v2025Collection();

                var query = new RlTxReport39v2025Query("a");
                ...
                ViewState["collRlTxReport39v2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport39v2025"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport3_9.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL3_9v2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport39v2025S)
            {
                RlTxReport39v2025.Process(fromMonth, toMonth, year, item.RlMasterReportItemID ?? 0, out int jml);
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport3_9.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;

            //Reset Detail
            if (oldVal != AppEnum.DataMode.Read)
                RlTxReport39v2025S = null;
