<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport3_7.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.v2025.RlReport3_7" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport3_7v2025.UniqueID %>", "process");
            }
            function onPrint() {
                __doPostBack("<%= grdRlReport3_7v2025.UniqueID %>", "print");
            }
        </script>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="entry">
                ...
                <telerik:RadTextBox ID="txtRlMasterReportName" runat="server" Width="350px" ReadOnly="True" />
            </td>
            <td>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport3_7v2025" runat="server" OnNeedDataSource="grdRlReport3_7v2025_NeedDataSource"
            ...
            <MasterTableView CommandItemDisplay="None" DataKeyNames="RlMasterReportItemID">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="60px" HeaderText="RM Hidup" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtRmHidup" runat="server" Width="35px" DbValue='<%#Eval("RmHidup")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="60px" HeaderText="RNM Hidup" HeaderStyle-HorizontalAlign="Center"
                       ItemStyle-HorizontalAlign="Center">
                       <ItemTemplate>
                           <telerik:RadNumericTextBox ID="txtRnmHidup" runat="server" Width="35px" DbValue='<%#Eval("RnmHidup")%>'
                               NumberFormat-DecimalDigits="0" />
                       </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="60px" HeaderText="NR Hidup" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtNrHidup" runat="server" Width="35px" DbValue='<%#Eval("NrHidup")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
