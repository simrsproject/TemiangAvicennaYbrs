<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport4_3.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport.v2025.RlReport4_3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport4_3V2025.UniqueID %>", "process");
            }

            function onPrint() {
                __doPostBack("<%= grdRlReport4_3V2025.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport4_3V2025" runat="server" OnNeedDataSource="grdRlReport4_3V2025_NeedDataSource"
            AutoGenerateColumns="False" GridLines="None" OnUpdateCommand="grdRlReport4_3V2025_UpdateCommand"
            OnDeleteCommand="grdRlReport4_3V2025_DeleteCommand" OnInsertCommand="grdRlReport4_3V2025_InsertCommand">
            <HeaderContextMenu>
            </HeaderContextMenu>
            <MasterTableView CommandItemDisplay="None" DataKeyNames="DiagnosaID">
                <CommandItemTemplate>
                    &nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="lbInsert" runat="server" CommandName="InitInsert" Visible='<%# !grdRlReport4_3V2025.MasterTableView.IsItemInserted %>'>
                    ...
                    &nbsp;&nbsp;
                    <asp:LinkButton ID="lbPickList" runat="server" Visible='<%# !grdRlReport4_3V2025.MasterTableView.IsItemInserted %>'
                ...
                <Columns>
                    ...
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="HidupMatiL" HeaderText="Pasien Hidup dan Mati Laki-laki"
                        UniqueName="HidupMatiL" SortExpression="HidupMatiL" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="HidupMatiP" HeaderText="Pasien Hidup dan Mati Perempuan"
                        UniqueName="HidupMatiP" SortExpression="HidupMatiP" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="TotalHidupMati" HeaderText="Total"
                        UniqueName="TotalHidupMati" SortExpression="Total" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="KeluarMatiL" HeaderText="Pasien Keluar Mati Laki-laki"
                        UniqueName="KeluarMatiL" SortExpression="KeluarMatiL" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="KeluarMatiP" HeaderText="Pasien Keluar Mati Perempuan"
                        UniqueName="KeluarMatiP" SortExpression="KeluarMatiP" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                    <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="TotalKeluarMati" HeaderText="Total"
                        UniqueName="TotalKeluarMati" SortExpression="Total" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                ...
                <EditFormSettings UserControlName="RlReport4_3Detail.ascx" EditFormType="WebUserControl">
                    <EditColumn UniqueName="RlReport4_3DetailCommand">
                    </EditColumn>
                </EditFormSettings>
            </MasterTableView>
            <FilterMenu>
