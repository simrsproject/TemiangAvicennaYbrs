<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport3_10.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.v2025.RlReport3_10" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport3_10.UniqueID %>", "process");
            }
            function onPrint() {
                __doPostBack("<%= grdRlReport3_10.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport3_10" runat="server" OnNeedDataSource="grdRlReport3_10_NeedDataSource"
...
<%--                    <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Total Rujukan Masuk"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtTotalRujukanMasuk" runat="server" Width="35px" 
                                DbValue='<%#Eval("TotalRujukanMasuk")%>' NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>--%>
                    <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Rujukan dikembalikan ke Puskesmas"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Rujukan dikembalikan ke RS Asal"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtDirujukKeRsAsal" runat="server" Width="35px" 
                                DbValue='<%#Eval("DirujukKeRsAsal")%>' NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
...
<%--                    <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Total Rujukan Masuk dikembalikan"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtTotalRujukanDikembalikan" runat="server" Width="35px" 
                                DbValue='<%#Eval("TotalRujukanDikembalikan")%>'
                                NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>--%>
...
<%--                    <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Total Dirujuk Keluar"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadNumericTextBox ID="txtTotalDirujukKeluar" runat="server" Width="35px"
                                DbValue='<%#Eval("TotalDirujukKeluar")%>' NumberFormat-DecimalDigits="0" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>--%>
