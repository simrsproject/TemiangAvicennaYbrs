...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport
{
    public partial class RlReport3_11 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport311V2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport311V2025Collection();
        ...
        {
            grdRlReport3_3.DataSource = RlTxReport311V2025S;
        }

        private RlTxReport311V2025Collection RlTxReport311V2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport33"];
                if (obj != null)
                    return ((RlTxReport311V2025Collection)(obj));

                var collection = new RlTxReport311V2025Collection();

                var query = new RlTxReport311V2025Query("a");
                ...
                ViewState["collRlTxReport33"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport33"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL3_11V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport311V2025S)
            {
                RlTxReport311V2025.Process(fromMonth, toMonth, year, item.RlMasterReportItemID ?? 0, out int jml);
