...
{
    public partial class RlReport3_2 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport32v2025Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport32v2025Collection();
            ...
            foreach (GridDataItem dataItem in grdRlReport3_1.MasterTableView.Items)
            {
                ...
                var txtPasienLKeluarMatiK48 = (dataItem.FindControl("txtPasienLKeluarMatiK48") as RadNumericTextBox);
                var txtPasienPKeluarMatiK48 = (dataItem.FindControl("txtPasienPKeluarMatiK48") as RadNumericTextBox);
                var txtPasienLKeluarMatiL48 = (dataItem.FindControl("txtPasienLKeluarMatiL48") as RadNumericTextBox);
                var txtPasienPKeluarMatiL48 = (dataItem.FindControl("txtPasienPKeluarMatiL48") as RadNumericTextBox);
                ...
                var txtAlokasiTT = (dataItem.FindControl("txtAlokasiTT") as RadNumericTextBox);
                ...
                rpt.PasienLKeluarMatiK48 = txtPasienLKeluarMatiK48.Value.ToInt();
                rpt.PasienPKeluarMatiK48 = txtPasienPKeluarMatiK48.Value.ToInt();
                rpt.PasienLKeluarMatiL48 = txtPasienLKeluarMatiL48.Value.ToInt();
                rpt.PasienPKeluarMatiL48 = txtPasienPKeluarMatiL48.Value.ToInt();
                ...
                rpt.AlokasiTT = txtAlokasiTT.Value.ToInt();
        ...
        {
            grdRlReport3_1.DataSource = RlTxReport32v2025S;
        }

        private RlTxReport32v2025Collection RlTxReport32v2025S
        {
            get
            {
                var obj = ViewState["collRlTxReport32v2025"];
                if (obj != null)
                    return ((RlTxReport32v2025Collection)(obj));

                var collection = new RlTxReport32v2025Collection();

                var query = new RlTxReport32v2025Query("a");
                ...
                if (collection.Count == 0)
                {
                    ...
                    foreach (var item in mric)
                    {
                        ...
                        coll.PasienLKeluarMatiK48 = 0;
                        coll.PasienPKeluarMatiK48 = 0;
                        coll.PasienLKeluarMatiL48 = 0;
                        coll.PasienPKeluarMatiL48 = 0;
                ...
                ViewState["collRlTxReport32v2025"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport32v2025"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL3_2V2025);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport32v2025S)
            {
                int pAwal = 0, pMasuk = 0, pHidup = 0, pLMatiK48 = 0, pPMatiK48 = 0, pLMatiL48 = 0, pPMatiL48 = 0, pAkhir = 0, lamaRawat = 0, hariRawat = 0;
                int pPindahan = 0, pDipindahkan = 0, AlokasiTT = 0;
                ...
                {
                    RlTxReport32v2025.Process(startDate, endDate, paramedicRl1, AppSession.Parameter.DischargeConditionDieLessThen48, AppSession.Parameter.DischargeConditionDieMoreThen48,
                            out pAwal, out pMasuk, out pHidup, out pLMatiK48, out pPMatiK48, out pLMatiL48, out pPMatiL48, out pAkhir, out lamaRawat, out hariRawat, out pPindahan, out pDipindahkan,
                            out vvip, out vip, out i, out ii, out iii, out khusus, out AlokasiTT);
                }

                item.PasienAwal = pAwal;
                item.PasienMasuk = pMasuk;
                item.PasienKeluarHidup = pHidup;
                item.PasienLKeluarMatiK48 = pLMatiK48;
                item.PasienPKeluarMatiK48 = pPMatiK48;
                item.PasienLKeluarMatiL48 = pLMatiL48;
                item.PasienPKeluarMatiL48 = pPMatiL48;
