...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord
{
    public partial class RlReport3_9 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport39Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport39Collection();
        ...
        {
            grdRlReport3_9.DataSource = RlTxReport39S;
        }

        private RlTxReport39Collection RlTxReport39S
        {
            get
            {
                var obj = ViewState["collRlTxReport39"];
                if (obj != null)
                    return ((RlTxReport39Collection)(obj));

                var collection = new RlTxReport39Collection();

                var query = new RlTxReport39Query("a");
                ...
                ViewState["collRlTxReport39"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport39"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL3_9);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport39S)
            {
