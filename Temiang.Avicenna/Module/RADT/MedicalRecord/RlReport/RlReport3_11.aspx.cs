...
{
    public partial class RlReport3_11 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport311Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport311Collection();

            foreach (GridDataItem dataItem in grdRlReport3_11.MasterTableView.Items)
            {
        ...
        protected void grdRlReport3_11_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport3_11.DataSource = RlTxReport311S;
        }

        private RlTxReport311Collection RlTxReport311S
        {
            get
            {
                var obj = ViewState["collRlTxReport311"];
                if (obj != null)
                    return ((RlTxReport311Collection)(obj));

                var collection = new RlTxReport311Collection();

                var query = new RlTxReport311Query("a");
                ...
                ViewState["collRlTxReport311"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport311"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport3_11.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL3_11);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport311S)
            {
                RlTxReport311.Process(fromMonth, toMonth, year, item.RlMasterReportItemID ?? 0, out int jml);
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport3_11.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;
