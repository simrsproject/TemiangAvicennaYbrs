...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord
{
    public partial class RlReport3_2 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport32Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport32Collection();

            foreach (GridDataItem dataItem in grdRlReport3_2.MasterTableView.Items)
            {
                ...
                var txtMatiDiUgd = (dataItem.FindControl("txtMatiDiUgd") as RadNumericTextBox);
                var txtDoa = (dataItem.FindControl("txtDoa") as RadNumericTextBox);
                ...
                rpt.MatiDiUgd = txtMatiDiUgd.Value.ToInt();
                rpt.Doa = txtDoa.Value.ToInt();
        ...
        protected void grdRlReport3_2_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport3_2.DataSource = RlTxReport32S;
        }

        private RlTxReport32Collection RlTxReport32S
        {
            get
            {
                var obj = ViewState["collRlTxReport32"];
                if (obj != null)
                    return ((RlTxReport32Collection)(obj));

                var collection = new RlTxReport32Collection();

                var query = new RlTxReport32Query("a");
                ...
                ViewState["collRlTxReport32"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport32"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport3_2.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL3_2);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport32S)
            {
                ...
                {
                    RlTxReport32.Process(fromMonth, toMonth, year, parValue, AppSession.Parameter.DischargeConditionDieLessThen48, AppSession.Parameter.DischargeConditionDieMoreThen48, AppSession.Parameter.DischargeConditionDie,
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport3_2.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;
