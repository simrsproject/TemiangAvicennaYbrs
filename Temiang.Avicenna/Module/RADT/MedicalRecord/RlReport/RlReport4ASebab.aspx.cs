...
{
    public partial class RlReport4ASebab : BasePageDetail
    {
        ...
        private void SaveEntity(RlTxReport entity)
        {
            ...
            var coll = new RlTxReport4ASebabCollection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = RlTxReport4ASebabs;

            RlTxReport4ASebab.Process(fromMonth, toMonth, year, AppSession.Parameter.DischargeConditionDieLessThen48, AppSession.Parameter.DischargeConditionDieMoreThen48, AppSession.UserLogin.UserID, newcoll, out newcoll);
            ...
            //    diagq.DtdNo.In(RlTxReport4ASebabs.Select(r => r.RlMasterReportItemCode).ToArray())
            //    );
            ...
            //    {
            //        var item = RlTxReport4ASebabs.Where(r => r.RlMasterReportItemCode == row["DtdNo"].ToString()).Single();
        ...
        protected void grdRlReport4ASebab_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            //grdRlReport4ASebab.DataSource = RlTxReport4ASebabs;
        }

        private RlTxReport4ASebabCollection RlTxReport4ASebabs
        {
            get
            {
                var obj = ViewState["collRlTxReport4ASebab"];
                if (obj != null)
                    return ((RlTxReport4ASebabCollection)(obj));

                var collection = new RlTxReport4ASebabCollection();
                ...
                ViewState["collRlTxReport4ASebab"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport4ASebab"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport4ASebab.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL4ASebab);
                    break;
            }
        }
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport4ASebab.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;
