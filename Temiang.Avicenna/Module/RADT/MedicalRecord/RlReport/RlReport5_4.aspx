<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport5_4.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport5_4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport5_4.UniqueID %>", "process");
            }
            function onPrint() {
                __doPostBack("<%= grdRlReport5_4.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport5_4" runat="server" OnNeedDataSource="grdRlReport5_4_NeedDataSource"
            AutoGenerateColumns="False" GridLines="None" OnUpdateCommand="grdRlReport5_4_UpdateCommand"
            OnDeleteCommand="grdRlReport5_4_DeleteCommand" OnInsertCommand="grdRlReport5_4_InsertCommand">
            <HeaderContextMenu>
            </HeaderContextMenu>
            <MasterTableView CommandItemDisplay="None" DataKeyNames="DiagnosaID">
                <CommandItemTemplate>
                    &nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="lbInsert" runat="server" CommandName="InitInsert" Visible='<%# !grdRlReport5_4.MasterTableView.IsItemInserted %>'>
                    ...
                    &nbsp;&nbsp;
                    <asp:LinkButton ID="lbPickList" runat="server" Visible='<%# !grdRlReport5_4.MasterTableView.IsItemInserted %>'
                ...
                <EditFormSettings UserControlName="RlReport5_4Detail.ascx" EditFormType="WebUserControl">
                    <EditColumn UniqueName="RlReport5_4DetailCommand">
                    </EditColumn>
                </EditFormSettings>
            </MasterTableView>
            <FilterMenu>
