...
namespace Temiang.Avicenna.Module.RADT.MedicalRecord
{
    public partial class RlReport3_15 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport315Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport315Collection();
        ...
        {
            grdRlReport3_15.DataSource = RlTxReport315S;
        }

        private RlTxReport315Collection RlTxReport315S
        {
            get
            {
                var obj = ViewState["collRlTxReport315"];
                if (obj != null)
                    return ((RlTxReport315Collection)(obj));

                var collection = new RlTxReport315Collection();

                var query = new RlTxReport315Query("a");
                ...
                ViewState["collRlTxReport315"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport315"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    break;
                case "print":
                    Print(AppConstant.Report.RL3_15);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport315S)
            {
                RlTxReport315.Process(fromMonth, toMonth, year, item.RlMasterReportItemID ?? 0, AppSession.Parameter.ServiceUnitLaboratoryID, AppSession.Parameter.ServiceUnitRadiologyID,
