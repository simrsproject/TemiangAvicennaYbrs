...
{
    public partial class RlReport1_3 : BasePageDetail
    {
        ...
        {
            var coll = new RlTxReport13Collection();
            coll.Query.Where(coll.Query.RlTxReportNo == entity.RlTxReportNo);
            coll.LoadAll();
            coll.MarkAllAsDeleted();
            coll.Save();

            var newcoll = new RlTxReport13Collection();

            foreach (GridDataItem dataItem in grdRlReport1_3.MasterTableView.Items)
            {
                var reportItemId = dataItem.GetDataKeyValue("RlMasterReportItemID").ToInt();
                var txtJumlahTt = (dataItem.FindControl("txtJumlahTt") as RadNumericTextBox);
                ...
                rpt.JumlahTt = txtJumlahTt.Value.ToInt();
        ...
        protected void grdRlReport1_3_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdRlReport1_3.DataSource = RlTxReport13S;
        }

        private RlTxReport13Collection RlTxReport13S
        {
            get
            {
                var obj = ViewState["collRlTxReport13"];
                if (obj != null)
                    return ((RlTxReport13Collection)(obj));

                var collection = new RlTxReport13Collection();

                var query = new RlTxReport13Query("a");
                ...
                ViewState["collRlTxReport13"] = collection;

                return collection;
            }
            set { ViewState["collRlTxReport13"] = value; }
        }
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                case "process":
                    ...
                    grdRlReport1_3.Rebind();

                    break;
                case "print":
                    Print(AppConstant.Report.RL1_3);
                    break;
            }
        }
        ...
        private void Process()
        {
            ...
            foreach (var item in RlTxReport13S)
            {
                ...
                string smfId = mri.SRParamedicRL1;
        ...
        private void RefreshCommandItemGrid(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            grdRlReport1_3.MasterTableView.CommandItemDisplay = isVisible ? GridCommandItemDisplay.Top : GridCommandItemDisplay.None;
