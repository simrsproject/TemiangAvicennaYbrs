<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true"
    CodeBehind="TestResultDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.TestResultDetail" %>
<%@ Import Namespace="Temiang.Avicenna.Common" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        function UploadImage(no) {
            var url = "../Cpoe/EmrCommon/ExamOrderResult/ExamOrderRadiologyImageUpload.aspx?trno=<%= TransactionNo %>&seqno=<%= SequenceNo %>&imgno=" + no + '&ccm=rebind&cet=<%=lvItemDocumentImage.ClientID %>';
        ...
        function ZoomViewImage(no) {
            var url = "../Cpoe/EmrCommon/ExamOrderResult/ExamOrderImageZoomView.aspx?trno=<%= TransactionNo %>&seqno=<%= SequenceNo %>&imgno=" + no;
        ...
        <tr>
            <td style="width: 50%; vertical-align: top">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadTextBox ID="txtRegistrationNo" runat="server" Width="192px" MaxLength="20"
                                ReadOnly="true" />
            ...
            <td style="width: 50%; vertical-align: top">
                <table width="100%">
                    <tr>
                        ...
                        <td class="entry">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <telerik:RadTextBox ID="txtAgeYear" runat="server" Width="30px" ReadOnly="true" /></td>
                                    <td>&nbsp;Year(s)&nbsp;&nbsp;</td>
                                    <td>
                                        <telerik:RadTextBox ID="txtAgeMonth" runat="server" Width="30px" ReadOnly="true" /></td>
                                    <td>&nbsp;Month(s)&nbsp;&nbsp;</td>
                                    <td>
                                        <telerik:RadTextBox ID="txtAgeDay" runat="server" Width="30px" ReadOnly="true" /></td>
                                    <td>&nbsp;Day(s)</td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblSRRadiologyCriticalResults" runat="server" Text="Radiology Critical Results"></asp:Label>
                        </td>
                        <td class="entry">
                            <telerik:RadComboBox runat="server" ID="cboSRRadiologyCriticalResults" Width="304px" AllowCustomText="true"
                                    Filter="Contains">
                            </telerik:RadComboBox>
                        </td>
                        <td width="20px">
                    ...
                    <tr>
                        <td width="25%">
                            <telerik:RadTextBox ID="txtS" runat="server" Width="98%" ReadOnly="true" Height="73px"
                                TextMode="MultiLine" ValidateRequestMode="Disabled" />
                        </td>
                        <td width="25%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:LinkButton ID="lbtnDocumentImageDelete" runat="server" ToolTip="Delete" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ImageNo")%>'
                                                                OnClientClick='return confirm("Delete this document image?")' OnClick="lbtnDocumentImageDelete_OnClick"><img src="../../../Images/Toolbar/delete16.png"/>
                                                            </asp:LinkButton>
