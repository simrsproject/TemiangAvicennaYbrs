<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientDischargeApptItemDetail.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.InPatient.PatientDischargeApptItemDetail" %>
