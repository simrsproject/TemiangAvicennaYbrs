...
{
    public partial class PatientDischargePlanRegistrationList : BasePage
    {
            ...
            get
            {
                ...
                query.Select
                    (
                        ...
                        query.ServiceUnitID,
                        su.ServiceUnitName,
                        query.DischargePlanDate,
                        query.SentToBillingDateTime,
        ...
        protected void grdList_ItemCommand(object source, GridCommandEventArgs e)
        {
            if (e.CommandName == "Print")
            {
                ...
                AppSession.PrintJobReportID = AppConstant.Report.Permit; /*surat izin pulang*/
        ...
        protected override void RaisePostBackEvent(IPostBackEventHandler source, string eventArgument)
        {
            ...
            else if (eventArgument.Contains("|"))
            {
                ...
                {
                    reg.SentToBillingDateTime = (new DateTime()).NowAtSqlServer();
                    reg.SentToBillingByUserID = AppSession.UserLogin.UserID;
