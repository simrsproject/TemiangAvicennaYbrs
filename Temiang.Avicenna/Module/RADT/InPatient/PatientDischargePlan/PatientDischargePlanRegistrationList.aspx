<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true"
    CodeBehind="PatientDischargePlanRegistrationList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.InPatient.PatientDischargePlanRegistrationList" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function openWinProcess(regno) {
                ...
                oWnd.SetUrl("PatientDischargePlanDetail.aspx?regno=" + regno);
            ...
            function rowSend(regNo) {
                if (confirm('Are you sure to process for selected registration?')) {
                    __doPostBack("<%= grdList.UniqueID %>", 'send|' + regNo);
                }
            }
        </script>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="RegistrationNo" ClientDataKeyNames="RegistrationNo"
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="DischargePlanDate" HeaderText="Discharge Plan"
                    UniqueName="DischargePlanDate" SortExpression="DischargePlanDate" DataType="System.DateTime"
                ...
                <telerik:GridBoundColumn DataField="SentToBillingDateTime" HeaderText="Sent To Billing Date Time"
                    UniqueName="SentToBillingDateTime" SortExpression="SentToBillingDateTime" DataType="System.DateTime"
                    DataFormatString="{0:MM/dd/yyyy HH:mm}">
                    <HeaderStyle HorizontalAlign="Center" Width="105px" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridTemplateColumn Groupable="false" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                        <%# (string.Format("<a href=\"#\" onclick=\"rowSend('{0}'); return false;\">{1}</a>",
                            DataBinder.Eval(Container.DataItem, "RegistrationNo"),
                            "<img src=\"../../../../Images/arrowright16.png\" border=\"0\" title=\"Send Billing\" />"))%>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridTemplateColumn UniqueName="Print" HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="center">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnPrint" runat="server" CommandName="Print" ToolTip='Print Permit'
