<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="PatientDischargePlanDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.InPatient.PatientDischargePlanDetail"
    Title="Patient Discharge Plan" %>
    ...
    <table width="100%" cellpadding="1" cellspacing="5">
        <tr>
            <td style="width: 100%">
                <fieldset>
                    <legend>
                        <asp:Label ID="Label3" runat="server" Text="DISCHARGE PLAN DETAIL" Font-Bold="True"
                        ...
                        <tr>
                            <td width="50%" style="vertical-align: top">
                                <table width="100%">
                                    <tr>
                                        <td class="label">
                                            <asp:Label ID="lblDischargePlanDate" runat="server" Text="Discharge Plan Date / Time"></asp:Label>
                                        </td>
                                        <td class="entry">
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadMaskedTextBox ID="txtDischargePlanTime" runat="server" Mask="<00..23>:<00..59>"
