...
{
    public partial class PatientResearchList : BasePageList
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            UrlPageSearch = "PatientResearchSearch.aspx";
            UrlPageDetail = "PatientResearchDetail.aspx";
        ...
        {
            grdList.DataSource = PatientResearchs;
        }

        private DataTable PatientResearchs
        {
            get
            {
