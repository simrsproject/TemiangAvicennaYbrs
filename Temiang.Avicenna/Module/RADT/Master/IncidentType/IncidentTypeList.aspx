<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    CodeBehind="IncidentTypeList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.IncidentTypeList" %>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource">
        <MasterTableView DataKeyNames="ItemID">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="ItemName" HeaderText="Incident Type" UniqueName="ItemName"
