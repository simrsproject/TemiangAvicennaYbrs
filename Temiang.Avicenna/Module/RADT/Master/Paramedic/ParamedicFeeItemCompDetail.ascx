<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParamedicFeeItemCompDetail.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.ParamedicFeeItemCompDetail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumParamedicFeeItemComp" runat="server" ValidationGroup="ParamedicFeeItemComp" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="ParamedicFeeItemComp"
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvTariffComponentID" runat="server" ErrorMessage="Tariff Component required."
                            ControlToValidate="cboTariffComponentID" SetFocusOnError="True" ValidationGroup="ParamedicFeeItemComp"
                            Width="100%">
                ...
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvFeeAmount" runat="server" ErrorMessage="Fee Amount required."
                            ControlToValidate="txtParamedicFeeAmount" ValidationGroup="ParamedicFeeItemComp"
                        ...
                        <asp:RequiredFieldValidator ID="rfvDeductionAmount" runat="server" ErrorMessage="Deduction Amount required."
                            ControlToValidate="txtDeductionFeeAmount" ValidationGroup="ParamedicFeeItemComp"
                            SetFocusOnError="True" Width="100%">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                    </td>
                ...
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvFeeAmountReferral" runat="server" ErrorMessage="Fee Amount Referral required."
                            ControlToValidate="txtParamedicFeeAmountReferral" ValidationGroup="ParamedicFeeItemComp"
                            SetFocusOnError="True" Width="100%">*</asp:RequiredFieldValidator>
                        <asp:RequiredFieldValidator ID="rfvDeductionAmountReferral" runat="server" ErrorMessage="Deduction Amount Referral required."
                            ControlToValidate="txtDeductionFeeAmountReferral" ValidationGroup="ParamedicFeeItemComp"
                            SetFocusOnError="True" Width="100%">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                    </td>
                ...
                <tr>
                    <td align="right" colspan="2" style="height: 26px">
                        <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="ParamedicFeeItemComp"
                            Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
                        <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                            ValidationGroup="ParamedicFeeItemComp" Visible='<%# DataItem is GridInsertionObject %>'>
                        </asp:Button>
                        &nbsp;
