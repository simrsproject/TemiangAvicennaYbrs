...
{
    public partial class ProcedureSynonymDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            if (DataItem is GridInsertionObject)
            {
                ...
                var coll = (ProcedureSynonymCollection)Session["collProcedureSynonym"];
            ...
            ViewState["SequenceNo"] = (String)DataBinder.Eval(DataItem, ProcedureSynonymMetadata.ColumnNames.SequenceNo);
            txtSynonym.Text = (String)DataBinder.Eval(DataItem, ProcedureSynonymMetadata.ColumnNames.SynonymText);
        }
