...
namespace Temiang.Avicenna.Module.RADT.Master
{
    public partial class RlMasterReportList : BasePageList
    {
        ...
        private void RedirectToPageDetail(GridDataItem dataItem, string mode)
        {
            ...
            string id = dataItem.GetDataKeyValue(RlMasterReportMetadata.ColumnNames.RlMasterReportID).ToString();
        ...
        private DataTable RlMasterReports
        {
            get
            {
                ...
                RlMasterReportQuery query;
                if (Session[SessionNameForQuery] != null)
                {
                    query = (RlMasterReportQuery)Session[SessionNameForQuery];
                }
                else
                {
                    query = new RlMasterReportQuery();
