...
namespace Temiang.Avicenna.Module.RADT.Master
{
    public partial class RlMasterReportDetail : BasePageDetail
    {
        ...
        {
            OnPopulateEntryControl(new RlMasterReport());
            chkIsActive.Checked = true;
        }

        protected override void OnMenuDeleteClick(ValidateArgs args)
        {
            RlMasterReport entity = new RlMasterReport();
        ...
        protected override void OnMenuAuditLogClick(AuditLogFilter auditLogFilter)
        {
            ...
            auditLogFilter.TableName = "RlMasterReport";
        }
        #endregion
        ...
        {
            RlMasterReport rlMasterReport = (RlMasterReport)entity;
        ...
        private void SetEntityValue(RlMasterReport entity)
        {
            ...
            foreach (RlMasterReportItem item in RlMasterReportItems)
            {
        ...
        private void SaveEntity(RlMasterReport entity)
        {
        ...
        {
            RlMasterReportQuery que = new RlMasterReportQuery();
        ...
        private RlMasterReportItemCollection RlMasterReportItems
        {
            get
            {
                if (IsPostBack)
                {
                    object obj = Session["collRlMasterReportItem"];
                    if (obj != null)
                    {
                        return ((RlMasterReportItemCollection)(obj));
                    }
                }

                var coll = new RlMasterReportItemCollection();
                var rlType = new SmfQuery("c");
                var header = new RlMasterReportQuery("b");
                ...
                Session["collRlMasterReportItem"] = coll;
                return coll;
            }
            set { Session["collRlMasterReportItem"] = value; }
        }
        ...
        protected void grdRlMasterReportItem_UpdateCommand(object source, GridCommandEventArgs e)
        {
            ...
            Int32 rlMasterReportItemID = Convert.ToInt32(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex][RlMasterReportItemMetadata.ColumnNames.RlMasterReportItemID]);
            RlMasterReportItem entity = FindRlMasterReportItem(rlMasterReportItemID);
            if (entity != null)
        ...
        protected void grdRlMasterReportItem_DeleteCommand(object source, GridCommandEventArgs e)
        {
            ...
            Int32 rlMasterReportItemID = Convert.ToInt32(item.OwnerTableView.DataKeyValues[item.ItemIndex][RlMasterReportItemMetadata.ColumnNames.RlMasterReportItemID]);
            RlMasterReportItem entity = FindRlMasterReportItem(rlMasterReportItemID);
            if (entity != null)
                entity.MarkAsDeleted();
        }
        ...
        {
            RlMasterReportItem entity = RlMasterReportItems.AddNew();
            SetEntityValue(entity, e);
        ...
        private RlMasterReportItem FindRlMasterReportItem(Int32 rlMasterReportItemID)
        {
            RlMasterReportItemCollection coll = RlMasterReportItems;
            RlMasterReportItem retEntity = null;
            foreach (RlMasterReportItem rec in coll)
            {
        ...
        private void SetEntityValue(RlMasterReportItem entity, GridCommandEventArgs e)
        {
