...
namespace Temiang.Avicenna.Module.RADT.Master
{
    public partial class ItemServiceUnitDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            chkIsAllowEditByUserVerificated.Checked =
                (bool)DataBinder.Eval(DataItem, ServiceUnitItemServiceMetadata.ColumnNames.IsAllowEditByUserVerificated);
            chkIsVisible.Checked =
                (bool)DataBinder.Eval(DataItem, ServiceUnitItemServiceMetadata.ColumnNames.IsVisible);
        }
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (ServiceUnitItemServiceCollection)Session["collServiceUnitItemService"];

                string id = cboServiceUnitID.SelectedValue;
                bool isExist = false;
                foreach (ServiceUnitItemService row in coll)
                {
