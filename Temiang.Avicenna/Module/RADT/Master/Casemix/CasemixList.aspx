<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true" CodeBehind="CasemixList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.CasemixList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="PathwayID">
            <Columns>
                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="PathwayID" HeaderText="Pathway ID"
