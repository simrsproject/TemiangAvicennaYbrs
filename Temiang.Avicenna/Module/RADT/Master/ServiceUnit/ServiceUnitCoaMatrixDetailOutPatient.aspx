<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="ServiceUnitCoaMatrixDetailOutPatient.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.ServiceUnitCoaMatrixDetailOutPatient" %>
                    ...
                    <tr>
                        ...
                        <td width="20px">
                            <asp:RequiredFieldValidator ID="rfvRegType" runat="server" ErrorMessage="Registration Type required."
                                ValidationGroup="entry" ControlToValidate="cboRegType" SetFocusOnError="True"
                                Width="100%">
