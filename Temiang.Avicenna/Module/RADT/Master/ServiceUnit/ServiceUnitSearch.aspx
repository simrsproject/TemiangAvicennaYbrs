<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    Codebehind="ServiceUnitSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.ServiceUnitSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td class="label">
                <asp:Label ID="lblDepartmentID" runat="server" Text="Department Name" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            ...
            <td class="entry">
                <telerik:RadTextBox ID="txtDepartmentID" runat="server" Width="300px" MaxLength="10" />
            </td>
            <td>
            </td>
        </tr>
