<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientIncidentInvestigationRealizationItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.PatientIncidentInvestigationRealizationItemDetail" %>
    ...
    <tr>
        <td width="50%" style="vertical-align: top">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="entry">
                        <telerik:RadDatePicker ID="txtRecomendationDateTime" runat="server" Width="100px" Enabled="False" />
                    </td>
                    <td width="20px">
                ...
                <tr>
                    ...
                    <td class="entry">
                        <telerik:RadTextBox ID="txtPersonInCharge" runat="server" Width="300px" MaxLength="50" ReadOnly="True" />
                    </td>
                    <td width="20px">
                ...
                <tr>
                    ...
                    <td class="entry">
                        <telerik:RadDatePicker ID="txtImplementationDateTime" runat="server" Width="100px" Enabled="False" />
                    </td>
                    <td width="20px">
        ...
        <td width="50%" style="vertical-align: top">
            <table width="100%">
                ...
                <tr>
                    <td class="label">
                        <asp:Label ID="lblFollowUpDateTime" runat="server" Text="Follow Up Date"></asp:Label>
                    </td>
                    <td class="entry">
                        <telerik:RadDatePicker ID="txtFollowUpDateTime" runat="server" Width="100px" />
                    </td>
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvFollowUpDateTime" runat="server" ErrorMessage="Follow Up Date required."
                            ControlToValidate="txtFollowUpDateTime" SetFocusOnError="True" ValidationGroup="IncidentInvestigation"
                            Width="100%">
