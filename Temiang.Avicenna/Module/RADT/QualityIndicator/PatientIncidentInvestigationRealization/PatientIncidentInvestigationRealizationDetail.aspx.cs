...
{
    public partial class PatientIncidentInvestigationRealizationDetail : BasePageDetail
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            // Url Search & List
            UrlPageSearch = "##";
            UrlPageList = "PatientIncidentInvestigationRealizationList.aspx";
        ...
        {
            var userControl = (PatientIncidentInvestigationRealizationItemDetail)e.Item.FindControl(GridEditFormItem.EditFormUserControlID);
            if (userControl != null)
            {
                ...
                entity.FollowUp = userControl.FollowUp;
                entity.FollowUpDateTime = userControl.FollowUpDateTime;
            }
        }
