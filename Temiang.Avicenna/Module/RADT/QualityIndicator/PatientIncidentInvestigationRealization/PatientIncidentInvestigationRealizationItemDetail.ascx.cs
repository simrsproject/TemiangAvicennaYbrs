...
{
    public partial class PatientIncidentInvestigationRealizationItemDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            object implementationDate = DataBinder.Eval(DataItem, PatientIncidentInvestigationMetadata.ColumnNames.ImplementationDateTime);
            ...
            txtFollowUp.Text = (String)DataBinder.Eval(DataItem, PatientIncidentInvestigationMetadata.ColumnNames.FollowUp);
            object followUpDate = DataBinder.Eval(DataItem, PatientIncidentInvestigationMetadata.ColumnNames.FollowUpDateTime);
            if (followUpDate != null)
                txtFollowUpDateTime.SelectedDate = (DateTime)DataBinder.Eval(DataItem, PatientIncidentInvestigationMetadata.ColumnNames.FollowUpDateTime);
            else
                txtFollowUpDateTime.Clear();
        }
        ...
        {
            get { return txtFollowUp.Text; }
        }

        public DateTime? FollowUpDateTime
        {
            get { return txtFollowUpDateTime.SelectedDate; }
        }
