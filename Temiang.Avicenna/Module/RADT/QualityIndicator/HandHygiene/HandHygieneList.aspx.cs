...
{
    public partial class HandHygieneList : BasePageList
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            UrlPageDetail = "HandHygieneDetail.aspx";
        ...
        {
            string id = dataItem.GetDataKeyValue(HandHygieneMetadata.ColumnNames.TransactionNo).ToString();
            Page.Response.Redirect("HandHygieneDetail.aspx?md=" + mode + "&id=" + id, true);
        }

        protected void grdList_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdList.DataSource = HandHygienes;
        }

        private DataTable HandHygienes
        {
            get
            {
                ...
                HandHygieneQuery query;
                if (Session[SessionNameForQuery] != null)
                {
                    query = (HandHygieneQuery)Session[SessionNameForQuery];
                }
                else
                {
                    query = new HandHygieneQuery("a");
