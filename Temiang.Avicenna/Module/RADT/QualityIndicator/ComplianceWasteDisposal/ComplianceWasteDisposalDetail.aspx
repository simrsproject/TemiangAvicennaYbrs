<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="ComplianceWasteDisposalDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.ComplianceWasteDisposalDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SRComplianceWasteDisposal">
            <Columns>               
                <telerik:GridBoundColumn HeaderStyle-Width="70px" DataField="SRComplianceWasteDisposal" HeaderText="ID"
                    UniqueName="SRComplianceWasteDisposal" SortExpression="SRComplianceWasteDisposal" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="300px" DataField="ComplianceWasteDisposalName" HeaderText="Compliance Waste Disposal"
                    UniqueName="ComplianceWasteDisposalName" SortExpression="ComplianceWasteDisposalName" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />                                                         
