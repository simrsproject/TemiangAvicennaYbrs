<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="PpiProcedureSurveillanceList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.PpiProcedureSurveillanceList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock runat="server" ID="RadCodeBlock1">
        ...
        <script type="text/javascript">
            function gotoViewUrl(id) {
                var url = 'PpiProcedureSurveillanceDetail.aspx?md=view&id=' + id;
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterProcedureDate">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdList" LoadingPanelID="fw_ajxLoadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="cboStatus">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="lblDate" LoadingPanelID="fw_ajxLoadingPanel" />
                    <telerik:AjaxUpdatedControl ControlID="grdList" LoadingPanelID="fw_ajxLoadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
                            ...
                            <td class="entry">
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadDatePicker ID="txtToRegistrationDate" runat="server" Width="100px" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="entry">
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <telerik:RadDatePicker ID="txtProcedureDateFrom" runat="server" Width="100px" />
                                        </td>
                                        <td style="width: 20px">
                                            to
                                        </td>
                                        <td>
                                            <telerik:RadDatePicker ID="txtProcedureDateTo" runat="server" Width="100px" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td style="text-align: left">
                                <asp:ImageButton ID="btnFilterProcedureDate" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                    OnClick="btnFilter_Click" ToolTip="Search" />
                            </td>
                        </tr>
                    </table>
                ...
                <td width="50%" style="vertical-align: top">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td class="entry">
                                <telerik:RadComboBox ID="cboStatus" runat="server" Width="304px" AutoPostBack="True"
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
        ...
        AllowSorting="true">
        <MasterTableView Name="master" DataKeyNames="BookingNo" ClientDataKeyNames="RegistrationNo"
            ...
            <Columns>
                ...
                <telerik:GridDateTimeColumn DataField="RealizationDateTimeFrom" HeaderText="Date"
