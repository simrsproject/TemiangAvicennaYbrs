...
{
    public partial class PatientIncidentInvestigationList : BasePage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ComboBox.PopulateWithServiceUnit(cboInvestigationServiceUnitID, true);
        ...
        private DataTable PatientIncidentOutstandings
        {
            get
            {
                var isEmptyFilter = txtIncidentFromDate.IsEmpty && txtIncidentToDate.IsEmpty && string.IsNullOrEmpty(txtIncidentNo.Text) && string.IsNullOrEmpty(cboInvestigationServiceUnitID.SelectedValue) &&
                ...
                var quser = new AppUserServiceUnitQuery("u");
                ...
                query.InnerJoin(quser).On(qrelUnit.ServiceUnitID == quser.ServiceUnitID &&
                                          quser.UserID == AppSession.UserLogin.UserID);
                ...
                query.OrderBy(rg.RiskGradingID.Descending, query.IncidentDateTime.Ascending);
                ...
                query.Where(query.IsVerified == true, qrelUnit.InvestigationDateTime.IsNull(),
                            query.SRIncidentFollowUp == AppSession.Parameter.IncidentFollowUpInvestigation,
                            query.IsApproved == true, query.IsRiskManagement == false);
                ...
                if (cboInvestigationServiceUnitID.SelectedValue != string.Empty)
                    query.Where(qrelUnit.ServiceUnitID == cboInvestigationServiceUnitID.SelectedValue);
        ...
        private DataTable PatientIncidentInvestigations
        {
            get
            {
                ...
                query.Where(query.IsVerified == true, qrelUnit.InvestigationDateTime.IsNotNull());
