<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="ManagementWasteDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.ManagementWasteDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SRManagementWaste">
            <Columns>               
                <telerik:GridBoundColumn HeaderStyle-Width="70px" DataField="SRManagementWaste" HeaderText="ID"
                    UniqueName="SRManagementWaste" SortExpression="SRManagementWaste" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="300px" DataField="ManagementWasteName" HeaderText="Management Waste"
                    UniqueName="ManagementWasteName" SortExpression="ManagementWasteName" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />                                                         
