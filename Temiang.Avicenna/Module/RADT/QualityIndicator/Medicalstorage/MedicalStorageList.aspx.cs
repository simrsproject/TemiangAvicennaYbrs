...
{
    public partial class MedicalStorageList : BasePageList
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            UrlPageDetail = "MedicalStorageDetail.aspx";
        ...
        {
            string id = dataItem.GetDataKeyValue(MedicalStorageMetadata.ColumnNames.TransactionNo).ToString();
            Page.Response.Redirect("MedicalStorageDetail.aspx?md=" + mode + "&id=" + id, true);
        }

        protected void grdList_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdList.DataSource = MedicalStorages;
        }

        private DataTable MedicalStorages
        {
            get
            {
                ...
                MedicalStorageQuery query;
                if (Session[SessionNameForQuery] != null)
                {
                    query = (MedicalStorageQuery)Session[SessionNameForQuery];
                }
                else
                {
                    query = new MedicalStorageQuery("a");
