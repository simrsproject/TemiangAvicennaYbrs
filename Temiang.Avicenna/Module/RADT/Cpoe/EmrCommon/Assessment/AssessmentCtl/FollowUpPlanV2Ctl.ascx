<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FollowUpPlanV2Ctl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.FollowUpPlanV2Ctl" %>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td colspan="4">
                ...
                <asp:RadioButton runat="server" ID="rbFupCIN" Text="Internal" GroupName="FUP" />
        ...
        <tr>
            <td></td>
            <td colspan="4">Date:&nbsp;<telerik:RadDatePicker ID="txtConsultDate" runat="server" Width="100px" />
            </td>
        </tr>
