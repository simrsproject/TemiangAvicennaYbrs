...
{
    public partial class MedHistCtl3 : BaseAssessmentCtl
    {
        ...
        private DataTable PastMedicalHistDataTableEditMode()
        {
            ...
            que.Where(que.StandardReferenceID == PastMedHist, que.IsActive== true);
        ...
        private DataTable PastMedicalHistDataTable()
        {
            ...
            que.LeftJoin(qrSri)
                .On(que.SRMedicalDisease == qrSri.ItemID & qrSri.StandardReferenceID == PastMedHist & qrSri.IsActive == true);
        ...
        private DataTable FamilyMedicalHistDataTableEditMode()
        {
            ...
            que.LeftJoin(qrFam)
                .On(que.ItemID == qrFam.SRMedicalDisease && qrFam.PatientID == PatientID);
            que.Where(que.StandardReferenceID == FamilyMedicalHistory.MedicalDiseaseStandardReferenceID, que.IsActive==true);
        ...
        private DataTable FamilyMedicalHistDataTable()
        {
            ...
            var qrSri = new AppStandardReferenceItemQuery("sri");
            que.LeftJoin(qrSri)
                .On(que.SRMedicalDisease == qrSri.ItemID & qrSri.StandardReferenceID == FamilyMedicalHistory.MedicalDiseaseStandardReferenceID & qrSri.IsActive == true);
            que.Where(que.PatientID == PatientID);
            que.Select(que.SRMedicalDisease.As("ItemID"), qrSri.ItemName, que.Notes, "<CONVERT(BIT,1) as IsSelected>");
            return que.LoadDataTable();
        }
