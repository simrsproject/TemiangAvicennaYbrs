<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RegInMedDiagnoseCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.RegInMedDiagnoseCtl" %>
    ...
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="grdDiagnose">
            <UpdatedControls>
                ...
                <telerik:AjaxUpdatedControl ControlID="hdnRegistrationInfoMedicID" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
...
<telerik:RadGrid ID="grdDiagnose" Width="100%" GridLines="None" runat="server"
    ...
    <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="SequenceNo"
        ...
        <CommandItemSettings AddNewRecordImageUrl="~/Images/Toolbar/insert16.png" AddNewRecordText="Add ICD X"></CommandItemSettings>
        <SortExpressions>
        ...
        <Columns>
            ...
            <telerik:GridTemplateColumn HeaderText="Diagnose Type" HeaderStyle-Width="120px" UniqueName="DiagnoseType">
                <ItemTemplate>
                    <%# Eval("DiagnoseType") %>
                </ItemTemplate>
            </telerik:GridTemplateColumn>
            <telerik:GridBoundColumn HeaderText="ICD X" HeaderStyle-Width="70px" UniqueName="DiagnoseID" DataField="DiagnoseID" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox ID="cboDiagnoseID" runat="server" Width="300px" EmptyMessage="Select a Diagnosis" Text='<%# Bind("DiagnoseID") %>'
                                ...
                                <ClientItemTemplate>
                                                    <div style="cursor:pointer;" onclick="onDiagnoseNameClick('#= Attributes.DiagnoseName #')">
                                                        <ul class="details">
