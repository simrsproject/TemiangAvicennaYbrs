<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AnamObjDiagPlanCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.AnamObjDiagPlanCtl" %>
...
<fieldset style="width: 49%;">
    ...
    <telerik:RadTextBox Visible="false" ID="txtAssessment" runat="server" Width="100%" Height="80px"
        TextMode="MultiLine" Resize="Vertical" />
