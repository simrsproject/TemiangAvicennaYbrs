...
{
    public partial class SoapV2Ctl : BaseAssessmentCtl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            SubjectiveText.Visible = AppParameter.IsYes(AppParameter.ParameterItem.IsEmrContinueAssementSubjectivetVisible);
            AssessmentText.Visible = AppParameter.IsYes(AppParameter.ParameterItem.IsEmrContinueAssementAssessmentVisible);
        }
