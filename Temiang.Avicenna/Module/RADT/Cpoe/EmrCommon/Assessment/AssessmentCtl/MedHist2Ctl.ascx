<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MedHist2Ctl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.MedHist2Ctl" %>
<%@ Import Namespace="Temiang.Avicenna.Common" %>
<table style="width: 100%; padding: 0 0 0 0;">
    <tr> <%--/* perubahan untuk rsmmp -- diky */--%>
        <td style="width: 50%;">
...
<%--                <tr>
                ...
                <tr>
                    <td valign="top" class="label">Job History<br/>Is the patient's work related to harmful substances (for example: Chemistry, Gas, etc.). Explain</td>
                    <td>
                    ...
                    <td>
                        <table width="100%">
                            <tr>
                                ...
                                <td><telerik:RadTextBox ID="txtYearOfTransfusion" runat="server" Width="100px" MaxLength="4"/></td>
                                <td></td>
                            </tr>
                            <tr>
