...
{
    public partial class GeneralV2Ctl : BaseAssessmentCtl
    {
        ...
        protected override void OnSetEntityValue(ValidateArgs args, PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            if (IsShowPnlFdolm)
            {
                ...
                PatientField.Update(PatientID, AppField.FieldNameEnum.Fdolm, assessment.AssessmentDateTime,
