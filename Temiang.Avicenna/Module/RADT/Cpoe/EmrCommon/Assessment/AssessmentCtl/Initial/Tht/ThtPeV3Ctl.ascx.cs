...
namespace Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl
{
    ...
    /// <summary>
    /// Physical Examination -> Default Normal & tambah Middle Ear
    /// </summary>
    /// Created By: Fahri 230928
    /// Request By: RS Jakarta
    /// 
    public partial class ThtPeV3Ctl : BaseAssessmentCtl
    {
        ...
        protected override void OnPopulateEntryControl(PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            optMiddleEar.SelectedIndex = ent.Telinga.MiddleEar.IsAbNormal ? 1 : 0;
            txtMiddleEar.Text = ent.Telinga.MiddleEar.Notes;
            ...
            optNEndoskopi.SelectedIndex = ent.Hidung.NEndoskopi.IsAbNormal ? 1 : 0;
            txtNEndoskopi.Text = ent.Hidung.NEndoskopi.Notes;
            ...
            optPVentrikularis.SelectedIndex = ent.Larinx.PVentri2.IsAbNormal ? 1 : 0;
            txtPVentrikularis.Text = ent.Larinx.PVentri2.Notes;
            optAritenoid.SelectedIndex = ent.Larinx.Aritenoid2.IsAbNormal ? 1 : 0;
            txtAritenoid.Text = ent.Larinx.Aritenoid2.Notes;
            optPAriepiglotis.SelectedIndex = ent.Larinx.PAriepiglotis2.IsAbNormal ? 1 : 0;
            txtPAriepiglotis.Text = ent.Larinx.PAriepiglotis2.Notes;
            ...
            optOrofaring.SelectedIndex = ent.Tenggorok.Orofaring.IsAbNormal ? 1 : 0;
            txtOrofaring.Text = ent.Tenggorok.Orofaring.Notes;
            optNasofaring.SelectedIndex = ent.Tenggorok.Nasofaring.IsAbNormal ? 1 : 0;
            txtNasofaring.Text = ent.Tenggorok.Nasofaring.Notes;
            optHipofaring.SelectedIndex = ent.Tenggorok.Hipofaring.IsAbNormal ? 1 : 0;
            txtHipofaring.Text = ent.Tenggorok.Hipofaring.Notes;
        ...
        protected override void OnSetEntityValue(ValidateArgs args, PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            ent.Telinga.MiddleEar = new AbNormalAndNotes { IsAbNormal = optMiddleEar.SelectedIndex == 1, Notes = txtMiddleEar.Text };
            ...
            ent.Hidung.NEndoskopi = new AbNormalAndNotes { IsAbNormal = optNEndoskopi.SelectedIndex == 1, Notes = txtNEndoskopi.Text };
            ...
            ent.Tenggorok.Orofaring = new AbNormalAndNotes { IsAbNormal = optOrofaring.SelectedIndex == 1, Notes = txtOrofaring.Text };
            ent.Tenggorok.Nasofaring = new AbNormalAndNotes { IsAbNormal = optNasofaring.SelectedIndex == 1, Notes = txtNasofaring.Text };
            ent.Tenggorok.Hipofaring = new AbNormalAndNotes { IsAbNormal = optHipofaring.SelectedIndex == 1, Notes = txtHipofaring.Text };
            ...
            ent.Larinx.PVentri2 = new AbNormalAndNotes { IsAbNormal = optPVentrikularis.SelectedIndex == 1, Notes = txtPVentrikularis.Text };
            ent.Larinx.Aritenoid2 = new AbNormalAndNotes { IsAbNormal = optAritenoid.SelectedIndex == 1, Notes = txtAritenoid.Text };
            ent.Larinx.PAriepiglotis2 = new AbNormalAndNotes { IsAbNormal = optPAriepiglotis.SelectedIndex == 1, Notes = txtPAriepiglotis.Text };
        ...
        private string GenerateSoapObjective(ThtPe pe)
        {
            ...
            if (isIncludeNormal || pe.Telinga.MiddleEar.IsAbNormal)
            {
                strBuilder.AppendFormat("MiddleEar: {1}: {0}", pe.Telinga.MiddleEar.Notes, pe.Telinga.MiddleEar.IsAbNormal ? "Abnormal" : "Normal");
                strBuilder.AppendLine(string.Empty);
            }
            ...
            if (isIncludeNormal || pe.Hidung.NEndoskopi.IsAbNormal)
            {
                strBuilder.AppendFormat("NEndoskopi: {1}: {0}", pe.Hidung.NEndoskopi.Notes, pe.Hidung.NEndoskopi.IsAbNormal ? "Abnormal" : "Normal");
                strBuilder.AppendLine(string.Empty);
            }
            ...
            if (isIncludeNormal || pe.Larinx.PAriepiglotis2.IsAbNormal)
            {
                strBuilder.AppendFormat("PAriepiglotis: {1}: {0}", pe.Larinx.PAriepiglotis2.Notes, pe.Larinx.PAriepiglotis2.IsAbNormal ? "Abnormal" : "Normal");
                strBuilder.AppendLine(string.Empty);
            }
            ...
            if (isIncludeNormal || pe.Tenggorok.Orofaring.IsAbNormal)
            {
                strBuilder.AppendFormat("Orofaring: {1}: {0}", pe.Tenggorok.Orofaring.Notes, pe.Tenggorok.Orofaring.IsAbNormal ? "Abnormal" : "Normal");
                strBuilder.AppendLine(string.Empty);
            }

            if (isIncludeNormal || pe.Tenggorok.Nasofaring.IsAbNormal)
            {
                strBuilder.AppendFormat("Nasofaring: {1}: {0}", pe.Tenggorok.Nasofaring.Notes, pe.Tenggorok.Nasofaring.IsAbNormal ? "Abnormal" : "Normal");
                strBuilder.AppendLine(string.Empty);
            }

            if (isIncludeNormal || pe.Tenggorok.Hipofaring.IsAbNormal)
            {
                strBuilder.AppendFormat("Hipofaring: {1}: {0}", pe.Tenggorok.Hipofaring.Notes, pe.Tenggorok.Hipofaring.IsAbNormal ? "Abnormal" : "Normal");
                strBuilder.AppendLine(string.Empty);
            }
