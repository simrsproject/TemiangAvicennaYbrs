...
{
    public partial class GeneralPeCtl : BaseAssessmentCtl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            txtColorBlind.ClientEvents.OnBlur = "function (s,a){ autoCheckOnBlur(s,a,'" + optColorBlind.ClientID + "'); }";
            txtVisus.ClientEvents.OnBlur = "function (s,a){ autoCheckOnBlur(s,a,'" + optVisus.ClientID + "'); }";
            ...
            txtHepar.ClientEvents.OnBlur = "function (s,a){ autoCheckOnBlur(s,a,'" + optHepar.ClientID + "'); }";
            txtLien.ClientEvents.OnBlur = "function (s,a){ autoCheckOnBlur(s,a,'" + optLien.ClientID + "'); }";
            txtReflexFis.ClientEvents.OnBlur = "function (s,a){ autoCheckOnBlur(s,a,'" + optReflexFis.ClientID + "'); }";
            txtReflexPat.ClientEvents.OnBlur = "function (s,a){ autoCheckOnBlur(s,a,'" + optReflexPat.ClientID + "'); }";
        ...
        protected override void OnPopulateEntryControl(PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            if (!string.IsNullOrEmpty(asses.PhysicalExam))
            {
                ...
                try
                {
                    ent = JsonConvert.DeserializeObject<GeneralPe>(asses.PhysicalExam);
                }
                catch (Exception)
                {
                    return;
            ...
            optVisus.SelectedIndex = pExam.Visus2.IsAbNormal ? 1 : 0;
            txtVisus.Text = pExam.Visus2.Notes;
        ...
        protected override void OnSetEntityValue(ValidateArgs args, PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            var pExam = new GeneralPe
            {
                ...
                Visus2 = new AbNormalAndNotes { IsAbNormal = optVisus.SelectedIndex == 1, Notes = txtVisus.Text },
        ...
        private string GenerateSoapObjective(GeneralPe pe)
        {
            ...
            /// <summary>
            /// Tambahan di Integrated Notes : ColorBlind, Visus, Hepar, Lien, Reflex Fisiologis, Reflex Patologis, Tumor, Hernia, Hemorrhoids
            /// </summary>
            ///Create By: Fajri
            /// Create Date: 2023-March-16
            /// Client Req: Untuk Semua RS
            ...
            if (isIncludeNormal || pe.Visus2.IsAbNormal)
            {
                strBuilder.AppendFormat("Visus: {1}: {0}", pe.Visus2.Notes, pe.Visus2.IsAbNormal ? "Abnormal" : "Normal");
                strBuilder.AppendLine(string.Empty);
            }
            ...
            {
                strBuilder.AppendFormat("Catatan Lainnya: {0}", pe.Notes);
                strBuilder.AppendLine(string.Empty);
            }
