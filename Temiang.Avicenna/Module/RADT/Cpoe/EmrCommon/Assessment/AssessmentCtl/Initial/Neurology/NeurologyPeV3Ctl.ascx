<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NeurologyPeV3Ctl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.NeurologyPeV3Ctl" %>
...
<%@ Register TagPrefix="cc" Namespace="Temiang.Avicenna.CustomControl" Assembly="Temiang.Avicenna" %>
    ...
    <cc:CollapsePanel ID="CollapsePanel1" runat="server" Title="General Physical Examination">
        <table width="100%">
            <tr>
