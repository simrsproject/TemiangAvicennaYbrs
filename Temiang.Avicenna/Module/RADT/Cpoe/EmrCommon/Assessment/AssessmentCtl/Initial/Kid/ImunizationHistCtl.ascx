<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImunizationHistCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.ImunizationHistCtl" %>
<%@ Import Namespace="Temiang.Avicenna.Common" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<fieldset>
    <legend>History of Imunization</legend>
