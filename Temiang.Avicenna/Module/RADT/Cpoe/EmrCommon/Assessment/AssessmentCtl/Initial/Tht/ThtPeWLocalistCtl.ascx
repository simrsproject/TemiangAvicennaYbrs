<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThtPeWLocalistCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.ThtPeWLocalistCtl" %>
<%@ Import Namespace="Temiang.Avicenna.Common" %>
<%@ Register Src="~/Module/RADT/Cpoe/EmrCommon/Assessment/AssessmentCtl/GcsCtl.ascx" TagPrefix="uc1" TagName="GcsCtl" %>
<%@ Register Src="~/Module/RADT/Cpoe/EmrCommon/Assessment/AssessmentCtl/LocalistCtl.ascx" TagPrefix="uc1" TagName="LocalistCtl" %>
    ...
    <tr>
        <td style="width: 50%" valign="top">
            ...
            <fieldset>
                ...
                <uc1:LocalistCtl runat="server" id="localistEars" BodyImageReferenceID="EARS" Width="100%" />
                <table style="width: 100%">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox ID="txtRSekret" runat="server" Width="100%" />
                        </td>
                        <td>
                            <telerik:RadTextBox ID="txtLSekret" runat="server" Width="100%" />
                        </td>

                    </tr>
                    <tr>
                        <td class="label">Cerumen</td>
                        <td>
                            <telerik:RadTextBox ID="txtRSerumen" runat="server" Width="100%" />
                        </td>
                        <td>
                            <telerik:RadTextBox ID="txtLSerumen" runat="server" Width="100%" />
                        </td>
            ...
            <fieldset>
                ...
                <uc1:LocalistCtl runat="server" id="localistNose" BodyImageReferenceID="NOSE"  Width="100%"/>
                <table style="width: 100%">
                    <tr>
                        <td class="labelcaption">Regio</td>
                        <td class="labelcaption">Right</td>
            ...
            <fieldset>
                ...
                <uc1:LocalistCtl runat="server" id="localistLarinx" BodyImageReferenceID="LARINX"  Width="100%"/>
                <table style="width: 100%">
                    <tr>
            ...
            <fieldset>
                <legend><b>MOUTH + OROPHARYNX</b></legend>
                <uc1:LocalistCtl runat="server" id="localistThroat" BodyImageReferenceID="THROAT"   Width="100%"/>
                <table style="width: 100%">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox ID="txtTongue" runat="server" Width="100%" />
                        </td>
                    </tr>
                    <tr>
                        <td class="label">Lips</td>
                        <td>
                            <telerik:RadTextBox ID="txtLips" runat="server" Width="100%" />
                        </td>
                    </tr>
                    <tr>
            ...
            <fieldset>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td class="label">Adenoid</td>
                        <td>
                            <telerik:RadTextBox ID="txtAdenoid" runat="server" Width="100%" />
                        </td>
                    ...
                    <tr>
                        <td class="label">Tuba Eustachius</td>
                        <td>
                            <telerik:RadTextBox ID="txtTubaEustachius" runat="server" Width="100%" />
                        </td>
                    </tr>
                </table>
            </fieldset>
            <fieldset>
                <legend><b>NECK</b></legend>
                <uc1:LocalistCtl runat="server" id="localistNeck" BodyImageReferenceID="NECK"   Width="100%"/>
            </fieldset>
