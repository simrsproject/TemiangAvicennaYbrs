...
{
    /// <summary>
    /// Assessment Control THT Physical Examination With Localist Display by ReferenceIDs
    /// </summary>
    /// Created By: Handono 230926
    /// Request By: RSUD Cideres
    /// 

    public partial class ThtPeWLocalistCtl : BaseAssessmentCtl
    {
        ...
        protected override void OnPopulateEntryControl(PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            #region Telinga
            localistEars.PopulateEntryControl(assessment, rim);
            ...
            txtRSekret.Text = rightTelinga.Sekret;
            txtRSerumen.Text = rightTelinga.Serumen;
            ...
            txtLSekret.Text = leftTelinga.Sekret;
            txtLSerumen.Text = leftTelinga.Serumen;

            #endregion

            #region Hidung
            localistNose.PopulateEntryControl(assessment, rim);
            ...
            #region Larinx
            localistLarinx.PopulateEntryControl(assessment, rim);
            var lrx = ent.Larinx;
            ...
            #region Tenggorok
            localistThroat.PopulateEntryControl(assessment, rim);
            ...
            txtTongue.Text = rightTengorok.Tongue;
            txtLips.Text = rightTengorok.Lips;
            txtPalatum.Text = rightTengorok.Palatum;
            #endregion
            ...
            #region Nasofaring
            txtKoana.Text = ent.Koana;
            txtAdenoid.Text = ent.Adenoid;
            txtMukosa.Text = ent.Mukosa;
            txtTubaEustachius.Text = ent.TubaEustachius;
            #endregion

            #region Leher
            localistNeck.PopulateEntryControl(assessment, rim);
            var nck = ent.Leher;
            #endregion
        }
        ...
        protected override void OnSetEntityValue(ValidateArgs args, PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            #region Telinga
            localistEars.SetEntityValue(args, assessment, rim);
            var rightTelinga = new ThtTelingaItem
            {
                ...
                Sekret = txtRSekret.Text,
                Serumen = txtRSerumen.Text
            };
            ...
            var leftTelinga = new ThtTelingaItem
            {
                ...
                Sekret = txtLSekret.Text,
                Serumen = txtLSerumen.Text
            };
            ent.Telinga.Left = leftTelinga;
            #endregion

            #region Hidung
            localistNose.SetEntityValue(args, assessment, rim);
            ...
            #region Tenggorok
            localistThroat.SetEntityValue(args, assessment, rim);
            ...
            localistLarinx.SetEntityValue(args, assessment, rim);
            ...
            localistNeck.SetEntityValue(args, assessment, rim);
            var leher = new ThtLeherItem
            {
            ...
            ent.Koana = txtKoana.Text;
            ent.Adenoid = txtAdenoid.Text;
            ent.Mukosa = txtMukosa.Text;
            ent.TubaEustachius = txtTubaEustachius.Text;
        ...
        private string GenerateSoapObjective(ThtPe pe)
        {
            ...
            Append(strBuilder, "Koana", pe.Koana);
            Append(strBuilder, "Adenoid", pe.Adenoid);
            Append(strBuilder, "Mukosa", pe.Mukosa);
            Append(strBuilder, "Tuba Eustachius", pe.TubaEustachius);
        ...
        private bool AppendEars(StringBuilder strBuilder, ThtTelinga value)
        {
            ...
            var exist1 = AppendRightLeft(strBuilder, "• Auricle", value.Right.Daun, value.Left.Daun)
                ...
                | AppendRightLeft(strBuilder, "• Secretion", value.Right.Sekret, value.Left.Sekret)
                | AppendRightLeft(strBuilder, "• Cerumen", value.Right.Serumen, value.Left.Serumen)
                ;
        ...
        private bool AppendThroat(StringBuilder strBuilder, ThtTenggorok value)
        {
            ...
            | Append(strBuilder, "Tongue", value.Right.Tongue)
            | Append(strBuilder, "Lips", value.Right.Lips)
            | Append(strBuilder, "Palatum", value.Right.Palatum)
            )
            {
