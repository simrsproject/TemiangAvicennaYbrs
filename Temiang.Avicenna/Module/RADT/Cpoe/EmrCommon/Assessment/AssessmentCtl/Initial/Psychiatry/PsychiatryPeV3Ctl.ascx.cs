...
{
    public partial class PsychiatryPeV3Ctl : BaseAssessmentCtl
    {
        ...
        protected override void OnPopulateEntryControl(PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            txtPemeriksaanFisik.Text = ent.PemeriksaanFisik;
            ...
            txtFarmakoterapi.Text = ent.Farmakoterapi;
        ...
        protected override void OnSetEntityValue(ValidateArgs args, PatientAssessment assessment, RegistrationInfoMedic rim)
        {
            ...
            ent.PemeriksaanFisik = txtPemeriksaanFisik.Text;
            ...
            ent.Farmakoterapi = txtFarmakoterapi.Text;
        ...
        private string GenerateSoapObjective(PsychiatryPe pe)
        {
            ...
            strBuilder.AppendFormat("• Pemeriksaan Fisik: {0}", pe.PemeriksaanFisik);
            strBuilder.AppendLine(string.Empty);
