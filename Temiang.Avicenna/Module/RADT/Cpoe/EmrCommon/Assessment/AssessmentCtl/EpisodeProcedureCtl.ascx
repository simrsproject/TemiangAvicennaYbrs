<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EpisodeProcedureCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.EpisodeProcedureCtl" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cboProcedureID" runat="server" Width="300px" EmptyMessage="Select a Procedure" Text='<%# Bind("ProcedureID") %>'
                                    ...
                                    <ClientItemTemplate>
                                                    <div style="cursor:pointer;" onclick="onProcedureNameClick('#= Attributes.ProcedureName #')">
                                                        <ul class="details">
