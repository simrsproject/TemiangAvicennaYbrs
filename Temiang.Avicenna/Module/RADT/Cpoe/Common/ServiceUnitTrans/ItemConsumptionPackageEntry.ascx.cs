...
namespace Temiang.Avicenna.Module.RADT.Cpoe
{
    public partial class ItemConsumptionPackageEntry : BaseUserControl
    {
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = ((TransChargesItemConsumptionCollection)Session["collTransChargesItemConsumption" + Request.UserHostName]).Where(i => i.TransactionNo == Request.QueryString["trans"] &&
