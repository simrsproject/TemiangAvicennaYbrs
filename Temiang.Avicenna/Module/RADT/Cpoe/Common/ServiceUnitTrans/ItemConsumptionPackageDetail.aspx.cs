...
namespace Temiang.Avicenna.Module.RADT.Cpoe
{
    public partial class ItemConsumptionPackageDetail : BasePageDialog
    {
        ...
        {
            if (ViewState["LocationID" + Request.UserHostName] == null)
            {
                var unit = new ServiceUnit();
                unit.LoadByPrimaryKey(Request.QueryString["unit"]);
                ViewState["LocationID" + Request.UserHostName] = unit.GetMainLocationId();
            ...
            try
            {
                ...
                query.InnerJoin(balance).On
                    (
                        ...
                        balance.LocationID == ViewState["LocationID" + Request.UserHostName]
                    );
                query.Where
                    (
                        query.SRItemType.In
        ...
        public override bool OnButtonOkClicked()
        {
            ...
            var item = ((TransChargesItemCollection)Session["collTransChargesItem" + Request.UserHostName]).FindByPrimaryKey(Request.QueryString["trans"],
            ...
            var cons = ((TransChargesItemConsumptionCollection)Session["collTransChargesItemConsumption" + Request.UserHostName]).FindByPrimaryKey(
