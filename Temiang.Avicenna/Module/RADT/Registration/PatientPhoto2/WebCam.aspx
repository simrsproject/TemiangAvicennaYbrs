<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="WebCam.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.WebCam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="my_camera" style="margin-left: 15px; margin-top: 10px;"></div>
        ...
        <tr>
            <td align="center">
                ...
                <div id="prepost_take_buttons" style="display: none">
                    ...
                    <input type="button" value="Use Snapshot" onclick="use_snapshot()" />
                </div>
            </td>
        </tr>
    </table>
