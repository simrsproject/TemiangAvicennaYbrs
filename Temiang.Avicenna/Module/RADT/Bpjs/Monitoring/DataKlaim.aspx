<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="DataKlaim.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Bpjs.Monitoring.DataKlaim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterStatusKlaim">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdList" LoadingPanelID="fw_ajxLoadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
                ...
                <td width="50%" style="vertical-align: top">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td class="entry">
                                <telerik:RadComboBox ID="cboStatusKlaim" runat="server" Width="304px">
                                    <Items>
                                        <telerik:RadComboBoxItem Value="1" Text="Proses Verifikasi" Selected="true" />
                                        <telerik:RadComboBoxItem Value="2" Text="Pending Verifikasi" />
                                        <telerik:RadComboBoxItem Value="3" Text="Klaim" />
                                    </Items>
                                </telerik:RadComboBox>
                            </td>
                            <td style="text-align: left">
                                <asp:ImageButton ID="btnFilterStatusKlaim" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                    OnClick="btnFilterTglPelayanan_Click" ToolTip="Search" />
                            </td>
                        </tr>
                    </table>
