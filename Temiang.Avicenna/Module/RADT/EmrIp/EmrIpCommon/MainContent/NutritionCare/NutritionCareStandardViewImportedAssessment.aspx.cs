...
{
    public partial class NutritionCareStandardViewImportedAssessment : BasePageDialog
    {
        ...
        private void BuildCustomEntryAssessment()
        {
            ...
            var nat = new NutritionCareAssessmentTransDTCollection();
            ...
            string AnswerText, double? AnswerNum, string AnswerSelectionLineID, bool ReadOnly)
        {
            return InitializedQuestion(q.QuestionID, q.QuestionText, q.SRAnswerType, q.AnswerWidth ?? 0,
                ...
                AnswerText, AnswerNum, AnswerSelectionLineID, ControlContainer, ReadOnly);
        }

        public static System.Web.UI.Control InitializedQuestion(DataRow question, GridDataItem cell, NutritionCareAssessmentTransDT nat)
        {
        ...
        public static System.Web.UI.Control InitializedQuestion(string QuestionID, string QuestionText, string SRAnswerType,
            ...
            string AnswerText, double? AnswerNum, string AnswerSelectionLineID,
                    ...
                    case "CBO":
                        {
                            var cbo = ComboBoxControl(controlID, QuestionAnswerSelectionID,
                                            QuestionAnswerDefaultSelectionID, AnswerWidth);
                    ...
                    case "CB2":
                        {
                            ...
                            var cbo2 = ComboBoxControl(controlID + "_2", QuestionAnswerSelectionID2,
                                            QuestionAnswerDefaultSelectionID2, AnswerWidth2);
        ...
        {
            var dttbl = NutritionCareDiagnoseTransDT.NutritionCareAssessment(ID, false);
