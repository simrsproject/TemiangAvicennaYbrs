...
{
    public partial class NosocomialCatheterEntry : BasePageDialogEntry
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    this.Title = "Catheter Installation of : " + pat.PatientName + " (MRN: " + pat.MedicalNo + ")";
                }
            }
        ...
        protected override void OnPopulateEntryControl(ValidateArgs args)
        {
            ...
            txtTypeOfCatheter.Text = ent.TypeOfCatheter;
        ...
        private void Save(bool isNewRecord)
        {
            ...
            if (isNewRecord || !ent.LoadByPrimaryKey(RegistrationNo, MonitoringNo))
            {
                ...
                ent.MonitoringType = "CAT";
            }
            ent.RoomID = cboRoomID.SelectedValue;
            ent.TypeOfCatheter = txtTypeOfCatheter.Text;
