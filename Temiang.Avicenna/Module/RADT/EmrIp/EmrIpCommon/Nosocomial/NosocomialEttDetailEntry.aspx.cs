...
{
    public partial class NosocomialEttDetailEntry : BasePageDialogEntry
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    this.Title = "Mechanic Ventilation Monitoring of : " + pat.PatientName + " (MRN: " + pat.MedicalNo + ")";
                }
        ...
        protected override void OnPopulateEntryControl(ValidateArgs args)
        {
            ...
            var ent = new NosocomialMonitoringEtt();
        ...
        {
            var qr = new NosocomialMonitoringEttQuery("a");
            var fb = new NosocomialMonitoringEtt();
