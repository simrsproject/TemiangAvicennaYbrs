<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialogEntry.Master" AutoEventWireup="true"
    CodeBehind="ResumeMedisRichTextOutPatientEntry.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.ResumeMedisRichTextOutPatientEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock runat="server" ID="cb">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function cboSRReferralServiceUnit_ClientItemsRequesting(sender, eventArgs) {
                var context = eventArgs.get_context();
                context["RefID"] = "ReferralServiceUnit";
            }
        ...
        <tr>
            ...
            <td style="width: 50%; vertical-align: top;">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td class="label">Type Of Service
                        </td>
                        <td>
                            <telerik:RadComboBox ID="CboSRTypeOfService" runat="server" Width="304px" AllowCustomText="true"
                                Filter="Contains" />
                        </td>
                        <td style="width: 20px"></td>
                        <td></td>
    ...
    <table width="100%">
        ...
        <tr>
             <td class="label algn">Cause Of Disease <br />
                       Penyebab Penyakit
                </td>
                  <td>
                   <telerik:RadComboBox ID="cboCauseOfDisease" runat="server" Width="304px" AllowCustomText="true"
                     Filter="Contains" />
                        </td>
                        <td style="width: 20px"></td>
        </tr>
        ...
        <tr>
             <td class="label algn">Causes Of Developmental Disorders <br />
                       Penyebab Gangguan Kelainan Tumbuh Kembang
                </td>
                  <td>
                   <telerik:RadComboBox ID="cboCauseOfDevelopDisorder" runat="server" Width="304px" AllowCustomText="true"
                     Filter="Contains" />
                        </td>
                        <td style="width: 20px"></td>
        </tr>
        <tr>
            <td class="label"></td>
            <td>
                <telerik:RadTextBox ID="txtCauseOfDevelopDisorder" runat="server" Width="100%" />
            </td>
            <td></td>
        </tr>
        ...
        <tr>
             <td class="label algn">Nature of Surgery <br />
                       Sifat Operasi
                </td>
                  <td>
                   <telerik:RadComboBox ID="cboSRNatureSurgery" runat="server" Width="304px" AllowCustomText="true"
                     Filter="Contains" />
                        </td>
                        <td style="width: 20px"></td>
        </tr>
        ...
        <tr>
          <td class="label" style="width: 15%;">
              <strong>Instruction & Follow Up / Intruksi dan Tindak Lanjut</strong>
          </td>
        <table width="98%" cellpadding="0" cellspacing="0">
            <tr>
                <td class="label"></td>
                <td class="entry">
                    <asp:CheckBox ID="chkInstruction1" runat="server" Text="Tidak Perlu Kunjungan Ulang" />
                </td>
                <td width="20"></td>
            </tr>
            <tr>
               <td class="label"></td>
                <td class="entry">
                    <asp:CheckBox ID="chkInstruction2" runat="server" Text="Perlu Kunjungan Ulang" />
                </td>
                <td width="20"></td>
            </tr>
            <tr>
               <td class="label"></td>
                <td class="entry">
                    <asp:CheckBox ID="chkInstruction3" runat="server" Text="Perlu Tindakan" />
                        <td class="entry">
                            <telerik:RadTextBox ID="txtInstruction3" runat="server" Width="500px"/>
                        </td>
                </td>
             </tr>
            <tr>
                <td class="label"></td>
                <td class="entry">
                    <asp:CheckBox ID="chkInstruction4" runat="server" Text="Perlu dirujuk ke" />
                    <td class="entry">
                        <telerik:RadTextBox ID="txtInstruction4" runat="server" Width="500px" />
                    </td>
                </td>
            </tr>
            <tr>
                <td class="label"></td>
                <td class="entry">
                    <asp:CheckBox ID="chkInstruction5" runat="server" Text="Perlu istirahat sakit" />
                    <td class="entry">
                        <telerik:RadTextBox ID="txtInstruction5" runat="server" Width="500px" />
                    </td>
                </td>
            </tr>
            <tr>
                <td class="label"></td>
                <td class="entry">
                    <asp:CheckBox ID="chkInstruction6" runat="server" Text="Perlu rawat inap dengan indikasi" />
                    <td class="entry">
                        <telerik:RadTextBox ID="txtInstruction6" runat="server" Width="500px" />
                    </td>
                </td>
            </tr>
         </table>
...
<%--        <tr>
            <td class="label algn">Instruction & Follow Up<br />
                ...
                <br />
                <asp:LinkButton runat="server" ID="lbtnLookUpFU" OnClick="lbtnLookUpFU_Click" OnClientClick="if (!confirm('Reset this Instruction & Follow Up')) return false;">
                    <img src="../../../../../Images/Toolbar/refresh16.png"/>
                </asp:LinkButton>
            </td>
            <td>
    ...
    <asp:Panel runat="server" ID="pnlRefer" Width="100%">
        <fieldset style="width: 98%">
            ...
            <table width="100%">
                ...
                <tr>
                    <td class="label">Specialist<br />
                        Spesialis
                    </td>
                    <td>
                        <telerik:RadComboBox ID="cboSRReferralServiceUnit" runat="server" Width="304px" EmptyMessage="Select Refer To"
                            EnableLoadOnDemand="true" ShowMoreResultsBox="true" EnableVirtualScrolling="true"
                            OnClientItemsRequesting="cboSRReferralServiceUnit_ClientItemsRequesting" OnClientFocus="showDropDown">
