...
namespace Temiang.Avicenna.Module.RADT.EmrIp.EmrIpCommon.ResumeMedis.RSISB
{
    ...
    /// Create Start: 
    /// ======================
    public partial class ResumeMedisRichTextEmPatientEntry : BasePageDialogEntry
    {
...
break;";
        ...
        protected override void OnPopulateEntryControl(ValidateArgs args)
        {
            ...
            if (medRes.LoadByPrimaryKey(RegistrationNo))
            {
                ...
                if (cboSRDischargeMethod.SelectedValue == "E09")
                {
        ...
        protected override void OnDataModeChanged(AppEnum.DataMode oldVal, AppEnum.DataMode newVal)
        {
            ...
            MdsDiagnoseEMPatientCtl.Rebind(newVal != AppEnum.DataMode.Read);
        ...
        protected override void OnMenuNewClick()
        {
            ...
            if (!medRes.LoadByPrimaryKey(RegistrationNo))
            {
                ...
                MdsDiagnoseEMPatientCtl.ImportWorkDiagnose(RegistrationNo, false);
        ...
        protected override void OnMenuEditClick()
        {
            ...
            var vall = cboSRDischargeCondition.SelectedValue;
            ...
            ComboBox.SelectedValue(cboSRDischargeCondition, vall);
        ...
        private void SaveReferExternal()
        {
            ...
            if (!isExist && cboSRDischargeMethod.SelectedValue == "E09")
            {
                isExist = true;
                refExt.AddNew();
        ...
        {
            MdsDiagnoseEMPatientCtl.ImportWorkDiagnose(RegistrationNo, true);
        }
