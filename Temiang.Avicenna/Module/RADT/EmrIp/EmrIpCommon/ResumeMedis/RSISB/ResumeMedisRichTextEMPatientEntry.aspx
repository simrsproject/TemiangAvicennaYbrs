<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialogEntry.Master" AutoEventWireup="true"
    CodeBehind="ResumeMedisRichTextEMPatientEntry.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.EmrIp.EmrIpCommon.ResumeMedis.RSISB.ResumeMedisRichTextEmPatientEntry" %>
...
<%@ Register Src="~/Module/RADT/EmrIp/EmrIpCommon/ResumeMedis/Ctl/MdsDiagnoseEMPatientCtl.ascx" TagPrefix="uc1" TagName="MdsDiagnoseEMPatientCtl" %>
...
<%--        <tr>
        ...
        <tr>
            ...
            <td>
                <uc1:MdsDiagnoseEMPatientCtl runat="server" id="MdsDiagnoseEMPatientCtl" />
            </td>
        </tr>
        <tr>
