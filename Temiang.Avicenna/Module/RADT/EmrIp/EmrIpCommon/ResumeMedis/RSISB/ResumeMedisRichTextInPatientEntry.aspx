<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialogEntry.Master" AutoEventWireup="true"
    CodeBehind="ResumeMedisRichTextInPatientEntry.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.EmrIp.EmrIpCommon.ResumeMedis.RSISB.ResumeMedisRichTextInPatientEntry" %>
...
<%--            function openDietHist() {
            ...
            function openAncillaryExamHist() {
                var url = 'SelectAncillaryExamHistory.aspx?regno=<%= RegistrationNo %>';
                openWinDialog(url);
            }
    ...
    <table width="100%">
        ...
        <tr>
            <td class="label algn">CONSULTATION RESULTS (FILL IN THE RESULTS OF ALL CONSULTATIONS IF ANY)
                <br />
                <td>
                    <telerik:RadEditor RenderMode="Lightweight" ID="edtconsultation" runat="server" Width="100%"
                        OnClientLoad="Avicenna.editor_onClientLoad" Height="150px" AutoResizeHeight="true" ToolsFile="ToolBarEditorSimple.xml" NewLineMode="Br">
                    </telerik:RadEditor>
                </td>
            </td>
            <td></td>
                ...
                <tr>
            <td class="label algn">INITIAL DIAGNOSE
                <br />
                <td>
                    <telerik:RadEditor RenderMode="Lightweight" ID="edtInitialDiagnose" runat="server" Width="100%"
                        OnClientLoad="Avicenna.editor_onClientLoad" Height="150px" AutoResizeHeight="true" ToolsFile="ToolBarEditorSimple.xml" NewLineMode="Br">
                    </telerik:RadEditor>
                </td>
            </td>
    ...
    <asp:Panel runat="server" ID="pnlRefer" Width="100%">
        ...
        <fieldset style="width: 98%">
            <legend><strong>HOME CARE</strong></legend>
            <tr>
                <telerik:RadEditor RenderMode="Lightweight" ID="edtHomeCare" runat="server" Width="100%"
                    OnClientLoad="Avicenna.editor_onClientLoad" Height="150px" AutoResizeHeight="true" ToolsFile="ToolBarEditorSimple.xml" NewLineMode="Br">
                </telerik:RadEditor>
                </td>
                    <td></td>
        ...
        <fieldset style="width: 98%">
            <legend><strong>EDUCATION PATIENT (DISEASE/DIET/OTHERS AT HOME)</strong></legend>
            <tr>
                <telerik:RadEditor RenderMode="Lightweight" ID="edtHomeEducation" runat="server" Width="100%"
                    OnClientLoad="Avicenna.editor_onClientLoad" Height="150px" AutoResizeHeight="true" ToolsFile="ToolBarEditorSimple.xml" NewLineMode="Br">
                </telerik:RadEditor>
                </td>
                    <td></td>
        ...
        <fieldset style="width: 98%">
            <table width="100%">
                <legend><strong>THE RESULTS OF SUPPORTING EXAMINATIONS ARE NOT YET AVAILABLE</strong></legend>
                <tr>
                    <td class="label">Medical Support<br />
                        PENUNJANG MEDIS</td>
                    <td>
                        <telerik:RadTextBox ID="txtMedicalSupport" runat="server" Width="304px" />
                    </td>
                    <td></td>
                    <td></td>
                </tr>
                <td></td>
                <tr>
                    <td class="label">In<br />
                        Di</td>
                    <td>
                        <telerik:RadTextBox ID="txtInLocation" runat="server" Width="304px" />
                    </td>
                    <td></td>
                </tr>
                <tr>
                    <td class="label">date<br />
                        Jam
                    </td>
                    <td>
                        <telerik:RadDateTimePicker ID="txtCollectionDateTime" runat="server" Width="170px" />
                    </td>
                    <td></td>
                </tr>
            </table>
