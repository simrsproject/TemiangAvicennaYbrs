<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MdsDiagnoseCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.Mds.Ctl.MdsDiagnoseCtl" %>
                ...
                <FormTemplate>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="rfvDiagnoseID" runat="server" ErrorMessage=" "
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="rfvDiagnosisText" runat="server" ErrorMessage=""
                        ...
                        <tr>
                            <td align="right" colspan="2">
                                <asp:Button ValidationGroup="EntryIcdX" ID="btnUpdate" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
