...
{
    public partial class DetailOpRegistrationAndDischargeList : BasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                units.Query.Where(units.Query.SRRegistrationType == AppConstant.RegistrationType.OutPatient,
                                 units.Query.IsActive == true);
                units.LoadAll();

                cboServiceUnitID.Items.Add(new RadComboBoxItem(string.Empty, string.Empty));
                foreach (ServiceUnit unit in units)
                {
        ...
        protected void grdList_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            ...
            var dataSource = OutpatientRegistrations;
            if (dataSource == null)
        ...
        private DataTable OutpatientRegistrations
        {
            get
            {
                var isEmptyFilter = txtDate.IsEmpty && string.IsNullOrEmpty(txtRegistrationNo.Text) && string.IsNullOrEmpty(txtPatientName.Text) && string.IsNullOrEmpty(cboParamedicID.SelectedValue) && string.IsNullOrEmpty(cboServiceUnitID.SelectedValue);
