<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true"
    CodeBehind="PatientBirthRecordList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.PatientBirthRecordList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function gotoViewUrl(id, regno) {
            var url = 'PatientBirthRecordDetail.aspx?md=view&id=' + id + '&mregno=' + regno;
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterIncludeCheckout">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
                ...
                <td td style="width: 50%; vertical-align: top">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td width="20">
                                <asp:ImageButton ID="btnFilterIncludeCheckout" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                    OnClick="btnFilter_Click" ToolTip="Search" />
                            </td>
                            <td>
                            </td>
