...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterBootstrap.Master" AutoEventWireup="true" CodeBehind="OTMonitoringDisplayV2.aspx.cs" Inherits="Temiang.Avicenna.Module.Kiosk.OTMonitoringDisplayV2" %>
    ...
    <script language="javascript">
        ...
        function CreateListOK(DtTblName, IsComplete) {
            return $('#' + DtTblName).DataTable({
                ...
                "columns": [
                    { title: "Room", data: 'RoomName', name: 'RoomName', className: "myTh" },
                    { title: "Date", data: 'BookingDateTimeFrom', name: 'BookingDateTimeFrom', className: "myTh" },
                    //{
                    //    title: "Date", data: 'BookingDateTimeFrom', name: 'BookingDateTimeFrom', className: "myTh",
                    ...
                    //    }
                    //},
                    { title: "Specialty", data: 'SmfName', name: 'SmfName', className: "myTh" },
                    { title: "Surgeon", data: 'dokterOperator', name: 'dokterOperator', className: "myTh" },
                    { title: "Anesthesiologist", data: 'dokterAnastesi', name: 'dokterAnastesi', className: "myTh" },
                    { title: "Status", data: 'NotesJam', name: 'NotesJam', className: "myTh" }
                ],
                "ajax": {
                    "url": "<%=Helper.UrlRoot() %>/WebService/KioskQueue.asmx/OperatingTheaterGetList2",
                    "type": "POST",
                    "datatype": "json",
                    "data": function (d) {
