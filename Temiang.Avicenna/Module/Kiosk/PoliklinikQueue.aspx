...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterBootstrap.Master" AutoEventWireup="true" CodeBehind="PoliklinikQueue.aspx.cs" Inherits="Temiang.Avicenna.Module.Kiosk.PoliklinikQueue" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        ...
        $(document).ready(function () {
            ...
            SetHtml("spanPageTitle", "<%= GetBrandName()%> Polyclinic List");
        ...
        function CreateListOK(DtTblName, IsComplete) {
            return $('#' + DtTblName).DataTable({
                ...
                "columns": [
                    { title: "Polyclinic", data: 'ServiceUnitName', name: 'ServiceUnitName', className: "myTh" },
                    { title: "Physician", data: 'ParamedicName', name: 'ParamedicName', className: "myTh" },
                    { title: "Que", data: 'RegistrationQue', name: 'RegistrationQue', className: "myTh" }
                ],
                "ajax": {
                    "url": "<%=Helper.UrlRoot() %>/WebService/KioskQueue.asmx/PoliklinikList",
                    "type": "POST",
                    "datatype": "json",
                    "data": function (d) {
