...
<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterBootstrap.Master" AutoEventWireup="true"
    CodeBehind="PrescQueueDisplay3Col.aspx.cs"
    Inherits="Temiang.Avicenna.Module.Kiosk.PrescQueueDisplay3Col" EnableTheming="False" %>
    ...
    <script language="javascript">
        ...
        function CreateList(DtTblName, iProgress) {
            return $('#' + DtTblName).DataTable({
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            ...
                            for (var i = 0; i < colsDef.length; i++) {
                                //console.log("|" + colsDef[i] + "|");
                                if (row[colsDef[i]].length > 0) {
                                    if (colsDef[i] == "Flag") {
                                        strDef = strDef + " (" + row[colsDef[i]] + ")";
                                    } else {
                ...
                "ajax": {
                    "url": "<%=Helper.UrlRoot() %>/WebService/KioskQueue.asmx/PrescriptionGetQueue3Col",
                    "type": "POST",
                    "datatype": "json",
                    "data": function (d) {
