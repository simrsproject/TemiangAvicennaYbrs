<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="ThrTransactionProcessList.aspx.cs" Inherits="Temiang.Avicenna.Module.Payroll.Process.ThrTransactionProcessList" %>
    ...
    <telerik:RadCodeBlock runat="server" ID="RadCodeBlock1">
        ...
        <script type="text/javascript">
            ...
            function Reprocessing(periodId, msg) {
                if (confirm('Are you sure to ' + msg + ' this THR transaction?'))
                    __doPostBack("<%= grdList.UniqueID %>", "reprocessing|" + periodId + "|" + msg);
            }
	        
	        function Closing(periodId) {
		        if (confirm('Are you sure to close this THR transaction?'))
