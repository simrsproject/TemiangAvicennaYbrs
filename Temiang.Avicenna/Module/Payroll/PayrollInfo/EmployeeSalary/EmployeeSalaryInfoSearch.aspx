<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="EmployeeSalaryInfoSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Payroll.PayrollInfo.EmployeeSalaryInfoSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            ...
            <td class="entry">
                <telerik:RadComboBox ID="cboOrganizationUnit" runat="server" Width="304px" AllowCustomText="true"
                    Filter="Contains" />
            </td>
            <td>
            </td>
