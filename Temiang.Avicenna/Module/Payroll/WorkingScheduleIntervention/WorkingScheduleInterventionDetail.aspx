<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="WorkingScheduleInterventionDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Payroll.WorkingScheduleInterventionDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td width="50%" valign="top">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:radcombobox id="cboPayrollPeriod" runat="server" width="300px" autopostback="true" allowcustomtext="true" filter="Contains" onselectedindexchanged="cboPayrollPeriod_SelectedIndexChanged" />
                        </td>
                        <td width="20px">
                    ...
                    <tr>
                        <td class="label">Working Schedule Name
                        </td>
                        <td class="entry">
                            <telerik:radcombobox id="cboWorkingSchedule" runat="server" width="300px" autopostback="true" allowcustomtext="true" filter="Contains" onselectedindexchanged="cboWorkingSchedule_SelectedIndexChanged" />
                        </td>
                        <td width="20px">
                            <asp:RequiredFieldValidator ID="rfvWorkingSchedule" runat="server" ErrorMessage="Working Schedule Name required."
                                ValidationGroup="entry" ControlToValidate="cboWorkingSchedule" SetFocusOnError="True"
                                Width="100%">
    ...
    <div style="padding-top: 170px;">
        <telerik:radgrid id="grdWorkingScheduleDetail" runat="server" onneeddatasource="grdWorkingScheduleDetail_NeedDataSource"
            ...
            <mastertableview commanditemdisplay="None" datakeynames="WorkingSchduleInterventionDetailID, WorkingSchduleInterventionID, PersonID">
                <columns>
