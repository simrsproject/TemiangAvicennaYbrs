...
{
    public partial class IncentivePositionList : BasePageList
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            UrlPageSearch = "IncentivePositionSearch.aspx";
            UrlPageDetail = "IncentivePositionDetail.aspx";
        ...
        {
            grdList.DataSource = Professions;
        }

        private DataTable Professions
        {
            get
            {
