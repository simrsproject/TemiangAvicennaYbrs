...
{
    public partial class IntermBillList : BasePage
    {
        ...
        private DataTable Registrations
        {
            get
            {
                var isEmptyFilter = string.IsNullOrEmpty(cboServiceUnitID.SelectedValue) && string.IsNullOrEmpty(cboParamedicID.SelectedValue) && string.IsNullOrEmpty(txtRegistrationNo.Text) && 
                    string.IsNullOrEmpty(txtPatientName.Text) && string.IsNullOrEmpty(txtIntermbillNo.Text);
                ...
                query.LeftJoin(ib).On(query.RegistrationNo == ib.RegistrationNo);
                ...
                if (txtIntermbillNo.Text != string.Empty)
                    query.Where(ib.IntermBillNo == txtIntermbillNo.Text);
