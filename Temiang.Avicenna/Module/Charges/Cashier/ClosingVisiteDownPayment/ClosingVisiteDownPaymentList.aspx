<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="ClosingVisiteDownPaymentList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.Cashier.ClosingVisiteDownPaymentList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterSsn">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btnFilterVisitDate">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterClosingNo">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdListD" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <telerik:RadTabStrip ID="tabStrip" runat="server" MultiPageID="multiPage" ShowBaseLine="true"
        ...
        <Tabs>
            <telerik:RadTab runat="server" Text="Visit Down Payment" PageViewID="pgDP" Selected="True" />
            <telerik:RadTab runat="server" Text="Closing Payment" PageViewID="pgCP" />
        </Tabs>
    </telerik:RadTabStrip>
    <telerik:RadMultiPage ID="multiPage" runat="server" BorderStyle="Solid" BorderColor="Gray">
        <telerik:RadPageView ID="pgDP" runat="server" Selected="true">
                    ...
                    <tr>
                        <td width="50%" style="vertical-align: top">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="entry">
                                        <telerik:RadTextBox ID="txtSsn" runat="server" Width="300px" MaxLength="20" />
                                    </td>
                                    <td width="20">
                                        <asp:ImageButton ID="btnFilterSsn" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                            OnClick="btnFilter_Click" ToolTip="Search" />
                                    </td>
                                    <td style="text-align: right"></td>
                                </tr>
                        ...
                        <td width="50%" style="vertical-align: top">
                            <table width="100%">
                                <tr>
                                    <td class="label">
                                        <asp:Label ID="lblVisiteDpDate" runat="server" Text="Visit Down Payment Date"></asp:Label>
                                    </td>
                                    <td class="entry">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <telerik:RadDatePicker ID="txtVisitDate1" runat="server" Width="100px" />
                                                </td>
                                                <td>&nbsp;-&nbsp;
                                                </td>
                                                <td>
                                                    <telerik:RadDatePicker ID="txtVisitDate2" runat="server" Width="100px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="20">
                                        <asp:ImageButton ID="btnFilterVisitDate" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                            OnClick="btnFilter_Click" ToolTip="Search" />
                                    </td>
                                    <td style="text-align: right"></td>
                                </tr>
            ...
            <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="PatientID" ClientDataKeyNames="PatientID" GroupLoadMode="Client">
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="">
                            <ItemTemplate>
                                <%# (this.IsUserAddAble.Equals(false) ? string.Empty
                                    : string.Format("<a href=\"ClosingVisiteDownPaymentDetail.aspx?md=new&patid={0}&ut=\"><img src=\"../../../../Images/Toolbar/new16.png\" border=\"0\" alt=\"New\" /></a>",
        ...
        <telerik:RadPageView ID="pgCP" runat="server">
                        ...
                        <td width="50%" style="vertical-align: top">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td class="entry">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <telerik:RadDatePicker ID="txtClosingDate1" runat="server" Width="100px" />
                                                </td>
                                                <td>&nbsp;-&nbsp;
                                                </td>
                                                <td>
                                                    <telerik:RadDatePicker ID="txtClosingDate2" runat="server" Width="100px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td width="20">
                                        <asp:ImageButton ID="btnFilterClosingNo" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                            OnClick="btnFilterD_Click" ToolTip="Search" />
                                    </td>
                                    <td style="text-align: right"></td>
                                </tr>
            ...
            <telerik:RadGrid ID="grdListD" runat="server" OnNeedDataSource="grdListD_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="ClosingNo" ClientDataKeyNames="ClosingNo" GroupLoadMode="Client">
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="edit" HeaderText="" Groupable="false">
                            <ItemTemplate>
                                <%# ((this.IsUserEditAble.Equals(false) || (DataBinder.Eval(Container.DataItem, "IsApproved").Equals(true) || DataBinder.Eval(Container.DataItem, "IsVoid").Equals(true))) ? string.Empty :
                                            string.Format("<a href=\"ClosingVisiteDownPaymentDetail.aspx?md=edit&id={0}&patid={1}&ut=\"><img src=\"../../../../Images/Toolbar/edit16.png\" border=\"0\" alt=\"Edit\" /></a>",
                                                                                    DataBinder.Eval(Container.DataItem, "ClosingNo"), 
                                                                                    DataBinder.Eval(Container.DataItem, "PatientID")))%>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" Width="35px" />
                            <ItemStyle HorizontalAlign="Center" />
                        </telerik:GridTemplateColumn>
                        <telerik:GridHyperLinkColumn HeaderStyle-Width="120px" DataTextField="ClosingNo"
                            DataNavigateUrlFields="ClosingUrl" HeaderText="Transaction No" UniqueName="ClosingNo"
                            SortExpression="ClosingNo" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                        <telerik:GridDateTimeColumn HeaderStyle-Width="100px" DataField="ClosingDate" HeaderText="Date"
                            UniqueName="ClosingDate" SortExpression="ClosingDate" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Center" />
                        <telerik:GridBoundColumn DataField="MedicalNo" HeaderText="Medical No" UniqueName="MedicalNo"
                            SortExpression="MedicalNo">
                            <HeaderStyle HorizontalAlign="Center" Width="100px" />
                        ...
                        <telerik:GridTableView Name="detail" DataKeyNames="PaymentNo" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="PaymentTime" HeaderText="Payment Time"
                                    ...
                                    ItemStyle-HorizontalAlign="Center" />
                                <telerik:GridNumericColumn HeaderStyle-Width="120px" DataField="Amount" HeaderText="Closing Amount"
