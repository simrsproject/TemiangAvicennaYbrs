<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="PaymentReceiveReturnList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.PaymentReceiveReturnList" %>
                ...
                <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="">
                    <ItemTemplate>
                        <%# (this.IsUserAddAble.Equals(false) || DataBinder.Eval(Container.DataItem, "IsChasierCheckin").Equals(false) ? string.Empty
                                                        : string.Format("<a href=\"PaymentReceiveReturnDetail.aspx?md=new&regno={0}&pc={1}&mcno={2}\"><img src=\"../../../../Images/Toolbar/new16.png\" border=\"0\" alt=\"New\" /></a>",
                                                                                        DataBinder.Eval(Container.DataItem, "RegistrationNo"), Page.Request.QueryString["pc"], DataBinder.Eval(Container.DataItem, "CashManagementNo")))%>
                    </ItemTemplate>
                ...
                <telerik:GridTableView Name="detail" DataKeyNames="PaymentNo,RegistrationNo" AutoGenerateColumns="false">
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="edit" HeaderText="" Groupable="false">
                            <ItemTemplate>
                                <%# ((this.IsUserEditAble.Equals(false) || (DataBinder.Eval(Container.DataItem, "IsApproved").Equals(true) || DataBinder.Eval(Container.DataItem, "IsVoid").Equals(true))) ? string.Empty :
                                                                        string.Format("<a href=\"PaymentReceiveReturnDetail.aspx?md=edit&id={0}&regno={1}&pc={2}&cmno={3}\"><img src=\"../../../../Images/Toolbar/edit16.png\" border=\"0\" alt=\"Edit\" /></a>",
                        ...
                        <telerik:GridCheckBoxColumn HeaderStyle-Width="60px" DataField="IsVoid" HeaderText="Void"
                            ...
                            ItemStyle-HorizontalAlign="Center" />
                        <telerik:GridBoundColumn HeaderStyle-Width="200px" DataField="UserName" HeaderText="Created By"
