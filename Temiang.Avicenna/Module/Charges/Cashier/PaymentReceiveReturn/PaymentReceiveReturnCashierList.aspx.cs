...
{
    public partial class PaymentReceiveReturnCashierList : BasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ProgramID = AppConstant.Program.PaymentReceiveReturnCashier;
        ...
        private DataTable OutStandings
        {
            get
            {
                ...
                if (!ValidateSearch(isEmptyFilter, "Payment Return (Cashier)")) return null;
                ...
                qpy.Where(qpy.TransactionCode == TransactionCode.PaymentReturn, qpy.IsApproved == false, qpy.IsVoid == false, qreg.IsClosed == false, qreg.IsVoid == false);
        ...
        private DataTable Payments
        {
            get
            {
                ...
                qpy.Where(qpy.TransactionCode == TransactionCode.PaymentReturn, qpy.IsApproved == true, qpy.ApproveByUserID == AppSession.UserLogin.UserID);
