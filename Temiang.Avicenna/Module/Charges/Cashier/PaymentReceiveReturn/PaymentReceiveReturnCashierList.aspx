<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="PaymentReceiveReturnCashierList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.PaymentReceiveReturnCashierList" %>
                ...
                <MasterTableView DataKeyNames="PaymentNo" ClientDataKeyNames="PaymentNo"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="edit" HeaderText="" Groupable="false">
                            <ItemTemplate>
                                <%# ((this.IsUserEditAble.Equals(false) || DataBinder.Eval(Container.DataItem, "IsChasierCheckin").Equals(false)) ? string.Empty :
                                                                        string.Format("<a href=\"PaymentReceiveReturnDetail.aspx?md=view&id={0}&regno={1}&pc={2}&cmno={3}&utype=c\"><img src=\"../../../../Images/Toolbar/views16.png\" border=\"0\" title=\"View\" /></a>",
                        ...
                        <telerik:GridNumericColumn HeaderStyle-Width="120px" DataField="TotalPaymentAmount"
                            HeaderText="Total Returned" UniqueName="TotalPaymentAmount" SortExpression="TotalPaymentAmount"
