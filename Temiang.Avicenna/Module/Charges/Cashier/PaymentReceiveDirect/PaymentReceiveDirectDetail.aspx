<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="PaymentReceiveDirectDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.PaymentReceiveDirectDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <td class="entry">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnOrderItem" runat="server" Text="Transaction Item List" OnClientClick="openWinOrderItem();return false;" />
                                    </td>
                ...
                <MasterTableView CommandItemDisplay="None" DataKeyNames="PaymentNo, SequenceNo">
                    <Columns>
                        ...
                        <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="AmountReceived" HeaderText="Received"
                            ...
                            ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n2}" Aggregate="sum" FooterAggregateFormatString="{0:n2}"
                            FooterStyle-HorizontalAlign="right" />
                        <%--<telerik:GridCalculatedColumn HeaderStyle-Width="100px" HeaderText="Change" UniqueName="Change"
                            DataType="System.Double" DataFields="Amount,AmountReceived"
                            Expression="({0}-{1})"
                    ...
                    <EditFormSettings UserControlName="PaymentReceiveDirectItem.ascx" EditFormType="WebUserControl">
                        <EditColumn UniqueName="PaymentReceiveDirectItemEditCommand">
                        </EditColumn>
                    </EditFormSettings>
                </MasterTableView>
                <FilterMenu>
        ...
        <tr>
            ...
            <td width="50%" style="vertical-align: top">
                <table width="100%">
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadNumericTextBox ID="txtPaymentAmount" runat="server" Width="100px" Value="0"
                                ClientEvents-OnValueChanged="txtPaymentAmount_ValueChanged" ClientEvents-OnKeyPress="txtPaymentAmount_KeyPress" />
                        </td>
                        <td width="20">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblReturnAmount" runat="server" Text="Return Amount"></asp:Label>
                        </td>
                        <td class="entry">
                            <telerik:RadNumericTextBox ID="txtReturnAmount" runat="server" Width="100px" ReadOnly="True"
                                Value="0" ClientEvents-OnKeyPress="txtPaymentAmount_KeyPress" />
                        </td>
                        <td width="20">
                        </td>
                        <td>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function txtPaymentAmount_KeyPress(sender, eventArgs) {
                var c = eventArgs.get_keyCode();
                if (c == 13) {
                    var preturn = $find("<%= txtReturnAmount.ClientID %>");
                    preturn.focus();
                    eventArgs.set_cancel(true);
                }
            }

            function txtPaymentAmount_ValueChanged(sender, eventArgs) {
                var amount = $find("<%= txtOrderAmount.ClientID %>");
                var payment = $find("<%= txtPaymentAmount.ClientID %>");
                var preturn = $find("<%= txtReturnAmount.ClientID %>");

                preturn.set_value(payment.get_value() - amount.get_value());
            }
            ...
            function openWinOrderItem() {
                ...
                oWnd.setUrl("PaymentReceiveDirectItemList.aspx?regno=" + oreg.get_value() + "&pyno=" + opy.get_value());
                oWnd.show();
                //oWnd.maximize();
