...
{
    public partial class PaymentReceiveDirectList : BasePage
    {
            ...
            get
            {
                ...
                if (!string.IsNullOrEmpty(txtPaymentNo.Text))
                {
                    ...
                    qr.Where(py.PaymentNo == txtPaymentNo.Text, 
                        qr.Or(py.TransactionCode == BusinessObject.Reference.TransactionCode.Payment,
                                 py.TransactionCode == BusinessObject.Reference.TransactionCode.PaymentReturn));
                }

                qr.Where(qr.IsClosed == false, qr.IsVoid == false, qr.ServiceUnitID != AppSession.Parameter.ServiceUnitIDForCafe);
        ...
        protected void grdList_DetailTableDataBind(object source, GridDetailTableDataBindEventArgs e)
        {
            ...
            query.Select
                (
                    ...
                    "<'PaymentReceiveDirectDetail.aspx?md=view&id='+a.PaymentNo+'&regno='+a.RegistrationNo+'&cmno='+ISNULL(a.CashManagementNo, '') as PaymentUrl>"
                );
            ...
            query.Where(query.Or(query.TransactionCode == BusinessObject.Reference.TransactionCode.Payment,
