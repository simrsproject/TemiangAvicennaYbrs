...
{
    public partial class DownPaymentCashierList : BasePage
    {
        ...
        private DataTable OutStandings
        {
            get
            {
                ...
                if (!ValidateSearch(isEmptyFilter, "Down Payment Received (Cashier)")) return null;
                ...
                qpy.Where(qpy.TransactionCode == TransactionCode.DownPayment, qpy.IsApproved == false, qpy.IsVoid == false);
        ...
        private DataTable Payments
        {
            get
            {
                ...
                qpy.Where(qpy.TransactionCode == TransactionCode.DownPayment, qpy.IsApproved == true, qpy.ApproveByUserID == AppSession.UserLogin.UserID);
