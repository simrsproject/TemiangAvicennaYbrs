<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="DownPaymentCashierList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.DownPaymentCashierList" %>
                        ...
                        <telerik:GridTemplateColumn UniqueName="edit" HeaderText="" Groupable="false">
                            <ItemTemplate>
                                <%# ((this.IsUserEditAble.Equals(false)) || DataBinder.Eval(Container.DataItem, "IsChasierCheckin").Equals(false) ? string.Empty :
                                            string.Format("<a href=\"DownPaymentDetail.aspx?md=view&id={0}&regno={1}&cmno={2}&patid={3}&utype=c\"><img src=\"../../../../Images/Toolbar/views16.png\" border=\"0\" title=\"View\" /></a>",
