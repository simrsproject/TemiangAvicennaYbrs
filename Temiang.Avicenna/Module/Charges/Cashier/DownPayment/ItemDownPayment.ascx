<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemDownPayment.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Charges.ItemDownPayment" %>
            ...
            <table width="100%">
                ...
                <asp:Panel ID="pnlCardDetail" runat="server">
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadComboBox ID="cboSRCardType" runat="server" Width="300px" AllowCustomText="true" Filter="Contains"/>
                        </td>
                        <td width="20px">
                        </td>
                        <td>
