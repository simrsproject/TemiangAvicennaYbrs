<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    Codebehind="SalesList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.Dispensary.SalesList"
    Title="Untitled Page" %>
        ...
        <MasterTableView DataKeyNames="TransactionNo">
            <Columns>
                ...
                <telerik:GridDateTimeColumn HeaderStyle-Width="80px" DataField="TransactionDate"
                    HeaderText="Sales Date" UniqueName="TransactionDate" SortExpression="TransactionDate"
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                <telerik:GridBoundColumn HeaderStyle-Width="300px" DataField="CustomerName" HeaderText="Customer"
                    UniqueName="CustomerName" SortExpression="FServiceUnitID" HeaderStyle-HorizontalAlign="Left"
