...
{
    public partial class PatientEducationEntry : BasePageDialogEntry
    {
        ...
        public int SeqNo
        {
            get
            {
                ...
                {
                    _seqNo = MethodExts.ToInt(Request.QueryString["seqno"]);
                }
                else
                    _seqNo = 0;
        ...
        protected override void OnPopulateEntryControl(ValidateArgs args)
        {
            ...
            if (ent.LoadByPrimaryKey(RegistrationNo, MethodExts.ToInt(SeqNo)))
            {
            ...
            grdPatientEducation.DataSource = PatientEducationDataTable(RegistrationNo, MethodExts.ToInt(txtSeqNo.Text), txtEducationType.Text, false);
        }
        ...
        {
            var ent = new PatientEducation();
            if (string.IsNullOrEmpty(txtSeqNo.Text) || !ent.LoadByPrimaryKey(RegistrationNo, MethodExts.ToInt(txtSeqNo.Text)))
            {
            ...
            ent.Duration = MethodExts.ToInt(txtDuration.Value);
        ...
        {
            var seqNo = MethodExts.ToInt(txtSeqNo.Text);
        ...
        private void SavePatientEducation()
        {
            using (var trans = new esTransactionScope())
            {
                ...
                {
                    medColl.Query.Where(medColl.Query.RegistrationNo == RegistrationNo, medColl.Query.SeqNo == MethodExts.ToInt(txtSeqNo.Text));
                    medColl.LoadAll();
                ...
                foreach (GridDataItem item in grdPatientEducation.MasterTableView.Items)
                {
                    ...
                    if (chkIsSelected.Checked)
                    {
                        ...
                        med.SeqNo = MethodExts.ToInt(txtSeqNo.Text);
