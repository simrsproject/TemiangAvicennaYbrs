<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemTransactionDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Charges.ItemTransactionDetail" %>
...
<asp:HiddenField runat="server" ID="hdnSrRegistrationType" />
...
<asp:HiddenField runat="server" ID="hdnItemConditionRuleID" />
<asp:HiddenField runat="server" ID="hdnIsNeedBookingNo" />
    ...
    <tr>
        <td>
            <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="50%">
                        <table width="100%">
                            <tr runat="server" id="trItemGroup">
                                <td class="label">
                            ...
                            <tr>
                                ...
                                <td class="entry">
                                    <telerik:RadComboBox runat="server" ID="cboItemID" Width="300px" AutoPostBack="True"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# !string.IsNullOrEmpty(DataBinder.Eval(Container.DataItem, "ItemGroupName").ToString()) ? DataBinder.Eval(Container.DataItem, "ItemGroupName", "<br />({0})") : string.Empty%>
                                ...
                                <td width="20px">
                                    <asp:RequiredFieldValidator ID="rfvItemID" runat="server" ErrorMessage="Item Name required."
                                ...
                                <td>
                                     <asp:Label ID="lblAlertBookingNo" runat="server" Text="*Booking No required." ForeColor="Red" />
                                </td> 
                            </tr>
        ...
        <td runat="server" id="tdImage" style="width: 125px;">
            <fieldset style="min-height: 125px;">
                <legend>Image</legend>
                <asp:Image runat="server" ID="imgFromWebCam" Width="180px" Height="180px" ClientIDMode="Static" />
                <asp:Button runat="server" Text="Capture Image" ID="btnCaptureImage" Width="180px"
                    OnClientClick="openWinWebCam();return false;" />
                <asp:HiddenField runat="server" ID="hdnImgFromWebCam" ClientIDMode="Static" />
            </fieldset>
        </td>
    </tr>
</table>
