...
namespace Temiang.Avicenna.Module.Charges
{
    public partial class ItemPickerDetail : BasePageDialog
    {
        ...
        protected void grdList_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            ...
            {
                var tariff = (Helper.Tariff.GetItemTariff(transDate, grr.SRTariffType, reg.ChargeClassID, reg.ChargeClassID, (string)row["ItemID"], reg.GuarantorID, false, reg.SRRegistrationType) ??
                          Helper.Tariff.GetItemTariff(transDate, grr.SRTariffType, AppSession.Parameter.DefaultTariffClass, reg.ChargeClassID, (string)row["ItemID"], reg.GuarantorID, false, reg.SRRegistrationType)) ??
                         (Helper.Tariff.GetItemTariff(transDate, AppSession.Parameter.DefaultTariffType, reg.ChargeClassID, reg.ChargeClassID, (string)row["ItemID"], reg.GuarantorID, false, reg.SRRegistrationType) ??
                          Helper.Tariff.GetItemTariff(transDate, AppSession.Parameter.DefaultTariffType, AppSession.Parameter.DefaultTariffClass, reg.ChargeClassID, (string)row["ItemID"], reg.GuarantorID, false, reg.SRRegistrationType));
