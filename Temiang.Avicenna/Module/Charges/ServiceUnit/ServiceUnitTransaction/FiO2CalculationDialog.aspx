<%@ Page Title="FiO2 Calculation" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="FiO2CalculationDialog.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.FiO2CalculationDialog" %>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                                                        ...
                                                                        <tr>
                                        <td class="label">
                                            <asp:Label ID="Label2" runat="server" Text="FiO2"></asp:Label>
                                        </td>
                                        <td class="entry2Column">
                                            <telerik:RadNumericTextBox ID="txtUsagePersen" runat="server" Width="100px">
                                                <NumberFormat DecimalDigits="2" />
