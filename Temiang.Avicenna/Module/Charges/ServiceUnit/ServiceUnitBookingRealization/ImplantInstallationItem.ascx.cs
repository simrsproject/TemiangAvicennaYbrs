...
{
    public partial class ImplantInstallationItem : BaseUserControl
    {
        ...
        private RadComboBox CboRegistrationNo
        {
            get
            { return (RadComboBox)Helper.FindControlRecursive(Page, "cboRegistrationNo"); }
        }
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            {
                txtImplantType.Enabled = false;
                txtSerialNo.Enabled = false;
                txtQty.Enabled = false;
                txtPlacementSite.Enabled = false;
            }
