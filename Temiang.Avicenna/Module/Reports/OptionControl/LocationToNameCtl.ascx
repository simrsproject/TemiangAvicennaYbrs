<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LocationToNameCtl.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Reports.OptionControl.LocationToNameCtl" %>
...
<table style="width: 90%">
    <tr>
        ...
        <td style="width: 100px">
            <asp:Label ID="lblName" runat="server" Text="To Location" />
        </td>
        <td>
