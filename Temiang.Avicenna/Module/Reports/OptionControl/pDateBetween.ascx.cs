...
{
    public partial class pDateBetween : BaseOptionCtl
    {
        ...
        public override PrintJobParameterCollection PrintJobParameters()
        {
            ...
            parameters.AddNew("pDateBetween_Start", txtFromDate.SelectedDate);
            parameters.AddNew("pDateBetween_End", txtToDate.SelectedDate);
