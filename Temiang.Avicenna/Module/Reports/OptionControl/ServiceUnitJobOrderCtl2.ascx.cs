...
{
    public partial class ServiceUnitJobOrderCtl2 : BaseOptionCtl
    {
        #region ComboBox
        protected void cboServiceUnitID_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
        {
            ComboBox.ServiceUnitJobOrderItemsRequested((RadComboBox)sender, e.Text);
        }
        ...
        public override PrintJobParameterCollection PrintJobParameters()
        {
            ...
            parameters.AddNew("p_ServiceUnitOrderID", cboServiceUnitID.SelectedValue);
