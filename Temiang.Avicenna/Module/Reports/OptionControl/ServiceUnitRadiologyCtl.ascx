<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitRadiologyCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ServiceUnitRadiologyCtl" %>
