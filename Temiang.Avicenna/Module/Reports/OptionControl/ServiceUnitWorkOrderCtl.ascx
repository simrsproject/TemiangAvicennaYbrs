<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitWorkOrderCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ServiceUnitWorkOrderCtl" %>
