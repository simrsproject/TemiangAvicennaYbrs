...
{
    public partial class DateFromToCtl2 : BaseOptionCtl
    {
        ...
        public override PrintJobParameterCollection PrintJobParameters()
        {
            ...
            parameters.AddNew("p_FromDate2", txtFromDate.SelectedDate);
            parameters.AddNew("p_ToDate2", txtToDate.SelectedDate);
