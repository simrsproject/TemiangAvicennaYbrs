...
{
    public partial class DischargeMethodIprCtl : BaseOptionCtl
    {
        #region ComboBox
        protected void cboDischargeMethod_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
        {
            ComboBox.StandardReferenceWithReferenceIDItemsRequested((RadComboBox)sender, "DischargeMethod", "IPR", e.Text);
        ...
        public override PrintJobParameterCollection PrintJobParameters()
        {
            ...
            parameters.AddNew("p_SRDischargeMethod", cboDischargeMethod.SelectedValue);
