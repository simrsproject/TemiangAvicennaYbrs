...
{
    public partial class LocationFromNameCtl : BaseOptionCtl
    {
        ...
        public override PrintJobParameterCollection PrintJobParameters()
        {
            ...
            parameters.AddNew("p_FromLocationID", cboLocationName.SelectedValue);
        ...
        public override string ReportSubTitle
        {
            get
            {
                return string.Format("From Location : {0}", cboLocationName.SelectedValue);
            }
        }
