<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitBudgetToCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ServiceUnitBudgetToCtl" %>
