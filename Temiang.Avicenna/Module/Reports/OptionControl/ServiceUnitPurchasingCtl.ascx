<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitPurchasingCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ServiceUnitPurchasingCtl" %>
