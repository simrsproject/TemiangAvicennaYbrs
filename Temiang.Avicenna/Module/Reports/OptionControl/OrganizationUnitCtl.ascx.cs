...
{
    public partial class OrganizationUnitCtl : BaseOptionCtl
    {
        #region ComboBox
        protected void cboOrganizationUnitID_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
        {
            ComboBox.OrganizationUnitItemsRequested((RadComboBox)sender, e.Text);
        }
        ...
        public override string ReportSubTitle
        {
            get
            {
                return string.Format("Registration Type : {0}", cboOrganizationUnitID.SelectedValue);
            }
        }
    }
}