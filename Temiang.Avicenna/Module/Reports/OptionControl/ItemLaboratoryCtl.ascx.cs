...
{
    public partial class ItemLaboratoryCtl : BaseOptionCtl
    {
        #region ComboBox
        protected void cboItem_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
        {
            ComboBox.ItemItemsRequested((RadComboBox)sender, e.Text, BusinessObject.Reference.ItemType.Laboratory);
        }
