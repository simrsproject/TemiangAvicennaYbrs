<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitOutpatientCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ServiceUnitOutpatientCtl" %>
