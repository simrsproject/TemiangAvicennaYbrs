<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="BloodTransformationDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.BloodBank.Stock.BloodTransformationDetail" %>
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="BagNo">
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="BloodRhesus" HeaderText="Rhesus"
                    ...
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="200px" DataField="BloodGroupFrom" HeaderText="Blood Group From"
                    UniqueName="BloodGroupFrom" SortExpression="BloodGroupFrom" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="200px" DataField="BloodGroupTo" HeaderText="Blood Group To" UniqueName="BloodGroupTo"
                    SortExpression="BloodGroupTo" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
            ...
            <EditFormSettings UserControlName="BloodTransformationItemDetail.ascx" EditFormType="WebUserControl">
                <EditColumn UniqueName="grdBloodTransformationItemEditCommand">
                </EditColumn>
            </EditFormSettings>
        </MasterTableView>
        <FilterMenu>
