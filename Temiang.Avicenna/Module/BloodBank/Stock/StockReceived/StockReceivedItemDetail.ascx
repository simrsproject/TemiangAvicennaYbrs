<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StockReceivedItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.BloodBank.Stock.StockReceivedItemDetail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumBloodReceivedItem" runat="server" ValidationGroup="BloodReceivedItem" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="BloodReceivedItem"
        ...
        <td style="width: 50%; vertical-align: top">
            <table width="100%">
                <tr>
                    ...
                    <td class="entry">
                        <telerik:RadTextBox ID="txtBagNo" runat="server" Width="300px" MaxLength="50" AutoPostBack="True"
                            OnTextChanged="txtBagNo_TextChanged" />
                    </td>
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvBagNo" runat="server" ErrorMessage="Bag No required."
                            ControlToValidate="txtBagNo" SetFocusOnError="True" ValidationGroup="BloodReceivedItem"
                            Width="100%">
                ...
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvSRBloodGroup" runat="server" ErrorMessage="Blood Group required."
                ...
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvExpiredDateTime" runat="server" ErrorMessage="Expired Date required."
                            ControlToValidate="txtExpiredDateTime" SetFocusOnError="True" ValidationGroup="BloodReceivedItem"
                            Width="100%">
                ...
                <tr>
                    <td align="right" colspan="2" style="height: 26px">
                        <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="BloodReceivedItem"
                            Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
                        <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                            ValidationGroup="BloodReceivedItem" Visible='<%# DataItem is GridInsertionObject %>'></asp:Button>
                        &nbsp;
