...
{
    public partial class TrainingSubTypeDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            if (DataItem is GridInsertionObject)
            {
                ...
                var coll = (AppStandardReferenceItemCollection)Session["collTrainigSubType"];
                if (coll.Count == 0)
                {
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                AppStandardReferenceItemCollection coll = (AppStandardReferenceItemCollection)Session["collTrainigSubType"];
