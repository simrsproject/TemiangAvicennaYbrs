...
{
    public partial class TrainingTypeList : BasePageList
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            UrlPageDetail = "TrainingTypeDetail.aspx";
        ...
        private void RedirectToPageDetail(GridDataItem dataItem, string mode)
        {
            ...
            Page.Response.Redirect("TrainingTypeDetail.aspx?md=" + mode + "&id=" + id, true);
        }

        protected void grdList_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdList.DataSource = TrainingTypes;
        }

        private DataTable TrainingTypes
        {
            get
            {
