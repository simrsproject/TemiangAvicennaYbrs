<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="ScoringDetail2.aspx.cs" Inherits="Temiang.Avicenna.Module.HR.Appraisal.Scoring.v2.ScoringDetail2" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="hdnQuestionerID" runat="server" />
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td class="entry">
                            ...
                            <asp:CheckBox ID="chkIsScoringRecapitulation" runat="server" Visible="false" />
                        </td>
                        <td width="20px"></td>
                        <td />
                    </tr>
    ...
    <telerik:RadTabStrip ID="tabDetail" runat="server" MultiPageID="mpgDetail" SelectedIndex="0">
        <Tabs>
            ...
            <telerik:RadTab runat="server" Text="Guidelines" PageViewID="pgvGuidelines">
            </telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
    <telerik:RadMultiPage ID="mpgDetail" runat="server" SelectedIndex="0" BorderStyle="Solid"
        ...
        <telerik:RadPageView ID="pgvScoresheet" runat="server">
            <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
                OnItemDataBound="grdList_ItemDataBound" OnItemCreated="grdList_ItemCreated" Height="560px" AutoGenerateColumns="False" GridLines="None">
                <MasterTableView DataKeyNames="ScoresheetItemID, QuestionerItemID, QuestionerID, QuestionName" CommandItemDisplay="None" ShowHeader="True">
                    <GroupByExpressions>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderStyle-Width="250px" DataField="QuestionGroupName" HeaderText="Group"
                            ...
                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="true" Visible="false" />
                        <telerik:GridTemplateColumn HeaderStyle-Width="400px" HeaderText="Question Name" UniqueName="lblQuestionName" HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="true">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="350px" HeaderText="Notes" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true" UniqueName="txtNotes">
                            <ItemTemplate>
                        ...
                        <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="ScoreX" HeaderText="Score"
                            UniqueName="ScoreX" SortExpression="ScoreX" HeaderStyle-HorizontalAlign="Right"
                            ItemStyle-HorizontalAlign="Right" HeaderStyle-Font-Bold="true" />
                        ...
                        <telerik:GridBoundColumn HeaderStyle-Width="150px" DataField="RatingX" HeaderText="Result"
                            UniqueName="RatingX" SortExpression="RatingX" HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="true" />
                        <telerik:GridTemplateColumn UniqueName="cboRatingID" HeaderText="Result">
                            <HeaderStyle Width="170px" HorizontalAlign="Center" Font-Bold="true" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <telerik:RadComboBox ID="cboRatingID" runat="server" Width="152px" EnableLoadOnDemand="true"
                                    MarkFirstMatch="true" HighlightTemplatedItems="true" OnItemDataBound="cboRatingID_ItemDataBound"
                                    OnItemsRequested="cboRatingID_ItemsRequested"
                                    Enabled='<%# System.Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsScoringEnabled")) %>'>
                                </telerik:RadComboBox>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridBoundColumn DataField="RatingID" UniqueName="RatingID" Visible="False" />
                        ...
                        <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="TotalScoreX" HeaderText="Total Score"
                            UniqueName="TotalScoreX" SortExpression="TotalScoreX" HeaderStyle-HorizontalAlign="Right"
                            ItemStyle-HorizontalAlign="Right" HeaderStyle-Font-Bold="true" />
                        <telerik:GridTemplateColumn />
                    </Columns>
                </MasterTableView>
                ...
                <MasterTableView DataKeyNames="QuestionerID" GroupLoadMode="Client">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="500px" HeaderText="Intervention Notes" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true" UniqueName="txtCapacity">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="500px" HeaderText="Needs To Be Developed" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true" UniqueName="txtNeedsToBeDeveloped">
                            <ItemTemplate>
        ...
        <telerik:RadPageView ID="pgvGuidelines" runat="server">
            <telerik:RadGrid ID="grdGuidelines" runat="server" OnNeedDataSource="grdGuidelines_NeedDataSource" Height="560px" AutoGenerateColumns="False" GridLines="None">
                <MasterTableView DataKeyNames="RatingID" CommandItemDisplay="None" ShowHeader="True">
                    <GroupByExpressions>
                        <telerik:GridGroupByExpression>
                            <SelectFields>
                                <telerik:GridGroupByField FieldName="QuestionerName" HeaderText="Questionnaire "></telerik:GridGroupByField>
                            ...
                            <GroupByFields>
                                <telerik:GridGroupByField FieldName="QuestionerID" SortOrder="Ascending"></telerik:GridGroupByField>
                            </GroupByFields>
                        </telerik:GridGroupByExpression>
                    </GroupByExpressions>
                    <Columns>
