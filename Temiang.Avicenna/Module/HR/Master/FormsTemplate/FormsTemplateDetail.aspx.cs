...
{
    public partial class FormsTemplateDetail : BasePageDetail
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            UrlPageList = "FormsTemplateList.aspx";
        ...
        {
            OnPopulateEntryControl(new EmployeeFormTemplate());
        ...
        {
            var forms = new EmployeeFormCollection();
            ...
            var entity = new EmployeeFormTemplate();
        ...
        protected override void OnMenuAuditLogClick(AuditLogFilter auditLogFilter)
        {
            ...
            auditLogFilter.TableName = "EmployeeFormTemplate";
        }
        #endregion
        ...
        {
            var template = (EmployeeFormTemplate)entity;
        ...
        private void SetEntityValue(EmployeeFormTemplate entity)
        {
        ...
        private void SaveEntity(EmployeeFormTemplate entity)
        {
        ...
        {
            var que = new EmployeeFormTemplateQuery();
