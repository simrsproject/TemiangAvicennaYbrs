...
namespace Temiang.Avicenna.Module.HR.Credential.Process
{
    public partial class CredentialingSearch : BasePageDialog
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                var lTypeExclude = new string[] { "01" };
                StandardReference.InitializeIncludeSpace(cboSRProfessionGroup, AppEnum.StandardReference.ProfessionGroup, lTypeExclude, false);
            }
        }
