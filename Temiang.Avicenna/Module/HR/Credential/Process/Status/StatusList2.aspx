<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="StatusList2.aspx.cs" Inherits="Temiang.Avicenna.Module.HR.Credential.Process.Status.StatusList2" %>
    ...
    <telerik:RadCodeBlock ID="radCodeBlock" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function openReportsDocument(pid) {
                var url = '<%= Temiang.Avicenna.Common.Helper.UrlRoot() %>/Module/HR/Credential/Document/DocumentHist.aspx?pid=' + pid + "&note=&type=cst2&role=&pg=<%= Request.QueryString["pg"] %>";
                        ...
                        <telerik:RadPageView ID="pgTimeStamp" runat="server">
                            <telerik:RadGrid ID="grdListTimeStamp" runat="server"
                                ...
                                <MasterTableView DataKeyNames="TransactionNo" ShowHeader="True">
                                    <Columns>
                                        <telerik:GridTemplateColumn UniqueName="SelfAssessment" HeaderText="Self Assessment">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="Verified" HeaderText="Assessment By Supervisor">
                                            <ItemTemplate>
                                                <%# (DataBinder.Eval(Container.DataItem, "IsVerified").Equals(true) ? string.Format("{0}", DataBinder.Eval(Container.DataItem, "VerifiedDateTimes"))
                                                        : string.Format("<a href=\"#\" return false;\"><img src=\"../../../../../Images/silang.jpg\" border=\"0\" title=\"Assessment By Supervisor\" /></a>"))%>
                                                <br />
                                                <%# (DataBinder.Eval(Container.DataItem, "IsVerified").Equals(true) ? string.Format("By: {0}", DataBinder.Eval(Container.DataItem, "VerifiedBy")) : string.Empty)%>
                                            </ItemTemplate>
                                            <HeaderStyle Width="190px" HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn UniqueName="CredentialProcess" HeaderText="Approval By Credentialing Sub Committee">
                                            <ItemTemplate>
                                                <%# (DataBinder.Eval(Container.DataItem, "IsCredentialing").Equals(true) ? string.Format("{0}", DataBinder.Eval(Container.DataItem, "LastCredentialingDateTimes"))
                                                        : string.Format("<a href=\"#\" return false;\"><img src=\"../../../../../Images/silang.jpg\" border=\"0\" title=\"Approval By Credential Sub Committee\" /></a>"))%>
                                                <br />
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="RecommendationLetter" HeaderText="Approval By Medical Committee">
                                            <ItemTemplate>
                                                <%# (DataBinder.Eval(Container.DataItem, "IsRecommendationLetter").Equals(true) ? string.Format("{0}", DataBinder.Eval(Container.DataItem, "LastRecommendationLetterDateTimes"))
                                                        : string.Format("<a href=\"#\" return false;\"><img src=\"../../../../../Images/silang.jpg\" border=\"0\" title=\"Approval By Medical Committee\" /></a>"))%>
                                                <br />
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="Verified2" HeaderText="Approval By Director">
                                            <ItemTemplate>
                                                <%# (DataBinder.Eval(Container.DataItem, "IsVerified2").Equals(true) ? string.Format("{0}", DataBinder.Eval(Container.DataItem, "VerifiedDateTime2s"))
                                                        : string.Format("<a href=\"#\" return false;\"><img src=\"../../../../../Images/silang.jpg\" border=\"0\" title=\"Approval By Director\" /></a>"))%>
                                                <br />
                                                <%# (DataBinder.Eval(Container.DataItem, "IsVerified2").Equals(true) ? string.Format("By: {0}", DataBinder.Eval(Container.DataItem, "Verified2By")) : string.Empty)%>
                                            </ItemTemplate>
                                            <HeaderStyle Width="190px" HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </telerik:GridTemplateColumn>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="entry" colspan="3">
                                                        <telerik:RadTextBox ID="txtRecommendationNotes" runat="server" Width="100%" ReadOnly="true" TextMode="MultiLine" Height="50px" Text='<%#Eval("RecommendationNotes")%>' />
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="entry" colspan="3">
                                                        <telerik:RadTextBox ID="txtRecommendationResultNotes" runat="server" Width="100%" ReadOnly="true" TextMode="MultiLine" Height="50px" Text='<%#Eval("RecommendationResultNotes")%>' />
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
