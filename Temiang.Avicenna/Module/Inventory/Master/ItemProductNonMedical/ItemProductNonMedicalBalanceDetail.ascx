<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemProductNonMedicalBalanceDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Inventory.Master.ItemProductNonMedicalBalanceDetail" %>
...
<table width="100%">
    <tr>
        <td class="label">
            <asp:Label ID="lblItemID" runat="server" Text="Location"></asp:Label>
        </td>
        <td class="entry">
            <telerik:RadComboBox runat="server" ID="cboLocationID" Height="190px" Width="300px" EnableLoadOnDemand="true"
                HighlightTemplatedItems="true" AutoPostBack="true" OnItemDataBound="cboLocationID_ItemDataBound"
                OnSelectedIndexChanged="cboLocationID_SelectedIndexChanged" OnItemsRequested="cboLocationID_ItemsRequested">
                <ItemTemplate>
                    <b>
