...
{
    public partial class ItemKitchenList : BasePageList
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            UrlPageDetail = "ItemKitchenDetail.aspx";
        ...
        private void RedirectToPageDetail(GridDataItem dataItem, string mode)
        {
            ...
            Page.Response.Redirect("ItemKitchenDetail.aspx?md=" + mode + "&id=" + id, true);
        }

        protected void grdList_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            grdList.DataSource = ItemKitchens;
        }
        ...
        private DataTable ItemKitchens
        {
            get
            {
                ...
                else
                {
                    ...
                    var qs = new ItemKitchenQuery("b");
                    var group = new ItemGroupQuery("c");
                    var pa = new ProductAccountQuery("d");

                    query.es.Top = AppSession.Parameter.MaxResultRecord;
                    
                    query.Where(query.SRItemType == BusinessObject.Reference.ItemType.Kitchen);
        ...
        public override void OnMenuExportToExcelClick(ValidateArgs args)
        {
            try
            {
                ...
                {
                    var fileName = "KITCHEN_" + DateTime.Now.Date.ToString("yyyyMMdd");
