<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductionFormulaDetailItem.ascx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Master.ProductionFormulaDetailItem" %>
        ...
        <td width="50%" valign="top">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="entry">
                        <asp:CheckBox ID="chkIsConsumables" runat="server" Text="Consumables" />
                    </td>
                    <td width="20px">
                    </td>
                    <td>
