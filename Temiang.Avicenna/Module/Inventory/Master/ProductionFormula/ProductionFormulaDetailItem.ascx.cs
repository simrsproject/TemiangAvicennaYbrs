...
{
    public partial class ProductionFormulaDetailItem : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            cboItemID.SelectedValue = (String)DataBinder.Eval(DataItem, ProductionFormulaItemMetadata.ColumnNames.ItemID);
            txtQuantity.Value = Convert.ToDouble(DataBinder.Eval(DataItem, ProductionFormulaItemMetadata.ColumnNames.Qty));
            ...
            chkIsConsumables.Checked = (bool)DataBinder.Eval(DataItem, ProductionFormulaItemMetadata.ColumnNames.IsConsumables);
        }
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                ProductionFormulaItemCollection coll =
                     (ProductionFormulaItemCollection)Session["collProductionFormulaItem"];

                string itemID = cboItemID.SelectedValue;
                bool isExist = false;
                foreach (ProductionFormulaItem row in coll)
                {
        ...
        {
            get { return chkIsConsumables.Checked; }
        }
