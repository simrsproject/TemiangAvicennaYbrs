...
{
    public partial class LocationTemplateItemKitchenDetail : BaseUserControl
    {
        ...
        private void PopulateCboItemID(RadComboBox comboBox, string textSearch)
        {
            ...
            var prod = new ItemKitchenQuery("b");
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll =
                    (LocationTemplateItemCollection)Session["collTemplateItemKitchen"];
