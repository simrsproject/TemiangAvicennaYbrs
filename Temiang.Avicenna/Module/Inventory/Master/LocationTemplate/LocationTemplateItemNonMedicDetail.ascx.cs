...
{
    public partial class LocationTemplateItemNonMedicDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            var prod = new ItemProductNonMedic();
        ...
        private void PopulateCboItemID(RadComboBox comboBox, string textSearch)
        {
            ...
            var prod = new ItemProductNonMedicQuery("b");
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll =
                    (LocationTemplateItemCollection)Session["collTemplateItemNonMedic"];
