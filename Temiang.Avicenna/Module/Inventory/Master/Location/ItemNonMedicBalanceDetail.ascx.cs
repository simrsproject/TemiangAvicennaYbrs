...
{
    public partial class ItemNonMedicBalanceDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            ItemProductNonMedic nonMedic = new ItemProductNonMedic();
            nonMedic.LoadByPrimaryKey(cboItemID.SelectedValue);
            txtSRItemUnitName.Text = nonMedic.SRItemUnit;
        ...
        private void PopulateCboSRItemBin(RadComboBox comboBox, string textSearch)
        {
            ...
            AppStandardReferenceQuery header = new AppStandardReferenceQuery("b");
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            if (ViewState["IsNewRecord"].Equals(true))
            {
                ItemBalanceCollection coll =
                    (ItemBalanceCollection)Session["collItemNonMedic" + PageId];
