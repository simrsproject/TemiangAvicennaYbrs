<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemKitchenBalanceDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Inventory.Master.ItemKitchenBalanceDetail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumItemBalance" runat="server" ValidationGroup="ItemKitchenBal" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="ItemKitchenBal"
...
<table width="100%">
    ...
    <tr>
        <td align="right" colspan="2" style="height: 26px">
            <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="ItemKitchenBal"
                Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
            <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                ValidationGroup="ItemKitchenBal" Visible='<%# DataItem is GridInsertionObject %>'>
            </asp:Button>
            &nbsp;
