...
{
    public partial class LocationExceptionDistConfirmDetail : BaseUserControl
    {
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                LocationExceptionDistributionConfirmCollection coll =
                    (LocationExceptionDistributionConfirmCollection)Session["collLocationExceptionDistributionConfirm" + PageId];

                string id = cboLocationExceptionID.SelectedValue;
                bool isExist = false;
                foreach (LocationExceptionDistributionConfirm row in coll)
                {
