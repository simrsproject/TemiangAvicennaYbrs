<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="PurchaseOrderReturnSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.PurchaseOrderReturnSearch"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td class="label">
                <asp:Label ID="lblTransactionNo" runat="server" Text="Returned No" Width="100px"></asp:Label>
            </td>
            <td class="filter">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="Label1" runat="server" Text="Returned Date" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            </td>
            <td class="entry">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblReferenceNo" runat="server" Text="Received No" Width="100px"></asp:Label>
            </td>
            <td class="filter">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblFromServiceUnitID" runat="server" Text="Returned Unit" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            </td>
            <td class="entry">
