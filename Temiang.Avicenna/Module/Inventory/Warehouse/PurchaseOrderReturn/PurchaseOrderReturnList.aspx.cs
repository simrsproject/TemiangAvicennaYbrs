...
{
    public partial class PurchaseOrderReturnList : BasePageList
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            UrlPageDetail = "PurchaseOrderReturnDetail.aspx?cons=" + getPageID;
        ...
        private void RedirectToPageDetail(GridDataItem dataItem, string mode)
        {
            ...
            string url = string.Format("PurchaseOrderReturnDetail.aspx?md={0}&id={1}&cons={2}", mode, id, getPageID);
        ...
        private DataTable ItemTransactions
        {
            get
            {
                ...
                else
                {
                    ...
                    query.Where(query.IsConsignment == (getPageID == "0" ? false : true));
