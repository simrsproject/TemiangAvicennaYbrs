...
{
    public partial class PurchaseOrderReturnSearch : BasePageDialog
    {
        ...
        {
            ProgramID = getPageID == "0" ? AppConstant.Program.PurchaseOrderReturn : AppConstant.Program.PurchaseOrderReturnConsignment;
            if (!IsPostBack)
            {
