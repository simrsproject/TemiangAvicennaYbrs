<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DistributionItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.DistributionItemDetail" %>
        ...
        <td style="width: 30%" valign="top">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="entry">
                        <telerik:RadNumericTextBox ID="txtBalance" runat="server" Width="100px" MaxLength="10"
                            MaxValue="99999999" NumberFormat-DecimalDigits="0"  Enabled="False" />
                    </td>
                    <td width="20px">
                    </td>
                    <td>
                ...
                <tr runat="server" id="trBooking">
                    <td class="label">
                        <asp:Label ID="lblBooking" runat="server" Text="Pending"></asp:Label>
                    </td>
                    <td class="entry">
                        <telerik:RadNumericTextBox ID="txtBooking" runat="server" Width="100px" MaxLength="10"
                            MaxValue="99999999" NumberFormat-DecimalDigits="0"  Enabled="False" />
                    </td>
                    <td width="20px">
                    </td>
                ...
                <tr>
                    <td class="label">
                        <asp:Label ID="lblMinimum" runat="server" Text="Min Qty"></asp:Label>
                    </td>
                    <td class="entry">
                        <telerik:RadNumericTextBox ID="txtMinimum" runat="server" Width="100px" MaxLength="10"
                            MaxValue="99999999" NumberFormat-DecimalDigits="0"  Enabled="False" />
                    </td>
                    <td width="20px">
                    </td>
                ...
                <tr>
                    <td class="label">
                        <asp:Label ID="lblMaximum" runat="server" Text="Max Qty"></asp:Label>
                    </td>
                    <td class="entry">
                        <telerik:RadNumericTextBox ID="txtMaximum" runat="server" Width="100px" MaxLength="10"
                            MaxValue="99999999" NumberFormat-DecimalDigits="0"  Enabled="False" />
                    </td>
                    <td width="20px">
                    </td>
        ...
        <td style="width: 30%" valign="top">
            <asp:Panel ID="pnlBudgetPlan" runat="server">
                <table width="100%">
                    <tr>
                        <td class="labelcaption" colspan="4">
                            <asp:Label ID="Label1" runat="server" Text="Budget Plan Information"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">
                            <asp:Label ID="Label2" runat="server" Text="Quota"></asp:Label>
                        </td>
                        <td class="entry">
                            <telerik:RadNumericTextBox ID="txtBpQuota" runat="server" Width="100px" MaxLength="10"
                                MaxValue="99999999" NumberFormat-DecimalDigits="0" ReadOnly="true"/>
                        </td>
                        <td width="20px">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="label">
                            <asp:Label ID="Label3" runat="server" Text="Distributed Qty"></asp:Label>
                        </td>
                        <td class="entry">
                            <telerik:RadNumericTextBox ID="txtBpQtyOffered" runat="server" Width="100px" MaxLength="10"
                                MaxValue="99999999" NumberFormat-DecimalDigits="0" ReadOnly="true"/>
                        </td>
                        <td width="20px">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadNumericTextBox ID="txtBpQtySaldo" runat="server" Width="100px" MaxLength="10"
                                MaxValue="99999999" NumberFormat-DecimalDigits="0" ReadOnly="true"/>
                        </td>
                        <td width="20px">
                        </td>
