...
{
    public partial class ConsignmentReturnList : BasePageList
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            UrlPageSearch = "ConsignmentReturnSearch.aspx";
            UrlPageDetail = "ConsignmentReturnDetail.aspx";
        ...
        private void RedirectToPageDetail(GridDataItem dataItem, string mode)
        {
            ...
            string url = string.Format("ConsignmentReturnDetail.aspx?md={0}&id={1}", mode, id);
