...
{
    public partial class ConsignmentReturnItemDetail : BaseUserControl
    {
        ...
        protected void btnCancel_ButtonClick(object sender, EventArgs e)
        {
            ...
            ItemTransactionItemCollection collitem = (ItemTransactionItemCollection)Session["ConsignmentReturnItems" + Request.UserHostName];
            if (collitem.Count == 0)
                cbo.Enabled = true;
        }
