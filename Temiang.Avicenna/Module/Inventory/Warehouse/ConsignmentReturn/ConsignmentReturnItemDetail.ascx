<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsignmentReturnItemDetail.ascx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.ConsignmentReturnItemDetail" %>
