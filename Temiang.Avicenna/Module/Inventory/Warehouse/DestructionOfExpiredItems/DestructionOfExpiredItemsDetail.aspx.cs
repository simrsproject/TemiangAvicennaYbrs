...
{
    public partial class DestructionOfExpiredItemsDetail : BasePageDetail
    {
        ...
        private void PopulateNewTransactionNo()
        {
            ...
            {
                _autoNumber = Helper.GetNewAutoNumber(txtTransactionDate.SelectedDate.Value.Date, BusinessObject.Reference.TransactionCode.DestructionOfExpiredItems, serv.DepartmentID);
        ...
        {
            // Url Search & List
            UrlPageSearch = "DestructionOfExpiredItemsSearch.aspx";
            UrlPageList = "DestructionOfExpiredItemsList.aspx";
        ...
        protected override void OnMenuApprovalClick(ValidateArgs args)
        {
            ...
            using (var trans = new esTransactionScope())
            {
                ...
                ItemBalance.PrepareItemBalancesForDestructionOfExpiredItems(entity, itemTransactionItems,
                                                                            ...
                                                                            ref chargesMovements, ref itemBalanceDetailEds, AppSession.Parameter.IsEnabledStockWithEdControl, out itemNoStock);
        ...
        protected override void OnPopulateEntryControl(esEntity entity)
        {
            ...
            ComboBox.PopulateWithServiceUnitForTransactionItemType(cboSRItemType, cboFromServiceUnitID.SelectedValue, BusinessObject.Reference.TransactionCode.DestructionOfExpiredItems);
        ...
        private void SetEntityValue(ItemTransaction entity)
        {
            ...
            entity.TransactionCode = BusinessObject.Reference.TransactionCode.DestructionOfExpiredItems;
            ...
            if (isNextRecord)
            {
                que.Where
                    (
                        ...
                        que.TransactionCode == BusinessObject.Reference.TransactionCode.DestructionOfExpiredItems
                    );
        ...
        private ItemTransactionItemCollection ItemTransactionItems
        {
            get
            {
                if (IsPostBack)
                {
                    object obj = Session["collDestructionOfExpiredItems" + Request.UserHostName];
                    if (obj != null)
                ...
                coll.Load(query);
                Session["collDestructionOfExpiredItems" + Request.UserHostName] = coll;

                return coll;
            }
            set { Session["collDestructionOfExpiredItems" + Request.UserHostName] = value; }
        }
        ...
        {
            var userControl = (DestructionOfExpiredItemsDetailItem)e.Item.FindControl(GridEditFormItem.EditFormUserControlID);
            if (userControl != null)
            {
