<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    Codebehind="PurchaseOrderReceiveSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.PurchaseOrderReceiveSearch"
    Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td class="label">
                <asp:Label ID="lblTransactionNo" runat="server" Text="Received No" Width="100px"></asp:Label>
            </td>
            <td class="filter">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="Label1" runat="server" Text="Received Date" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            </td>
            <td class="entry">
        ...
        <tr>
            ...
            <td class="entry">
				<telerik:RadTextBox ID="txtBusinessPartnerName" runat="server" Width="300px" />
            </td>
            <td>
            </td>
        </tr>
        <tr>
            <td class="label">
                <asp:Label ID="lblReferenceNo" runat="server" Text="PO No" Width="100px"></asp:Label>
            </td>
            <td class="filter">
