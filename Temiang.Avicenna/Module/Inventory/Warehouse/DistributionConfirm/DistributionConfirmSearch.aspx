<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="DistributionConfirmSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.DistributionConfirmSearch"
    Title="Search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblReferenceNo" runat="server" Text="Distribution No" Width="100px"></asp:Label>
            </td>
            <td class="filter">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="Label2" runat="server" Text="From Unit" Width="100px"></asp:Label>
            </td>
            <td class="filter">
                <telerik:RadComboBox ID="cboFilterFromUnit" runat="server" Width="100%">
                    <Items>
                        <telerik:RadComboBoxItem runat="server" Text="Equal" Value="Equal" />
                    </Items>
                </telerik:RadComboBox>
            ...
            <td class="entry">
                <telerik:RadComboBox ID="cboFromUnit" runat="server" Width="300px" AllowCustomText="true"
                    Filter="Contains" />
            </td>
            <td>
            </td>
        ...
        <tr>
            <td class="label">
                <asp:Label ID="Label3" runat="server" Text="Status" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            </td>
            <td class="entry">
