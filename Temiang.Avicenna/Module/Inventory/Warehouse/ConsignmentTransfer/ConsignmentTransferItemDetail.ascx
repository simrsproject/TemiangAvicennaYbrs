<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsignmentTransferItemDetail.ascx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.ConsignmentTransferItemDetail" %>
