<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="ConsignmentTransferDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.ConsignmentTransferDetail" %>
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SequenceNo">
            <Columns>
                ...
                <telerik:GridTemplateColumn UniqueName="editED" HeaderText="" Groupable="false">
                    <ItemTemplate>
                        <%# (DataBinder.Eval(Container.DataItem, "IsControlExpired").Equals(false) ? string.Format("<a href=\"#\" onclick=\"viewEdDetail('{0}'); return false;\">{1}</a>",
                                            DataBinder.Eval(Container.DataItem, "SequenceNo"), "<img src=\"../../../../Images/calendar16_d.png\" border=\"0\" title=\"Batch No. & ED (Optional)\" />") :
            ...
            <EditFormSettings UserControlName="ConsignmentTransferItemDetail.ascx" EditFormType="WebUserControl">
