<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InventoryIssueItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.InventoryIssueItemDetail" %>
