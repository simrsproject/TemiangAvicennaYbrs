...
{
    public partial class InventoryIssueItemDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            if (DataItem is GridInsertionObject)
            {
                ...
                ItemTransactionItemCollection collitem = (ItemTransactionItemCollection)Session["InventoryIssue:collItemTransactionItem" + Request.UserHostName];
                if (collitem.Count == 0)
            ...
            cboItemID.Enabled = string.IsNullOrEmpty(TxtReferenceNo.Text);
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                ItemTransactionItemCollection coll = (ItemTransactionItemCollection)Session["InventoryIssue:collItemTransactionItem" + Request.UserHostName];
