...
{
    public partial class DistributionRequestOutstandingList : BasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ProgramID = AppConstant.Program.DistributionRequestOutstanding;
            if (!IsPostBack)
            {
                ...
                ComboBox.PopulateWithServiceUnitForTransaction(cboServiceUnitID, TransactionCode.DistributionRequest, false);
                ComboBox.PopulateWithServiceUnitForTransaction(cboToUnit, TransactionCode.Distribution, true);
        ...
        {
            var isEmptyFilter = txtFromDate.IsEmpty && txtToDate.IsEmpty && string.IsNullOrEmpty(txtRequestNo.Text) && string.IsNullOrEmpty(cboServiceUnitID.SelectedValue) && string.IsNullOrEmpty(cboToUnit.SelectedValue) && string.IsNullOrEmpty(cboSRItemType.SelectedValue);
            if (!ValidateSearch(isEmptyFilter, "Distribution Request Maintenance")) return null;
