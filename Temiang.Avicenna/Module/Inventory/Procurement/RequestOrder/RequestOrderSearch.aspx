<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="RequestOrderSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Procurement.RequestOrderSearch"
    Title="Search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblServiceUnitCostID" runat="server" Text="Cost For Unit" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            </td>
            <td class="entry">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblToServiceUnitID" runat="server" Text="Purchasing Unit" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            </td>
            <td class="entry">
        ...
        <tr>
            ...
            <td class="entry">
                <telerik:RadComboBox ID="cboCloseStatus" runat="server" Width="300px">
                </telerik:RadComboBox>
            </td>
            <td>
            </td>
        </tr>
        <tr runat="server" id="trApprovedStatus" Visible="False">
            <td class="label">
                <asp:Label ID="lblApprovedStatus" runat="server" Text="Proceed Status" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            </td>
            <td class="entry">
                <telerik:RadComboBox ID="cboApprovedStatus" runat="server" Width="300px">
                </telerik:RadComboBox>
            </td>
            <td>
            </td>
