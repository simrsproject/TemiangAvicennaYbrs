<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    CodeBehind="StockOpnameList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Stock.StockOpnameList" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function openWinImport() {
                var oWnd = $find("<%= winStockOpnameAdd.ClientID %>");
                oWnd.setUrl("StockOpnameImport.aspx");
                oWnd.show();
            }
        </script>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource">
        <MasterTableView DataKeyNames="TransactionNo">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="FromLocationID" HeaderText="Location"
                    UniqueName="FromLocationID" SortExpression="FromLocationID" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
