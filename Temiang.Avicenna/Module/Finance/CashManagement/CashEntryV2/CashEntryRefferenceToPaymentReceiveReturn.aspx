<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="CashEntryRefferenceToPaymentReceiveReturn.aspx.cs"
    Inherits="Temiang.Avicenna.Module.Finance.CashManagement.CashEntryV2.CashEntryRefferenceToPaymentReceiveReturn" %>
        ...
        <MasterTableView DataKeyNames="dataKey" GroupLoadMode="Client" CommandItemDisplay="None">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="CardNo" UniqueName="CardNo" SortExpression="CardNo"
                    HeaderText="Card No" />
                <telerik:GridNumericColumn DataField="Amount" HeaderText="Payment Amount" DataType="System.Decimal" DataFormatString="{0:N2}"
                    UniqueName="Amount" SortExpression="Amount">
                    <HeaderStyle HorizontalAlign="Right" Width="100" />
                    <ItemStyle HorizontalAlign="Right" />
                </telerik:GridNumericColumn>
                <telerik:GridNumericColumn DataField="Balance" HeaderText="Payment Return" DataType="System.Decimal" DataFormatString="{0:N2}"
