<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    ...
    Inherits="Temiang.Avicenna.Module.Finance.ParamedicFee.ParamedicFeeVerificationByDischargeDateDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function openWinAddDeduc() {
                ...
                oWnd.setUrl("../ParamedicFeeVerificationByPayment/ParamedicFeeVerificationByPaymentAddDeducPickList.aspx?ver=" + over.get_value() + "&pid=" + opid._value);
                oWnd.show();
                //oWnd.maximize();
                oWnd.add_pageLoad(onClientPageLoad);
            }
            ...
            function onClientClose(oWnd) {
                if (oWnd.argument && oWnd.argument.command != null) {
                    ...
                    if (command[1] == 'calc')
                        ...
                        __doPostBack("<%= grdAddDeduc.UniqueID %>", "rebind");
                }
            }
        </script>
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1"
        ShowBaseLine="true">
        <Tabs>
            <telerik:RadTab runat="server" Text="Fee Calculation" PageViewID="pgVerification"
                Selected="True" />
            <telerik:RadTab runat="server" Text="Additional / Deduction" PageViewID="pgAddDeduc" />
        </Tabs>
    </telerik:RadTabStrip>
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" BorderStyle="Solid" SelectedIndex="0"
        ...
        <telerik:RadPageView ID="pgVerification" runat="server">
            <telerik:RadGrid ID="grdFeeCalculation" runat="server" OnNeedDataSource="grdFeeCalculation_NeedDataSource"
                AutoGenerateColumns="False" ShowFooter="true" GridLines="None" OnDeleteCommand="grdFeeCalculation_DeleteCommand">
                <HeaderContextMenu>
                </HeaderContextMenu>
        ...
        <telerik:RadPageView ID="pgAddDeduc" runat="server">
            <telerik:RadGrid ID="grdAddDeduc" runat="server" OnNeedDataSource="grdAddDeduc_NeedDataSource"
                AutoGenerateColumns="False" GridLines="None" OnDeleteCommand="grdAddDeduc_DeleteCommand">
                <HeaderContextMenu>
                </HeaderContextMenu>
