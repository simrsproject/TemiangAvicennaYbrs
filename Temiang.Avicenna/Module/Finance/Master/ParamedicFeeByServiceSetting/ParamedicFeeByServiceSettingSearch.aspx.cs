...
namespace Temiang.Avicenna.Module.Finance.Master.ParamedicFee
{
    public partial class ParamedicFeeByServiceSettingSearch : BasePageDialog
    {
        ...
        public override bool OnButtonOkClicked()
        {
            ...
            {
                query.Where(query.SRParamedicFeeCaseType.Like(string.Format("%{0}%", cboSRParamedicFeeCaseType.SelectedValue)));
            }
            if (!string.IsNullOrEmpty(cboSRParamedicFeeIsTeam.SelectedValue))
            {
                query.Where(query.SRParamedicFeeIsTeam.Like(string.Format("%{0}%", cboSRParamedicFeeIsTeam.SelectedValue)));
            }
            if (!string.IsNullOrEmpty(cboSRParamedicFeeTeamStatus.SelectedValue))
            {
                query.Where(query.SRParamedicFeeTeamStatus.Like(string.Format("%{0}%", cboSRParamedicFeeTeamStatus.SelectedValue)));
            }
