...
{
    public partial class SupplierItemDetailKitchen : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            query.Where(query.SRItemType == ItemType.Kitchen,
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (SupplierItemCollection)Session["collSupplierItemKitchen"];
