...
{
    public partial class SupplierItemDetail : BaseUserControl
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            var prodmedQ = new ItemProductMedicQuery("b");
            ...
            query.Where(query.SRItemType == ItemType.Medical, 
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (SupplierItemCollection)Session["collSupplierItem"];
