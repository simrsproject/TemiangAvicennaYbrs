<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplierItemDetailNonMedical.ascx.cs" Inherits="Temiang.Avicenna.Module.Finance.Master.SupplierItemDetailNonMedical" %>
                ...
                <tr>
                    <td align="right" colspan="2" style="height: 26px">
                        ...
                        <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                            ValidationGroup="SupplierItem" Visible='<%# DataItem is GridInsertionObject %>'></asp:Button>
                        &nbsp;
