...
{
    public partial class SupplierContractItemNonMedicDetail : BaseUserControl
    {
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (SupplierContractItemCollection)Session["collSupplierContractItemNonMedic"];
