<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplierContractItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Finance.Master.SupplierContractItemDetail" %>
