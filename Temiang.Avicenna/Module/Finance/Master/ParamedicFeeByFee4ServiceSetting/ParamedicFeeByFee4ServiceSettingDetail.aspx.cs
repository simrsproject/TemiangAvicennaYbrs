...
{
    public partial class ParamedicFeeByFee4ServiceSettingDetail : BasePageDetail
    {
        private void SetEntityValue(ParamedicFeeByFee4ServiceSetting entity)
        {
            ...
            entity.SRSpecialty = cboSpecialty.SelectedValue;
            ...
            entity.SRItemConditionRuleType = "";
            entity.ItemConditionRuleID = "";
        ...
        protected override void OnPopulateEntryControl(esEntity entity)
        {
            ...
            cboSpecialty.SelectedValue = s.SRSpecialty;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            UrlPageList = "ParamedicFeeByFee4ServiceSettingList.aspx";
