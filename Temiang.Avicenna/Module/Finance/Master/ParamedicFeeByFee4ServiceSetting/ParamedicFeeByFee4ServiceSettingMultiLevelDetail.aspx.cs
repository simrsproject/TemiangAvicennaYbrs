...
namespace Temiang.Avicenna.Module.Finance.Master
{
    public partial class ParamedicFeeByFee4ServiceSettingMultiLevelDetail : BasePageDetail
    {
        ...
        {
            OnPopulateEntryControl(new ParamedicFeeByFee4ServiceSetting());
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                trNetto.Visible = AppParameter.IsYes(AppParameter.ParameterItem.IsFeeEnableDualBruto);
                if (trNetto.Visible) lblFormula.Text = "Fee Formula Bruto";
