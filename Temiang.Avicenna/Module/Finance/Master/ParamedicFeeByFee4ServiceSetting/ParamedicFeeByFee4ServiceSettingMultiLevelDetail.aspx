<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    ...
    Inherits="Temiang.Avicenna.Module.Finance.Master.ParamedicFeeByFee4ServiceSettingMultiLevelDetail" %>
        ...
        <tr>
            ...
            <td style="width: 60%; vertical-align: top;">
                <table width="100%">
                    ...
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblFormula" runat="server" Text="Fee Formula"></asp:Label>
                        </td>
                        <td class="entry">
                             <telerik:RadTextBox ID="txtFormula" runat="server" Width="100%" MaxLength="500" TextMode="MultiLine" Height="100px" ></telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr id="trNetto" runat="server">
                        <td class="label">
                            <asp:Label ID="lblFormulaNetto" runat="server" Text="Fee Netto Multiplier Formula <br />ex: @bruto * 0.8"></asp:Label>
                        </td>
                        <td class="entry">
                             <telerik:RadTextBox ID="txtFormulaNetto" runat="server" Width="100%" MaxLength="500" TextMode="MultiLine" Height="100px" ></telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
