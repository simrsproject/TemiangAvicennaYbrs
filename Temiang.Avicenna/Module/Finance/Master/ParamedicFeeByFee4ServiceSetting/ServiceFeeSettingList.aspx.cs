...
{
    public partial class ServiceFeeSettingList : BasePageList
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            UrlPageDetail = "ServiceFeeSettingDetail.aspx";
        ...
        {
            string id = dataItem.GetDataKeyValue(ServiceFeeSettingMetadata.ColumnNames.Id).ToString();
        ...
        private DataTable FeeSetting
        {
            get
            {
                ...
                ServiceFeeSettingQuery query;

                if (Session[SessionNameForQuery] != null)
                    query = (ServiceFeeSettingQuery)Session[SessionNameForQuery];
                else
                {
                    query = new ServiceFeeSettingQuery("a");
