<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    CodeBehind="ServiceFeeSettingList.aspx.cs" Inherits="Temiang.Avicenna.Module.Finance.Master.ServiceFeeSettingList" %>
    ...
    <telerik:RadCodeBlock runat="server" ID="RadCodeBlock1">
        ...
        <script type="text/javascript">
            function gotoEditUrl(id) {
                var url = 'ServiceFeeSettingDetail.aspx?md=edit&id=' + id;
                window.location.href = url;
            }

            function gotoViewUrl(id) {
                var url = 'ServiceFeeSettingDetail.aspx?md=view&id=' + id
                window.location.href = url;
            }
        </script>
            ...
            <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource" OnDataBound="grdList_DataBound"
                ...
                <MasterTableView DataKeyNames="Id">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="ItemConditionRuleTypeName" HeaderText="Item Cond Rule Type" UniqueName="ItemConditionRuleTypeName"
                            SortExpression="ItemConditionRuleTypeName" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn DataField="ItemConditionRuleName" HeaderText="Item Cond Rule" UniqueName="ItemConditionRuleName"
                        ...
                        <telerik:GridBoundColumn DataField="FormulaDirektur" HeaderText="Formula Direktur" UniqueName="FormulaDirektur"
                            SortExpression="FormulaDirektur" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn DataField="FormulaStruktural" HeaderText="Formula Struktural" UniqueName="FormulaStruktural"
                            SortExpression="FormulaStruktural" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn DataField="FormulaMedis" HeaderText="Formula Medis" UniqueName="FormulaMedis"
                            SortExpression="FormulaMedis" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn DataField="FormulaUnit" HeaderText="Formula Unit" UniqueName="FormulaUnit"
                            SortExpression="FormulaUnit" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn DataField="FormulaPemerataan" HeaderText="Formula Pemerataan" UniqueName="FormulaPemerataan"
                            SortExpression="FormulaPemerataan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
