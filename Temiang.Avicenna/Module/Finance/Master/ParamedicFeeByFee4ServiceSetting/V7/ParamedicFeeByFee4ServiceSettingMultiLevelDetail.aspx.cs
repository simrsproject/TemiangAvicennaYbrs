...
{
    public partial class ParamedicFeeByFee4ServiceSettingMultiLevelDetail : BasePageDetail
    {
        private void SetEntityValue(ParamedicFeeByFee4ServiceSetting entity)
        {
            ...
            entity.SRRegistrationTypeMergeBilling = cboSRRegistrationTypeMergeBilling.SelectedValue;
            ...
            entity.IsUsingFormula = chkIsUsingFormula.Checked;
            entity.IsFeeValueInPercent = chkIsFeeValueInPercent.Checked;
            entity.IsFeeValueFromPlafon = chkIsFeeValueFromPlafon.Checked;
            entity.IsFeeValueFromTariffPrice = chkIsFeeValueFromTariffPrice.Checked;
            entity.FeeValue = (decimal)txtFeeValue.Value.Value;
            entity.Formula = txtFormula.Text;
            entity.FormulaNetto = txtFormulaNetto.Text;
        ...
        {
            ParamedicFeeByFee4ServiceSettingQuery que = new ParamedicFeeByFee4ServiceSettingQuery();
            ...
            ParamedicFeeByFee4ServiceSetting entity = new ParamedicFeeByFee4ServiceSetting();
            entity.Load(que);
        ...
        {
            var s = (ParamedicFeeByFee4ServiceSetting)entity;
            ...
            cboSRRegistrationTypeMergeBilling.SelectedValue = s.SRRegistrationTypeMergeBilling;
            ...
            chkIsUsingFormula.Checked = s.IsUsingFormula ?? false;
            chkIsUsingFormula_CheckedChanged(chkIsUsingFormula, new EventArgs());

            chkIsFeeValueFromPlafon.Checked = s.IsFeeValueFromPlafon ?? false;
            chkIsFeeValueFromTariffPrice.Checked = s.IsFeeValueFromTariffPrice ?? false;
            chkIsFeeValueInPercent.Checked = s.IsFeeValueInPercent ?? false;
            txtFeeValue.Value = System.Convert.ToDouble((s.FeeValue ?? 0));
            txtFormula.Text = s.Formula;
            txtFormulaNetto.Text = s.FormulaNetto;
        ...
        protected override void OnMenuAuditLogClick(AuditLogFilter auditLogFilter)
        {
            ...
            auditLogFilter.TableName = "ParamedicFeeByFee4ServiceSetting";
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            UrlPageList = "ParamedicFeeByFee4ServiceSettingMultiLevelList.aspx";
            ...
            if (!IsPostBack)
            {
                ...
                StandardReference.InitializeIncludeSpace(cboSRRegistrationTypeMergeBilling, AppEnum.StandardReference.RegistrationType);
                ...
                trMedis.Visible = AppParameter.IsYes(AppParameter.ParameterItem.IsPhysicianFeeCalculatePreFee);
            }
        }

        protected override void OnMenuDeleteClick(ValidateArgs args)
        {
            var entity = new ParamedicFeeByFee4ServiceSetting();
            entity.LoadByPrimaryKey(System.Convert.ToInt32(hfId.Value));
        ...
        private void SaveEntity(ParamedicFeeByFee4ServiceSetting entity)
        {
        ...
        protected void cboGuarantor_ItemsRequested(object o, RadComboBoxItemsRequestedEventArgs e)
        {
            ...
            query.Where
                (
                    ...
                    query.IsActive == true,
                    query.Or(query.GuarantorID.Like(searchTextContain), query.GuarantorName.Like(searchTextContain))
                );
        ...
        protected void chkIsUsingFormula_CheckedChanged(object sender, EventArgs e)
        {
            chkIsFeeValueInPercent.Enabled = !chkIsUsingFormula.Checked;
            chkIsFeeValueFromPlafon.Enabled = !chkIsUsingFormula.Checked;
            chkIsFeeValueFromTariffPrice.Enabled = !chkIsUsingFormula.Checked;
            txtFeeValue.Enabled = !chkIsUsingFormula.Checked;
            txtFormula.Enabled = chkIsUsingFormula.Checked;
            txtFormulaNetto.Enabled = txtFormula.Enabled;
        }
    }
}
