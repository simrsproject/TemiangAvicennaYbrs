<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GuarantorItemPrescriptionByTherapyRuleDetail.ascx.cs" Inherits="Temiang.Avicenna.Module.Finance.Master.GuarantorItemPrescriptionByTherapyRuleDetail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumGuarantorItemPrescriptionByTherapyRule" runat="server" ValidationGroup="GuarantorItemPrescriptionByTherapyRule" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="GuarantorItemPrescriptionByTherapyRule"
        ...
        <td width="50%" style="vertical-align: top">
            <table width="100%">
                <tr>
                    ...
                    <td class="entry">
                        <telerik:RadComboBox runat="server" ID="cboSRTherapyGroup" Width="300px" EnableLoadOnDemand="true"
                            HighlightTemplatedItems="true" AutoPostBack="false" OnItemDataBound="cboSRTherapyGroup_ItemDataBound"
                            OnItemsRequested="cboSRTherapyGroup_ItemsRequested">
                            <ItemTemplate>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvSRTherapyGroup" runat="server" ErrorMessage="Therapy Group required."
                            ControlToValidate="cboSRTherapyGroup" SetFocusOnError="True" ValidationGroup="GuarantorItemPrescriptionByTherapyRule"
                            Width="100%">
                ...
                <tr>
                    <td align="right" colspan="2" style="height: 26px">
                        <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="GuarantorItemPrescriptionByTherapyRule"
                            Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
                        <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                            ValidationGroup="GuarantorItemPrescriptionByTherapyRule" Visible='<%# DataItem is GridInsertionObject %>'>
                        </asp:Button>
                        &nbsp;
                ...
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvAmountValue" runat="server" ErrorMessage="Amount Value (IPR/Default) required."
                            ControlToValidate="txtAmountValue" SetFocusOnError="True" ValidationGroup="GuarantorItemPrescriptionByTherapyRule"
                            Width="100%">
                            <asp:Image ID="Image2" runat="server" SkinID="rfvImage" />
                        </asp:RequiredFieldValidator>
                        <asp:RequiredFieldValidator ID="rfvAmountValueOPR" runat="server" ErrorMessage="Amount Value (OPR) required."
                            ControlToValidate="txtAmountOPR" SetFocusOnError="True" ValidationGroup="GuarantorItemPrescriptionByTherapyRule"
                            Width="100%">
                            <asp:Image ID="Image3" runat="server" SkinID="rfvImage" />
                        </asp:RequiredFieldValidator>
                        <asp:RequiredFieldValidator ID="rfvAmountValueEMR" runat="server" ErrorMessage="Amount Value (EMR) required."
                            ControlToValidate="txtAmountEMR" SetFocusOnError="True" ValidationGroup="GuarantorItemPrescriptionByTherapyRule"
                            Width="100%">
