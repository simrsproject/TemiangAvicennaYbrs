...
{
    public partial class GuarantorItemRestrictionsLaboratoryDetail : BaseUserControl
    {
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (GuarantorItemRestrictionsCollection)Session["collGuarantorItemLaboratoryRestrictions"];
        ...
        protected void cboItemID_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
        {
            ...
            query.Where
                (query.SRItemType == ItemType.Laboratory, query.IsActive == true,
                 query.Or
                     (
