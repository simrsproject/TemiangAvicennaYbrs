<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GuarantorItemRestrictionsRadiologyDetail.ascx.cs" Inherits="Temiang.Avicenna.Module.Finance.Master.GuarantorItemRestrictionsRadiologyDetail" %>
