...
{
    public partial class GuarantorItemRestrictionsRadiologyDetail : BaseUserControl
    {
        ...
        protected void customValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            {
                var coll = (GuarantorItemRestrictionsCollection)Session["collGuarantorItemRadiologyRestrictions"];
        ...
        protected void cboItemID_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
        {
            ...
            query.Where
                (query.SRItemType == ItemType.Radiology, query.IsActive == true,
                 query.Or
                     (
