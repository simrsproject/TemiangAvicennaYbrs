<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="ItemServiceProcedureSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Finance.Master.ItemServiceProcedureSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td class="label"> 
                <asp:Label ID="lblItemName" runat="server" Text="Procedure Name" Width="100px"></asp:Label>
			</td>
            <td class="filter">
