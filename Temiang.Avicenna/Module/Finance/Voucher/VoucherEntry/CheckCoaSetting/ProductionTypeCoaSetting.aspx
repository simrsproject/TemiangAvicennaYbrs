<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="ProductionTypeCoaSetting.aspx.cs" Inherits="Temiang.Avicenna.Module.Finance.Voucher.VoucherEntry.CheckCoaSetting.ProductionTypeCoaSetting" %>
    ...
    <telerik:RadMultiPage ID="mpagDetail" runat="server" BorderStyle="Solid" SelectedIndex="0"
        ...
        <telerik:RadPageView ID="pgLeft" runat="server">
            <telerik:RadGrid ID="grdLeft" runat="server" OnNeedDataSource="grdLeft_NeedDataSource"
                ...
                <MasterTableView CommandItemDisplay="None" DataKeyNames="LocationID, ServiceUnitID, ItemID"
