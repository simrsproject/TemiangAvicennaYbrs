...
{
    public partial class POReturnedTypeDetail : BasePageDialog
    {
        ...
        protected void grdDetail_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            ...
            txtReceivedAmount.Text = System.Math.Abs(itm.ChargesAmount.Value).ToString();
            txtTaxAmount.Text = System.Math.Abs(itm.TaxAmount.Value).ToString();
        }
    }
}
