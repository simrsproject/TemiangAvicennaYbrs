...
<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterBootstrap.Master" AutoEventWireup="true"
    CodeBehind="PrescQueueDisplayV2.aspx.cs"
    Inherits="Temiang.Avicenna.Module.Kiosk.PrescQueueDisplayV2" EnableTheming="False" %>
    ...
    <script language="javascript">
        ...
        function CreateList(DtTblName, IsComplete) {
            return $('#' + DtTblName).DataTable({
                ...
                "columns": [
                    { title: "No", data: 'PrescriptionNo2', name: 'PrescriptionNo2', className: "myTh" },
                    { title: "Que", data: 'PrescriptionNo', name: 'ItemID', className: "myTh" },
