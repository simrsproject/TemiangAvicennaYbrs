<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RlReport5_3Detail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport5_3Detail" %>
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvKeluarHidupL" runat="server" ErrorMessage="Pasien Keluar Hidup Lk required."
                ControlToValidate="txtKeluarHidupL" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvKeluarHidupP" runat="server" ErrorMessage="Pasien Keluar Hidup Pr required."
                ControlToValidate="txtKeluarHidupP" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvKeluarMatiL" runat="server" ErrorMessage="Pasien Keluar Mati Lk required."
                ControlToValidate="txtKeluarMatiL" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvKeluarMatiP" runat="server" ErrorMessage="Pasien Keluar Mati Pr required."
                ControlToValidate="txtKeluarMatiP" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
