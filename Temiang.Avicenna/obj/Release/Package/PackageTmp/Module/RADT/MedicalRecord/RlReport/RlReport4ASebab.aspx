<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport4ASebab.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport4ASebab" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport4ASebab.UniqueID %>", "process");
            }
            function onPrint() {
                __doPostBack("<%= grdRlReport4ASebab.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport4ASebab" runat="server" OnNeedDataSource="grdRlReport4ASebab_NeedDataSource"
