<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport5_2.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport5_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport5_2.UniqueID %>", "process");
            }
            function onPrint() {
                __doPostBack("<%= grdRlReport5_2.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport5_2" runat="server" OnNeedDataSource="grdRlReport5_2_NeedDataSource"
