<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RlReport5_3Detail.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.v2025.RlReport5_3Detail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumRlReport5_3" runat="server" ValidationGroup="RlReport5_3" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="RlReport5_3"
...
<table width="100%">
    <tr>
        ...
        <td width="20">
            <asp:RequiredFieldValidator ID="rfvDiagnoseID" runat="server" ErrorMessage="Kode ICD X required."
                ValidationGroup="RlReport5_3" ControlToValidate="cboDiagnoseID" SetFocusOnError="True"
                Width="100%">
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvKasusBaruL" runat="server" ErrorMessage="Kasus Baru Lk required."
                ControlToValidate="txtKasusBaruL" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvKasusBaruP" runat="server" ErrorMessage="Kasus Baru Pr required."
                ControlToValidate="txtKasusBaruP" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvJumlahKasusBaru" runat="server" ErrorMessage="Jumlah Kasus Baru required."
                ControlToValidate="txtJumlahKasusBaru" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvKunjunganL" runat="server" ErrorMessage="Kunjungan Lk required."
                ControlToValidate="txtKunjunganL" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvJumlahKunjungan" runat="server" ErrorMessage="Jumlah Kunjungan required."
                ControlToValidate="txtJumlahKunjungan" SetFocusOnError="True" ValidationGroup="RlReport5_3"
                Width="100%">
    ...
    <tr>
        ...
        <td class="entry" style="height: 26px">
            <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="RlReport5_3"
                Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
            <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                ValidationGroup="RlReport5_3" Visible='<%# DataItem is GridInsertionObject %>'>
            </asp:Button>
            &nbsp;
