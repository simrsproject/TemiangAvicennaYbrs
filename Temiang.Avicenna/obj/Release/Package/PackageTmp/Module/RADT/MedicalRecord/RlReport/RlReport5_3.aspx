<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport5_3.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport5_3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport5_3.UniqueID %>", "process");
            }

            function onPrint() {
                __doPostBack("<%= grdRlReport5_3.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport5_3" runat="server" OnNeedDataSource="grdRlReport5_3_NeedDataSource"
            AutoGenerateColumns="False" GridLines="None" OnUpdateCommand="grdRlReport5_3_UpdateCommand"
            OnDeleteCommand="grdRlReport5_3_DeleteCommand" OnInsertCommand="grdRlReport5_3_InsertCommand">
            <HeaderContextMenu>
            </HeaderContextMenu>
            <MasterTableView CommandItemDisplay="None" DataKeyNames="DiagnosaID">
                <CommandItemTemplate>
                    &nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="lbInsert" runat="server" CommandName="InitInsert" Visible='<%# !grdRlReport5_3.MasterTableView.IsItemInserted %>'>
                    ...
                    &nbsp;&nbsp;
                    <asp:LinkButton ID="lbPickList" runat="server" Visible='<%# !grdRlReport5_3.MasterTableView.IsItemInserted %>'
