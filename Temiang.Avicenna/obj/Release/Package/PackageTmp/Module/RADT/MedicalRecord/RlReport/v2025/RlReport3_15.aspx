<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport3_15.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.v2025.RlReport3_15" %>
        ...
        <telerik:RadGrid ID="grdRlReport3_15" runat="server" OnNeedDataSource="grdRlReport3_15_NeedDataSource"
            ...
            <MasterTableView CommandItemDisplay="None" DataKeyNames="RlMasterReportItemID">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Jumlah Laki Laki" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Jumlah Perempuan" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
