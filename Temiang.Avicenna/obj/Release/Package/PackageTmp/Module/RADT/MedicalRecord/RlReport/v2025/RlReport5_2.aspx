<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="RlReport5_2.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.MedicalRecord.RlReport.RlReport5_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function onProcess() {
                __doPostBack("<%= grdRlReport5_2V2025.UniqueID %>", "process");
            }
            function onPrint() {
                __doPostBack("<%= grdRlReport5_2V2025.UniqueID %>", "print");
            }
        </script>
    ...
    <telerik:RadAjaxPanel ID="ajxPanel" runat="server" Width="100%" LoadingPanelID="ajxLoadingPanel">
        <telerik:RadGrid ID="grdRlReport5_2V2025" runat="server" OnNeedDataSource="grdRlReport5_2V2025_NeedDataSource"
            AutoGenerateColumns="False" GridLines="None" OnUpdateCommand="grdRlReport5_2V2025_UpdateCommand"
            OnDeleteCommand="grdRlReport5_2V2025_DeleteCommand" OnInsertCommand="grdRlReport5_2V2025_InsertCommand">
            <HeaderContextMenu>
            </HeaderContextMenu>
            <MasterTableView CommandItemDisplay="None" DataKeyNames="DiagnosaID">
                <CommandItemTemplate>
                    &nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="lbInsert" runat="server" CommandName="InitInsert" Visible='<%# !grdRlReport5_2V2025.MasterTableView.IsItemInserted %>'>
                    ...
                    &nbsp;&nbsp;
                    <asp:LinkButton ID="lbPickList" runat="server" Visible='<%# !grdRlReport5_2V2025.MasterTableView.IsItemInserted %>'
                ...
                <EditFormSettings UserControlName="RlReport5_2Detail.ascx" EditFormType="WebUserControl">
                    <EditColumn UniqueName="RlReport5_2DetailCommand">
                    </EditColumn>
                </EditFormSettings>
            </MasterTableView>
            <FilterMenu>
