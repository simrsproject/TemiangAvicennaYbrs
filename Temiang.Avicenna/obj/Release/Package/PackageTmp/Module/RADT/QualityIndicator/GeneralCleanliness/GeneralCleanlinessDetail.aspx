<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="GeneralCleanlinessDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.GeneralCleanlinessDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SRGeneralCleanliness">
            <Columns>               
                <telerik:GridBoundColumn HeaderStyle-Width="70px" DataField="SRGeneralCleanliness" HeaderText="ID"
                    UniqueName="SRGeneralCleanliness" SortExpression="SRGeneralCleanliness" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="300px" DataField="GeneralCleanlinessName" HeaderText="General Cleanliness"
                    UniqueName="GeneralCleanlinessName" SortExpression="GeneralCleanlinessName" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />                                                         
