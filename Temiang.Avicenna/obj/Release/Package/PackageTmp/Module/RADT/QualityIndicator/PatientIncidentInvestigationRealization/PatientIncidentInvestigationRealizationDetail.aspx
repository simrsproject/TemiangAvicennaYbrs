<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="PatientIncidentInvestigationRealizationDetail.aspx.cs"
    Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.PatientIncidentInvestigationRealizationDetail" %>
            ...
            <td style="width: 50%; vertical-align: top;">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadTextBox ID="txtIncidentChronologyCauses" runat="server" Width="100%"
                                MaxLength="5000" TextMode="MultiLine" ReadOnly="True" />
                        </td>
                        <td width="20">
                        </td>
                        <td>
                    ...
                    <tr style="display: none">
                        ...
                        <td class="entry">
                            <telerik:RadTextBox ID="txtIncidentUnderlyingCauses" runat="server" Width="100%"
                                MaxLength="500" TextMode="MultiLine" Height="100px" ReadOnly="True" />
                        </td>
                        <td width="20">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <telerik:RadDatePicker ID="txtInvestigationDate" runat="server" Width="100px" Enabled="False">
                                        </telerik:RadDatePicker>
                                    </td>
                                    <td>
        ...
        <telerik:RadPageView ID="pgvUnderlyingCauses" runat="server">
            <telerik:RadGrid ID="grdUnderlyingCauses" runat="server" OnNeedDataSource="grdUnderlyingCauses_NeedDataSource"
                ...
                <MasterTableView CommandItemDisplay="Top" DataKeyNames="FactorID,FactorItemID,ComponentID">
                    ...
                    <EditFormSettings UserControlName="PatientIncidentUnderlyingCausesItemDetail.ascx"
        ...
        <telerik:RadPageView ID="pgvInvestigation" runat="server">
            <telerik:RadGrid ID="grdInvestigation" runat="server" OnNeedDataSource="grdInvestigation_NeedDataSource"
                ...
                <MasterTableView CommandItemDisplay="None" DataKeyNames="SeqNo">
                    ...
                    <EditFormSettings UserControlName="PatientIncidentInvestigationRealizationItemDetail.ascx"
                        EditFormType="WebUserControl">
