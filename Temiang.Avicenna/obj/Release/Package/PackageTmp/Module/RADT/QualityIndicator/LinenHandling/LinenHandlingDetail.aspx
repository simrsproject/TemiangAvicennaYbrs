<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="LinenHandlingDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.LinenHandlingDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SRLinenHandling">
            <Columns>               
                <telerik:GridBoundColumn HeaderStyle-Width="70px" DataField="SRLinenHandling" HeaderText="ID"
                    UniqueName="SRLinenHandling" SortExpression="SRLinenHandling" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="300px" DataField="LinenHandlingName" HeaderText="Linen Handling"
                    UniqueName="LinenHandlingName" SortExpression="LinenHandlingName" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />                                                         
