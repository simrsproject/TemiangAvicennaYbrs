<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="MedicalStorageDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.MedicalStorageDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SRMedicalStorage">
            <Columns>               
                <telerik:GridBoundColumn HeaderStyle-Width="70px" DataField="SRMedicalStorage" HeaderText="ID"
                    UniqueName="SRMedicalStorage" SortExpression="SRMedicalStorage" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="300px" DataField="MedicalStorageName" HeaderText="Medical Storage"
                    UniqueName="MedicalStorageName" SortExpression="MedicalStorageName" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />                                                         
