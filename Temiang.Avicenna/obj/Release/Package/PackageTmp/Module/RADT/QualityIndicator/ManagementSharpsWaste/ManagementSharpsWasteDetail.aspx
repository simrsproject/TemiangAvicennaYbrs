<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="ManagementSharpsWasteDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.QualityIndicator.ManagementSharpsWasteDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SRManagementSharpsWaste">
            <Columns>               
                <telerik:GridBoundColumn HeaderStyle-Width="70px" DataField="SRManagementSharpsWaste" HeaderText="ID"
                    UniqueName="SRManagementSharpsWaste" SortExpression="SRManagementSharpsWaste" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="300px" DataField="ManagementSharpsWasteName" HeaderText="Management Sharps Waste"
                    UniqueName="ManagementSharpsWasteName" SortExpression="ManagementSharpsWasteName" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />                                                         
