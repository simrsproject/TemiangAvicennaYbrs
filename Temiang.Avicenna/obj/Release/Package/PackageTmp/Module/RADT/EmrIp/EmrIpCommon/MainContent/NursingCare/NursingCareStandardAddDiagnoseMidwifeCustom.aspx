<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="NursingCareStandardAddDiagnoseMidwifeCustom.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.EmrIp.MainContent.NursingCare.NursingCareStandardAddDiagnoseMidwifeCustom" %>
    ...
    <telerik:RadAjaxManagerProxy runat="server" ID="rmpAddDiag">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="gridEtiologyNew">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="txtPrefix" />
                    <telerik:AjaxUpdatedControl ControlID="txtSuffix" />
                ...
                <fieldset>
                    ...
                    <table width="100%"  border="0">
                        <tr>
                            ...
                            <td>
                                <telerik:RadTextBox ID="txtPrefix" runat="server" Width="100%" 
                                    TextMode="MultiLine" Height="100px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="label" style="width:50px">
                                <asp:Label ID="Label1" runat="server" Text="diagnosis"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblSelectedDiagnosa" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="label" style="width:25%">
                                <asp:Label ID="Label9" runat="server" Text="suffix"></asp:Label>
                            </td>
                            <td style="width:75%">
                                <telerik:RadTextBox ID="txtSuffix" runat="server" Width="100%" 
