<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialogEntry.Master" AutoEventWireup="true"
    CodeBehind="NosocomialNgtEntry.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.NosocomialNgtEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="Label2" runat="server" Text="NGT Location"></asp:Label>
            </td>
            <td class="entry">
                <telerik:RadTextBox ID="txtLocation" runat="server" Width="304px" MaxLength="100" />
            </td>
            <td width="20px"></td>
            <td></td>
        </tr>
        ...
        <tr>
            <td class="label">
                <asp:Label ID="Label5" runat="server" Text="NGT No"></asp:Label>
            </td>
            <td class="entry">
                <telerik:RadTextBox ID="txtNgtNo" runat="server" Width="304px" MaxLength="200" />
            </td>
            <td width="20px"></td>
        </tr>
        <tr>
