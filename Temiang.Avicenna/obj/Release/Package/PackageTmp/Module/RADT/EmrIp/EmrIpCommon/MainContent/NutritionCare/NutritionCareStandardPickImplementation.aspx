<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="NutritionCareStandardPickImplementation.aspx.cs" 
    Inherits="Temiang.Avicenna.Module.RADT.EmrIp.MainContent.NutritionCare.NutritionCareStandardPickImplementation" %>
        ...
        <tr>
            <td style="width: 75%; vertical-align: top;">
                <telerik:RadGrid ID="gridListImplementasi" runat="server" AutoGenerateColumns="false"
                    ...
                    <MasterTableView ClientDataKeyNames="TerminologyID" DataKeyNames="TerminologyID,ID" 
                    InsertItemPageIndexAction="ShowItemOnCurrentPage">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Implemetation" UniqueName="GetFullImplementationName">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemTemplate>
	                                <%# GetFullImplementationNameFormatted(((string)Eval("TerminologyName")), (string)Eval("S"),(string)Eval("O"),(string)Eval("A"),((string)Eval("P"))).Replace("\n", "<br/>")%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn DataField="TmpTerminologyID" HeaderText="Id" SortExpression="TmpTerminologyID"
                                Visible="false" UniqueName="TmpTerminologyID">
                            </telerik:GridBoundColumn>
