<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true"
    CodeBehind="PatientDischargeRegistrationList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.InPatient.PatientDischargeRegistrationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function openWinProcess(regno) {
                ...
                //oWnd.SetUrl("PatientDischargeDetail.aspx?regno=" + regno);
                oWnd.SetUrl("PatientDischargeApptDetail.aspx?regno=" + regno);
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterBPJSSepNo">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <tr>
                <td width="50%" valign="top">
                    <table width="100%">
                        ...
                        <tr>
                            <td class="label">
                                <asp:Label ID="lblSepNo" runat="server" Text="SEP No / NIK"></asp:Label>
                            </td>
                            <td class="entry">
                                <telerik:RadTextBox ID="txtBPJSSepNo" runat="server" Width="300px" MaxLength="20" />
                            </td>
                            <td width="20">
                                <asp:ImageButton ID="btnFilterBPJSSepNo" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                    OnClick="btnFilter_Click" ToolTip="Search" />
                            </td>
                            <td>
                            </td>
        ...
        <MasterTableView DataKeyNames="RegistrationNo" ClientDataKeyNames="RegistrationNo"
            ...
            <Columns>
                <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="">
                    <ItemTemplate>
                        <%# (this.IsUserEditAble.Equals(true) && DataBinder.Eval(Container.DataItem, "IsVisible").Equals(true) ? string.Format("<a href=\"#\" onclick=\"openWinProcess('{0}'); return false;\"><img src=\"../../../../Images/Toolbar/edit16.png\" border=\"0\" alt=\"Edit\" /></a>",
                ...
                <telerik:GridDateTimeColumn DataField="BPJSSepNo" HeaderText="SEP" UniqueName="BPJSSepNo"
