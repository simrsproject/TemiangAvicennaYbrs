<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="PhysicianTeamList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.InPatient.PhysicianTeamList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function gotoEditUrl(regno) {
            var url = 'PhysicianTeamDetail.aspx?md=edit&regno=' + regno + '&fr=1';
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterIncludeCheckedOut">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <tr>
                ...
                <td style="width: 50%" valign="top">
                    <table width="100%">
                        ...
                        <tr>
                            <td class="label">
                                <asp:Label ID="Label1" runat="server" Text="Include Checked Out"></asp:Label>
                            </td>
                            <td class="entry">
                                <asp:CheckBox ID="chkIncludeCheckedOut" runat="server" />
                            </td>
                            <td width="20">
                                <asp:ImageButton ID="btnFilterIncludeCheckedOut" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                    OnClick="btnFilter_Click" ToolTip="Search" />
                            </td>
                            <td>
                            </td>
