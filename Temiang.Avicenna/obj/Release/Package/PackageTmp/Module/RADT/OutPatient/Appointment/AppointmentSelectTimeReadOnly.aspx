<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="AppointmentSelectTimeReadOnly.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.OutPatient.AppointmentSelectTimeReadOnly"
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox ID="cboParamedicID" runat="server" Width="300px" AutoPostBack="true"
                                Enabled="false" OnSelectedIndexChanged="cboParamedicID_SelectedIndexChanged">
                            </telerik:RadComboBox>
                        </td>
                        <td width="20">
                        </td>
                    ...
                    <tr style="display: none">
                        ...
                        <td width="20">
                            <asp:RequiredFieldValidator ID="rfvAppointmentDate" runat="server" ErrorMessage="Appointment Date required."
                                ControlToValidate="txtAppointmentTime" SetFocusOnError="True" Display="Dynamic"
                                EnableClientScript="true" Width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadScheduler ID="schedule" runat="server" AllowDelete="False" AllowEdit="False"
                                AllowInsert="False" HoursPanelTimeFormat="HH:mm" LastDayOfWeek="Sunday" MinutesPerRow="10"
                                ShowAllDayRow="False" Width="100%" RowHeaderWidth="60px" Height="450px" ShowDateHeaders="false"
                                ShowFooter="False" ShowNavigationPane="false" ShowResourceHeaders="False" ShowViewTabs="False"
                                TimeLabelRowSpan="1" OnClientTimeSlotClick="OnClientTimeSlotClick" OnNavigationComplete="schedule_NavigationComplete"
                                RowHeight="20px">
