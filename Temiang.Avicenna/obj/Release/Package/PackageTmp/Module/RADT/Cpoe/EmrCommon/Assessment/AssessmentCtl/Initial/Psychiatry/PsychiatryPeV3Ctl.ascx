<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PsychiatryPeV3Ctl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.PsychiatryPeV3Ctl" %>
    ...
    <tr>
            ...
            <fieldset>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox ID="txtPemeriksaanFisik" runat="server" Width="100%" TextMode="MultiLine" />
                        </td>
                    </tr>
                </table>
            </fieldset>
        ...
        <td width="50%" valign="top">
            ...
            <fieldset>
                ...
                <table width="100%">
                    <tr>
                        <td class="label">Pharmacotherapy</td>
                        <td class="entry">
                            <telerik:RadTextBox ID="txtFarmakoterapi" runat="server" Width="100%" TextMode="MultiLine" />
                        </td>
                    </tr>
                    <tr>
                        <td class="label">Psychotherapy</td>
                        <td class="entry">
