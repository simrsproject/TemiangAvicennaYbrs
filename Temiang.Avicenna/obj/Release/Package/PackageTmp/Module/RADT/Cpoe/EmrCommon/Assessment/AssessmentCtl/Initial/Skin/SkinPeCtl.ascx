<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SkinPeCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.SkinPeCtl" %>
...
<%@ Register Src="~/Module/RADT/Cpoe/EmrCommon/Assessment/AssessmentCtl/GcsCtl.ascx" TagPrefix="uc1" TagName="GcsCtl" %>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="3">
                <div class="divcaption">Status Dermatologikus</div>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <telerik:RadTextBox ID="txtDermatologikus" runat="server" Width="100%" Height="80px"
        ...
        <tr>
            <td colspan="3">
                <div class="divcaption">Notes</div>
            </td>
        </tr>
        <tr>
            <td colspan="3">
