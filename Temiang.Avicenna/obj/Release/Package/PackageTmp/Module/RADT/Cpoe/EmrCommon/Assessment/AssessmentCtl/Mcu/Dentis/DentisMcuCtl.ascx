<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DentisMcuCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.DentisMcuCtl" %>
...
<telerik:RadContextMenu ID="mnuTeeth" runat="server" OnClientItemClicked="OnClientItemClicked"
