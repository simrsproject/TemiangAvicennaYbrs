<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialogEntry.Master" AutoEventWireup="true"
    CodeBehind="ServiceUnitTransEntry.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Cpoe.ServiceUnitTransEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript" language="javascript" src="<%=Helper.UrlRoot()%>/JavaScript/DateFormat.js"></script>
        ...
        <script type="text/javascript" language="javascript">
                ...
                if (unit.get_value() != '') {
                    ...
                    if (tr == 'jo' || tr == 'ds') {
                        ...
                        oWnd.setUrl('ItemPickerList.aspx?transno=' + trans.get_value() + '&unit=' + unit.get_value() + '&reg=' + reg.get_value() +
                            '&type=' + '<%= Request.QueryString["type"] %>' + '&FUnit=' + FUnit + '&TUnit=' + TUnit);
                        oWnd.set_title('Item List');
                    }
                    else if (loc.get_value() != '') {
                        oWnd.setUrl('ItemPickerListItemProduct.aspx?transno=' + trans.get_value() + '&loc=' + loc.get_value() + '&reg=' + reg.get_value() + '&type=' + '<%= Request.QueryString["type"] %>');
                        oWnd.set_title('Item Product List');
                    }

                    //                    if (unit.get_value() == '<%=Temiang.Avicenna.Common.AppSession.Parameter.ServiceUnitLaboratoryID%>')
                    //                        oWnd.setUrl('ItemPickerList.aspx?transno=' + trans.get_value() + '&unit=' + unit.get_value() + '&reg=' + reg.get_value() + '&type=' + '<%= Request.QueryString["type"] %>');
                    //                    else
                    //                        oWnd.setUrl('ItemPickerDetail.aspx?transno=' + trans.get_value() + '&unit=' + unit.get_value() + '&loc=' + loc.get_value() + '&reg=' + reg.get_value() + '&type=' + '<%= Request.QueryString["type"] %>' + '&verif=' + '<%= Request.QueryString["verif"] %>');
            ...
            function openWinComp(transNo, seqNo, itemID) {
                ...
                if (unitT != null)
                    oWnd.setUrl('TariffComponentPackage.aspx?transno=' + trans.get_value() + '&reg=' + reg.get_value() + '&date=' + date.get_selectedDate().format("isoDate") + '&from=' + unitF.get_value() + '&to=' + unitT.get_value() + '&trans=' + transNo + '&seq=' + seqNo + '&item=' + itemID + '&type=' + '<%= Request.QueryString["type"] %>');
                else
                    oWnd.setUrl('TariffComponentPackage.aspx?transno=' + trans.get_value() + '&reg=' + reg.get_value() + '&date=' + date.get_selectedDate().format("isoDate") + '&from=' + unitF.get_value() + '&to=&trans=' + transNo + '&seq=' + seqNo + '&item=' + itemID + '&type=' + '<%= Request.QueryString["type"] %>');
            ...
            function openWinCons(transNo, seqNo, itemID) {
                ...
                oWnd.setUrl('ItemConsumptionPackage.aspx?trans=' + transNo + '&seq=' + seqNo + '&item=' + itemID + "&unit=" + unit.get_value() + '&reg=' + reg.get_value());
                oWnd.show();
                //oWnd.maximize();
                oWnd.add_pageLoad(onClientPageLoad);
            }
            ...
            function openWinExtra(transNo, seqNo, itemID) {
                ...
                oWnd.setUrl('ItemExtraPackage.aspx?trans=' + transNo + '&seq=' + seqNo + '&item=' + itemID + '&grr=' + grr.get_value() + '&reg=' + reg.get_value());
                oWnd.show();
                //oWnd.maximize();
                oWnd.add_pageLoad(onClientPageLoad);
            }
    ...
    <telerik:RadWindow runat="server" Animation="None" Width="900px" Height="600px" Behavior="Move, Close"
            ...
            <td style="width: 42%; vertical-align: top;">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadComboBox ID="cboLocationID" runat="server" Width="304px" AllowCustomText="true"
                    ...
                    <tr id="pnlServiceUnitBookingNo" runat="server" visible="False">
                        ...
                        <td class="entry">
                            ...
                            <telerik:RadComboBox ID="cboServiceUnitBookingNo" runat="server" Width="304px" AllowCustomText="true"
                                Filter="Contains">
                            </telerik:RadComboBox>
                        </td>
                        <td width="20px">
                    ...
                    <tr runat="server" id="trPhysicianSenders" visible="False">
                        ...
                        <td class="entry">
                            <telerik:RadComboBox ID="cboPhysicianSender" runat="server" Width="304px" HighlightTemplatedItems="True"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="TransactionNo, SequenceNo"
            ...
            <CommandItemTemplate>
                ...
                <asp:LinkButton ID="lbInsert" runat="server" CommandName="InitInsert" Visible='<%# !grdTransChargesItem.MasterTableView.IsItemInserted %>'>
                    <img style="border: 0px; vertical-align: middle;" alt="" src="<%#Helper.UrlRoot()%>/Images/Toolbar/insert16.png" />
                ...
                <asp:LinkButton ID="lbPickList" runat="server" Visible='<%# !grdTransChargesItem.MasterTableView.IsItemInserted %>'
                    ...
                    <img style="border: 0px; vertical-align: middle;" alt="" src="<%#Helper.UrlRoot()%>/Images/Toolbar/views16.png" />
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn UniqueName="extra" HeaderText="" Groupable="false">
                    <ItemTemplate>
                        <%# (DataBinder.Eval(Container.DataItem, "IsPackage").Equals(false) || DataBinder.Eval(Container.DataItem, "IsApprove").Equals(true)? string.Empty :
                                string.Format("<a href=\"#\" onclick=\"openWinExtra('{0}','{1}','{2}'); return false;\"><img src=\"{3}/Images/Toolbar/insert16.png\" border=\"0\" /></a>",
                                    DataBinder.Eval(Container.DataItem, "TransactionNo"), DataBinder.Eval(Container.DataItem, "SequenceNo"), 
                                        DataBinder.Eval(Container.DataItem, "ItemID"),Helper.UrlRoot()))%>
                    </ItemTemplate>
                ...
                <telerik:GridTemplateColumn UniqueName="comp" HeaderText="" Groupable="false">
                    <ItemTemplate>
                        <%# (DataBinder.Eval(Container.DataItem, "IsPackage").Equals(false) || DataBinder.Eval(Container.DataItem, "IsApprove").Equals(true)? string.Empty :
                                string.Format("<a href=\"#\" onclick=\"openWinComp('{0}','{1}','{2}'); return false;\"><img src=\"{3}/Images/Toolbar/dokter.png\" border=\"0\" /></a>",
                                    DataBinder.Eval(Container.DataItem, "TransactionNo"), DataBinder.Eval(Container.DataItem, "SequenceNo"), 
                                        DataBinder.Eval(Container.DataItem, "ItemID"),Helper.UrlRoot()))%>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" Width="35px" />
                ...
                <telerik:GridTemplateColumn UniqueName="cons" HeaderText="" Groupable="false">
                    <ItemTemplate>
                        <%# (DataBinder.Eval(Container.DataItem, "IsItemTypeService").Equals(true) && DataBinder.Eval(Container.DataItem, "IsApprove").Equals(false) && DataBinder.Eval(Container.DataItem, "IsVoid").Equals(false) ? string.Format("<a href=\"#\" onclick=\"openWinCons('{0}','{1}','{2}'); return false;\"><img src=\"{3}/Images/Toolbar/consumption.png\" border=\"0\" /></a>",
                                    DataBinder.Eval(Container.DataItem, "TransactionNo"), DataBinder.Eval(Container.DataItem, "SequenceNo"), 
                                        DataBinder.Eval(Container.DataItem, "ItemID"),Helper.UrlRoot()) : string.Empty
                                )%>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" Width="35px" />
                    <ItemStyle HorizontalAlign="Center" />
                ...
                <telerik:GridTemplateColumn UniqueName="ItemName" HeaderText="Item Name" Groupable="false">
                    <ItemTemplate>
                        ...
                        <br />
                        <%# DataBinder.Eval(Container.DataItem, "ItemName")%>&nbsp;<span style="color:red"><%# DataBinder.Eval(Container.DataItem, "PrevOrder")%></span>&nbsp;<span style="color:orange"><%# DataBinder.Eval(Container.DataItem, "Notes")%></span>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
            ...
            <EditFormSettings UserControlName="ServiceUnitTransDetail.ascx" EditFormType="WebUserControl">
