<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingPeCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.NursingPeCtl" %>
        ...
        <tr>
            ...
            <td style="vertical-align: top">
                <table style="width: 100%">
                    <tr>
                        <td class="label">Examination Inside / inspekulo</td>
                        <td class="entry">
                            <telerik:RadTextBox ID="txtInspekulo" runat="server" Width="100%" Height="80px"
...
<fieldset style="width: 49%;">
    <legend><b>ANCILLARY EXAMINATION</b></legend>
