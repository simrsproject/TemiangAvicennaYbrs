<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GeneralCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.GeneralCtl" %>
        ...
        <td style="width: 50%;" valign="top">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvComplaint" runat="server" ErrorMessage="Chief Complaint required."
                            ValidationGroup="entry" ControlToValidate="txtComplaint" SetFocusOnError="True"
                            Width="100%">
                            <asp:Image ID="Image1" runat="server" SkinID="rfvImage" />
                        </asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr runat="server" id="rowSCTChiefComplaint">
                    <td class="label">
                        <asp:Label ID="Label5" runat="server" Text="Chief Complaint Snomed CT"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="label">
                        <asp:Label ID="Label3" runat="server" Text="History of Medikamentosa"></asp:Label>
                    </td>
                    <td>
                        <telerik:RadTextBox ID="txtMedikamentosa" runat="server" Width="100%" Height="60px" Resize="Vertical"
                            TextMode="MultiLine" ClientEvents-OnBlur="fixDangText" />
                    </td>
                </tr>
                <tr>
        ...
        <td style="vertical-align: top;">
            ...
            <telerik:RadAjaxPanel runat="server" id="curbPanel">
                <fieldset>
                    ...
                    <telerik:RadGrid ID="grdCurb" runat="server"
                        AutoGenerateColumns="False" GridLines="None">
                        <MasterTableView DataKeyNames="VitalSignID" ShowHeader="False">
                            <Columns>
                                <telerik:GridBoundColumn DataField="VitalSignName" UniqueName="Question" HeaderText="Question" HeaderStyle-Width="100px"></telerik:GridBoundColumn>
