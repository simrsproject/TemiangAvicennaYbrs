<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FollowUpPlanOprCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.FollowUpPlanOprCtl" %>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="width: 240px">
                <telerik:RadComboBox runat="server" ID="cboSRDischargeCondition" Width="100%">
                </telerik:RadComboBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="rfvDischargeCondition" runat="server" ErrorMessage="Discharge Condition required."
        ...
        <tr>
            <td></td>
            <td colspan="4">
                <div style="display: none"><asp:RadioButton runat="server" ID="rbFupRPK" Text="Refer to Puskesmas" GroupName="FUP"/></div>
            </td>
        </tr>
        <tr>
            <td></td>
