<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientChildBirthHistCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Emr.AssessmentCtl.PatientChildBirthHistCtl" %>
    ...
    <telerik:RadGrid ID="grdPatientChildBirthHist" Width="100%" runat="server" GridLines="None" RenderMode="Lightweight" AutoGenerateColumns="False" EnableViewState="true"
        ...
        <MasterTableView DataKeyNames="SequenceNo">
            <Columns>
                ...
                <%--<telerik:GridBoundColumn DataField="SRBirthType" UniqueName="SRBirthType" HeaderText="Birth Type" Display="False" />
                <telerik:GridBoundColumn DataField="BirthType" UniqueName="BirthType" HeaderText="Birth Type" HeaderStyle-Width="100px" />
                <telerik:GridTemplateColumn HeaderText="Birth Type" UniqueName="BirthTypeEdit" HeaderStyle-Width="100px">
                    <ItemTemplate>
                        <telerik:RadComboBox runat="server" ID="cboSRBirthType" Width="100%"></telerik:RadComboBox>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>--%>
