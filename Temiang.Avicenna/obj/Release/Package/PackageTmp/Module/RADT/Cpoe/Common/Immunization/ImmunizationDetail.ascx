<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImmunizationDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.RADT.Cpoe.ImmunizationDetail" %>
...
<table width="100%">
    ...
    <tr runat="server" id="pnltariff" visible="false">
        ...
        <td class="entrydescription">
            ...
            <table id="pnlComponentTariff" runat="server" width="100%" visible="false" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <telerik:RadGrid ID="grdTariff" runat="server" OnItemCreated="grdTariff_ItemCreated"
                            AutoGenerateColumns="False" GridLines="None" Height="125px">
