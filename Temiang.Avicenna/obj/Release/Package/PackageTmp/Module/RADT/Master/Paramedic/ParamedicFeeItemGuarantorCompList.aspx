<%@ Page Title="Physician Fee Item - Guarantor - Component" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="ParamedicFeeItemGuarantorCompList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.ParamedicFeeItemGuarantorCompList" %>
        ...
        <tr>
            <td colspan="2">
                <telerik:RadGrid ID="grdDetail" runat="server" OnNeedDataSource="grdDetail_NeedDataSource"
                    ...
                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="ParamedicID,ItemID,GuarantorID,TariffComponentID">
                        <Columns>
                        ...
                        <EditFormSettings UserControlName="ParamedicFeeItemGuarantorCompDetail.ascx" EditFormType="WebUserControl">
                            <EditColumn UniqueName="grdParamedicFeeItemGuarantorCompEditCommand">
                            </EditColumn>
                        </EditFormSettings>
                    </MasterTableView>
                    <FilterMenu>
