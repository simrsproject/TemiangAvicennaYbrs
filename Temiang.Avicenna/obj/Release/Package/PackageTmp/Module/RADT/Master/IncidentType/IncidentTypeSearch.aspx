<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="IncidentTypeSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.IncidentTypeSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblItemName" runat="server" Text="Incident Type" Width="100px"></asp:Label>
            </td>
            <td class="filter">
