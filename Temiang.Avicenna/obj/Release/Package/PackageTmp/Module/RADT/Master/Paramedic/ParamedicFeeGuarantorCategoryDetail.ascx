<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParamedicFeeGuarantorCategoryDetail.ascx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.ParamedicFeeGuarantorCategoryDetail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumParamedicFeeGuarantorCategory" runat="server" ValidationGroup="ParamedicFeeGuarantorCategory" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="ParamedicFeeGuarantorCategory"
        ...
        <td width="50%" style="vertical-align: top">
            <table width="100%">
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvSRPhysicianFeeType" runat="server" ErrorMessage="Guarantor Category required."
                            ControlToValidate="cboSRPhysicianFeeType" SetFocusOnError="True" ValidationGroup="ParamedicFeeGuarantorCategory"
                            Width="100%">
                ...
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvFeeAmount" runat="server" ErrorMessage="Fee Amount required."
                            ControlToValidate="txtParamedicFeeAmount" ValidationGroup="ParamedicFeeGuarantorCategory"
                        ...
                        <asp:RequiredFieldValidator ID="rfvDeductionAmount" runat="server" ErrorMessage="Deduction Amount required."
                            ControlToValidate="txtDeductionFeeAmount" ValidationGroup="ParamedicFeeGuarantorCategory"
                            SetFocusOnError="True" Width="100%">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                    </td>
                ...
                <tr>
                    ...
                    <td width="20px">
                        <asp:RequiredFieldValidator ID="rfvFeeAmountReferral" runat="server" ErrorMessage="Fee Amount Referral required."
                            ControlToValidate="txtParamedicFeeAmountReferral" ValidationGroup="ParamedicFeeGuarantorCategory"
                            SetFocusOnError="True" Width="100%">*</asp:RequiredFieldValidator>
                        <asp:RequiredFieldValidator ID="rfvDeductionAmountReferral" runat="server" ErrorMessage="Deduction Amount Referral required."
                            ControlToValidate="txtDeductionFeeAmountReferral" ValidationGroup="ParamedicFeeGuarantorCategory"
                            SetFocusOnError="True" Width="100%">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                    </td>
                ...
                <tr>
                    <td align="right" colspan="2" style="height: 26px">
                        <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="ParamedicFeeGuarantorCategory"
                            Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
                        <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                            ValidationGroup="ParamedicFeeGuarantorCategory" Visible='<%# DataItem is GridInsertionObject %>'>
                        </asp:Button>
                        &nbsp;
