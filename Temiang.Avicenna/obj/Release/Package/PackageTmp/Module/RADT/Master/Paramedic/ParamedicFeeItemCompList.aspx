<%@ Page Title="Physician Fee Item - Component" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="ParamedicFeeItemCompList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.ParamedicFeeItemCompList" %>
        ...
        <tr>
            <td colspan="2">
                <telerik:RadGrid ID="grdDetail" runat="server" OnNeedDataSource="grdDetail_NeedDataSource"
                    ...
                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="ParamedicID,ItemID,TariffComponentID">
                        <Columns>
                        ...
                        <EditFormSettings UserControlName="ParamedicFeeItemCompDetail.ascx" EditFormType="WebUserControl">
                            <EditColumn UniqueName="grdParamedicFeeItemCompEditCommand">
                            </EditColumn>
                        </EditFormSettings>
                    </MasterTableView>
                    <FilterMenu>
