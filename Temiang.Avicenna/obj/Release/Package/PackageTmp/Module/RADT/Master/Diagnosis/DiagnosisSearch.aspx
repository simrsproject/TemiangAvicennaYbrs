<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master"
    AutoEventWireup="true" CodeBehind="DiagnosisSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.Master.DiagnosisSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td class="label">
                <asp:Label ID="lblDiagnoseID" runat="server" Text="Diagnose ID" Width="100px"></asp:Label>
            </td>
            <td class="filter">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblDiagnoseName" runat="server" Text="Diagnose Name" Width="100px"></asp:Label>
            </td>
            <td class="filter">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblDtdNo" runat="server" Text="DTD No" Width="100px"></asp:Label>
            </td>
            <td class="filter">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblDtdName" runat="server" Text="DTD Name" Width="100px"></asp:Label>
            </td>
            <td class="filter">
