<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="PhysicianScheduleInformationList.aspx.cs" Inherits="Temiang.Avicenna.Module.RADT.PhysicianScheduleInformationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="ServiceUnitID,ParamedicID,ScheduleDate" GroupLoadMode="client">
            <Columns>
                    ...
                    <ItemTemplate>
                        <div style="width: 130px; text-align: center;">
                            <telerik:RadBinaryImage ID="RadBinaryImage1" runat="server"
                                Width="125px" Height="125px" ResizeMode="Fit" DataValue='<%# Eval("Foto") == DBNull.Value? new System.Byte[0]: Eval("Foto") %>'></telerik:RadBinaryImage>
                        </div>
                    </ItemTemplate>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="250px" DataField="ServiceUnitName" HeaderText="Service Unit"
                    ...
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="150px" DataField="OperationalTimeName" HeaderText="Operational Time"
