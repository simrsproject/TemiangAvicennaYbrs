<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LinenItemsExterminationDetailItem.ascx.cs" Inherits="Temiang.Avicenna.Module.Laundry.Transaction.LinenItemsExterminationDetailItem" %>
