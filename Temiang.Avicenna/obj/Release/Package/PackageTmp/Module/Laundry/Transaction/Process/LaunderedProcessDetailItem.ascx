<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LaunderedProcessDetailItem.ascx.cs" Inherits="Temiang.Avicenna.Module.Laundry.Transaction.LaunderedProcessDetailItem" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:ValidationSummary ID="vsumLaunderedProcessItem" runat="server" ValidationGroup="LaunderedProcessItem" />
<asp:CustomValidator ID="customValidator" runat="server" ValidationGroup="LaunderedProcessItem"
...
<table width="100%">
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvProcessSeqNo" runat="server" ErrorMessage="Sequence No required."
                ControlToValidate="txtProcessSeqNo" SetFocusOnError="True" ValidationGroup="LaunderedProcessItem"
                Width="100%">
    ...
    <tr height="30">
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvQuantity" runat="server" ErrorMessage="Quantity required."
                ControlToValidate="txtQty" SetFocusOnError="True" ValidationGroup="LaunderedProcessItem"
                Width="100%">
                <asp:Image ID="Image2" runat="server" SkinID="rfvImage" />
            </asp:RequiredFieldValidator>
            <asp:RequiredFieldValidator ID="rfvSRItemUnit" runat="server" ErrorMessage="Unit required."
                ControlToValidate="cboSRItemUnit" SetFocusOnError="True" ValidationGroup="LaunderedProcessItem"
                Width="100%">
    ...
    <tr>
        <td align="right" colspan="2" style="height: 26px">
            <asp:Button ID="btnUpdate" Text="Update" runat="server" CommandName="Update" ValidationGroup="LaunderedProcessItem"
                Visible='<%# !(DataItem is GridInsertionObject) %>'></asp:Button>
            <asp:Button ID="btnInsert" Text="Insert" runat="server" CommandName="PerformInsert"
                ValidationGroup="LaunderedProcessItem" Visible='<%# DataItem is GridInsertionObject %>'>
            </asp:Button>
            &nbsp;
