<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="LaundrySortingProcessSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Laundry.Transaction.LaundrySortingProcessSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblProcessNo" runat="server" Text="Reference No" Width="100px"></asp:Label>
            </td>
            <td class="filter">
