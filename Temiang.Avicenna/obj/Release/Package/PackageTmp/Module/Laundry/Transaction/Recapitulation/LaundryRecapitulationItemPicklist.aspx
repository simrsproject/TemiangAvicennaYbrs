<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="LaundryRecapitulationItemPicklist.aspx.cs" Inherits="Temiang.Avicenna.Module.Laundry.Transaction.LaundryRecapitulationItemPicklist" %>
                ...
                <telerik:RadGrid ID="grdList" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="ItemID" ClientDataKeyNames="ItemID">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="110px" HeaderText="Quantity"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <telerik:RadNumericTextBox ID="txtQty" runat="server" Width="90px" NumberFormat-DecimalDigits="2" DbValue='<%#Eval("Qty")%>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderStyle-Width="110px" HeaderText="Re-Washing"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <telerik:RadNumericTextBox ID="txtQtyRewashing" runat="server" Width="90px" NumberFormat-DecimalDigits="2" DbValue='<%#Eval("QtyRewashing")%>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
