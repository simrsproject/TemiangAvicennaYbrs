<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="BloodRequestHistoryList.aspx.cs" Inherits="Temiang.Avicenna.Module.BloodBank.BloodRequestHistoryList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterRequestStatus">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <tr>
                <td width="50%" style="vertical-align: top">
                    <table width="100%">
                        ...
                        <tr>
                            <td class="label">
                                <asp:Label ID="lblRequestStatus" runat="server" Text="Status"></asp:Label>
                            </td>
                            <td class="entry">
                                <telerik:RadComboBox runat="server" ID="cboRequestStatus" Width="300px" AllowCustomText="true"
                                    Filter="Contains">
                                </telerik:RadComboBox>
                            </td>
                            <td width="20">
                                <asp:ImageButton ID="btnFilterRequestStatus" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
                                    OnClick="btnFilter_Click" ToolTip="Search" />
                            </td>
                            <td style="text-align: right"></td>
                        </tr>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="TransactionNo" ClientDataKeyNames="TransactionNo"
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn UniqueName="BloodStatus" HeaderStyle-Width="50px" HeaderText="Status"
                    ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:TextBox ID="txtSRBloodBagStatus" runat="server" Width="20px" ToolTip='<%#string.Format("{0}", DataBinder.Eval(Container.DataItem, "BloodBagStatusName").ToString()) %>' 
                            BackColor='<%# GetColorOfTriase(DataBinder.Eval(Container.DataItem,"SRBloodBagStatus")) %>'></asp:TextBox>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
            </Columns>
