<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="BloodRequestList.aspx.cs" Inherits="Temiang.Avicenna.Module.BloodBank.BloodRequestList" %>
                ...
                <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="">
                    <ItemTemplate>
                        <%# (this.IsUserAddAble.Equals(false) ? string.Empty
                                                        : string.Format("<a href=\"BloodRequestDetail.aspx?md=new&regno={0}\"><img src=\"../../../Images/Toolbar/new16.png\" border=\"0\" title=\"New\" /></a>",
            ...
            <DetailTables>
                <telerik:GridTableView Name="detail" DataKeyNames="TransactionNo" AutoGenerateColumns="false">
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="edit" HeaderText="" Groupable="false">
                            <ItemTemplate>
                                <%# ((this.IsUserEditAble.Equals(false) || (DataBinder.Eval(Container.DataItem, "IsApproved").Equals(true) || DataBinder.Eval(Container.DataItem, "IsVoid").Equals(true))) ? string.Empty :
                                                                        string.Format("<a href=\"BloodRequestDetail.aspx?md=edit&id={0}&regno={1}\"><img src=\"../../../Images/Toolbar/edit16.png\" border=\"0\" title=\"Edit\" /></a>",
                        ...
                        <telerik:GridTemplateColumn UniqueName="edit" HeaderText="" Groupable="false">
                            <ItemTemplate>
                                <%# (string.Format("<a href=\"BloodRequestDetail.aspx?md=view&id={0}&regno={1}\"><img src=\"../../../Images/Toolbar/views16.png\" border=\"0\" title=\"View\" /></a>",
                                                                            DataBinder.Eval(Container.DataItem, "TransactionNo"), DataBinder.Eval(Container.DataItem, "RegistrationNo")))%>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" Width="35px" />
                            <ItemStyle HorizontalAlign="Center" />
                        </telerik:GridTemplateColumn>
                        <telerik:GridHyperLinkColumn HeaderStyle-Width="110px" DataTextField="TransactionNo"
                            DataNavigateUrlFields="RequestUrl" HeaderText="Transaction No" UniqueName="TransactionNo"
                        ...
                        <telerik:GridDateTimeColumn HeaderStyle-Width="80px" DataField="RequestDate" HeaderText="Request Date"
                            ...
                            ItemStyle-HorizontalAlign="Center" />
                        <telerik:GridBoundColumn HeaderStyle-Width="80px" DataField="RequestTime" HeaderText="Request Time"
                        ...
                        <telerik:GridBoundColumn HeaderStyle-Width="120px" DataField="PdutNo" HeaderText="PDUT No"
                            ...
                            ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn HeaderStyle-Width="80px" DataField="BloodType" HeaderText="Blood Type"
                            UniqueName="BloodType" SortExpression="BloodType" HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn HeaderStyle-Width="50px" DataField="BloodRhesus" HeaderText="Rhesus"
                            UniqueName="BloodRhesus" SortExpression="BloodRhesus" HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn HeaderStyle-Width="120px" DataField="BloodGroup" HeaderText="Blood Group"
                        ...
                        <telerik:GridNumericColumn HeaderStyle-Width="80px" DataField="QtyBagRequest" HeaderText="Volume"
                            UniqueName="VolumeBag" SortExpression="VolumeBag" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n0}" />
                        <telerik:GridBoundColumn DataField="Officer" HeaderText="Officer" UniqueName="Officer"
                            SortExpression="Officer" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
