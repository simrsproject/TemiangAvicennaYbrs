<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="CrossMatchingDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.BloodBank.CrossMatchingDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="grdItem" runat="server" OnNeedDataSource="grdItem_NeedDataSource"
        ...
        OnItemCreated="grdItem_ItemCreated" OnItemCommand="grdItem_ItemCommand">
        <HeaderContextMenu>
        </HeaderContextMenu>
        <MasterTableView CommandItemDisplay="Top" DataKeyNames="BagNo">
            <ColumnGroups>
                <telerik:GridColumnGroup HeaderText="Screening" Name="Screening" HeaderStyle-HorizontalAlign="Center">
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn UniqueName="Print" HeaderStyle-Width="35px" ItemStyle-HorizontalAlign="center">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnPrintGuarantorReceipt" runat="server" CommandName="PrintLabel"
                            Visible='<%# DataBinder.Eval(Container.DataItem, "IsCrossmatchingPassed") %>' ToolTip='Print Label'
                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "BagNo") %>'>
                ...
                <telerik:GridBoundColumn DataField="CrossMatchingByUserName"
                    HeaderText="Conducted By" UniqueName="CrossMatchingByUserName" SortExpression="CrossMatchingByUserName"
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="CrossmatchCompatibleAutoControl"
                    ...
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="CrossmatchCompatibleDctControl"
                    HeaderText="DCT" UniqueName="CrossmatchCompatibleDctControl" SortExpression="CrossmatchCompatibleDctControl"
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                ...
                <telerik:GridNumericColumn HeaderStyle-Width="60px" DataField="CrossmatchCompatibleAutoControlLevel"
                    HeaderText="Auto Control Level" UniqueName="CrossmatchCompatibleAutoControlLevel" SortExpression="CrossmatchCompatibleAutoControlLevel"
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:n0}" />
                <telerik:GridNumericColumn HeaderStyle-Width="60px" DataField="CrossmatchCompatibleDctControlLevel"
                    HeaderText="DCT Level" UniqueName="CrossmatchCompatibleDctControlLevel" SortExpression="CrossmatchCompatibleDctControlLevel"
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:n0}" />

                <telerik:GridCheckBoxColumn HeaderStyle-Width="50px" DataField="IsScreening1"
                    HeaderText="#1" UniqueName="IsScreening1" SortExpression="IsScreening1"
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ColumnGroupName="Screening" />
                <telerik:GridCheckBoxColumn HeaderStyle-Width="50px" DataField="IsScreening2"
                    HeaderText="#2" UniqueName="IsScreening2" SortExpression="IsScreening2"
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ColumnGroupName="Screening" />
                <telerik:GridCheckBoxColumn HeaderStyle-Width="50px" DataField="IsScreening3"
                    HeaderText="#3" UniqueName="IsScreening3" SortExpression="IsScreening3"
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ColumnGroupName="Screening" />
            ...
            <EditFormSettings UserControlName="CrossMatchingItemDetail.ascx" EditFormType="WebUserControl">
                <EditColumn UniqueName="grdBloodCrossMatchingEditCommand">
                </EditColumn>
            </EditFormSettings>
        </MasterTableView>
        <FilterMenu>
