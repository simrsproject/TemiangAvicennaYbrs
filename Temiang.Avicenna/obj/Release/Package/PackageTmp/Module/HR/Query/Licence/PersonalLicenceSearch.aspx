<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="PersonalLicenceSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.HR.Query.PersonalLicenceSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblSRLicenceType" runat="server" Text="Licence Type" Width="100px"></asp:Label>
            </td>
            <td class="filter">
            </td>
            <td class="entry">
