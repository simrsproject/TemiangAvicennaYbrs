<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="NeedleStickInjuryList.aspx.cs" Inherits="Temiang.Avicenna.Module.HR.K3RS.NeedleStickInjuryList" %>
                ...
                <MasterTableView DataKeyNames="TransactionNo" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <telerik:GridHyperLinkColumn HeaderStyle-Width="150px" DataTextField="TransactionNo"
                            DataNavigateUrlFields="NewUrl" HeaderText="Transaction No" UniqueName="TransactionNo"
