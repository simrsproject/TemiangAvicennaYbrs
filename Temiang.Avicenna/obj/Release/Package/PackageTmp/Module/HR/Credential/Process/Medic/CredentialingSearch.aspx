<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="CredentialingSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.HR.Credential.Process.Medic.CredentialingSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblSRClinicalAuthorityLevel" runat="server" Text="Qualification"></asp:Label>
            </td>
            <td class="filter">
