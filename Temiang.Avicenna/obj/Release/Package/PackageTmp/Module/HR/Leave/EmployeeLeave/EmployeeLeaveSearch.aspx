<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="EmployeeLeaveSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.HR.Leave.EmployeeLeaveSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td class="label">
                <asp:Label ID="lblSREmployeeLeaveType" runat="server" Text="Leave Type" Width="100px"></asp:Label>
            </td>
            <td class="filter"></td>
            <td class="entry">
                <telerik:RadComboBox ID="cboSREmployeeLeaveType" runat="server" Width="304px" AllowCustomText="true"
                    Filter="Contains" />
            </td>
            <td />
        </tr>
