<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="DocumentHist.aspx.cs" Inherits="Temiang.Avicenna.Module.HR.KEHRS.Document.DocumentHist" %>
    ...
    <telerik:RadCodeBlock ID="radCodeBlock" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function showDetail(mode, pdid) {
                var url = '<%= Helper.UrlRoot() %>/Module/HR/KEHRS/Document/DocumentUpload.aspx?md=' + mode + '&pdid=' + pdid +'&pid=<%= Request.QueryString["pid"] %>&ccm=rebind&cet=<%=grdDocument.ClientID %>&note=<%= Request.QueryString["note"] %>';
            ...
            function ShowFile(id, fileName) {
                if (fileName.toLowerCase().includes(".dcm") == true) // DICOM file gunakan external app
                {
                    ...
                    if (fileName.toLowerCase().includes(".pdf") == true) {
                        ...
                        url = "DocumentImageZoomView.aspx?id=" + id +"&pid=<%= Request.QueryString["pid"] %>";
                    }
                    openWinMaximize(url);
                }
            }
