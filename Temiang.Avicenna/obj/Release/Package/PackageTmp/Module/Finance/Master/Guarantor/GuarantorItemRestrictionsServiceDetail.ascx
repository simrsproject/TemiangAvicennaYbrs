<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GuarantorItemRestrictionsServiceDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Finance.Master.GuarantorItemRestrictionsServiceDetail" %>
