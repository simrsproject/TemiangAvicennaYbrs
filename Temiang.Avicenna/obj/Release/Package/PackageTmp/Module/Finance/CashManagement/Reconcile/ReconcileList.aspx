<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true"
    CodeBehind="ReconcileList.aspx.cs" Inherits="Temiang.Avicenna.Module.Finance.CashManagement.Reconcile.ReconcileList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock runat="server" ID="RadCodeBlock1">
        ...
        <script type="text/javascript">
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                switch (val) {
                    case "export":
                        __doPostBack("<%= grdList.UniqueID %>", 'export');
                        break;
                    default :
    ...
    <telerik:RadToolBar ID="RadToolBar2" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
        <Items>
            <telerik:RadToolBarButton runat="server" Text="Export" Value="export" ImageUrl="~/Images/Toolbar/imp_exp_excel16.png"
                HoveredImageUrl="~/Images/Toolbar/imp_exp_excel16.png" DisabledImageUrl="~/Images/Toolbar/imp_exp_excel16.png" />
        </Items>
    </telerik:RadToolBar>
