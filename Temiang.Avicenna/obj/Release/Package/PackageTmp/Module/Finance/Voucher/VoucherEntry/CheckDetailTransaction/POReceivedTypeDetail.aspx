<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POReceivedTypeDetail.aspx.cs"
    MasterPageFile="~/MasterPage/MasterDialog.Master" Inherits="Temiang.Avicenna.Module.Finance.Voucher.VoucherEntry.CheckDetailTransaction.POReceivedTypeDetail" %>
            ...
            <td width="50%">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadNumericTextBox ID="txtStampAmount" runat="server" MaxLength="16" MinValue="0"
                                ReadOnly="true" Width="150px" />
                        </td>
                        <td />
                    </tr>
