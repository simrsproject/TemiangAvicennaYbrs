<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    CodeBehind="LedgerBalanceDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Finance.Voucher.VoucherEntry.LedgerBalanceDetail" %>
        ...
        <MasterTableView DataKeyNames="">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="SubLedgerName" ItemStyle-Wrap="false" AllowSorting="false"
                 ...
                 <telerik:GridBoundColumn DataField="RefferenceNumber" ItemStyle-Wrap="false" AllowSorting="false"
                    HeaderText="Reff No" UniqueName="RefferenceNumber" SortExpression="RefferenceNumber"
                    HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />   
