<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="MealOrderChangeList.aspx.cs" Inherits="Temiang.Avicenna.Module.Nutrient.Transaction.MealOrderChangeList" %>
    ...
    <telerik:RadCodeBlock runat="server" ID="RadCodeBlock1">
        ...
        <script type="text/javascript">
            function gotoViewUrl(id, regno, unitid) {
                ...
                var url = 'MealOrderChangeDetail.aspx?md=view&id=' + id + '&regno=' + regno + '&unitid=' + unitid + '&mealset=' + oms._value + '&type=<%= Page.Request.QueryString["type"] %>';
