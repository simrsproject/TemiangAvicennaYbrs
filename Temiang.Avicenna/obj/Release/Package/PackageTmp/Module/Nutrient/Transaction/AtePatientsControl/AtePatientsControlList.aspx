<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="AtePatientsControlList.aspx.cs" Inherits="Temiang.Avicenna.Module.Nutrient.Transaction.AtePatientsControlList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function openWinDialog(orderNo) {
                var oWnd = $find("<%= winPickList.ClientID %>");
                var oset = $find("<%= cboSRMealSet.ClientID %>");

                oWnd.setUrl("AtePatientsControlDialog.aspx?set=" + oset._value + "&orderno=" + orderNo);
                oWnd.show();
                //oWnd.maximize();
            ...
            <MasterTableView DataKeyNames="OrderNo" ClientDataKeyNames="OrderNo" GroupLoadMode="Client">
                ...
                <Columns>
                    <telerik:GridTemplateColumn UniqueName="History" HeaderText="" Groupable="false">
                        <ItemTemplate>
                            <a href="#" onclick="openWinDialog('<%# DataBinder.Eval(Container.DataItem, "OrderNo") %>'); return false;">
                                <img src="../../../../Images/Toolbar/edit16.png" border="0" alt="Ate Patients Control" /></a>
                        </ItemTemplate>
                    ...
                    <telerik:GridCheckBoxColumn HeaderStyle-Width="80px" DataField="IsControl" HeaderText="Controlled"
                        UniqueName="IsControl" SortExpression="IsControl" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Center" />
                </Columns>
            </MasterTableView>
            <FilterMenu>
