<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="DistributionPortionCheckedList.aspx.cs" Inherits="Temiang.Avicenna.Module.Nutrient.Transaction.DistributionPortionCheckedList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock runat="server" ID="RadCodeBlock1">
        ...
        <script type="text/javascript">
            function rowInvalid(orderNo) {
                if (confirm('Are you sure?')) {
                    __doPostBack("<%= grdList.UniqueID %>", 'invalid|' + orderNo);
                }
            }
        </script>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource" OnItemCreated="grdList_ItemCreated"
        ...
        <MasterTableView DataKeyNames="OrderNo" ClientDataKeyNames="OrderNo" GroupLoadMode="Client">
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="OrderNo" HeaderText="Order No"
                    UniqueName="OrderNo" SortExpression="RegistrationNo">
                ...
                <telerik:GridCheckBoxColumn HeaderStyle-Width="80px" DataField="IsDistributed" HeaderText="Distributed"
                    UniqueName="IsDistributed" SortExpression="IsDistributed" HeaderStyle-HorizontalAlign="Center"
                    ItemStyle-HorizontalAlign="Center" Visible="false" />
                <telerik:GridCheckBoxColumn HeaderStyle-Width="60px" DataField="IsInvalid" HeaderText="Invalid"
                ...
                <telerik:GridTemplateColumn UniqueName="Reason" HeaderText="Reason">
                    ...
                    <ItemStyle HorizontalAlign="Left" />
                    <ItemTemplate>
                        <telerik:RadComboBox ID="cboSRInvalidReason" runat="server" Width="100%" EnableLoadOnDemand="true"
                            MarkFirstMatch="true" HighlightTemplatedItems="true" OnItemDataBound="cboSRInvalidReason_ItemDataBound"
                            OnItemsRequested="cboSRInvalidReason_ItemsRequested">
                        </telerik:RadComboBox>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridBoundColumn DataField="SRInvalidReason" UniqueName="SRInvalidReason" Visible="False" />
                <telerik:GridTemplateColumn Groupable="false" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                        <%# (DataBinder.Eval(Container.DataItem, "IsInvalid").Equals(true) ? string.Empty :
                                    string.Format("<a href=\"#\" onclick=\"rowInvalid('{0}'); return false;\"><img src=\"../../../../Images/cancel16.png\" border=\"0\" title=\"Invalid\" /></a>",
