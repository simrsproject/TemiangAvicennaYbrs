<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="LiquidFoodDietSettingSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Nutrient.Initialization.LiquidFoodDietSettingSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            ...
            <td class="entry">
                <telerik:RadTextBox ID="txtDietName" runat="server" Width="300px" MaxLength="200" />
            </td>
            <td>
            </td>
        </tr>
