<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganizationUnitCtl.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Reports.OptionControl.OrganizationUnitCtl" %>
