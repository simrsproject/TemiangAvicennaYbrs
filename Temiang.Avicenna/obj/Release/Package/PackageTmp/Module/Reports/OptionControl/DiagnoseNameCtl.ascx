<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DiagnoseNameCtl.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Reports.OptionControl.DiagnoseNameCtl" %>
...
<table style="width: 90%">
    <tr>
        ...
        <td>
            <telerik:RadComboBox ID="cboDiagnoseName" Width="100%" runat="server" EnableLoadOnDemand="true"
