<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitInpatientCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ServiceUnitInpatientCtl" %>
