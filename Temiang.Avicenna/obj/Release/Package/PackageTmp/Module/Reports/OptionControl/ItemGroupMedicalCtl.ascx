<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemGroupMedicalCtl.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ItemGroupMedicalCtl" %>
