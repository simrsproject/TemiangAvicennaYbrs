<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DischargeMethodEMRCtl.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Reports.OptionControl.DischargeMethodEMRCtl" %>
