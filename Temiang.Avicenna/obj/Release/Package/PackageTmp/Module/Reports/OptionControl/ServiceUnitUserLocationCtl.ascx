<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitUserLocationCtl.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ServiceUnitUserLocationCtl" %>
