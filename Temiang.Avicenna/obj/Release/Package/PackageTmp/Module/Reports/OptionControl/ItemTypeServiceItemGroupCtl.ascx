<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemTypeServiceItemGroupCtl.ascx.cs" Inherits="Temiang.Avicenna.Module.Reports.OptionControl.ItemTypeServiceItemGroupCtl" %>
