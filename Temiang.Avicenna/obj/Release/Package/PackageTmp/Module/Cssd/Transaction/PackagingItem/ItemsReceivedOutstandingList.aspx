<%@ Page Title="Outstanding List" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="ItemsReceivedOutstandingList.aspx.cs" Inherits="Temiang.Avicenna.Module.Cssd.Transaction.ItemsReceivedOutstandingList" %>
                ...
                <telerik:RadGrid ID="grdList" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="ReceivedNo, ReceivedSeqNo" ClientDataKeyNames="ReceivedNo, ReceivedSeqNo">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="110px" HeaderText="Reuse To"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <telerik:RadNumericTextBox ID="txtReuseTo" runat="server" Width="90px" DbValue='<%#Eval("ReuseTo")%>'
                                        NumberFormat-DecimalDigits="0" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Need Ultrasound" HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-HorizontalAlign="Center" UniqueName="chkIsNeedUltrasound">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkIsNeedUltrasound" runat="server" Width="50px" Checked='<%#Eval("IsNeedUltrasound")%>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="DTT" HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-HorizontalAlign="Center" UniqueName="chkIsDtt">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkIsDtt" runat="server" Width="50px" Checked='<%#Eval("IsDtt")%>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="cboIsDtt" HeaderText="Temperature">
                                <HeaderStyle Width="120px" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <telerik:RadComboBox ID="cboIsDtt" runat="server" Width="110px" EnableLoadOnDemand="true"
                                        MarkFirstMatch="true" HighlightTemplatedItems="true" OnItemDataBound="cboIsDtt_ItemDataBound"
                                        OnItemsRequested="cboIsDtt_ItemsRequested">
                                    </telerik:RadComboBox>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                        </Columns>
