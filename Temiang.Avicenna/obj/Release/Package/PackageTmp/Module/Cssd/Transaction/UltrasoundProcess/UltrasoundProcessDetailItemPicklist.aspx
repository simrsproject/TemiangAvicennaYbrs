<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master"
    AutoEventWireup="true" CodeBehind="UltrasoundProcessDetailItemPicklist.aspx.cs"
    Inherits="Temiang.Avicenna.Module.Cssd.Transaction.UltrasoundProcessDetailItemPicklist" %>
                ...
                <telerik:RadGrid ID="grdList" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="ReceivedNo, ReceivedSeqNo" ClientDataKeyNames="ReceivedNo, ReceivedSeqNo">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="110px" HeaderText="Qty Received" HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-HorizontalAlign="Center" Visible="False">
                                <ItemTemplate>
                                    <telerik:RadNumericTextBox ID="txtQtyProcessed" runat="server" Width="90px" DbValue='<%#Eval("Qty")%>'
