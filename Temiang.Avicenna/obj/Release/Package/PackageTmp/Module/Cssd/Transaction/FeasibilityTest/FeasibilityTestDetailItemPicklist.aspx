<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="FeasibilityTestDetailItemPicklist.aspx.cs" Inherits="Temiang.Avicenna.Module.Cssd.Transaction.FeasibilityTestDetailItemPicklist" %>
                ...
                <telerik:RadGrid ID="grdList" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <MasterTableView DataKeyNames="ReceivedNo, ReceivedSeqNo" ClientDataKeyNames="ReceivedNo, ReceivedSeqNo">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Passed" HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-HorizontalAlign="Center" UniqueName="chkIsFeasibilityTestPassed">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkIsFeasibilityTestPassed" runat="server" Width="50px" Checked='<%#Eval("IsFeasibilityTestPassed")%>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Broken Instrument" HeaderStyle-HorizontalAlign="Center"
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkIsBrokenInstrument" runat="server" Width="50px" Checked='<%#Eval("IsBrokenInstrument")%>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Qty Replacements" UniqueName="TxtQtyReplacements"
                                ...
                                <ItemTemplate>
                                    <telerik:RadNumericTextBox runat="server" ID="txtQtyReplacements" Width="80px"
                                        Value='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "QtyReplacements")) %>'
                                        MinValue="0"
                                        MaxValue='<%# System.Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "QtyProcessed")) %>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
