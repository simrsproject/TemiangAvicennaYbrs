<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NonPatientCustomerChargesItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Charges.NonPatientCustomerChargesItemDetail" %>
        ...
        <td width="50%">
            <table width="100%" id="pnlParamedic" runat="server">
                <tr>
                    ...
                    <td class="entrydescription">
                        <telerik:RadComboBox runat="server" ID="cboParamedicID" Width="304px" EnableLoadOnDemand="true"
...
<table width="100%">
    ...
    <tr runat="server" id="pnltariff" visible="false">
        ...
        <td class="entrydescription">
            <table id="pnlVariableAndDiscount" runat="server" visible="false">
                <tr>
                    ...
                    <td colspan="4" class="labelcaption">
                        <asp:Label ID="lblDiscountAmount1" runat="server" Text="Discount Amount" />
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <table id="pnlComponentTariff" runat="server" width="100%" visible="false">
                <tr>
                    <td>
                            ...
                            <MasterTableView DataKeyNames="TariffComponentID" CellSpacing="-1">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Discount (%)" UniqueName="PercentDiscountText"
                                        ...
                                        <HeaderStyle Width="120px" />
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox runat="server" ID="txtPercentDiscount" Width="100px" MaxValue="100" />
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Physician" UniqueName="PhysicianText" HeaderStyle-HorizontalAlign="left">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadComboBox ID="cboPhysicianID" runat="server" Width="304px" EnableLoadOnDemand="true"
    ...
    <tr id="pnlAsset" runat="server" visible="false">
        ...
        <td class="entry">
            <telerik:RadComboBox runat="server" ID="cboAssetID" Width="304px" />
        </td>
        <td width="20px" />
        <td />
    </tr>
        ...
        <td width="50%" style="vertical-align: top">
            <table width="100%">
                <tr id="pnlDiscountReason" runat="server">
                    ...
                    <td class="entrydescription">
                        <telerik:RadComboBox ID="cboSRDiscountReason" runat="server" Width="304px" />
                    </td>
                    <td width="20" />
                    <td />
                </tr>
        ...
        <td width="50%" style="vertical-align: top">
            <table width="100%">
                <tr id="trCenterID" runat="server">
                    ...
                    <td class="entrydescription">
                        <telerik:RadComboBox ID="cboCenterID" runat="server" Width="304px" />
                    </td>
                    <td width="20px">
                    ...
                    <td class="entrydescription">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="4px" />
                                <td>
                                    <telerik:RadComboBox ID="cboSRCitoPercentage" runat="server"></telerik:RadComboBox>
                                </td>
                                <td width="4px" />
                                <td>
                                </td>
