<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="ItemPickerDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.ItemPickerDetail" %>
            ...
            <td width="60%">
                <table width="100%">
                    <tr runat="server" id="pnlItemType">
                        ...
                        <td class="entry">
                            <telerik:RadComboBox runat="server" ID="cboItemType" Width="300px" AutoPostBack="true"
