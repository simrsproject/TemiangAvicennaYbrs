<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemDownPaymentVisite.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Charges.ItemDownPaymentVisite" %>
...
<table width="100%">
    <tr>
        ...
        <td class="entry">
            <telerik:RadComboBox ID="cboServiceUnitID" runat="server" Width="300px" AutoPostBack="true"
                ...
                OnSelectedIndexChanged="cboServiceUnitID_SelectedIndexChanged" OnItemDataBound="cboServiceUnitID_ItemDataBound"
    ...
    <tr>
        ...
        <td width="20px">
            <asp:RequiredFieldValidator ID="rfvAmount" runat="server" ErrorMessage="Visite Qty is required."
