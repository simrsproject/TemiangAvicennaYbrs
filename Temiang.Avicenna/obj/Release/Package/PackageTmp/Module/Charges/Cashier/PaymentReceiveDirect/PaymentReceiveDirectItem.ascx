<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentReceiveDirectItem.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Charges.PaymentReceiveDirectItem" %>
            ...
            <table width="100%">
                ...
                <asp:Panel ID="pnlCardDetail" runat="server">
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadComboBox ID="cboSRCardType" runat="server" Width="304px" AutoPostBack="true"
