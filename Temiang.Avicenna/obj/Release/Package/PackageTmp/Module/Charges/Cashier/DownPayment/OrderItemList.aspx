<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master"
    AutoEventWireup="true" CodeBehind="OrderItemList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.Cashier.OrderItemList" %>
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
        <tr>
            <td align="center">
                ...
                <cc:CollapsePanel ID="CollapsePanel2" runat="server" Title="Order Item">
                    <telerik:RadGrid ID="grdDetail" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ...
                        <MasterTableView CommandItemDisplay="None" DataKeyNames="SequenceNo">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="ServiceUnitName" HeaderText="Service Unit" UniqueName="ServiceUnitName"
                                    SortExpression="ServiceUnitName" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left" Visible="false" />
