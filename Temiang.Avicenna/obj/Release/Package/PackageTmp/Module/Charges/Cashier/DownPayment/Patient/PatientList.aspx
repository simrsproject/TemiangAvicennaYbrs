<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    CodeBehind="PatientList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.DownPayment.PatientList" %>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource">
        <MasterTableView DataKeyNames="PaymentNo">
            <Columns>
                ...
                <telerik:GridCheckBoxColumn HeaderStyle-Width="100px" DataField="IsApproved" HeaderText="Approved"
                    UniqueName="IsApproved" SortExpression="IsApproved" HeaderStyle-HorizontalAlign="Center"
                    ItemStyle-HorizontalAlign="Center" />
                <telerik:GridCheckBoxColumn HeaderStyle-Width="100px" DataField="IsVoid" HeaderText="Void"
