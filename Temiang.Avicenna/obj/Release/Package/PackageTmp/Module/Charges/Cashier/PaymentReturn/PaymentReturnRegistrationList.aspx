<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true"
    CodeBehind="PaymentReturnRegistrationList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.Cashier.PaymentReturnRegistrationList" %>
                        ...
                        <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="">
                            <ItemTemplate>
                                <%# (this.IsUserAddAble.Equals(false) || DataBinder.Eval(Container.DataItem, "IsChasierCheckin").Equals(false) ? string.Empty
                                    : string.Format("<a href=\"PaymentReturnDetail.aspx?md=new&regno={0}&cmno={1}&patid={2}&utype=\"><img src=\"../../../../Images/Toolbar/new16.png\" border=\"0\" alt=\"New\" /></a>",
                        ...
                        <telerik:GridTableView Name="detail" DataKeyNames="PaymentNo,RegistrationNo" AutoGenerateColumns="false">
                            <Columns>
                                <telerik:GridTemplateColumn UniqueName="edit" HeaderText="" Groupable="false">
                                    <ItemTemplate>
                                        <%# ((this.IsUserEditAble.Equals(false) || DataBinder.Eval(Container.DataItem, "IsApproved").Equals(true) || DataBinder.Eval(Container.DataItem, "IsVoid").Equals(true)) ? string.Empty :
                                            string.Format("<a href=\"PaymentReturnDetail.aspx?md=edit&id={0}&regno={1}&cmno={2}&patid={3}&utype=\"><img src=\"../../../../Images/Toolbar/edit16.png\" border=\"0\" alt=\"Edit\" /></a>",
                                ...
                                <telerik:GridTemplateColumn UniqueName="view" HeaderText="" Groupable="false">
                                    <ItemTemplate>
                                        <%# string.Format("<a href=\"PaymentReturnDetail.aspx?md=view&id={0}&regno={1}&cmno={2}&patid={3}&utype=\"><img src=\"../../../../Images/Toolbar/views16.png\" border=\"0\" alt=\"View\" /></a>",
                                                                                DataBinder.Eval(Container.DataItem, "PaymentNo"), 
                                                                                DataBinder.Eval(Container.DataItem, "RegistrationNo"), 
                                                                                DataBinder.Eval(Container.DataItem, "CashManagementNo"),
                                                                                DataBinder.Eval(Container.DataItem, "PatientID"))%>
