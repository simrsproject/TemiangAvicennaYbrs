<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialogEntry.Master"
    AutoEventWireup="true" CodeBehind="PrescriptionProgress.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.Dispensary.PrescriptionSales.PrescriptionProgress" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        ...
        <telerik:RadGrid ID="grdPrescriptionProgress" Width="100%" runat="server" RenderMode="Lightweight"
            AutoGenerateColumns="False" EnableViewState="true" AllowMultiRowSelection="True"
            OnItemDataBound="grdPrescriptionProgress_ItemDataBound" OnNeedDataSource="grdPrescriptionProgress_NeedDataSource">
            <MasterTableView DataKeyNames="ItemID,LineNumber" Width="100%">
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="ProgressByUserName" UniqueName="ProgressByUserName"
                        HeaderText="By" />
                </Columns>
            </MasterTableView>
            <FilterMenu>
