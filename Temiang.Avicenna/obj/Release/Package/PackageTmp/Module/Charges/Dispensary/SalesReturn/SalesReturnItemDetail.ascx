<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SalesReturnItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Charges.Dispensary.SalesReturnItemDetail" %>
