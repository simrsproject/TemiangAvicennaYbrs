<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SalesItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Charges.Dispensary.SalesItemDetail" %>
            ...
            <tr>
                ...
                <td class="entry">
                    <telerik:RadComboBox runat="server" ID="cboItemID" Height="190px" Width="350px" EnableLoadOnDemand="true"
                     ...
                     <telerik:RadTextBox ID="txtDescription" runat="server" Width="300px" Visible="false" />
                </td>
                <td width="20px">
                </td>
                <td>
