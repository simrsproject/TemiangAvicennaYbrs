<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master" AutoEventWireup="true" CodeBehind="UnLockFinalizeBillingList.aspx.cs" Inherits="Temiang.Avicenna.Module.Charges.Billing.UnLockFinalizeBillingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function rowDelete(regNo) {
                if (confirm('Are you sure to un-lock verification and finalize billing for selected registration?')) {
                    __doPostBack("<%= grdList.UniqueID %>", 'delete|' + regNo);
                }
            }
        </script>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="RegistrationNo" ClientDataKeyNames="RegistrationNo"
            ...
            <Columns>
                <telerik:GridTemplateColumn Groupable="false" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                        <%# (string.Format("<a href=\"#\" onclick=\"rowDelete('{0}'); return false;\">{1}</a>", 
                                        ...
                                        "<img src=\"../../../../Images/Toolbar/process16.png\" border=\"0\" alt=\"Un-Lock\" />"))%>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridBoundColumn HeaderStyle-Width="180px" DataField="RegistrationNo" HeaderText="Registration No"
                ...
                <telerik:GridDateTimeColumn DataField="LockVerifiedBillingDateTime" HeaderText="Lock Date"
                    UniqueName="LockVerifiedBillingDateTime" SortExpression="LockVerifiedBillingDateTime">
                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridDateTimeColumn>
                <telerik:GridBoundColumn DataField="LockVerifiedBillingByUserID" HeaderText="User" UniqueName="LockVerifiedBillingByUserID"
                    SortExpression="LockVerifiedBillingByUserID">
                    <HeaderStyle HorizontalAlign="Left" Width="100px" />
                    <ItemStyle HorizontalAlign="Left" />
                </telerik:GridBoundColumn>
            </Columns>
