<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemMedicBalanceDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Inventory.Master.ItemMedicBalanceDetail" %>
