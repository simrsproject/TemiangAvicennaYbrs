<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    CodeBehind="ItemProductMedicalList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Master.ItemProductMedicalList" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function gotoAddUrl(type) {
                var url = "ItemProductMedicalDetail.aspx?md=new&type=" + type;
        ...
        <MasterTableView DataKeyNames="ItemID">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Notes" HeaderText="Notes"
                    ...
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridCheckBoxColumn HeaderStyle-Width="60px" DataField="IsAntibiotic" HeaderText="Antibiotic"
                    UniqueName="IsAntibiotic" SortExpression="IsAntibiotic" HeaderStyle-HorizontalAlign="Center"
