<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LocationExceptionDistConfirmDetail.ascx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Master.LocationExceptionDistConfirmDetail" %>
