<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="InventoryIssueRequestByTemplatePickList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.InventoryIssueRequestByTemplatePickList" %>
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="cboFromLocationID">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="cboTemplateNo" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="ItemID" PageSize="20">
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Request Qty" HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <telerik:RadNumericTextBox ID="txtQtyInput" runat="server" Width="70px" DbValue='<%#DataBinder.Eval(Container.DataItem,"QtyInput")%>' NumberFormat-DecimalDigits="2" />
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
