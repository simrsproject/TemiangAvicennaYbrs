<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    CodeBehind="DistributionConfirmList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.DistributionConfirmList"
    Title="Untitled Page" %>
        ...
        <MasterTableView DataKeyNames="TransactionNo" GroupLoadMode="Client">
            <GroupByExpressions>
                <telerik:GridGroupByExpression>
                    <SelectFields>
                        <telerik:GridGroupByField FieldName="FServiceUnitID" HeaderText="Service Unit ">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="ItemName" HeaderText="Item Type"
                    ...
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="200px" DataField="FromUnit" HeaderText="From Unit"
                    UniqueName="FromUnit" SortExpression="FromUnit" HeaderStyle-HorizontalAlign="Left"
                    ItemStyle-HorizontalAlign="Left" />    
                <telerik:GridBoundColumn HeaderStyle-Width="140px" DataField="ReferenceNo" HeaderText="Distribution No"
