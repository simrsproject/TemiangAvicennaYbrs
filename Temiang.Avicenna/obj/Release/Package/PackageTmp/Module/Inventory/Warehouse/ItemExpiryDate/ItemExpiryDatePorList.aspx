<%@ Page Title="Batch Number & Expired Date List" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="ItemExpiryDatePorList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.ItemExpiryDatePorList" %>
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="ListKey" GroupLoadMode="client">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="BatchNumber" HeaderText="Batch Number" UniqueName="BatchNumber"
                ...
                <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="QuantityInBaseUnit" HeaderText="Quantity"
                    UniqueName="QuantityInBaseUnit" SortExpression="QuantityInBaseUnit" HeaderStyle-HorizontalAlign="Right"
