<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true"
    Codebehind="PurchaseOrderReturnList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.PurchaseOrderReturnList"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function gotoAddUrl(cons) {
                var url = "PurchaseOrderReturnDetail.aspx?md=new&cons=" + cons;
        ...
        <MasterTableView DataKeyNames="TransactionNo">
            <GroupByExpressions>
                <telerik:GridGroupByExpression>
                    <SelectFields>
                        <telerik:GridGroupByField FieldName="FServiceUnitID" HeaderText="Returned Unit ">
            ...
            <Columns>
                <telerik:GridBoundColumn HeaderStyle-Width="130px" DataField="TransactionNo" HeaderText="Return No"
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="100px" DataField="ItemName" HeaderText="Item Type"
                    ...
                    ItemStyle-HorizontalAlign="Left" />
                <telerik:GridBoundColumn HeaderStyle-Width="150px" DataField="ReferenceNo" HeaderText="Received No"
