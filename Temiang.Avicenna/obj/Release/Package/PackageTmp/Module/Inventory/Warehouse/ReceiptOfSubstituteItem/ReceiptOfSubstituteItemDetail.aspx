<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master"
    AutoEventWireup="true" CodeBehind="ReceiptOfSubstituteItemDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.ReceiptOfSubstituteItemDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function openWinPickList() {
                ...
                var osu = $find("<%= cboToServiceUnitID.ClientID %>");

                oWnd.setUrl("ReceiptOfSubstituteItemPickList.aspx?it=" + oit._value + "&supid=" + osup._value + "&suid=" + osu._value + "&wid=" + i);
                oWnd.show();
                //oWnd.maximize();
    ...
    <telerik:RadWindow runat="server" Animation="None" Width="820px" Height="600px" Behavior="Close, Move, Maximize"
        ShowContentDuringLoad="False" VisibleStatusbar="False" Modal="true" Title="Purchase Order Returned List"
        ...
        <tr>
            <td style="vertical-align: top">
                <table>
                    ...
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblReferenceNo" runat="server" Text="Returned No"></asp:Label>
                        </td>
                        <td class="entry">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnGetPickList" runat="server" Text="Substitute Item" OnClientClick="javascript:openWinPickList();return false;" />
    ...
    <telerik:RadGrid ID="grdItemTransactionItem" runat="server" ShowFooter="True" OnNeedDataSource="grdItemTransactionItem_NeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SequenceNo, ItemID">
            <Columns>
            ...
            <EditFormSettings UserControlName="ReceiptOfSubstituteItemDetailItem.ascx" EditFormType="WebUserControl">
                <EditColumn UniqueName="ReceiptOfSubstituteItemDetailItemEditCommand">
                </EditColumn>
            </EditFormSettings>
        </MasterTableView>
        <FilterMenu>
