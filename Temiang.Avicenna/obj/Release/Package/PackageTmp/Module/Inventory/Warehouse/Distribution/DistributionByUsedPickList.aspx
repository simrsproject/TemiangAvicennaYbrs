<%@ Page Title="Pick from Usage History" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="DistributionByUsedPickList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.DistributionByUsedPickList" %>
    ...
    <telerik:RadGrid ID="grdDetail" runat="server" PageSize="15" AutoGenerateColumns="False"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="ItemID" PageSize="13">
            <Columns>
                ...
                <telerik:GridNumericColumn HeaderStyle-Width="100px" DataField="BalanceFrom" HeaderText="From Location Balance"
