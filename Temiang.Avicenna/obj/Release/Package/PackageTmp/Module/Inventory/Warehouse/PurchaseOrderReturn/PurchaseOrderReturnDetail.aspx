<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true"
    CodeBehind="PurchaseOrderReturnDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.PurchaseOrderReturnDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function openWinPickList() {
                ...
                oWnd.setUrl("PurchaseOrderReturnPickList.aspx?it=" + oit._value + '&supid=' + osup._value + '&suid=' + osu._value + '&wid=' + i + '&cons=' + '<%= Request.QueryString["cons"] %>' + '&pageId=' + pageId);
                oWnd.show();
                //oWnd.maximize();
    ...
    <telerik:RadWindow runat="server" Animation="None" Width="820px" Height="600px" Behavior="Close, Move, Maximize"
        ShowContentDuringLoad="False" VisibleStatusbar="False" Modal="true" Title="Purchase Order Received List"
        ...
        <tr>
            <td style="vertical-align: top">
                <table>
                    ...
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblReferenceNo" runat="server" Text="PO Received No"></asp:Label>
                        </td>
                        <td class="entry">
            ...
            <td style="vertical-align: top">
                <table>
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblSRPurchaseReturnType" runat="server" Text="Return Type"></asp:Label>
                        </td>
                        <td class="entry">
                            <telerik:RadComboBox ID="cboSRPurchaseReturnType" runat="server" Width="300px" />
                        </td>
                        <td width="20">
                            <asp:RequiredFieldValidator ID="rfvSRPurchaseReturnType" runat="server" ErrorMessage="Return Type required."
                                ValidationGroup="entry" ControlToValidate="cboSRPurchaseReturnType" SetFocusOnError="True"
                                Width="100%">
                    ...
                    <tr>
                        ...
                        <td class="entry">
                            <telerik:RadTextBox ID="txtExternalReferenceNo" runat="server" Width="300px" MaxLength="20" />
                        </td>
                        <td width="20">
                        </td>
                        <td>
                    ...
                    <tr runat="server" id="trLocationConsignment">
                        <td class="label">
                            <asp:Label ID="Label1" runat="server" Text="Location For Consignment"></asp:Label>
                        </td>
                        <td class="entry">
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="SequenceNo, ItemID, BatchNumber">
            <Columns>
                ...
                <telerik:GridCalculatedColumn HeaderStyle-Width="100px" HeaderText="Total" UniqueName="TotalPrice"
                    ...
                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n2}" Visible="False" />
                <telerik:GridBoundColumn HeaderStyle-Width="200px" DataField="BatchNumber" HeaderText="Batch No"
            ...
            <EditFormSettings UserControlName="PurchaseOrderReturnItemDetail.ascx" EditFormType="WebUserControl">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" runat="server" id="tblPrice"
        visible="False">
        <tr>
