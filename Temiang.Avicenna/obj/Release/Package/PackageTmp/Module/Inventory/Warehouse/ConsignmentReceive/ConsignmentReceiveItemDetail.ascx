<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsignmentReceiveItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.ConsignmentReceiveItemDetail" %>
