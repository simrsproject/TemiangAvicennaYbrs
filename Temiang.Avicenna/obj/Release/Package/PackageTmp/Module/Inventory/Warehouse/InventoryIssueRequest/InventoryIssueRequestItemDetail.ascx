<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InventoryIssueRequestItemDetail.ascx.cs"
    Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.InventoryIssueRequestItemDetail" %>
