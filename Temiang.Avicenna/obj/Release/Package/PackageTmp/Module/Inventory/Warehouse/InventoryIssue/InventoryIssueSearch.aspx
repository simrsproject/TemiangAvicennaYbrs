<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="InventoryIssueSearch.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.InventoryIssueSearch" Title="Untitled Page" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td class="label"> 
                <asp:Label ID="lblTransactionNo" runat="server" Text="Issue No" Width="100px"></asp:Label>
			</td>
            <td class="filter">
        ...
        <tr>
            <td class="label"> 
                <asp:Label ID="Label1" runat="server" Text="Issue Date" Width="100px"></asp:Label>
			</td>
            <td class="filter">
        ...
        <tr>
            <td class="label"> 
                <asp:Label ID="lblToUnit" runat="server" Text="To Unit" Width="100px"></asp:Label>
			</td>
            <td class="filter">
