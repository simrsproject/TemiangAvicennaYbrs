<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="DistributionRequestOutstandingList.aspx.cs"
    Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.DistributionRequestOutstandingList" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function OnClientButtonClicking() {
                if (confirm('Are you sure to close selected distribution request?'))
            ...
            <DetailTables>
                <telerik:GridTableView DataKeyNames="TransactionNo,SequenceNo" ClientDataKeyNames="TransactionNo,SequenceNo"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderStyle-Width="65px" DataField="QuantityFinishInBaseUnit" HeaderText="Qty Dist"
                            UniqueName="QuantityFinishInBaseUnit" SortExpression="QuantityFinishInBaseUnit" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n2}"/>    
