<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="DistributionRequestPickList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.DistributionRequestPickList"
        ...
        <tr>
            ...
            <td style="vertical-align: top">
                <table>
                    <tr>
                        <td class="label">
                            <asp:Label ID="lblToLocation" runat="server" Text="Request To Location"></asp:Label>
                        </td>
                        <td class="entry">
    ...
    <telerik:RadGrid ID="grdDetail" runat="server" PageSize="15" AutoGenerateColumns="False"
        ...
        <MasterTableView CommandItemDisplay="None" DataKeyNames="ItemID" PageSize="20">
            <Columns>
                ...
                <telerik:GridNumericColumn HeaderStyle-Width="80px" DataField="BalanceTo" HeaderText="Balance (To_Location)"
                    UniqueName="BalanceTo" SortExpression="BalanceTo" HeaderStyle-HorizontalAlign="Center"
                ...
                <telerik:GridNumericColumn HeaderStyle-Width="80px" DataField="Balance" HeaderText="Balance"
                    ...
                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n2}" />
                <telerik:GridTemplateColumn UniqueName="tempColQtyInput" HeaderStyle-Width="100px" HeaderText="Request Qty" HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
