<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReceiptOfSubstituteItemDetailItem.ascx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Warehouse.ReceiptOfSubstituteItemDetailItem" %>
