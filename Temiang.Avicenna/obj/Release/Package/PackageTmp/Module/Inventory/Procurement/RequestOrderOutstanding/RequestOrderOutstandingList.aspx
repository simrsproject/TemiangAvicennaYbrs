<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="RequestOrderOutstandingList.aspx.cs" Inherits="Temiang.Avicenna.Module.Inventory.Procurement.RequestOrderOutstandingList" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function OnClientButtonClicking() {
                if (confirm('Are you sure to close selected request order?'))
                ...
                <td width="50%" valign="top">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td class="entry">
                                <telerik:RadComboBox runat="server" ID="cboToServiceUnitID" Width="300px" />
                            </td>
                            <td style="text-align: left">
    ...
    <telerik:RadGrid ID="grdList" runat="server" OnNeedDataSource="grdList_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="TransactionNo" ClientDataKeyNames="TransactionNo"
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="200px" DataField="ToServiceUnit" HeaderText="Purchasing Unit"
