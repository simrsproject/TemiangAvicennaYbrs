<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDetail.Master" AutoEventWireup="true" CodeBehind="WorkOrderPointDetail.aspx.cs" Inherits="Temiang.Avicenna.Module.AssetManagement.Management.WorkOrderPointDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadTabStrip ID="tabStrip" runat="server" MultiPageID="multiPage" ShowBaseLine="true"
        ...
        <Tabs>
            <telerik:RadTab runat="server" Text="Work Order" PageViewID="pgWo" Selected="True" />
            <telerik:RadTab runat="server" Text="Asset Information" PageViewID="pgImp" />
        </Tabs>
    </telerik:RadTabStrip>
        ...
        <telerik:RadPageView ID="pgWo" runat="server" Selected="true">
                    ...
                    <td style="width: 50%; vertical-align: top;">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td class="entry">
                                    <telerik:RadComboBox ID="cboSRWorkTrade" runat="server" Width="300px" Enabled="false">
                                    </telerik:RadComboBox>
                                </td>
                                <td width="20"></td>
                                <td></td>
            ...
            <table style="width: 100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <fieldset>
                            <legend>REALIZATION INFORMATION</legend>
                            <table width="100%">
                                <tr>
                                    <td style="width: 50%; vertical-align: top">
                                        <table width="100%">
                                    ...
                                    <td style="width: 50%; vertical-align: top">
                                        <table width="100%">
                                            ...
                                            <tr style="display: none">
                                                <td class="label"></td>
                                                <td class="entry">
                                                    <telerik:RadTextBox ID="txtReceivedByUserID" runat="server" ReadOnly="true" />
                                                </td>
                                                <td width="20"></td>
                                                <td></td>
                                            </tr>
                                            ...
                                            <tr style="display: none">
                                                <td class="label"></td>
                                                <td class="entry">
                                                    <telerik:RadTextBox ID="txtFirstResponseByUserID" runat="server" ReadOnly="true" />
                                                </td>
                                                <td width="20"></td>
                                                <td></td>
                                            </tr>
                                            ...
                                            <tr style="display: none">
                                                <td class="label"></td>
                                                <td class="entry">
                                                    <telerik:RadTextBox ID="txtLastRealizationByUserID" runat="server" ReadOnly="true" />
                                                </td>
                                                <td width="20"></td>
                                                <td></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="entry">
                                                    <telerik:RadTextBox ID="txtAcceptedBy" runat="server" Width="300px" ReadOnly="true" />
                                                </td>
                                                <td width="20"></td>
                                                <td></td>
                                            </tr>
            ...
            <table style="width: 100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <fieldset>
                            <legend>WORK ORDER POINT</legend>
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="width: 50%; vertical-align: top">
                                        <table width="100%">
                                            <tr>
                                                <td class="label">
                                                    <asp:Label ID="lblSRWorkOrderPoint" runat="server" Text="Point Type"></asp:Label>
                                                </td>
                                                <td class="entry">
                                                    <telerik:RadComboBox ID="cboSRWorkOrderPoint" runat="server" Width="300px" AllowCustomText="true"
                                                        Filter="Contains" AutoPostBack="true" OnSelectedIndexChanged="cboSRWorkOrderPoint_SelectedIndexChanged">
                                                    </telerik:RadComboBox>
                                                </td>
                                                <td width="20">
                                                    <asp:RequiredFieldValidator ID="rfvSRWorkOrderPoint" runat="server" ErrorMessage="Point Type required."
                                                        ValidationGroup="entry" ControlToValidate="cboSRWorkOrderPoint" SetFocusOnError="True"
                                                        Width="100%">
                                            ...
                                            <tr>
                                                <td class="label">
                                                    <asp:Label ID="lblWorkOrderPoint" runat="server" Text="Point Value"></asp:Label>
                                                </td>
                                                <td class="entry">
                                                    <telerik:RadNumericTextBox ID="txtWorkOrderPoint" runat="server" Width="120px" ReadOnly="True">
