<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="PreventiveMaintenanceList.aspx.cs" Inherits="Temiang.Avicenna.Module.AssetManagement.PreventiveMaintenanceList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function OnClientButtonClicking(sender, args) {
                ...
                switch (val) {
                    case "generate":
                        if (confirm('Are you sure to generate preventive maintenance for the selected schedule?'))
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnFilterPMDate">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdListTaskList" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <tr>
                <td width="50%">
                    <table width="100%">
                        ...
                        <tr>
                            <td class="label">
                                <asp:Label ID="lblToServiceUnit" runat="server" Text="Maintenance Unit"></asp:Label>
                            </td>
                            <td class="entry">
    ...
    <telerik:RadMultiPage ID="multiPage" runat="server" BorderStyle="Solid" BorderColor="Gray">
        <telerik:RadPageView ID="pgSchedule" runat="server" Selected="true">
            <telerik:RadToolBar ID="RadToolBar2" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarButton runat="server" Text="Generate Preventive Maintenance" Value="generate"
                    ...
                    <MasterTableView DataKeyNames="AssetID,ScheduleDate" ClientDataKeyNames="AssetID,ScheduleDate"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="AssetID" HeaderText="AssetID" UniqueName="AssetID"
                                SortExpression="AssetID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                Visible="False" />
                            ...
                            <telerik:GridBoundColumn DataField="ServiceUnitID" HeaderText="ServiceUnitID" UniqueName="ServiceUnitID"
                                ...
                                Visible="False" />
                            <telerik:GridBoundColumn DataField="MaintenanceServiceUnitID" HeaderText="MaintenanceServiceUnitID"
                                UniqueName="MaintenanceServiceUnitID" SortExpression="MaintenanceServiceUnitID"
                                HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" Visible="False" />
                            <telerik:GridTemplateColumn HeaderText="Work Trade" UniqueName="SRWorkTrade" HeaderStyle-HorizontalAlign="left">
                                <ItemTemplate>
                                    <telerik:RadComboBox ID="cboSRWorkTrade" runat="server" Width="175px" MarkFirstMatch="true">
                                    </telerik:RadComboBox>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                        </Columns>
        ...
        <telerik:RadPageView ID="pgTaskList" runat="server">
                ...
                <tr>
                    <td width="50%">
                        <table width="100%">
                            <tr>
                                <td class="label">
                                    <asp:Label ID="lblPMDate" runat="server" Text="PM Date"></asp:Label>
                                </td>
                                <td class="entry">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <telerik:RadDatePicker ID="txtPMDate" runat="server" Width="100px" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="text-align: left">
                                    <asp:ImageButton ID="btnFilterPMDate" runat="server" ImageUrl="~/Images/Toolbar/search16.png"
            ...
            <telerik:RadGrid ID="grdListTaskList" runat="server" OnNeedDataSource="grdListTaskList_NeedDataSource"
                ...
                <MasterTableView DataKeyNames="PMNo">
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="CheckBoxTemplateColumn" HeaderStyle-Width="40px">
                            <HeaderTemplate>
                        ...
                        <telerik:GridBoundColumn HeaderStyle-Width="150px" DataField="PMNo" HeaderText="PMNo" UniqueName="PMNo"
                            SortExpression="PMNo" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" Visible="false" />
                        <telerik:GridHyperLinkColumn HeaderStyle-Width="150px" DataTextField="PMNo" DataNavigateUrlFields="PmUrl"
                            HeaderText="Prev. Maintenance No" UniqueName="PMNo" SortExpression="PMNo" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Center" />
                        <telerik:GridBoundColumn DataField="PMDate" HeaderText="Date" UniqueName="PMDate"
                            SortExpression="PMDate" DataType="System.DateTime" DataFormatString="{0:dd-MMM-yyyy}">
                            <HeaderStyle HorizontalAlign="Center" Width="90px" />
                            <ItemStyle HorizontalAlign="Center" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="AssetName" HeaderText="Asset" UniqueName="AssetName"
                        ...
                        <telerik:GridBoundColumn DataField="SerialNumber" HeaderText="Serial No" UniqueName="SerialNumber"
                            SortExpression="SerialNumber" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <telerik:GridBoundColumn DataField="ServiceUnitName" HeaderText="Maintenance Unit"
                        ...
                        <telerik:GridBoundColumn DataField="WorkTrade" HeaderText="Work Trade" UniqueName="WorkTrade"
                            SortExpression="WorkTrade" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        ...
                        <telerik:GridTemplateColumn Groupable="false" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container.DataItem, "IsApproved").Equals(true) ? string.Empty
                                     : string.Format("<a href=\"#\" onclick=\"rowApproved('{0}'); return false;\"><img src=\"../../../../Images/Toolbar/post16.png\" border=\"0\" alt=\"Approval\" title=\"Approval\" /></a>",
                                                                            DataBinder.Eval(Container.DataItem, "PMNo"))%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>--%>
