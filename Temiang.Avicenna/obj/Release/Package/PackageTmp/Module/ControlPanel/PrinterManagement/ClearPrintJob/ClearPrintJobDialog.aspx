<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterCustom.Master"
    AutoEventWireup="true" CodeBehind="ClearPrintJobDialog.aspx.cs" Inherits="Temiang.Avicenna.Module.ControlPanel.PrinterManagement.ClearPrintJobDialog" %>
        ...
        <table width="100%" height="400px" style="vertical-align: middle;">
            <tr>
                <td valign="middle" align="center">
                    <table width="500">
                        <tr>
                            <td align="center" style="background-color:Black; font-weight:bold; color:White;">
                                <asp:Label runat="server" ID="lblText" Text="CLEAR PRINT JOB" Font-Size="14"></asp:Label>
