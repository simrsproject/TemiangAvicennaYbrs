<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterList.Master" AutoEventWireup="true" CodeBehind="WageStructureAndScaleWorkGroupList.aspx.cs" Inherits="Temiang.Avicenna.Module.Payroll.Master.WageStructureAndScaleWorkGroupList" %>
        ...
        <MasterTableView DataKeyNames="ItemID">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="ItemName"
                    HeaderText="Work Group" UniqueName="ItemName" SortExpression="ItemName"
                    HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
