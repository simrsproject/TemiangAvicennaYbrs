...
CREATE PROCEDURE spxml_RL3_15V2025(  
 @RlTxReportNo VARCHAR(20)  
)  
  
AS  
  
--DECLARE @RlTxReportNo VARCHAR(20) = 'RL/250130-0001'  
  
SELECT 'RL 3.15 Rekapitulasi Kegiatan Pelayanan Kesehatan Jiwa' RptName,  
       CASE   
