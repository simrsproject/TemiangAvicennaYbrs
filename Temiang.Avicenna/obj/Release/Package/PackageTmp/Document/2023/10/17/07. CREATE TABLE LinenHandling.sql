CREATE TABLE [dbo].[LinenHandling](
 ...
 CONSTRAINT [PK_LinenHandling] PRIMARY KEY CLUSTERED 
(
	[TransactionNo] ASC
...
CREATE TABLE [dbo].[LinenHandlingItem](
	[TransactionNo] [varchar](20) NOT NULL,
	[SRLinenHandling] [varchar](20) NOT NULL,
	[IsYes] [bit] NOT NULL,
	...
	[LastUpdateDateTime] [datetime] NULL,
	[LastUpdateByUserID] [varchar](15) NULL,
 CONSTRAINT [PK_LinenHandlingItem] PRIMARY KEY CLUSTERED 
(
	[TransactionNo] ASC,
	[SRLinenHandling] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
