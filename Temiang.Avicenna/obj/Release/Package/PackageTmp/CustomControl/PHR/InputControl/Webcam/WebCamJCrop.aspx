<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true" CodeBehind="WebCamJCrop.aspx.cs" Inherits="Temiang.Avicenna.CustomControl.Phr.InputControl.WebCamJCrop" %>

<%@ Import Namespace="Temiang.Avicenna.BusinessObject" %>
<%@ Import Namespace="Temiang.Avicenna.Common" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- First, include the Webcam.js JavaScript Library -->
    <script type="text/javascript" src="<%=Helper.UrlRoot()%>/JavaScript/webcam.min.js"></script>
    <script src="<%=Helper.UrlRoot()%>/JavaScript/JCrop/jquery.min.js" type="text/javascript"></script>
    <script src="<%=Helper.UrlRoot()%>/JavaScript/JCrop/jquery.Jcrop.min.js" type="text/javascript"></script>

    <link rel="stylesheet" href="<%=Helper.UrlRoot()%>/JavaScript/JCrop/jquery.Jcrop.min.css" type="text/css" />
