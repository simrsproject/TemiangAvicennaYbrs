<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FamilyMedicalHistoryCtl.ascx.cs" Inherits="Temiang.Avicenna.CustomControl.Phr.InputControl.FamilyMedicalHistoryCtl" %>
