...
// ***********************
jQuery.keyboard.language.id = {
	language: 'Bahasa (Bahasa Indonesia)', // e.g. 'Русский (Russian)'
	display : {
		'a'      : '\u2714:Terima (Shift+Enter)', // check mark - same action as accept
		'accept' : 'Terima:Terima (Shift+Enter)',
		'alt'    : 'AltGr:Alternate Graphemes',
		'b'      : '\u2190:Backspace',    // Left arrow (same as &larr;)
		'bksp'   : 'Bksp:Backspace',
		'c'      : '\u2716:Batal (Esc)', // big X, close - same action as cancel
		'cancel' : 'Batal:Batal (Esc)',
