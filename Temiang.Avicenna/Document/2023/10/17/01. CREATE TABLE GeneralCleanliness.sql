CREATE TABLE [dbo].[GeneralCleanliness](
 ...
 CONSTRAINT [PK_GeneralCleanliness] PRIMARY KEY CLUSTERED 
(
	[TransactionNo] ASC
...
CREATE TABLE [dbo].[GeneralCleanlinessItem](
	[TransactionNo] [varchar](20) NOT NULL,
	[SRGeneralCleanliness] [varchar](20) NOT NULL,
	[IsYes] [bit] NOT NULL,
	...
	[LastUpdateDateTime] [datetime] NULL,
	[LastUpdateByUserID] [varchar](15) NULL,
 CONSTRAINT [PK_GeneralCleanlinessItem] PRIMARY KEY CLUSTERED 
(
	[TransactionNo] ASC,
	[SRGeneralCleanliness] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
