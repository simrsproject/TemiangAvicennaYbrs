CREATE PROCEDURE spxml_RL3_14V2025
 @RlTxReportNo VARCHAR(20)  
AS  
  
SET NOCOUNT ON  
  
SELECT 'RL 3.14 Rekapitulasi Kegiatan Pelayanan Khusus' ReportName,  
         CASE    
            ...
            ELSE 'Periode : ' + asri.ItemName + ' s/d ' + asri2.ItemName + ' ' +    
                 b.PeriodYear   
       END AS Periode,    
h.HospitalCode, h.HealthcareName, h.ProvincesCode, h.City, b.PeriodYear, c.RlMasterReportItemCode AS 'No', c.RlMasterReportItemName AS 'JenisKegiatan',   
 a.Jumlah  
FROM RlTxReport3_14V2025 AS a  
