...
AS
 ...
 --   DECLARE  @p_PayrollPeriodID INT = 15, 
	--@p_WageProcessTypeID INT = 1, 
	--@p_TransactionDate DATETIME ='9/25/2023', 
	--@p_UserID VARCHAR(40) = 'sci', 
	--@p_PersonID INT = -1
