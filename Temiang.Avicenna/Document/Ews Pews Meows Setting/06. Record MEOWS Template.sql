...
WHERE  [TemplateName] = 'MEOWS' AND IsActive = 1
...
BEGIN
    ...
    UPDATE [NursingDiagnosaTemplate] SET [TemplateName]='MEOWS', [TemplateText]='Modified Early Obstetrics Warning Score'
    WHERE  TemplateID = @templateID
END 
ELSE
BEGIN
    ...
    VALUES(N'MEOWS',N'Modified Early Obstetrics Warning Score',1,N'han',getdate(),N'han',getdate());
...
INSERT INTO [NursingDiagnosaTemplateDetail]([TemplateID],[QuestionID],[CreateByUserID],[CreateDateTime],[LastUpdateByUserID],[LastUpdateDateTime],[RowIndex])
VALUES(@templateID,N'WS.BPD',N'han',GETDATE(),N'han',GETDATE(),7);
INSERT INTO [NursingDiagnosaTemplateDetail]([TemplateID],[QuestionID],[CreateByUserID],[CreateDateTime],[LastUpdateByUserID],[LastUpdateDateTime],[RowIndex])
VALUES(@templateID,N'WS.HR',N'han',GETDATE(),N'han',GETDATE(),5);
INSERT INTO [NursingDiagnosaTemplateDetail]([TemplateID],[QuestionID],[CreateByUserID],[CreateDateTime],[LastUpdateByUserID],[LastUpdateDateTime],[RowIndex])
VALUES(@templateID,N'WS.O2S',N'han',GETDATE(),N'han',GETDATE(),3);
INSERT INTO [NursingDiagnosaTemplateDetail]([TemplateID],[QuestionID],[CreateByUserID],[CreateDateTime],[LastUpdateByUserID],[LastUpdateDateTime],[RowIndex])
VALUES(@templateID,N'WS.OUT',N'han',GETDATE(),N'han',GETDATE(),9);
INSERT INTO [NursingDiagnosaTemplateDetail]([TemplateID],[QuestionID],[CreateByUserID],[CreateDateTime],[LastUpdateByUserID],[LastUpdateDateTime],[RowIndex])
VALUES(@templateID,N'WS.PAIN',N'han',GETDATE(),N'han',GETDATE(),8);
INSERT INTO [NursingDiagnosaTemplateDetail]([TemplateID],[QuestionID],[CreateByUserID],[CreateDateTime],[LastUpdateByUserID],[LastUpdateDateTime],[RowIndex])
VALUES(@templateID,N'WS.PROT',N'han',GETDATE(),N'han',GETDATE(),10);
INSERT INTO [NursingDiagnosaTemplateDetail]([TemplateID],[QuestionID],[CreateByUserID],[CreateDateTime],[LastUpdateByUserID],[LastUpdateDateTime],[RowIndex])
