...
namespace Temiang.Avicenna.WebService
{
    ...
    public class RlReporting : V0.BaseDataService
    {
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void Rl_All_Process(string AccessKey, int month, int year)
        {
            Rl1_2_Process(AccessKey, month, year);
            Rl1_3_Process(AccessKey, month, year);
            Rl3_1_Process(AccessKey, month, year);
            Rl3_2_Process(AccessKey, month, year);
            Rl3_3_Process(AccessKey, month, year);
            Rl3_4_Process(AccessKey, month, year);
            Rl3_5_Process(AccessKey, month, year);
            Rl3_6_Process(AccessKey, month, year);
            Rl3_7_Process(AccessKey, month, year);
            Rl3_8_Process(AccessKey, month, year);
            Rl3_9_Process(AccessKey, month, year);
            Rl3_10_Process(AccessKey, month, year);
            Rl3_11_Process(AccessKey, month, year);
            Rl3_12_Process(AccessKey, month, year);
            Rl3_13_Process(AccessKey, month, year);
            Rl3_13b_Process(AccessKey, month, year);

            Rl3_14_Process(AccessKey, month, year);
            Rl3_15_Process(AccessKey, month, year);
            Rl4A_Process(AccessKey, month, year);
            Rl4ASebab_Process(AccessKey, month, year);
            Rl4B_Process(AccessKey, month, year);
            Rl4BSebab_Process(AccessKey, month, year);
            Rl51_Process(AccessKey, month, year);
            Rl52_Process(AccessKey, month, year);
            Rl53_Process(AccessKey, month, year);
            Rl54_Process(AccessKey, month, year);
        }
        ...
        public void Rl3_3_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int jml;
                    RlTxReport33.Process(month, month, year, mri.RlMasterReportItemID ?? 0, out jml);
        ...
        public void Rl3_4_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int pRmRumahSakit,  pRmBidan,  pRmPuskesmas,  pRmFasKesLain,  pRmHidup,  pRmMati,  pRnmHidup,  pRnmMati,
                        pNrHidup,  pNrMati,  pDiRujuk;
                    RlTxReport34.Process(month, month, year, mri.RlMasterReportItemID ?? 0, AppSession.Parameter.ServiceUnitImunisasiTTId, AppSession.Parameter.ItemIdImunisasiTT1, AppSession.Parameter.ItemIdImunisasiTT2,
                        out pRmRumahSakit, out pRmBidan, out pRmPuskesmas, out pRmFasKesLain, out pRmHidup, out pRmMati, out pRnmHidup, out pRnmMati,
                        out pNrHidup, out pNrMati, out pDiRujuk);
                    var item = detail.AddNew();
                    item.RlTxReportNo = entity.RlTxReportNo;
                    item.RlMasterReportItemID = mri.RlMasterReportItemID;
                    item.RlMasterReportItemCode = mri.RlMasterReportItemCode;
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int pRmRumahSakit,
                        ...
                        pNrMati,
                        pDiRujuk;
                    RlTxReport35.Process(month, month, year, mri.RlMasterReportItemID ?? 0, out pRmRumahSakit, out pRmBidan, out pRmPuskesmas, out pRmFasKesLain,
                        out pRmHidup, out pRmMati, out pRnmHidup, out pRnmMati, out pNrHidup, out pNrMati, out pDiRujuk);
        ...
        public void Rl3_7_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int jml;
                    RlTxReport37.Process(month, month, year, mri.RlMasterReportItemID ?? 0, out jml);
        ...
        public void Rl3_8_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int jml;
                    RlTxReport38.Process(month, month, year, mri.RlMasterReportItemID ?? 0, out jml);
        ...
        public void Rl3_9_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int jml;
                    RlTxReport39.Process(month, month, year, mri.RlMasterReportItemID ?? 0, out jml);
        ...
        public void Rl3_10_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int jml;
                    RlTxReport310.Process(month, month, year, mri.RlMasterReportItemID ?? 0, out jml);
        ...
        public void Rl3_11_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int jml;
                    RlTxReport311.Process(month, month, year, mri.RlMasterReportItemID ?? 0, out jml);
        ...
        public void Rl3_12_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int konselingAnc,  konselingPascaPersalinan,  kbBaruCmBukanRujukan,
                    kbBaruCmRujukanRi,  kbBaruCmRujukanRj,  kbBaruCmTotal,  kbBaruDkNifas,  kbBaruDkAbortus,  kbBaruDkLain,  kunjunganUlang,
                    keluhanEfekSamping,  keluhanEfekSampingDiRujuk;

                    RlTxReport312.Process(startDate, endDate, mri.RlMasterReportItemID ?? 0, out konselingAnc, out konselingPascaPersalinan, out kbBaruCmBukanRujukan,
                        out kbBaruCmRujukanRi, out kbBaruCmRujukanRj, out kbBaruCmTotal, out kbBaruDkNifas, out kbBaruDkAbortus, out kbBaruDkLain, out kunjunganUlang,
                        out keluhanEfekSamping, out keluhanEfekSampingDiRujuk);
        ...
        public void Rl3_13_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int rj, rd, ri;
                    RlTxReport313.Process(month, month, year, mri.RlMasterReportItemCode, out rj, out rd, out ri);
                    var item = detail.AddNew();
                    item.RlTxReportNo = entity.RlTxReportNo;
                    item.RlMasterReportItemID = mri.RlMasterReportItemID;
                    item.RlMasterReportItemCode = mri.RlMasterReportItemCode;
        ...
        public void Rl3_13b_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int jmlItemObat, jmlItemObatRs, jmlItemObatFormulariumRs;
                    RlTxReport313b.Process(mri.RlMasterReportItemCode, out jmlItemObat, out jmlItemObatRs, out jmlItemObatFormulariumRs);
                    var item = detail.AddNew();
                    item.RlTxReportNo = entity.RlTxReportNo;
                    item.RlMasterReportItemID = mri.RlMasterReportItemID;
                    item.RlMasterReportItemCode = mri.RlMasterReportItemCode;
        ...
        public void Rl3_15_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int riJpk,  riJld,  rj,  rjLab,  rjRad,  rjLl;
                    RlTxReport315.Process(month, month, year, mri.RlMasterReportItemID ?? 0, AppSession.Parameter.ServiceUnitLaboratoryID, AppSession.Parameter.ServiceUnitRadiologyID,
                        out riJpk, out riJld, out rj, out rjLab, out rjRad, out rjLl);
        ...
        public void Rl4A_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                var query = new RlTxReport4AQuery("a");
                ...
                if (coll.LoadAll())
                {
                    ...
                    query.Where(query.RlTxReportNo == entity.RlTxReportNo);
                    detail.Load(query);
                ...
                else
                {
                    ...
                    query.Where(query.RlTxReportNo == "xxx");
                    detail.Load(query);
                }
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    item.RlMasterReportItemName = mri.RlMasterReportItemName;
                    var dtd = new Dtd();
                    dtd.LoadByPrimaryKey(mri.RlMasterReportItemCode);
        ...
        public void Rl4ASebab_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                var query = new RlTxReport4ASebabQuery("a");
                var mriq = new RlMasterReportItemQuery("b");
                query.InnerJoin(mriq).On(query.RlMasterReportItemID == mriq.RlMasterReportItemID);
                query.Select(
                        query,
        ...
        public void Rl4B_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                var query = new RlTxReport4BQuery("a");
                var mriq = new RlMasterReportItemQuery("b");
                query.InnerJoin(mriq).On(query.RlMasterReportItemID == mriq.RlMasterReportItemID);
                query.Select(
                        query,
        ...
        public void Rl51_Process(string AccessKey, int month, int year)
        {
            ...
            try
            {
                ...
                foreach (var mri in mstDt)
                {
                    ...
                    int jml;
                    RlTxReport51.Process(month, month, year, mri.RlMasterReportItemCode, out jml);
