<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterDialog.Master" AutoEventWireup="true"
    CodeBehind="ChangePassCode.aspx.cs" Inherits="Temiang.Avicenna.ChangePassCode" %>
        ...
        <table width="100%" height="400px" style="vertical-align: middle;">
            <tr>
                <td valign="middle" align="center">
                    <table>
                        <tr>
                            <td colspan="4" align="center" style="background-color: Black; font-weight: bold; color: White;">Current Passcode
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
                                <asp:Label ID="lblPassword" runat="server" Text="Passcode*"></asp:Label>
                            </td>
                            <td class="entry">
                                <telerik:RadTextBox ID="txtPassword" runat="server" Width="300px" TextMode="Password" />
                            </td>
                            <td width="20">
                                <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ErrorMessage="Current Passcode required."
                        ...
                        <tr>
                            <td colspan="4" align="center" style="background-color: Black; font-weight: bold; color: White;">New Passcode
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
                                <asp:Label ID="Label1" runat="server" Text="New Passcode"></asp:Label>
                            </td>
                            <td class="entry">
                        ...
                        <tr>
                            <td class="label">
                                <asp:Label ID="Label2" runat="server" Text="Validation passcode"></asp:Label>
                            </td>
                            <td class="entry">
                        ...
                        <tr>
                            <td colspan="4">
                                <table align="center">
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnOk" runat="server" ValidationGroup="entry" Text="Save" Width="80px"
                                                OnClick="btnOk_Click" />
                                        </td>
                                        <td>
                        ...
                        <tr id="trPasswordPolicy1" runat="server" visible="false">
                            <td colspan="4" align="center" style="background-color: Yellow; font-weight: bold; color: Black;">Passcode Policy Rule
                            </td>
                        </tr>
