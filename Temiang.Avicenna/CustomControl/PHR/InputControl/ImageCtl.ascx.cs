...
{
    public partial class ImageCtl : BasePhrCtl
    {
        public override object Value
        {
            get
            {
                ...
                //return hdnImage.Value.ToImage().ToByteArray(ImageFormat.Png); ;
        ...
        protected override void OnPopulateEntryControl(Patient pat, Registration reg, PatientHealthRecord phr, PatientHealthRecordLine phrLine, string lastRegistrationNo)
        {
            ...
            txtNotes.Text = phrLine.QuestionAnswerText;
        }
        ...
        {
            phrLine.QuestionAnswerText = txtNotes.Text;
            if (!string.IsNullOrWhiteSpace(hdnImage.Value))
            {
                var imgHelper = new ImageHelper();
                phrLine.BodyImage = imgHelper.ToByteArray(imgHelper.ToImage(hdnImage.Value), ImageFormat.Png);
            }
        }
    }
}