...
{
    public partial class ImunizationHistCtl  : BasePhrCtl
    {
        ...
        //protected override void OnDataModeChanged(AppEnum.DataMode oldDataMode, AppEnum.DataMode newDataMode)
        //{
        //    if (oldDataMode != newDataMode)
        //    {
        //        // Refresh
        //        grdImunizationHist.DataSource = null;
        //        grdImunizationHist.Rebind();
        ...
        private void SaveImmunization()
        {
            ...
            foreach (GridDataItem item in grdImunizationHist.MasterTableView.Items)
            {
                for (int i = 1; i < 11; i++)
                {
                    AddPatientManualImmunization(coll, item, i,PatientID);
                }
            }
        ...
        private void AddPatientManualImmunization(PatientImmunizationCollection coll, GridDataItem item, int seqNo, string PatientID)
        {
