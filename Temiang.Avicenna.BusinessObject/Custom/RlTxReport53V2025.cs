...
{
    public partial class RlTxReport53V2025
    {
        ...
        public static void Process(int fromMonth, int toMonth, int year, string transactionNo, string userId, RlTxReport53V2025Collection coll, out RlTxReport53V2025Collection newColl)
        {
