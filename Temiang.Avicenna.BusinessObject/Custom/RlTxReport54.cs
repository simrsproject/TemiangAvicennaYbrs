...
namespace Temiang.Avicenna.BusinessObject
{
    public partial class RlTxReport54
    {
        ...
        public static void Process(int fromMonth, int toMonth, int year, string transactionNo, string userId, RlTxReport54Collection coll, out RlTxReport54Collection newColl)
        {
