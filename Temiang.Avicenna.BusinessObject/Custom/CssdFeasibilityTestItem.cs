...
{
    public partial class CssdFeasibilityTestItem
    {
        ...
        public decimal QtyReplacementsDetail
        {
            get { return Convert.ToDecimal(GetColumn("refToCssdSterileItemsReceivedItemDetail_QtyReplacements")); }
            set { SetColumn("refToCssdSterileItemsReceivedItemDetail_QtyReplacements", value); }
        }

        public bool IsBrokenInstrumentDetail
        {
            get { return Convert.ToBoolean(GetColumn("refToCssdSterileItemsReceivedItemDetail_IsBrokenInstrument")); }
            set { SetColumn("refToCssdSterileItemsReceivedItemDetail_IsBrokenInstrument", value); }
        }
    }
}
