...
{
    public partial class RlTxReport310V2025
    {
        ...
        public static void Process(int fromMonth, int toMonth, int year, string paramedicRl1, out int rujukanPuskesmas, out int rujukanRsLain, out int rujukanFasKesLain, 
            out int dirujukKePuskesmasAsal, out int dirujukKeRsAsal, out int dirujukKeFasKesAsal, out int dirujukPasienRujukan, out int dirujukPasienDtgSendiri, out int dirujukDiterimaKembali)
        {
            rujukanPuskesmas = 0;
            rujukanRsLain = 0;
            rujukanFasKesLain = 0;
