...
{
    public partial class RlTxReport4BSebab
    {
        ...
        public static void Process(int fromMonth, int toMonth, int year, string userId, RlTxReport4BSebabCollection coll, out RlTxReport4BSebabCollection newcoll)
        {
