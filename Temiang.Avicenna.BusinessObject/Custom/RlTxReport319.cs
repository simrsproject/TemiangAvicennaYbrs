...
{
    public partial class RlTxReport319
    {
            ...
            out int riJpk, out int riJld, out int rj, out int rjLab, out int rjRad, out int rjLl)
        {
            ...
            {
                case 161: //membayar sendiri
                case 163: //Asuransi Pemerintah (BPJS / AKSES)
                case 164: //Asuransi Swasta
                case 165: //Keringanan (Cost Sharing)
                case 166: //Kartu Sehat
                case 167: 
                case 169:
                case 170:
                ...
                case 162: //Asuransi:
                    ...
                    regq2.Where(
                        ...
                        guarq2.RlMasterReportItemID.In(163,164,165,166)
                        );
                ...
                case 168: //Gratis:
                    ...
                    regq3.Where(
                        ...
                        guarq3.RlMasterReportItemID.In(169,170,171)
                        );
