...
namespace Temiang.Avicenna.BusinessObject
{
	...
	[Serializable]
	abstract public class esAppUserGroupCollection : esEntityCollectionWAuditLog
	{
	...
	[Serializable]
	abstract public class esAppUserGroup : esEntityWAuditLog
	{
		/// <summary>
	...
	public partial class AppUserGroupMetadata : esMetadata, IMetadata
	{
		...
		private esProviderSpecificMetadata esDefault(string mapName)
		{
			if(!_providerMetadataMaps.ContainsKey(mapName))
			{
				...
				meta.AddTypeMap("UserGroupName", new esTypeMap("varchar", "System.String"));
