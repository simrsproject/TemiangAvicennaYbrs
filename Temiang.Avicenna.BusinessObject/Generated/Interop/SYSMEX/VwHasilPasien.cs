...
Driver          : SQL
Date Generated  : 10/2/2019 9:45:06 PM
===============================================================================
*/
...
namespace Temiang.Avicenna.BusinessObject.Interop.SYSMEX
{
    ...
    abstract public class esVwHasilPasien : esEntityWAuditLog
    {
        ...
        /// <summary>
        /// Maps to Vw_HasilPasien.UNIT
        /// </summary>
        virtual public System.String Unit
        {
            get
            {
                return base.GetSystemString(VwHasilPasienMetadata.ColumnNames.Unit);
            }

            set
            {
                base.SetSystemString(VwHasilPasienMetadata.ColumnNames.Unit, value);
            }
        }

        /// <summary>
        /// Maps to Vw_HasilPasien.TEST_COMMENT
        /// </summary>
        virtual public System.String TestComment
        {
            get
            {
                return base.GetSystemString(VwHasilPasienMetadata.ColumnNames.TestComment);
            }

            set
            {
                base.SetSystemString(VwHasilPasienMetadata.ColumnNames.TestComment, value);
            }
        }

        /// <summary>
        /// Maps to Vw_HasilPasien.REF_RANGE
        /// </summary>
        virtual public System.String RefRange
        {
            get
            {
                return base.GetSystemString(VwHasilPasienMetadata.ColumnNames.RefRange);
            }

            set
            {
                base.SetSystemString(VwHasilPasienMetadata.ColumnNames.RefRange, value);
            }
        }

        /// <summary>
        /// Maps to Vw_HasilPasien.FLAG
        /// </summary>
        virtual public System.String Flag
        {
            get
            {
                return base.GetSystemString(VwHasilPasienMetadata.ColumnNames.Flag);
            }

            set
            {
                base.SetSystemString(VwHasilPasienMetadata.ColumnNames.Flag, value);
            }
        }

        /// <summary>
        /// Maps to Vw_HasilPasien.VALIDATE_BY
        /// </summary>
        virtual public System.String ValidateBy
        {
            get
            {
                return base.GetSystemString(VwHasilPasienMetadata.ColumnNames.ValidateBy);
            }

            set
            {
                base.SetSystemString(VwHasilPasienMetadata.ColumnNames.ValidateBy, value);
            }
        }

        /// <summary>
        /// Maps to Vw_HasilPasien.VALIDATE_ON
        /// </summary>
        virtual public System.String ValidateOn
        {
            get
            {
                return base.GetSystemString(VwHasilPasienMetadata.ColumnNames.ValidateOn);
            }

            set
            {
                base.SetSystemString(VwHasilPasienMetadata.ColumnNames.ValidateOn, value);
            }
        }
    ...
    abstract public class esVwHasilPasienQuery : esDynamicQuery
    {
        ...
        public esQueryItem Unit
        {
            get
            {
                return new esQueryItem(this, VwHasilPasienMetadata.ColumnNames.Unit, esSystemType.String);
            }
        }
        ...
        public esQueryItem TestComment
        {
            get
            {
                return new esQueryItem(this, VwHasilPasienMetadata.ColumnNames.TestComment, esSystemType.String);
            }
        }
        ...
        public esQueryItem RefRange
        {
            get
            {
                return new esQueryItem(this, VwHasilPasienMetadata.ColumnNames.RefRange, esSystemType.String);
            }
        }
        ...
        public esQueryItem Flag
        {
            get
            {
                return new esQueryItem(this, VwHasilPasienMetadata.ColumnNames.Flag, esSystemType.String);
            }
        }
        ...
        public esQueryItem ValidateBy
        {
            get
            {
                return new esQueryItem(this, VwHasilPasienMetadata.ColumnNames.ValidateBy, esSystemType.String);
            }
        }
        ...
        public esQueryItem ValidateOn
        {
            get
            {
                return new esQueryItem(this, VwHasilPasienMetadata.ColumnNames.ValidateOn, esSystemType.String);
            }
        }
    ...
    public partial class VwHasilPasienMetadata : esMetadata, IMetadata
    {
        ...
        protected VwHasilPasienMetadata()
        {
            ...
            c = new esColumnMetadata(VwHasilPasienMetadata.ColumnNames.Unit, 10, typeof(System.String), esSystemType.String);
            c.PropertyName = VwHasilPasienMetadata.PropertyNames.Unit;
            c.CharacterMaxLength = 15;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(VwHasilPasienMetadata.ColumnNames.TestComment, 11, typeof(System.String), esSystemType.String);
            c.PropertyName = VwHasilPasienMetadata.PropertyNames.TestComment;
            c.CharacterMaxLength = 500;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(VwHasilPasienMetadata.ColumnNames.RefRange, 12, typeof(System.String), esSystemType.String);
            c.PropertyName = VwHasilPasienMetadata.PropertyNames.RefRange;
            c.CharacterMaxLength = 30;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(VwHasilPasienMetadata.ColumnNames.Flag, 13, typeof(System.String), esSystemType.String);
            c.PropertyName = VwHasilPasienMetadata.PropertyNames.Flag;
            c.CharacterMaxLength = 2;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(VwHasilPasienMetadata.ColumnNames.ValidateBy, 14, typeof(System.String), esSystemType.String);
            c.PropertyName = VwHasilPasienMetadata.PropertyNames.ValidateBy;
            c.CharacterMaxLength = 60;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(VwHasilPasienMetadata.ColumnNames.ValidateOn, 15, typeof(System.String), esSystemType.String);
            c.PropertyName = VwHasilPasienMetadata.PropertyNames.ValidateOn;
