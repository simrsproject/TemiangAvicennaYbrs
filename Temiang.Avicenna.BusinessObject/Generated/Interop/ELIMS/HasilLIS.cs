...
Driver          : SQL
Date Generated  : 9/16/2021 6:40:33 PM
===============================================================================
*/
...
namespace Temiang.Avicenna.BusinessObject.Interop.ELIMS
{
	...
	abstract public class esHasilLISQuery : esDynamicQuery
	{
		...
		public esQueryItem FLAG_TAKEN
		{
			get
			{
				return new esQueryItem(this, HasilLISMetadata.ColumnNames.FLAG_TAKEN, esSystemType.String);
			}
		}

		public esQueryItem KRITIS_JAM_DITEMUKAN
		{
			get
			{
				return new esQueryItem(this, HasilLISMetadata.ColumnNames.KRITIS_JAM_DITEMUKAN, esSystemType.String);
			}
		}

		public esQueryItem KRITIS_DITERIMA_OLEH
		{
			get
			{
				return new esQueryItem(this, HasilLISMetadata.ColumnNames.KRITIS_DITERIMA_OLEH, esSystemType.String);
			}
		}

		public esQueryItem USER_LAPOR_KRITIS
		{
			get
			{
				return new esQueryItem(this, HasilLISMetadata.ColumnNames.USER_LAPOR_KRITIS, esSystemType.String);
			}
		}
	...
	public partial class HasilLISMetadata : esMetadata, IMetadata
	{
		...
		protected HasilLISMetadata()
		{
			...
			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.FLAG_TAKEN, 28, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.FLAG_TAKEN;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.KRITIS_JAM_DITEMUKAN, 29, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.KRITIS_JAM_DITEMUKAN;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);


			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.KRITIS_DITERIMA_OLEH, 30, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.KRITIS_DITERIMA_OLEH;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);


			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.USER_LAPOR_KRITIS, 31, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.USER_LAPOR_KRITIS;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);


			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.ISOLATE_NUMBER, 32, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.ISOLATE_NUMBER;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.BIONUMBER, 33, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.BIONUMBER;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.ORGANISME_ID, 34, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.ORGANISME_ID;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);


			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.ORGANISME, 35, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.ORGANISME;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.DRGLIST_ID, 36, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.DRGLIST_ID;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.ANTIBIOTIC, 37, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.ANTIBIOTIC;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.HASIL_MICRO, 38, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.HASIL_MICRO;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.INTEPRETASI, 39, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.INTEPRETASI;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);


			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.SENSITIVE, 40, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.SENSITIVE;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.INTERMEDIET, 41, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.INTERMEDIET;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.RESISTEN, 42, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.RESISTEN;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.JNS_BAKTERI, 43, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.JNS_BAKTERI;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);


			c = new esColumnMetadata(HasilLISMetadata.ColumnNames.PDF, 43, typeof(System.String), esSystemType.String);
			c.PropertyName = HasilLISMetadata.PropertyNames.PDF;
			c.CharacterMaxLength = 150;
			c.IsNullable = true;
			_columns.Add(c);
		...
		{ 
			...
			public const string FLAG_TAKEN = "FLAG_TAKEN";
			public const string KRITIS_JAM_DITEMUKAN = "KRITIS_JAM_DITEMUKAN";
			public const string KRITIS_DITERIMA_OLEH = "KRITIS_DITERIMA_OLEH";
			public const string USER_LAPOR_KRITIS = "USER_LAPOR_KRITIS";
			public const string ISOLATE_NUMBER = "ISOLATE_NUMBER";
			public const string BIONUMBER = "BIONUMBER";
			public const string ORGANISME_ID = "ORGANISME_ID";
			public const string ORGANISME = "ORGANISME";
			public const string DRGLIST_ID = "DRGLIST_ID";
			public const string ANTIBIOTIC = "ANTIBIOTIC";
			public const string HASIL_MICRO = "HASIL_MICRO";
			public const string INTEPRETASI = "INTEPRETASI";
			public const string SENSITIVE = "SENSITIVE";
			public const string INTERMEDIET = "INTERMEDIET";
			public const string RESISTEN = "RESISTEN";
			public const string JNS_BAKTERI = "JNS_BAKTERI";
		...
		private esProviderSpecificMetadata esDefault(string mapName)
		{
			if(!_providerMetadataMaps.ContainsKey(mapName))
			{
				...
				meta.AddTypeMap("FLAG_TAKEN", new esTypeMap("int", "System.String"));
				meta.AddTypeMap("KRITIS_JAM_DITEMUKAN", new esTypeMap("datetime", "System.String"));
				meta.AddTypeMap("KRITIS_DITERIMA_OLEH", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("USER_LAPOR_KRITIS", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("ISOLATE_NUMBER", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("BIONUMBER", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("ORGANISME_ID", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("ORGANISME", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("DRGLIST_ID", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("ANTIBIOTIC", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("HASIL_MICRO", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("INTEPRETASI", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("SENSITIVE", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("INTERMEDIET", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("RESISTEN", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("JNS_BAKTERI", new esTypeMap("varchar", "System.String"));
				meta.AddTypeMap("PDF", new esTypeMap("varchar", "System.String"));
