...
Driver          : SQL
Date Generated  : 9/16/2021 6:40:35 PM
===============================================================================
*/
...
namespace Temiang.Avicenna.BusinessObject.Interop.ELIMS
{
	...
	abstract public class esKirimLIS : esEntityWAuditLog
	{
		...
		virtual public System.String IS_CITO
		{
			get
			{
				return base.GetSystemString(KirimLISMetadata.ColumnNames.IS_CITO);
			}

			set
			{
				base.SetSystemString(KirimLISMetadata.ColumnNames.IS_CITO, value);
			}
		}
	...
	abstract public class esKirimLISQuery : esDynamicQuery
	{
		...
		public esQueryItem IS_CITO
		{
			get
			{
				return new esQueryItem(this, KirimLISMetadata.ColumnNames.IS_CITO, esSystemType.String);
			}
		}
	...
	public partial class KirimLISMetadata : esMetadata, IMetadata
	{
		...
		protected KirimLISMetadata()
		{
			...
			c = new esColumnMetadata(KirimLISMetadata.ColumnNames.NIK, 26, typeof(System.String), esSystemType.String);
			...
			c = new esColumnMetadata(KirimLISMetadata.ColumnNames.IS_CITO, 27, typeof(System.Int32), esSystemType.Int32);
			c.PropertyName = KirimLISMetadata.PropertyNames.IS_CITO;
			c.NumericPrecision = 10;
			c.HasDefault = true;
			c.Default = @"((0))";
			_columns.Add(c);
		...
		public class ColumnNames
		{
			...
			public const string IS_CITO = "IS_CITO";
		...
		private esProviderSpecificMetadata esDefault(string mapName)
		{
			if (!_providerMetadataMaps.ContainsKey(mapName))
			{
				...
				meta.AddTypeMap("IS_CITO", new esTypeMap("int", "System.String"));
