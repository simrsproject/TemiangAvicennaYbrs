...
Driver          : SQL
Date Generated  : 9/9/2021 7:17:54 PM
===============================================================================
*/
...
namespace Temiang.Avicenna.BusinessObject.Interop.VANSLITE
{
	...
	public partial class LabHasilMetadata : esMetadata, IMetadata
	{
		...
		protected LabHasilMetadata()
		{
			...
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.NoUrut, 3, typeof(System.Int32), esSystemType.Int32);
			c.PropertyName = LabHasilMetadata.PropertyNames.NoUrut;
			c.NumericPrecision = 10;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.KodePemeriksaan, 4, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.KodePemeriksaan;
			c.CharacterMaxLength = 10;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.NamaPemeriksaan, 5, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.NamaPemeriksaan;
			c.CharacterMaxLength = 80;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.Unit, 6, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.Unit;
			c.CharacterMaxLength = 20;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.Normal, 7, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.Normal;
			c.CharacterMaxLength = 550;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.Hasil, 8, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.Hasil;
			c.CharacterMaxLength = 2024;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.Flag, 9, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.Flag;
			c.CharacterMaxLength = 2;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.TglJamInsert, 10, typeof(System.DateTime), esSystemType.DateTime);
			...
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.FlagAmbil, 11, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.FlagAmbil;
			c.CharacterMaxLength = 1;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.TglJamAmbil, 12, typeof(System.DateTime), esSystemType.DateTime);
			c.PropertyName = LabHasilMetadata.PropertyNames.TglJamAmbil;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.Type, 13, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.Type;
			c.CharacterMaxLength = 1;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.NoRm, 14, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.NoRm;
			c.CharacterMaxLength = 15;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.TglDaftar, 15, typeof(System.DateTime), esSystemType.DateTime);
			c.PropertyName = LabHasilMetadata.PropertyNames.TglDaftar;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.TglHasil, 16, typeof(System.DateTime), esSystemType.DateTime);
			c.PropertyName = LabHasilMetadata.PropertyNames.TglHasil;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.KodeSir, 17, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.KodeSir;
			c.CharacterMaxLength = 15;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.KodeRuang, 18, typeof(System.String), esSystemType.String);
			c.PropertyName = LabHasilMetadata.PropertyNames.KodeRuang;
			c.CharacterMaxLength = 20;
			c.IsNullable = true;
			_columns.Add(c);
				
			c = new esColumnMetadata(LabHasilMetadata.ColumnNames.KodeDokter, 19, typeof(System.String), esSystemType.String);
