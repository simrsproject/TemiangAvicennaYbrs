...
namespace Temiang.Avicenna.ReportLibrary.Payroll.Rekap.RSSA
{
    /// <summary>
    /// Summary description for PoliklinikDailyRpt.
    /// </summary>
    public partial class SalaryListByPeriodRekapRpt : Report
    {
        public SalaryListByPeriodRekapRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
