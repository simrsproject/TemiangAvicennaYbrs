...
namespace Temiang.Avicenna.ReportLibrary.Charges
{
    ...
    /// </summary>
    public partial class DailyReceiptPerCashierRpt : Telerik.Reporting.Report
    {
        public DailyReceiptPerCashierRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
