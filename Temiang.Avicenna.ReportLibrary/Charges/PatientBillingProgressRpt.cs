namespace Temiang.Avicenna.ReportLibrary.Charges
{
    ...
    /// <summary>
    /// Summary description for PatientBillingProgressRpt.
    /// </summary>
    public partial class PatientBillingProgressRpt : Telerik.Reporting.Report
    {
        public PatientBillingProgressRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
