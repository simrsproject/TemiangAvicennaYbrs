...
namespace Temiang.Avicenna.ReportLibrary.Charges
{
    ...
    /// <summary>
    /// Summary description for LaporanUang Muka Keluar - Masuk.
    /// </summary>
    public partial class DownPaymentMutationRpt : Telerik.Reporting.Report
    {
        public DownPaymentMutationRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
