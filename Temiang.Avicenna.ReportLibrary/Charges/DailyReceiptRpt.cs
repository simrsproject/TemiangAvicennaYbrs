...
namespace Temiang.Avicenna.ReportLibrary.Charges
{
    ...
    public partial class DailyReceiptRpt : Telerik.Reporting.Report
    {
        public DailyReceiptRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
            //programID = "DailyReceiptRpt";
