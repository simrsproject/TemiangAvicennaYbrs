...
namespace Temiang.Avicenna.ReportLibrary.RADT
{
    ...
    public partial class InPatientDailyRpt : Telerik.Reporting.Report
    {
        public InPatientDailyRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
