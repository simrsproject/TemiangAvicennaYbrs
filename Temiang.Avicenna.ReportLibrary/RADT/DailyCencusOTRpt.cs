namespace Temiang.Avicenna.ReportLibrary.RADT
{
    ...
    /// <summary>
    /// Summary description for DailyCencusOTRpt.
    /// </summary>
    public partial class DailyCencusOTRpt : Telerik.Reporting.Report
    {
        public DailyCencusOTRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
