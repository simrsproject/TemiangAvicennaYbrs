...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.Inventory.ReceivedNPurchasedItemAnalysis
{
    ...
    public partial class ReceivedByMedicalItemGroupRpt : Report
    {
        public ReceivedByMedicalItemGroupRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
