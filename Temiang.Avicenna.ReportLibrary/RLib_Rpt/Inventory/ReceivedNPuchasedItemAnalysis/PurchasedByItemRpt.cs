...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.Inventory.ReceivedNPuchasedItemAnalysis
{
    ...
    /// <summary>
    /// Summary description for PurchasedByItem.
    /// </summary>
    public partial class PurchasedByItemRpt : Report
    {
        public PurchasedByItemRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
