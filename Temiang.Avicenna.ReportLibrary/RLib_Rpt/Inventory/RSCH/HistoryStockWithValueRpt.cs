namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.Inventory.RSCH
{
    ...
    /// </summary>
    public partial class HistoryStockWithValueRpt : Telerik.Reporting.Report
    {
        public HistoryStockWithValueRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
