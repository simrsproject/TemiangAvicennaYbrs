...
{
    public partial class PharmaceuticalActivitiesPrescriptionService : Report
    {
        public PharmaceuticalActivitiesPrescriptionService(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
