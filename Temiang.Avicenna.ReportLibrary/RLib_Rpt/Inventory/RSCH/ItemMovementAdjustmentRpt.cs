namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.Inventory.RSCH
{
    ...
    public partial class ItemMovementAdjustmentRpt : Telerik.Reporting.Report
    {
        public ItemMovementAdjustmentRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
