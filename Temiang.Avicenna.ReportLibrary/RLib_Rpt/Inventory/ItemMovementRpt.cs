...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.Inventory
{
    ...
    using System.Linq;
    /// <summary>
    /// Summary description for ItemMovementRpt.
    /// </summary>
    public partial class ItemMovementRpt : Telerik.Reporting.Report
    {
        public ItemMovementRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            {
                /// <summary>
