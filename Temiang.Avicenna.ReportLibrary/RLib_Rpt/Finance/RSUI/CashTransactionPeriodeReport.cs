...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.Finance.RSUI
{
    ...
    public partial class CashTransactionPeriodeReport : Telerik.Reporting.Report
    {
        ...
        private void SetupReport(PrintJobParameterCollection printJobParameters)
        {
            ...
            string Picfinance2 = AppParameter.GetParameterValue(AppParameter.ParameterItem.PicFinance2);
            txtPicFinance2.Value = Picfinance2;
            string PicAsFinance2 = AppParameter.GetParameterValue(AppParameter.ParameterItem.PicAsFinance2);
            txtPicAssFinance.Value = PicAsFinance2;
