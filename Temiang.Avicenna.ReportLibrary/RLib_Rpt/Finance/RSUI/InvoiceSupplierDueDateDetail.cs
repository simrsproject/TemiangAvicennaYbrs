...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.Finance.RSUI
{
    ...
    /// </summary>
    public partial class InvoiceSupplierDueDateDetail :Report
    {
        public InvoiceSupplierDueDateDetail(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
