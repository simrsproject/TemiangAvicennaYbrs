...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class SalesMedicalItemByPhysicianRpt : Report
    {
        public SalesMedicalItemByPhysicianRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
