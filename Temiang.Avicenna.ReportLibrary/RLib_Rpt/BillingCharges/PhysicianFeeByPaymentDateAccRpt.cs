...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    /// <summary>
    /// Summary description for PhysicianFeeByPaymentDateRpt.
    /// </summary>
    public partial class PhysicianFeeByPaymentDateAccRpt : Telerik.Reporting.Report
    {
        public PhysicianFeeByPaymentDateAccRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
