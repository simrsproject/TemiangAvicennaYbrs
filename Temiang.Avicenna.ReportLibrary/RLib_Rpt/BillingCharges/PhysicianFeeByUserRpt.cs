...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    /// <summary>
    /// Summary description for PhysicianFeeByUserRpt.
    /// </summary>
    public partial class PhysicianFeeByUserRpt : Telerik.Reporting.Report
    {
        public PhysicianFeeByUserRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
