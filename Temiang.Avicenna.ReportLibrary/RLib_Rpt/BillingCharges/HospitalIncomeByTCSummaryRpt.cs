...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class HospitalIncomeByTCSummaryRpt : Report
    {
        public HospitalIncomeByTCSummaryRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
