...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class IncomeReceiveByUserRpt : Telerik.Reporting.Report
    {
        public IncomeReceiveByUserRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
