...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    /// </summary>
    public partial class PhysicianFeeByPaymentDateRpt : Telerik.Reporting.Report
    {
        public PhysicianFeeByPaymentDateRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
