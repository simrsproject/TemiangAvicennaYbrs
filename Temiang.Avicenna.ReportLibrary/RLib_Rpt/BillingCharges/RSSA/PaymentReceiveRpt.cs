...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges.RSSA
{
    ...
    public partial class PaymentReceiveRpt : Telerik.Reporting.Report
    {
        public PaymentReceiveRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
