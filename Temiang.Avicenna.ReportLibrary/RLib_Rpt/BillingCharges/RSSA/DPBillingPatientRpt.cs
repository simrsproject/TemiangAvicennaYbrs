...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges.RSSA
{
    ...
    public partial class DPBillingPatientRpt : Telerik.Reporting.Report
    {
        public DPBillingPatientRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
