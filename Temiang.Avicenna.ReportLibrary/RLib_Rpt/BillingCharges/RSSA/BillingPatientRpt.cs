...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges.RSSA
{
    ...
    public partial class BillingPatientRpt : Telerik.Reporting.Report
    {
        public BillingPatientRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
