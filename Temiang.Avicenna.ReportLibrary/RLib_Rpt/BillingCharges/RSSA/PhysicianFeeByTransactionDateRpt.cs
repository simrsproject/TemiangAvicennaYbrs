...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges.RSSA
{
    ...
    /// <summary>
    /// Summary description for PhysicianFeeByTransactionDateRpt.
    /// </summary>
    public partial class PhysicianFeeByTransactionDateRpt : Telerik.Reporting.Report
    {
        public PhysicianFeeByTransactionDateRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
