namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class MedicalSupportRealizationDetailRpt : Telerik.Reporting.Report
    {
        public MedicalSupportRealizationDetailRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
