...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges.RSCH
{
    ...
    /// </summary>
    public partial class LaporanKunjunganLaboratoriumRpt : Telerik.Reporting.Report
    {
        public LaporanKunjunganLaboratoriumRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
