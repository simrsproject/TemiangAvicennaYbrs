namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class MedicalSupportActivitiesV2Rpt : Telerik.Reporting.Report
    {
        public MedicalSupportActivitiesV2Rpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
