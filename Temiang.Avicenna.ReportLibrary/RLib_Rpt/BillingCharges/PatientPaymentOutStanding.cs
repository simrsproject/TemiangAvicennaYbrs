namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class PatientPaymentOutStanding : Telerik.Reporting.Report
    {
        public PatientPaymentOutStanding(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
