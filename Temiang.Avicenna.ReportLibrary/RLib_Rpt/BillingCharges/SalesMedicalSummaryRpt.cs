...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    /// </summary>
    public partial class SalesMedicalSummaryRpt : Telerik.Reporting.Report
    {
        public SalesMedicalSummaryRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
