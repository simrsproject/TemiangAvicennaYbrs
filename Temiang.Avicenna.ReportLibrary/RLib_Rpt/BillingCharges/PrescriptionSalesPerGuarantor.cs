...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    /// </summary>
    public partial class PrescriptionSalesPerGuarantor : Report
    {
        public PrescriptionSalesPerGuarantor(string programID, PrintJobParameterCollection printJobParameters)
        {
            {
                /// <summary>
