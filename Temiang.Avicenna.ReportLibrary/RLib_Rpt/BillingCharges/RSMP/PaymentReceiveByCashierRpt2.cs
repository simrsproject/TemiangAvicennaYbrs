...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges.RSMP
{
    ...
    /// </summary>
    public partial class PaymentReceiveByCashierRpt2 : Telerik.Reporting.Report
    {
        public PaymentReceiveByCashierRpt2(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
