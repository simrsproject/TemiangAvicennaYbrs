namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class MedicalSupportRadiologyDetailRpt : Telerik.Reporting.Report
    {
        public MedicalSupportRadiologyDetailRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
