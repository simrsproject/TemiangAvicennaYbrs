namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class PrescriptionOutStandingRpt : Telerik.Reporting.Report
    {
        public PrescriptionOutStandingRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
