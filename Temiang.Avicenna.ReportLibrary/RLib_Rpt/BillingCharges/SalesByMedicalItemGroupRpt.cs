...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    public partial class SalesByMedicalItemGroupRpt : Report
    {
        public SalesByMedicalItemGroupRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
