...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    /// </summary>
    public partial class PrescriptionSalesEmployesSummaryRpt : Report
    {
        public PrescriptionSalesEmployesSummaryRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            {
                /// <summary>
