...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    /// </summary>
    public partial class PrescriptionSalesEmployesRpt : Report
    {
        public PrescriptionSalesEmployesRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            {
                /// <summary>
