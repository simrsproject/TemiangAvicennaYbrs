...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.BillingCharges
{
    ...
    /// </summary>
    public partial class SalesMedicalQtyRByGroupRpt : Report
    {
        public SalesMedicalQtyRByGroupRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            {
                /// <summary>
