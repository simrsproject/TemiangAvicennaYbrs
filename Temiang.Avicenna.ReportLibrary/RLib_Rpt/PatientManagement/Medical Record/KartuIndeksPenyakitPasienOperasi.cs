...
{
    /// <summary>
    /// Summary description for KartuIndeksPenyakitPasienOperasi.
    /// </summary>
    public partial class KartuIndeksPenyakitPasienOperasi : Report
    {
        public KartuIndeksPenyakitPasienOperasi(string programID, PrintJobParameterCollection printJobParameters)
        {
