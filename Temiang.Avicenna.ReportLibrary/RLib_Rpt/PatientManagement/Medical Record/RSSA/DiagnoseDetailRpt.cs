...
{
    /// <summary>
    /// Summary description for DiagnoseDetailRpt.
    /// </summary>
    public partial class DiagnoseDetailRpt : Report
    {
        public DiagnoseDetailRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
