...
{
    /// <summary>
    /// Summary description for KartuIndeksDokter.
    /// </summary>
    public partial class KartuIndeksDokter : Report
    {
        public KartuIndeksDokter(string programID, PrintJobParameterCollection printJobParameters)
        {
