...
{
    /// <summary>
    /// Summary description for KartuIndeksKematian.
    /// </summary>
    public partial class RL_2c : Report
    {
        public RL_2c(string programID, PrintJobParameterCollection printJobParameters)
        {
        ...
        private void PopulateHealthcareInfo()
        {
            ...
            textBox3.Value = "Kode RS : " + healthcare.HospitalCode;
            textBox66.Value = healthcare.City + " ,";
            textBox67.Value = "Direktur " + healthcare.HealthcareName;
        }
    }
}