...
{
    /// <summary>
    /// Summary description for TindakanEMRRpt.
    /// </summary>
    public partial class TindakanIGDRpt : Report
    {
        public TindakanIGDRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
