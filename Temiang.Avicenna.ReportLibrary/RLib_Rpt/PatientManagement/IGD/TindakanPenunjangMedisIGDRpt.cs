...
{
    public partial class TindakanPenunjangMedisIGDRpt : Report
    {
        public TindakanPenunjangMedisIGDRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
