...
{
    /// <summary>
    /// Summary description for KLLEMRRpt.
    /// </summary>
    public partial class KLLEMRRpt : Report
    {
        public KLLEMRRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
