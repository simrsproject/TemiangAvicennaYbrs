...
{
    public partial class PelayananGawatDaruratSummary : Report
    {
        public PelayananGawatDaruratSummary(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
