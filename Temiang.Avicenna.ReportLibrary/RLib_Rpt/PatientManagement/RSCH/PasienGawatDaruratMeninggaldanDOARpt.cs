...
{
    public partial class PasienGawatDaruratMeninggaldanDOARpt : Report
    {
        public PasienGawatDaruratMeninggaldanDOARpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
