...
{
    public partial class PasienGawatDaruratDataBelumLengkapRpt : Report
    {
        public PasienGawatDaruratDataBelumLengkapRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
