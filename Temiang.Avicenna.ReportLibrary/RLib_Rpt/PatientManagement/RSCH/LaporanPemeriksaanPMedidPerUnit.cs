...
namespace Temiang.Avicenna.ReportLibrary.RLib_Rpt.PatientManagement.RSCH
{
    ...
    /// </summary>
    public partial class LaporanPemeriksaanPMedidPerUnit : Report
    {
        public LaporanPemeriksaanPMedidPerUnit(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
