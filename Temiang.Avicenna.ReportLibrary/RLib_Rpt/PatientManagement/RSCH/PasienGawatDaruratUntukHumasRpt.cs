...
{
    public partial class PasienGawatDaruratUntukHumasRpt : Report
    {
        public PasienGawatDaruratUntukHumasRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
