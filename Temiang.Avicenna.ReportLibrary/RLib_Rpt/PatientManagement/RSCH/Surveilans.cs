...

{
    ...
    public partial class Surveilans : Report
    {
        ...
        private void PopulateHealthcareInfo()
        {
            ...
            textBox166.Value = ": Sumatera Selatan";
            textBox169.Value = ": " + healthcare.City;
            textBox258.Value = ": " + healthcare.HealthcareName;
            textBox202.Value ="Direktur " + healthcare.HealthcareName;
            textBox173.Value = healthcare.City + ", " + DateTime.Now.ToString("dd-MM-yyyy");
