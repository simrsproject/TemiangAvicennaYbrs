...
{
    public partial class RekapKunjunganGawatDaruratSummary : Report
    {
        public RekapKunjunganGawatDaruratSummary(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
