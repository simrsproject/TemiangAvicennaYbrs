...
{
    public partial class IGDMemerlukanPenunjangMedikDetail : Report
    {
        public IGDMemerlukanPenunjangMedikDetail(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
