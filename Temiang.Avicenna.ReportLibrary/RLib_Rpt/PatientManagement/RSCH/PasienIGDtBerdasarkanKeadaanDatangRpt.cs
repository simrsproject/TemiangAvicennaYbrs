...
{
    public partial class PasienIGDtBerdasarkanKeadaanDatangRpt : Report
    {
        public PasienIGDtBerdasarkanKeadaanDatangRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
