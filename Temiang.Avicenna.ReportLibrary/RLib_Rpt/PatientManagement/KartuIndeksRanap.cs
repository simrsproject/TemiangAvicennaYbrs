...
{
    /// <summary>
    /// Summary description for KartuIndeksRanap.
    /// </summary>
    public partial class KartuIndeksRanap : Report
    {
        public KartuIndeksRanap(string programID, PrintJobParameterCollection printJobParameters)
        {
