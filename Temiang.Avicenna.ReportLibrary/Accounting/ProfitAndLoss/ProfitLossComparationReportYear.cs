namespace Temiang.Avicenna.ReportLibrary.Accounting.ProfitLoss
{
    ...
    /// </summary>
    public partial class ProfitLossComparationReportYear : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public ProfitLossComparationReportYear(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
