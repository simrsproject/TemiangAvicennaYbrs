namespace Temiang.Avicenna.ReportLibrary.Accounting.ProfitAndLoss
{
    ...
    /// </summary>
    public partial class ProfitLossDetailByGuarantorType : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public ProfitLossDetailByGuarantorType(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
