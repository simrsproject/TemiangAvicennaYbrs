namespace Temiang.Avicenna.ReportLibrary.Accounting.ProfitLoss
{
    ...
    /// </summary>
    public partial class ProfitLossHighLightByUnitReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public ProfitLossHighLightByUnitReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
        ...
        private void SetupReport(PrintJobParameterCollection printJobParameters)
        {
            ...
            string Subledger = printJobParameters.FindByParameterName("p_SubLUnit").ValueString;
