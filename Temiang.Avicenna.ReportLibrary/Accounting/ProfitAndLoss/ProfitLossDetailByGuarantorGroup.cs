namespace Temiang.Avicenna.ReportLibrary.Accounting.ProfitAndLoss
{
    ...
    /// </summary>
    public partial class ProfitLossDetailByGuarantorGroup : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public ProfitLossDetailByGuarantorGroup(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
        ...
        private void SetupReport(PrintJobParameterCollection printJobParameters)
        {
            ...
            this.txtPeriode.Value = string.Format("Periode : {0:dd-MMMM-yyyy} s/d {1:dd-MMMM-yyyy}", fromDate, toDate);
