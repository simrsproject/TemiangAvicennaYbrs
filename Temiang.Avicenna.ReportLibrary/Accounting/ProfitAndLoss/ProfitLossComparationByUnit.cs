namespace Temiang.Avicenna.ReportLibrary.Accounting.ProfitLoss
{
    ...
    /// </summary>
    public partial class ProfitLossComparationByUnit : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public ProfitLossComparationByUnit(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
        ...
        private void SetupReport(PrintJobParameterCollection printJobParameters)
        {
            ...
            //string unit = printJobParameters.FindByParameterName("p_SubLUnit").ValueString;
