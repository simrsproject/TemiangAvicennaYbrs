namespace Temiang.Avicenna.ReportLibrary.Accounting.ProfitLoss
{
    ...
    /// </summary>
    public partial class ProfitLossGeneralReportLvl2 : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public ProfitLossGeneralReportLvl2(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
