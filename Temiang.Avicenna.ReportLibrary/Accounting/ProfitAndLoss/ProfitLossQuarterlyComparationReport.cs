namespace Temiang.Avicenna.ReportLibrary.Accounting.ProfitLoss
{
    ...
    /// </summary>
    public partial class ProfitLossQuarterlyComparationReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public ProfitLossQuarterlyComparationReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
