namespace Temiang.Avicenna.ReportLibrary.Accounting.Ledgers
{
    ...
    /// </summary>
    public partial class LedgerSummaryReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public LedgerSummaryReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
