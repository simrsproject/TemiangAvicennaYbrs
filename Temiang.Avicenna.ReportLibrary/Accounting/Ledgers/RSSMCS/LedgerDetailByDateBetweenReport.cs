...

{
    ...
    /// </summary>
    public partial class LedgerDetailByDateBetweenReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public LedgerDetailByDateBetweenReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
        ...
        private void SetDataSource(string programID, PrintJobParameterCollection printJobParameters)
        {
            ...
            DataTable tblInitBalance = reportDataSource.GetDataTableDirect("sprpt_Accounting_Ledger_LedgerGeneralByAccountCodeDateBetween", printJobParameters);
