...

{
    ...
    /// </summary>
    public partial class LedgerDetailByQtyReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public LedgerDetailByQtyReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
