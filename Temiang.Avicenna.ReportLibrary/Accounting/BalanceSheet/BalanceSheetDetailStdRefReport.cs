namespace Temiang.Avicenna.ReportLibrary.Accounting.BalanceSheet
{
    ...
    /// </summary>
    public partial class BalanceSheetDetailStdRefReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public BalanceSheetDetailStdRefReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
