namespace Temiang.Avicenna.ReportLibrary.Accounting.BalanceSheet.RSMP
{
    ...
    /// </summary>
    public partial class BalanceSheetDetailReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public BalanceSheetDetailReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
