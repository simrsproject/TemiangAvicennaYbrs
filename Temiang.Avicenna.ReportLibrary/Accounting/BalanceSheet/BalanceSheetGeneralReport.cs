namespace Temiang.Avicenna.ReportLibrary.Accounting.BalanceSheet
{
    ...
    /// </summary>
    public partial class BalanceSheetGeneralReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public BalanceSheetGeneralReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
