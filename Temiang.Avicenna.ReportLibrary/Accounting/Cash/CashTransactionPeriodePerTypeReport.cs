...
namespace Temiang.Avicenna.ReportLibrary.Accounting.Cash
{
    ...
    /// </summary>
    public partial class CashTransactionPeriodePerTypeReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public CashTransactionPeriodePerTypeReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
