...
namespace Temiang.Avicenna.ReportLibrary.Accounting.Cash
{
    ...
    public partial class CashTransactionNotApproved : Report
    {
        public CashTransactionNotApproved(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
