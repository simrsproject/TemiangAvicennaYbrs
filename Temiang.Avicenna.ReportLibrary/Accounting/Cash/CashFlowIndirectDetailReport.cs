...
namespace Temiang.Avicenna.ReportLibrary.Accounting.Cash
{
    ...
    /// </summary>
    public partial class CashFlowIndirectDetailReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public CashFlowIndirectDetailReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
