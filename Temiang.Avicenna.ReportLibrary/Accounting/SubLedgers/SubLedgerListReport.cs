namespace Temiang.Avicenna.ReportLibrary.Accounting.SubLedgers
{
    ...
    /// </summary>
    public partial class SubLedgerListReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public SubLedgerListReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
