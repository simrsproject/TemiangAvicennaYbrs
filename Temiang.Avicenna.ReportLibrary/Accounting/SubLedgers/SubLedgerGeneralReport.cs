namespace Temiang.Avicenna.ReportLibrary.Accounting.SubLedgers
{
    ...
    /// </summary>
    public partial class SubLedgerGeneralReport : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public SubLedgerGeneralReport(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
