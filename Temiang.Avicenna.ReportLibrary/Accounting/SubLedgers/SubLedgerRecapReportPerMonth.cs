namespace Temiang.Avicenna.ReportLibrary.Accounting.SubLedgers
{
    ...
    /// </summary>
    public partial class SubLedgerRecapReportPerMonth : Telerik.Reporting.Report
    {
        private ReportDataSource reportDataSource = new ReportDataSource();

        public SubLedgerRecapReportPerMonth(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
        ...
        {
            object year = printJobParameters.FindByParameterName("pSinglePostingPeriode_Year").ValueString;
