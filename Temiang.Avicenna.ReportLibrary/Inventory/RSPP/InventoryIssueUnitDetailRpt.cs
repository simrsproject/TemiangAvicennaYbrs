namespace Temiang.Avicenna.ReportLibrary.Inventory.RSPP
{
    ...
    /// <summary>
    /// Summary description for InventoryIssueUnitDetailRpt.
    /// </summary>
    public partial class InventoryIssueUnitDetailRpt : Telerik.Reporting.Report
    {
        public InventoryIssueUnitDetailRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
