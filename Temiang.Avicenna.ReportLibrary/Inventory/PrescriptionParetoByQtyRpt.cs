namespace Temiang.Avicenna.ReportLibrary.Inventory
{
    ...
    /// <summary>
    /// Summary description for PrescriptionParetoByQtyRpt.
    /// </summary>
    public partial class PrescriptionParetoByQtyRpt : Telerik.Reporting.Report
    {
        public PrescriptionParetoByQtyRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
