namespace Temiang.Avicenna.ReportLibrary.Inventory
{
    ...
    /// <summary>
    /// Summary description for DistributionSummaryRpt.
    /// </summary>
    public partial class DistributionSummaryRpt : Telerik.Reporting.Report
    {
        public DistributionSummaryRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
