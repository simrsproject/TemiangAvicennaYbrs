...
namespace Temiang.Avicenna.ReportLibrary.Inventory
{
    ...
    /// </summary>
    public partial class RekapDistributionItemRpt : Report
    {
        public RekapDistributionItemRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
            //printJobParameters.AddNew("p_FromDate", new System.DateTime(2009, 11, 10));
            //printJobParameters.AddNew("p_ToDate", new System.DateTime(2010, 05, 12));
            //----------------
