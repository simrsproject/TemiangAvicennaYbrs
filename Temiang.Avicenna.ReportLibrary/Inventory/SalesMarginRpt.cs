namespace Temiang.Avicenna.ReportLibrary.Inventory
{
    ...
    /// <summary>
    /// Summary description for SalesMarginRpt.
    /// </summary>
    public partial class SalesMarginRpt : Telerik.Reporting.Report
    {
        public SalesMarginRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
