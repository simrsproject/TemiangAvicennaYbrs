...
namespace Temiang.Avicenna.ReportLibrary.Inventory
{
    ...
    /// </summary>
    public partial class PurchaseReceiveSlipRpt : Telerik.Reporting.Report
    {
        public PurchaseReceiveSlipRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
