namespace Temiang.Avicenna.ReportLibrary.Inventory
{
    ...
    /// <summary>
    /// Summary description for StockMovementRpt.
    /// </summary>
    public partial class StockAdjustmentRpt : Telerik.Reporting.Report
    {
        public StockAdjustmentRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
