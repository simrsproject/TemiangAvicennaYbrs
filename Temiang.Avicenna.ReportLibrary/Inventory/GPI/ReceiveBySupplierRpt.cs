...
namespace Temiang.Avicenna.ReportLibrary.Inventory.GPI
{

    public partial class ReceiveBySupplierRpt : Report
    {
        public ReceiveBySupplierRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //Test Parameter
