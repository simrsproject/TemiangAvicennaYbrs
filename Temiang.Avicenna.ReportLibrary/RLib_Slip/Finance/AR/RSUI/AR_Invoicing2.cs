namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Finance.AR.RSUI
{
    ...
    public partial class AR_Invoicing2 : Telerik.Reporting.Report
    {
        public AR_Invoicing2(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
        ...
        private void PopulateHealthcareInfo()
        {
            ...
            string BankAccNameKalbar = AppParameter.GetParameterValue(AppParameter.ParameterItem.BankAccNameForSlipBankKalbar);
            textBox27.Value = BankAccNameKalbar;
            string BankAccNoKalbar = AppParameter.GetParameterValue(AppParameter.ParameterItem.BankAccNoForSlipBankKalbar);
            textBox34.Value = BankAccNoKalbar;
            string BankNameForSlipBankKalbar = AppParameter.GetParameterValue(AppParameter.ParameterItem.BankNameForSlipBankKalbar);
            textBox45.Value = BankNameForSlipBankKalbar;
            string BankCabangSlipBankKalbar = AppParameter.GetParameterValue(AppParameter.ParameterItem.BankCabangSlipBankKalbar);
            textBox46.Value = BankCabangSlipBankKalbar;
        }
    }
}