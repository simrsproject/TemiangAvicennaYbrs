...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Finance.AR.RSUI
{
    ...
    /// </summary>
    public partial class AR_PaymentReceiveReceipt2 : Telerik.Reporting.Report
    {
        public AR_PaymentReceiveReceipt2(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            ...
            var patient = new PatientQuery("g");
            ...
            query.InnerJoin(patient).On(patient.PatientID == detail.PatientID);
            query.Where
                (
