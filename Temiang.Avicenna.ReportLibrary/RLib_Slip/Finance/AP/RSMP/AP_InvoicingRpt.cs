namespace Temiang.Avicenna.ReportLibrary.Rlib_Slip.Finance.AP.RSMP
{
    ...
    /// </summary>
    public partial class AP_InvoicingRpt : Telerik.Reporting.Report
    {
        public AP_InvoicingRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
            ...
            var picFinance2 = AppParameter.GetParameterValue(AppParameter.ParameterItem.PicFinance2);
            ...
            query.Select
                (
                    ...
                    string.Format("<'{0}' AS PicFinance2>", picFinance2)
                );
