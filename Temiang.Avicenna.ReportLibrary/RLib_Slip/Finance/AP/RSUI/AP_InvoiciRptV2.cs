namespace Temiang.Avicenna.ReportLibrary.Rlib_Slip.Finance.AP.RSUI
{
    ...
    /// </summary>
    public partial class AP_InvoiciRptV2 : Telerik.Reporting.Report
    {
        public AP_InvoiciRptV2(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
            ...
            var JournalTransactions = new JournalTransactionsQuery("e");
            var JournalTransactionDetails = new JournalTransactionDetailsQuery("f");
            ...
            query.Select
                (
                    ...
                    detail.PPnAmount,
                    detail.StampAmount,
                    itemTransaction.ChargesAmount,
                    itemTransaction.TaxAmount,
                    JournalTransactionDetails.Credit,
                    @"<ISNULL(b.OtherDeduction, 0) OtherDeduction>",
            ...
            query.InnerJoin(JournalTransactions).On(JournalTransactions.RefferenceNumber == detail.TransactionNo);
            query.InnerJoin(JournalTransactionDetails).On(JournalTransactionDetails.JournalId == JournalTransactions.JournalId &&
                                                                 JournalTransactionDetails.ChartOfAccountId == ("1393"));
