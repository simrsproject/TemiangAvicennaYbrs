...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.Continued
{
    ...
    public partial class Umum : Report
    {
        ...
        public Umum(string programID, PrintJobParameterCollection printJobParameters)
        {
            ...
            {
                textBox2.Value = "ASESMEN LANJUTAN GAWAT DARURAT";
            }
            else if (reg.SRRegistrationType == "IPR")
            {
                textBox2.Value = "ASESMEN LANJUTAN RAWAT INAP";
            }
            else
            {
                textBox2.Value = "ASESMEN LANJUTAN RAWAT JALAN";
            }
            ...
            // RM.04.b	ASESMEN LANJUTAN RAWAT JALAN
            var nphrColl = new PatientHealthRecordCollection();
            var qrLastPhr = new PatientHealthRecordQuery("a");
            qrLastPhr.Where(qrLastPhr.RegistrationNo == reg.RegistrationNo, qrLastPhr.QuestionFormID == "RM.04.b");
            qrLastPhr.es.Top = 1;
