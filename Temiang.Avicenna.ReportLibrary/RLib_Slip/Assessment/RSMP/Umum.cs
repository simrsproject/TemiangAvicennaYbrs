...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.RSMP
{
    ...
    /// </summary>
    public partial class Umum : Report
    {

        public Umum(string programID, PrintJobParameterCollection printJobParameters)
        {
            ...
            if (reg.SRRegistrationType == "EMR")
            {
                textBox2.Value = "ASESMEN AWAL GAWAT DARURAT";
            }
            else if(reg.SRRegistrationType == "IPR")
            {
                textBox2.Value = "ASESMEN AWAL RAWAT INAP";
            }
            else
            {
                textBox2.Value = "ASESMEN AWAL RAWAT JALAN";
            }
            ...
            // RM.04.a	ASESMEN AWAL RAWAT JALAN
            var nphrColl = new PatientHealthRecordCollection();
            var qrLastPhr = new PatientHealthRecordQuery("a");
            qrLastPhr.Where(qrLastPhr.RegistrationNo == reg.RegistrationNo, qrLastPhr.QuestionFormID == "RM.04.a");
            qrLastPhr.es.Top = 1;
    ...
    txtHeight);
        ...
        private void PopulatePsikologis(PatientHealthRecordLineCollection phrlColl)
        {
            ...
            // Curiga Penganiyaan
            questionID = "ST.SO.002"; 
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkCr_Ya.Value = ent.QuestionAnswerSelectionLineID.Equals("UM.YN1");
                chkCr_Tidak.Value = ent.QuestionAnswerSelectionLineID.Equals("UM.YN2");
            }

            // Kegiatan Ibadah
            questionID = "ST.SO.003";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkKgt_Bantuan.Value = ent.QuestionAnswerSelectionLineID.Equals("ADL.ID2");
                chkKgt_Tidak.Value = ent.QuestionAnswerSelectionLineID.Equals("ADL.ID1");
            }

            // Status Emosional
            questionID = "ST.SO.004";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkSe_Normal.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkSe_TidakSemangat.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkSe_RasaTertekan.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                chkSe_Depresi.Value = ent.QuestionAnswerSelectionLineID.Equals("4");
                chkSe_Cemas.Value = ent.QuestionAnswerSelectionLineID.Equals("5");
                chkSe_SulitTidur.Value = ent.QuestionAnswerSelectionLineID.Equals("6");
                chkSe_CepatLelah.Value = ent.QuestionAnswerSelectionLineID.Equals("7");
                chkSe_SulitKons.Value = ent.QuestionAnswerSelectionLineID.Equals("8");
                chkSe_MerasaBersalah.Value = ent.QuestionAnswerSelectionLineID.Equals("9");
            }

            // Keyakinan Khusus
            questionID = "ST.SO.005";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkKy_Tidak.Value = ent.QuestionAnswerSelectionLineID.Equals("ADATDKSBT01");
                if (ent.QuestionAnswerSelectionLineID.Equals("ADATDKSBT02"))
                {
                    var values = ent.QuestionAnswerText.Split('|');
                    chkKy_Ya.Value = true;
                    txtKy_Sebutkan.Value = values[1];
                }
            }

            // Cara Bayar
            questionID = "ST.SO.006";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkCb_Umum.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkCb_Bpjs.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkCb_Asuransi.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                if (ent.QuestionAnswerSelectionLineID.Equals("4"))
                {
                    var values = ent.QuestionAnswerText.Split('|');
                    chkCb_Lainnya.Value = true;
                    txtCb_Lainnya.Value = values[1];
                }
            }

            // Bahasa Yang Digunakan
            questionID = "ST.SO.007";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkBhs_Daerah.Value = ent.QuestionAnswerSelectionLineID.Equals("LANG3");
                chkBhs_Indo.Value = ent.QuestionAnswerSelectionLineID.Equals("LANG1");
                chkBhs_Inggris.Value = ent.QuestionAnswerSelectionLineID.Equals("LAN2");
            }
        ...
        private void PopulateStatusFungsional(PatientHealthRecordLineCollection phrlColl)
        {
            ...
            //Defekasi
            questionID = "AS.KEB.004";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkDef_Normal.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkDef_Konstipasi.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkDef_Diare.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                chkDef_Alvi.Value = ent.QuestionAnswerSelectionLineID.Equals("5");
            }

            // Miksi
            questionID = "AS.KEB.005";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkMk_Normal.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkMk_Retensi.Value = ent.QuestionAnswerSelectionLineID.Equals("5");
                chkMk_Urin.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
            }

            // Gastro intestinal 
            questionID = "AS.KEB.006";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkGs_Normal.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkGs_Refluks.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkGs_Nausea.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                chkGs_Muntah.Value = ent.QuestionAnswerSelectionLineID.Equals("4");
            }

            // Pola Tidur 
            questionID = "AS.KEB.007";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkTdr_Normal.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkTdr_Masalah.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
            }

            // Cairan 
            questionID = "AS.KEB.008";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkCai_Normal.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkCai_Dehidrasi.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
            }

            // Pernafasan 
            questionID = "AS.KEB.009";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkNaf_Normal.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkNaf_SesakNafas.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
            }

            // Pernafasan 
            questionID = "AS.KEB.010";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkKar_Normal.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkKar_Debar.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkKar_Aritmia.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
            }

            // Berpakaian 
            questionID = "AS.KEB.011";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkBp_Mandiri.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkBp_Alat.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkBp_OrangLain.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                chkBp_Total.Value = ent.QuestionAnswerSelectionLineID.Equals("4");
            }

            // Buang Air 
            questionID = "AS.KEB.012";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkBa_Mandiri.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkBa_Alat.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkBa_OrangLain.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                chkBa_Total.Value = ent.QuestionAnswerSelectionLineID.Equals("4");
            }

            // Personal Hygiene 
            questionID = "AS.KEB.013";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkPh_Mandiri.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkPh_Alat.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkPh_OrangLain.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                chkPh_Total.Value = ent.QuestionAnswerSelectionLineID.Equals("4");
            }

            // Personal Hygiene 
            questionID = "AS.KEB.014";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkPh_Mandiri.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
            ...
            // Berpindah 
            questionID = "AS.KEB.015";
            ent = phrlColl.FirstOrDefault(x => questionID.Equals(x.QuestionID));
            if (ent != null)
            {
                chkBd_Mandiri.Value = ent.QuestionAnswerSelectionLineID.Equals("1");
                chkBd_Alat.Value = ent.QuestionAnswerSelectionLineID.Equals("2");
                chkBd_OrangLain.Value = ent.QuestionAnswerSelectionLineID.Equals("3");
                chkBd_Total.Value = ent.QuestionAnswerSelectionLineID.Equals("4");
            }
        }
