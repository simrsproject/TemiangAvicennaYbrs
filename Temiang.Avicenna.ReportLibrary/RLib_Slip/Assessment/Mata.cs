...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment
{
    ...
    /// </summary>
    public partial class Mata : Telerik.Reporting.Report
    {
        public Mata(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
        ...
        private void PopulatePhysicalExam(PatientAssessment asses)
        {
            ...
            try
            {
                ...
                //Ishihara
                chkIshiharaNormal.Value = !pexam.Ishihara.IsAbNormal;
