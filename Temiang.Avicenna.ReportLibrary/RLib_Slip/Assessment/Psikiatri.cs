...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment
{
    ...
    /// </summary>
    public partial class Psikiatri : Telerik.Reporting.Report
    {
        public Psikiatri(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
        ...
        private void PopulatePhysicalExam(PatientAssessment asses)
        {
            ...
            {
                // Convert to class w json
                var pexam = JsonConvert.DeserializeObject<PsychiatryPe>(asses.PhysicalExam);
