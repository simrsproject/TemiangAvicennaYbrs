...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment.MCU
{
    ...
    /// <summary>
    /// Summary description for Neurologi.
    /// </summary>
    public partial class Neurologi : Telerik.Reporting.Report
    {
        public Neurologi(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
