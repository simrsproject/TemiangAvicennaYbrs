...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment.MCU
{
    ...
    /// <summary>
    /// Summary description for BedahWanita.
    /// </summary>
    public partial class BedahWanita : Telerik.Reporting.Report
    {
        public BedahWanita(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
