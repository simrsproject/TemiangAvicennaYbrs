...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment.MCU
{
    ...
    /// <summary>
    /// Summary description for BedahLaki.
    /// </summary>
    public partial class BedahLaki : Telerik.Reporting.Report
    {
        public BedahLaki(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
