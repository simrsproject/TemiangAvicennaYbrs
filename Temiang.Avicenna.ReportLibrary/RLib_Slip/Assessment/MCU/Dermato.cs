...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment.MCU
{
    ...
    /// <summary>
    /// Summary description for Dermato.
    /// </summary>
    public partial class Dermato : Telerik.Reporting.Report
    {
        public Dermato(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
