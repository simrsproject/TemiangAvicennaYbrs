...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment.MCU
{
    ...
    /// <summary>
    /// Summary description for Anamnesa.
    /// </summary>
    public partial class Anamnesa : Telerik.Reporting.Report
    {
        public Anamnesa(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            Helper.InitializeLogoOnly(this.reportHeader);
