...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment.MCU
{
    ...
    /// <summary>
    /// Summary description for Spirometri.
    /// </summary>
    public partial class Spirometri : Telerik.Reporting.Report
    {
        public Spirometri(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
