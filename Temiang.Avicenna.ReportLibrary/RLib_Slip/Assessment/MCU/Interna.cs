...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment.MCU
{
    ...
    /// <summary>
    /// Summary description for Interna.
    /// </summary>
    public partial class Interna : Telerik.Reporting.Report
    {
        public Interna(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
