...
namespace Temiang.Avicenna.ReportLibrary.RSCH.RLib_Slip.Assessment.MCU
{
    ...
    /// <summary>
    /// Summary description for Obstetri.
    /// </summary>
    public partial class Obstetri : Telerik.Reporting.Report
    {
        public Obstetri(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
