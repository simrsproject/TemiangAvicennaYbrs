...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient
{
    ...
    /// <summary>
    /// Summary description for Psychiatry_P1.
    /// </summary>
    public partial class Psychiatry_P1 : Telerik.Reporting.Report
    {
        public Psychiatry_P1(string programID, PrintJobParameterCollection printJobParameters, BusinessObject.Registration reg, PatientAssessment asses, Patient pat)
        {
            //
            ...
            picGenogram.Value = (new ImageHelper()).ConvertByteArrayToImage(asses.Genogram);
