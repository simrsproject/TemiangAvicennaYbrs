...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient
{
    ...
    /// <summary>
    /// Summary description for Skin_P1.
    /// </summary>
    public partial class Skin_P1 : Telerik.Reporting.Report
    {
        public Skin_P1(string programID, PrintJobParameterCollection printJobParameters, BusinessObject.Registration reg, PatientAssessment asses)
        {
            //
