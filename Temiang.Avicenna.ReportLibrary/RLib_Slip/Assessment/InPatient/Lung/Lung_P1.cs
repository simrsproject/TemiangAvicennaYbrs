...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient
{
    ...
    /// <summary>
    /// Summary description for Lung_P1.
    /// </summary>
    public partial class Lung_P1 : Telerik.Reporting.Report
    {
        public Lung_P1(string programID, PrintJobParameterCollection printJobParameters, BusinessObject.Registration reg, PatientAssessment asses, Patient pat)
        {
            //
