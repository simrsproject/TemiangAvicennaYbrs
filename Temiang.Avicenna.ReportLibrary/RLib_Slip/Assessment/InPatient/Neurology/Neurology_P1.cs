...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient
{
    ...
    /// <summary>
    /// Summary description for Neurology_P1.
    /// </summary>
    public partial class Neurology_P1 : Telerik.Reporting.Report
    {
        public Neurology_P1(string programID, PrintJobParameterCollection printJobParameters, BusinessObject.Registration reg, PatientAssessment asses)
        {
            //
