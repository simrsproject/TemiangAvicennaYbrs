...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient
{
    ...
    /// <summary>
    /// Summary description for Eyes_P1.
    /// </summary>
    public partial class Eyes_P1 : Telerik.Reporting.Report
    {
        public Eyes_P1(string programID, PrintJobParameterCollection printJobParameters, Patient pat, BusinessObject.Registration reg, PatientAssessment asses)
        {
            //
        ...
        private void PopulatePhysicalExam(PatientAssessment asses, BusinessObject.Registration reg)
        {
            ...
            try
            {
                ...
                //Mata Kanan
                var right = pexam.RightEye;
                txtRVisus.Value = right.Visus;
                txtRCorrection.Value = right.Correction;
                txtRGlasses.Value = right.Glasses;
                txtROcular.Value = right.Ocular;
                txtRAnterior.Value = right.Anterior;
                txtRPosterior.Value = right.Posterior;
