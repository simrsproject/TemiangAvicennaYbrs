...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient.Heart
{
    ...
    /// <summary>
    /// Summary description for Heart_P1.
    /// </summary>
    public partial class Heart_P1 : Telerik.Reporting.Report
    {
        public Heart_P1(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
