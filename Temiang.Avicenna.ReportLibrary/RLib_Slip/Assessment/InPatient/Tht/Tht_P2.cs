...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient
{
    ...
    /// </summary>
    public partial class Tht_P2 : Telerik.Reporting.Report
    {
        public Tht_P2(string programID, PrintJobParameterCollection printJobParameters, Patient pat, BusinessObject.Registration reg, PatientAssessment asses)
        {
            //
        ...
        private void PopulatePhysicalExam(PatientAssessment asses)
        {
            ...
            try
            {
                ...
                //TODO untuk display table hidung dan telinga
