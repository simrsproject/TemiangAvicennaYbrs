...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient
{
    ...
    /// <summary>
    /// Summary description for Tht_P1.
    /// </summary>
    public partial class Tht_P1 : Telerik.Reporting.Report
    {
        public Tht_P1(string programID, PrintJobParameterCollection printJobParameters, Patient pat, BusinessObject.Registration reg, PatientAssessment asses)
        {
            //
