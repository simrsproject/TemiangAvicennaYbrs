...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Assessment.InPatient
{
    ...
    /// <summary>
    /// Summary description for Stroke_P4.
    /// </summary>
    public partial class Stroke_P4 : Telerik.Reporting.Report
    {
        public Stroke_P4(string programID, PrintJobParameterCollection printJobParameters, BusinessObject.Registration reg, PatientAssessment asses)
        {
            //
            ...
            //tblSasaranTerukur.DataSource = MeasuredGoalItems(asses.MeasuredGoals);
