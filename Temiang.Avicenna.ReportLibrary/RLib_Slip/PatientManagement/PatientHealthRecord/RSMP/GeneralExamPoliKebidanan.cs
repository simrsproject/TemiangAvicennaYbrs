namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.PatientHealthRecord.RSMP
{
    ...
    /// </summary>
    public partial class GeneralExamPoliKebidanan : Report
    {

        public GeneralExamPoliKebidanan(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            if (phrlColl.Load(phrl)) {
                ...
                GeneralExamMaster.Fill(phrlColl, textBox122, "PHY.P.LP");
                GeneralExamMaster.Fill(phrlColl, textBox123, "PHY.P.LP1");
                GeneralExamMaster.Fill(phrlColl, textBox124, "PHY.P.LP2");
                GeneralExamMaster.Fill(phrlColl, textBox125, "PHY.P.LP3");
                GeneralExamMaster.Fill(phrlColl, textBox126, "PHY.P.LP4");

                GeneralExamMaster.Fill(phrlColl, textBox127, "PHY.AU.DJ");
                GeneralExamMaster.FillCheckBox(phrlColl, textBox130, textBox129, "PHY.AU.DJR");
                GeneralExamMaster.FillCheckBox(phrlColl, textBox131, textBox132, "PHY.AU.DJI");
                GeneralExamMaster.FillCheckBox(phrlColl, textBox133, textBox134, "PHY.E.LLP");
                GeneralExamMaster.FillCheckBox(phrlColl, textBox135, textBox136, "PHY.E.LLO");
                GeneralExamMaster.Fill(phrlColl, textBox139, "PHY.EX.RP");
                GeneralExamMaster.Fill(phrlColl, textBox140, "PHY.EX.OU");
