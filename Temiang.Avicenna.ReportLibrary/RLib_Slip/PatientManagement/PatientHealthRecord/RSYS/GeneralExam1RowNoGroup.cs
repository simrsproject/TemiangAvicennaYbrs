namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.PatientHealthRecord.RSYS
{
    ...
    /// <summary>
    /// Summary description for GeneralExam1RowNoGroup.
    /// </summary>
    public partial class GeneralExam1RowNoGroup : Report
    {
        private System.Collections.Generic.List<int> CTColWidth;

        public GeneralExam1RowNoGroup(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
