namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.PatientHealthRecord.RSYS
{
    ...
    /// <summary>
    /// Summary description for GeneralExamOpr1RowNoGroup.
    /// </summary>
    public partial class GeneralExamOpr1RowNoGroup : Report
    {
        private System.Collections.Generic.List<int> CTColWidth;

        public GeneralExamOpr1RowNoGroup(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
