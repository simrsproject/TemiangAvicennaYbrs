namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.PatientHealthRecord.RSMMP
{
    ...
    public partial class GeneralExam : Report
    {
        ...
        public GeneralExam(string programID, PrintJobParameterCollection printJobParameters)
        {
            ...
            TxtAddress2.Value = healthcare.AddressLine1 + ' ' + healthcare.AddressLine2 + " Telp :" + healthcare.PhoneNo;
            TxtAddress3.Value = " Fax :" + healthcare.FaxNo;
            Txtemail.Value = healthcare.EmailAddr;
