namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.PatientHealthRecord.RSETA
{
    ...
    /// <summary>
    /// Summary description for PostOperasi.
    /// </summary>
    public partial class PostOperasi : Report
    {
        public PostOperasi(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
