namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.PatientHealthRecord.EMCS
{
    ...
    /// <summary>
    /// Summary description for GeneralExamMpp.
    /// </summary>
    public partial class GeneralExamMpp : Report
    {
        private System.Collections.Generic.List<int> CTColWidth;

        public GeneralExamMpp(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
