namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.PatientHealthRecord.General
{
    ...
    /// <summary>
    /// Summary description for GeneralExamOpr1RowFilled.
    /// </summary>
    public partial class GeneralExamOpr1RowFilled : Report
    {
        private System.Collections.Generic.List<int> CTColWidth;

        public GeneralExamOpr1RowFilled(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
