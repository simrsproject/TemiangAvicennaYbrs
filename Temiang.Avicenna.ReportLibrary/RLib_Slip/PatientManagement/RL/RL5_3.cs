...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.RL
{
    ...
    /// <summary>
    /// Summary description for RL5_3.
    /// </summary>
    public partial class RL5_3 : Telerik.Reporting.Report
    {
        public RL5_3(string programID, PrintJobParameterCollection printJobParameters)
        {
