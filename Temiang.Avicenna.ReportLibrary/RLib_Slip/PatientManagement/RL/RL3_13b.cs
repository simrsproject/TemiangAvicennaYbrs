...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.RL
{
    ...
    /// <summary>
    /// Summary description for RL3_13.
    /// </summary>
    public partial class RL3_13b : Telerik.Reporting.Report
    {
        public RL3_13b(string programID, PrintJobParameterCollection printJobParameters)
        {
