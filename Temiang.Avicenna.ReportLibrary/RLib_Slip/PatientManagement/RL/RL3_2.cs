...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.RL
{
    ...
    /// <summary>
    /// Summary description for RL3_2.
    /// </summary>
    public partial class RL3_2 : Telerik.Reporting.Report
    {
        public RL3_2(string programID, PrintJobParameterCollection printJobParameters)
        {
