...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.RL
{
    ...
    /// <summary>
    /// Summary description for RL5_4_10.
    /// </summary>
    public partial class RL5_4 : Telerik.Reporting.Report
    {
        public RL5_4(string programID, PrintJobParameterCollection printJobParameters)
        {
