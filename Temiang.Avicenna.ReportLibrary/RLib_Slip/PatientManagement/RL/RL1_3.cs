...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.RL
{
    ...
    /// <summary>
    /// Summary description for RL1_3.
    /// </summary>
    public partial class RL1_3 : Telerik.Reporting.Report
    {
        public RL1_3(string programID, PrintJobParameterCollection printJobParameters)
        {
