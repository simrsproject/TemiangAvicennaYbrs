...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.RL
{
    ...
    /// <summary>
    /// Summary description for RL1_2.
    /// </summary>
    public partial class RL1_2 : Telerik.Reporting.Report
    {
        public RL1_2(string programID, PrintJobParameterCollection printJobParameters)
        {
