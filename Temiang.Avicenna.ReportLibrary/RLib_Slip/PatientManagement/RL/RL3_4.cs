...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.RL
{
    ...
    /// <summary>
    /// Summary description for  RL3_4.
    /// </summary>
    public partial class RL3_4 : Telerik.Reporting.Report
    {
        public RL3_4(string programID, PrintJobParameterCollection printJobParameters)
        {
