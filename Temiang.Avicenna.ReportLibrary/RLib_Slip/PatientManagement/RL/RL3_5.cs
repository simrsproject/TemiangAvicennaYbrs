...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.RL
{
    ...
    /// <summary>
    /// Summary description for  RL3_5.
    /// </summary>
    public partial class RL3_5 : Telerik.Reporting.Report
    {
        public RL3_5(string programID, PrintJobParameterCollection printJobParameters)
        {
