...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.Registration.RSSA
{
    ...
    /// </summary>
    public partial class RegistrationLabelIpRpt : Telerik.Reporting.Report
    {
        public RegistrationLabelIpRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            // Test parameter
