...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.Registration.RSSA
{
    ...
    /// </summary>
    public partial class RegistrationLabelErCenterRpt : Telerik.Reporting.Report
    {
        public RegistrationLabelErCenterRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            // Test parameter
