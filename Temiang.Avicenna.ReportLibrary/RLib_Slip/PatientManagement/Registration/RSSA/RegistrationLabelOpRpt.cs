...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.Registration.RSSA
{
    ...
    /// </summary>
    public partial class RegistrationLabelOpRpt : Telerik.Reporting.Report
    {
        public RegistrationLabelOpRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            // Test parameter
