...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.Registration.RSSA
{
    ...
    /// <summary>
    /// Summary description for RegistrationLabelIpRpt.
    /// </summary>
    public partial class RegistrationLabelOpCenterRpt : Telerik.Reporting.Report
    {
        public RegistrationLabelOpCenterRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            // Test parameter
            //programID = "RegistrationLabelIpRpt";
