...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.Registration.RSSMCB
{
    ...
    /// </summary>
    public partial class RegistrationLabelRpt2 : Telerik.Reporting.Report
    {
        public RegistrationLabelRpt2(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            // Test parameter
            ...
            //int x = reg.SRRegistrationType == "IPR" ? 5 : 5;
            int x = 1;
