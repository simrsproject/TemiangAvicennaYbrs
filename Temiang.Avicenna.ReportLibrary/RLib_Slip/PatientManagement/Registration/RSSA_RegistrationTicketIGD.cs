...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement.Registration
{
    ...
    /// </summary>
    public partial class RSSA_RegistrationTicketIGD : Report
    {
        public RSSA_RegistrationTicketIGD(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
            /// Required for telerik Reporting designer support
            /// </summary>
            InitializeComponent();
            Helper.InitializeNoLogo(this.reportFooterSection1);
