...
{
    /// <summary>
    /// Summary description for RegistrationReceipt.
    /// </summary>
    public partial class RegistrationReceipt : Report
    {
        public RegistrationReceipt(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
           ...
           // TxtCityRS.Value = healthcare.AddressLine1 + ' ' + healthcare.City;
            ...
            //TxtOperator.Value = "Print Nota Operator : " + user.UserName + ' ' + DateTime.Now;
        }
    }
}