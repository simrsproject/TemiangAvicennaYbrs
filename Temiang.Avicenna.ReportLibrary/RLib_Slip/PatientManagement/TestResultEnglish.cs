namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.PatientManagement
{
    ...
    /// </summary>
    public partial class TestResultEnglish : Telerik.Reporting.Report
    {
        public TestResultEnglish(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            ...
            query.Select
                (
                    ...
                    query.TestResultOtherLang.As("Result"),
                    patient.PatientName,
