namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Pharmacy.RSUI
{
    using System;
    ...
    public partial class PrescriptionOriReceipt : Report
    {
        public PrescriptionOriReceipt(string programID, PrintJobParameterCollection printJobParameters)
        {
            ...
            hd.Select(
                ...
                reg.PatientID,
                userr.UserID,
                "<m.UserID + ' / ' + m.UserName AS UserName>",
                emb.EmbalaceLabel,
            ...
            hd.InnerJoin(userr).On(userr.UserID == hd.CreatedByUserID);
