...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Pharmacy
{
    ...
    /// </summary>
    public partial class RSSA_PrescriptionReturnReceipt : Report
    {
        public RSSA_PrescriptionReturnReceipt(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
