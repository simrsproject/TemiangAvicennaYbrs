...

{
    ...
    /// <summary>
    /// Summary description for DownPaymentReturnReceiptNoLogo.
    /// </summary>
    public partial class DownPaymentReturnReceiptNoLogo : Telerik.Reporting.Report
    {
        public DownPaymentReturnReceiptNoLogo(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
            ...
            query.Select
                (
                    ...
                    @"<CASE WHEN c.GuarantorID ='SELF' THEN 
                        'Pasien Umum'
                    ELSE e.GuarantorName END AS 'GuarantorName'>",
