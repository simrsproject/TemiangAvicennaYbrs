...

{
    ...
    /// <summary>
    /// Summary description for DownPaymentReceiptNoLogo.
    /// </summary>
    public partial class DownPaymentReceiptNoLogo : Telerik.Reporting.Report
    {
        public DownPaymentReceiptNoLogo(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
