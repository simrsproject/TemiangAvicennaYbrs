...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Charges.RSSMCS
{
    ...
    public partial class PaymentReceipt : Report
    {
        public PaymentReceipt(string programID, PrintJobParameterCollection printJobParameters)
        {
            ...
            /// </summary>
            InitializeComponent();
            //Helper.in(this.pageHeader);

            string regNo = printJobParameters.FindByParameterName("RegNo").ValueString;

            textBox22.Value = printJobParameters[0].ValueString;
            ...
            textBox6.Value = ptn.FirstName + ' ' + ptn.MiddleName + ' ' + ptn.LastName;
            ...
            if (total > 0)
            {
                ...
                textBox3.Value = pay.PrintReceiptAsName;
            ...
            else
            {
                ...
                TxtAmount.Value = string.Format("{0:n0}", (-total));
                textBox3.Value = healthcare.HealthcareName;

                //textBox17.Value = string.Empty;
            }
            TxtNameRS.Value = healthcare.HealthcareName;
            textBox16.Value = healthcare.AddressLine1 + " " + healthcare.AddressLine2;
            TxtTelp.Value = "No.Telp " + healthcare.PhoneNo + ", Fax " + healthcare.FaxNo;
            textBox15.Value = healthcare.NPWP;
