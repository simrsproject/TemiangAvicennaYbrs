...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Charges.RSUI
{
    ...
    public partial class PaymentReceiveReceiptDetailOutPatient : Telerik.Reporting.Report
    {
        public PaymentReceiveReceiptDetailOutPatient(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            ...
            textBox14.Format = healthcare.City + ", {0:dd-MM-yyyy}"; //+ ", " + textBox14.Value; //+ ", " + string.Format("{0:dd-MMM-yyyy}", DateTime.Now);
