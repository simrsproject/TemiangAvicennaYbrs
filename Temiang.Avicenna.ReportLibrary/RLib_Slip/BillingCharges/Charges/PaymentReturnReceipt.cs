...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Charges
{
    ...
    using System.Linq;
    /// <summary>
    /// Summary description for PaymentReturnReceipt.
    /// </summary>
    public partial class PaymentReturnReceipt : Telerik.Reporting.Report
    {
        public PaymentReturnReceipt(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
            ...
            query.Select
                (
                    ...
                    @"<Case WHEN b.Balance > 0 then 'Kwitansi Pengembalian Uang'
                    else
                    'Kwitansi Pengembalian Uang' END As 'Title'>",
