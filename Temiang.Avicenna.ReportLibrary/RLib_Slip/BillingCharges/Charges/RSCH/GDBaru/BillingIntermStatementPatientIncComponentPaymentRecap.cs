...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Charges.RSCH.GDBaru
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentPaymentRecap.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPaymentRecap : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPaymentRecap(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
