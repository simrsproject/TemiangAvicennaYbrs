...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Charges.RSCH
{
    ...
    /// <summary>
    /// Summary description for PaymentReceiveReceiptOP.
    /// </summary>
    public partial class PaymentReceiveReceiptOP : Telerik.Reporting.Report
    {
        public PaymentReceiveReceiptOP(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
            ...
            query.Where(query.IsApproved == true, item.SRPaymentType != printJobParameters[2].ValueString);
