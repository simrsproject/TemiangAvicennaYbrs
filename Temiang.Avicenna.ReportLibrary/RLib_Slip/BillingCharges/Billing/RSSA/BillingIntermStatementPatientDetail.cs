...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSSA
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientDetail : Report
    {
        public BillingIntermStatementPatientDetail(string programID, PrintJobParameterCollection printJobParameters)
        {
            {
                InitializeComponent();
