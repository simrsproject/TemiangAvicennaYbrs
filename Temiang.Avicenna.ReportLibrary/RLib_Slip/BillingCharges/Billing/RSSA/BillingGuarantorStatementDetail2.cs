...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSSA
{
    ...
    /// </summary>
    public partial class BillingGuarantorStatementDetail2 : Report
    {
        public BillingGuarantorStatementDetail2(string programID, PrintJobParameterCollection printJobParameters)
        {
            {
                /// <summary>
