...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSUDSKY
{
    ...
    /// <summary>
    /// Summary description for BillingStatementPatientInacbgWithPrice.
    /// </summary>
    public partial class BillingStatementPatientInacbgWithPrice : Telerik.Reporting.Report
    {
        public BillingStatementPatientInacbgWithPrice(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            textBox16.Value = printJobParameters.FindByParameterName("UserName").ValueString;
            ...
            textBox87.Value = string.Format("{0:N2}", selisih); //selisih
