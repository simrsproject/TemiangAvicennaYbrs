...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSUDSKY
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentExtPribadi : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentExtPribadi(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            textBox31.Value = "(" + Director.ParameterValue + ")";
            ...
            if(cls.LoadByPrimaryKey(regis.ClassID)){
                if(srRegType == "IPR"){
                    ...
                    textBox9.Value = string.IsNullOrEmpty(cls.ShortName) ? cls.ClassName : cls.ShortName + " / " + textBox9.Value;
                }
            }
            // hak kelas
            ...
            textBox13.Value += srRegType == "IPR" ? " PERAWATAN" : " PEMERIKSAAN RAWAT JALAN";
            ...
            textBox30.Value = srRegType == "IPR" ? "Email: " + Email : "Telp. " + healthcare.PhoneNo + " Fax " + healthcare.FaxNo;
