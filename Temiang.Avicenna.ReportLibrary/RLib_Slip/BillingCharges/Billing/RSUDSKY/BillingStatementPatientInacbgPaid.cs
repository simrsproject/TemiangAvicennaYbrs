...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSUDSKY
{
    ...
    /// <summary>
    /// Summary description for BillingStatementPatientInacbgPaid.
    /// </summary>
    public partial class BillingStatementPatientInacbgPaid : Telerik.Reporting.Report
    {
        public BillingStatementPatientInacbgPaid(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
