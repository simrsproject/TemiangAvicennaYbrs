...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.TARIFFSURGICAL
{
    ...
    public partial class OperationPredicationEstimationForm : Report
    {
        public OperationPredicationEstimationForm(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
            ...
            regis.LoadByPrimaryKey(printJobParameters.FindByParameterName("p_RegistrationNo").ValueString);
            ...
            textBox12.Value = printJobParameters.FindByParameterName("p_RegistrationNo").ValueString + " / " + p.MedicalNo;
