...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSIWithDisc
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentRecapPatientOnlyNoLogo.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentRecapPatientOnlyNoLogo : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentRecapPatientOnlyNoLogo(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            textBox18.Value = string.Format("{0} hari", dd.ToString());
            textBox5.Visible = textBox6.Visible = textBox18.Visible = (srRegType == "IPR");
