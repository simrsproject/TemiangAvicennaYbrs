...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSIWithDisc
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPatientOnly : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPatientOnly(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            textBox22.Value = string.Format("{0} hari", dd.ToString());
            textBox6.Visible = textBox31.Visible = textBox33.Visible = textBox22.Visible = (srRegType == "IPR");
