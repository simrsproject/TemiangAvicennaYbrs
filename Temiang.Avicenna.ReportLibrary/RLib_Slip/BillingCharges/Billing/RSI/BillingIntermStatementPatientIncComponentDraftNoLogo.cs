...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSI
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentDraftNoLogo : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentDraftNoLogo(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            var p = new Patient();
            var tt = new AppStandardReferenceItem();
            p.LoadByPrimaryKey(regis.PatientID);
            tt.LoadByPrimaryKey("Salutation", p.SRSalutation);
            textBox10.Value = p.PatientName + " ," + tt.ItemName;
            ...
            // NPWP
            textBox9.Value = hc.NPWP;
            textBox110.Value = hc.HealthcareName;
