namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing
{
    ...
    public partial class OperationCostEstimationFormSummary : Report
    {
        public OperationCostEstimationFormSummary(string programID, PrintJobParameterCollection printJobParameters)
        {
            InitializeComponent();
