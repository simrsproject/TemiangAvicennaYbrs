...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.BILLINGCHSCLASS
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentPaymentReceiptNoLogo.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPaymentReceiptNoLogo : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPaymentReceiptNoLogo(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            //if (dd == 0) dd++;
            textBox114.Value = string.Format("{0} hari", dd.ToString());
            textBox49.Visible = textBox115.Visible = textBox114.Visible = (srRegType == "IPR");
