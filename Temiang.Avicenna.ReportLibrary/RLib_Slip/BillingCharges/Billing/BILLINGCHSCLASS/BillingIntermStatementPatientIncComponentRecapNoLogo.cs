...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.BILLINGCHSCLASS
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentRecapNoLogo.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentRecapNoLogo : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentRecapNoLogo(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
