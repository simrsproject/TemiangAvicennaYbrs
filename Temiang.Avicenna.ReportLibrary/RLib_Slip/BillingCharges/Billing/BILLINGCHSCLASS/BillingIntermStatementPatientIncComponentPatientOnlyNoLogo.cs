...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.BILLINGCHSCLASS
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPatientOnlyNoLogo : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPatientOnlyNoLogo(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
