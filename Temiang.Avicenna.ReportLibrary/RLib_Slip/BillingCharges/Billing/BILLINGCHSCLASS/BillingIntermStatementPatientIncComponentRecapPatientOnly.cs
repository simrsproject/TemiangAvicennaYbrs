...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.BILLINGCHSCLASS
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentRecapPatientOnly.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentRecapPatientOnly : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentRecapPatientOnly(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
