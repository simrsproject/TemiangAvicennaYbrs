...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentRecap.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentRecap : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentRecap(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            if (AppSession.Parameter.IsBillingStatementLosCalculationWithAdd1Day)
            {
            ...
            textBox15.Value = string.Format("{0} hari", dd.ToString());
            

            string srRegType = regis.SRRegistrationType;
            
            textBox18.Visible = textBox16.Visible = textBox15.Visible = (srRegType == "IPR");
            ...
            textBox20.Value = p.StreetName + ' ' + p.City;
            ...
            if (regis.DischargeDate.HasValue)
            {
                ...
                textBox15.Value = string.Format("{0} hari", dds.ToString());
