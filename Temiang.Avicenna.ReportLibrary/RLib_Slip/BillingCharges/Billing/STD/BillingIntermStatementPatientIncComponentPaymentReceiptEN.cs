...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.STD
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentPaymentReceiptEN.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPaymentReceiptEN : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPaymentReceiptEN(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            if (dd == 0) dd++;
            textBox114.Value = string.Format("{0} days", dd.ToString());
            textBox157.Visible = textBox115.Visible = textBox114.Visible = (srRegType == "IPR");
            ...
            textBox6.Value = p.StreetName + ' ' + p.City;
