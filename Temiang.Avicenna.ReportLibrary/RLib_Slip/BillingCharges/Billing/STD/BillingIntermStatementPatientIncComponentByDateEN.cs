...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.STD
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentByDateEN.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentByDateEN : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentByDateEN(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            textBox2.Value = srRegType == "IPR" ? "Ward" : "Examination Room";
            ...
            if (regis.DischargeDate.HasValue)
            {
                ...
                textBox129.Value = "Period " + (srRegType == "IPR" ? "Treatment" : "Examinition") + " : " +
