...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.STD
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentRecapPatientOnlyEN.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentRecapPatientOnlyEN : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentRecapPatientOnlyEN(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            if (dd == 0) dd++;
            textBox18.Value = string.Format("{0} days", dd.ToString());
            textBox157.Visible = textBox6.Visible = textBox18.Visible = (srRegType == "IPR");
            ...
            textBox16.Value = p.StreetName + ' ' + p.City;
            ...
            textBox129.Value = "Periode " + (srRegType == "IPR" ? "" : "") + " : " +
