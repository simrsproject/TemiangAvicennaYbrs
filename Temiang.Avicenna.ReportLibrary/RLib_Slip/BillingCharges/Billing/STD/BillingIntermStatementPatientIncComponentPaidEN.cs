...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.STD
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentPaidEN.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPaidEN : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPaidEN(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            if (dd == 0) dd++;
            textBox33.Value = string.Format("{0} days", dd.ToString());
            textBox34.Visible = textBox28.Visible = textBox33.Visible = (srRegType == "IPR");
            ...
            {
                textBox54.Value = (guar.GuarantorHeaderID == Common.AppSession.Parameter.SelfGuarantor) ? "PERSONAL" : "GUARANTOR";
            ...
            {
                textBox54.Value = (regis.GuarantorID == Common.AppSession.Parameter.SelfGuarantor) ? "PERSONAL" : "GUARANTOR";
            }
            ...
            else
            {
                ...
                if (mb.LoadByPrimaryKey(regis.RegistrationNo))
                {
                    ...
                    if (regTo.LoadByPrimaryKey(r))
                    {
                        ...
                        textBox121.Value = (regTo.SRRegistrationType == "IPR") ? "Reg. Inpatient Number" : "Reg. Initial Number";
                        textBox123.Value = regTo.RegistrationNo;

                        textBox126.Value = (regTo.SRRegistrationType == "IPR") ? "Ward / Bed" : "Room";
