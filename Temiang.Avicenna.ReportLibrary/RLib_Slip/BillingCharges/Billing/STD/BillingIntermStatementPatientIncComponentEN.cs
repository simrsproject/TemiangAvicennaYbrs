...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.STD
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentEN.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentEN : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentEN(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            var dd = ((regis.DischargeDate ?? DateTime.Now) - regis.RegistrationDate.Value).Days + 1;
            if (dd == 0) dd++;
            textBox159.Value = string.Format("{0} days", dd.ToString());
            ...
            textBox2.Value = srRegType == "IPR" ? "Ward" : "Examinition Room";
            ...
            // kelas ruang
            textBox4.Value = srRegType == "IPR" ? "Class / Bed Number" : "Policlinic";
            ...
            else
            {
                ...
                {
                    textBox123.Value = string.Format("{0:dd-MMM-yyyy}", regis.AllowPatientCheckOutDateTime.Value);
                }
                else
                {
            ...
            textBox129.Value = "Periode " + (srRegType == "IPR" ? "Treatment" : "Examinition") + " : " +
            ...
            textBox13.Value += srRegType == "IPR" ? "" : ("" + svu.ServiceUnitName);
            textBox50.Value = srRegType == "IPR" ? "Date of Entry" : "Check Date";
            ...
            else
            {
                ...
                if (mb.LoadByPrimaryKey(regis.RegistrationNo))
                {
                    ...
                    if (regTo.LoadByPrimaryKey(r))
                    {
                        ...
                        textBox121.Value = "Reg. Inpatient Number";
                        textBox123.Value = regTo.RegistrationNo;

                        textBox126.Value = "Ward / Bed";
