...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.STD
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentRecapEN.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentRecapEN : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentRecapEN(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            if (dd == 0) dd++;
            textBox15.Value = string.Format("{0} days", dd.ToString());
