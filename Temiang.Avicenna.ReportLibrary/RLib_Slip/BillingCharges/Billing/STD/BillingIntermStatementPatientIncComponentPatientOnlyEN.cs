...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.STD
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentPatientOnlyEN.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPatientOnlyEN : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPatientOnlyEN(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            if (dd == 0) dd++;
            textBox22.Value = string.Format("{0} days", dd.ToString());
            textBox157.Visible = textBox31.Visible = textBox22.Visible = (srRegType == "IPR");
