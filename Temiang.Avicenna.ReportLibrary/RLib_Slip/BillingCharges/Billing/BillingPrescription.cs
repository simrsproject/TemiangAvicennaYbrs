...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing
{
    ...
    /// </summary>
    public partial class BillingPrescription : Telerik.Reporting.Report
    {
        public BillingPrescription(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
           ...
           //textBox131.Value = printJobParameters.FindByParameterName("UserName").ValueString;
            ...
            textBox13.Value = "PERINCIAN RESEP PASIEN";
