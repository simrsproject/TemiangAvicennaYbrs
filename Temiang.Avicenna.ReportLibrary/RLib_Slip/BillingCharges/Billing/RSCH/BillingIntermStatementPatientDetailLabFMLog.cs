...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSCH
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientDetailLabFMLog : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientDetailLabFMLog(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
