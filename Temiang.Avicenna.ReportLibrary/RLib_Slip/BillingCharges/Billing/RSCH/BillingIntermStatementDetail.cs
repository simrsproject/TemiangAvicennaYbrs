...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSCH
{
    ...
    /// </summary>
    public partial class BillingIntermStatementDetail : Telerik.Reporting.Report
    {
        public BillingIntermStatementDetail(string programID, PrintJobParameterCollection printJobParameters)
        {
            ...
            Helper.InitializeLogoOnly(this.reportHeaderSection1);
            ...
            textBox132.Value = healthcare.HealthcareName;
            textBox133.Value = healthcare.AddressLine1;
            textBox139.Value = healthcare.City;
            textBox140.Value =  "Telp. " + healthcare.PhoneNo + " Fax " + healthcare.FaxNo;
