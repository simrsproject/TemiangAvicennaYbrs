...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSCH.GDBaru
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPaid : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPaid(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
