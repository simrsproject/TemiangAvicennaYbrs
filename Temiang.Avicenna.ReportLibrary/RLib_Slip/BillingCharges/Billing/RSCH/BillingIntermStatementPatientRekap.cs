...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSCH
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientRekap : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientRekap(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
