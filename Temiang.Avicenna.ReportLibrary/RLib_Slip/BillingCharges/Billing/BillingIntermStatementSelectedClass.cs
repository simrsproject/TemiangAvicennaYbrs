...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementSelectedClass.
    /// </summary>
    public partial class BillingIntermStatementSelectedClass : Telerik.Reporting.Report
    {
        public BillingIntermStatementSelectedClass(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
            ...
            textBox13.Value = "PERINCIAN TAGIHAN PASIEN (SESUAI KELAS YANG DIPILIH)";
