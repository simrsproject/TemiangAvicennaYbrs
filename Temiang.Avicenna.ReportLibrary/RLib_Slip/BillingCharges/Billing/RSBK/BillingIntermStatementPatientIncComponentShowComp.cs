...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSBK
{
    ...
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentShowComp : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentShowComp(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
