...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.BillingCharges.Billing.RSBK
{
    ...
    /// <summary>
    /// Summary description for BillingIntermStatementPatientIncComponentPaymentReceipt.
    /// </summary>
    public partial class BillingIntermStatementPatientIncComponentPaymentReceipt : Telerik.Reporting.Report
    {
        public BillingIntermStatementPatientIncComponentPaymentReceipt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
