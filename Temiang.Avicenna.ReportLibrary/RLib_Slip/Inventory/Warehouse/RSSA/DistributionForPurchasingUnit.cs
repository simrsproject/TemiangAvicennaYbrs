...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Inventory.Warehouse.RSSA
{
    ...
    /// </summary>
    public partial class DistributionForPurchasingUnit : Report
    {
        public DistributionForPurchasingUnit(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
