...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Inventory.Procurement.ARSANI
{
    ...
    /// <summary>
    /// Summary description for PurchaseRequestNonMedis.
    /// </summary>
    public partial class PurchaseRequestNonMedis : Telerik.Reporting.Report
    {
        public PurchaseRequestNonMedis(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
