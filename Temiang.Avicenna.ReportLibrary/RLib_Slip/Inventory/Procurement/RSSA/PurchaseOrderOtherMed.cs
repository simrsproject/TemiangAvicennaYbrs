...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Inventory.Procurement.RSSA
{
    ...
    /// </summary>
    public partial class PurchaseOrderOtherMed : Telerik.Reporting.Report
    {
        public PurchaseOrderOtherMed(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
