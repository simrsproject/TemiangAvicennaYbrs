...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Inventory.Procurement.RSUI
{
    ...
    /// </summary>
    public partial class PurchaseRequestSM : Telerik.Reporting.Report
    {
        public PurchaseRequestSM(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
