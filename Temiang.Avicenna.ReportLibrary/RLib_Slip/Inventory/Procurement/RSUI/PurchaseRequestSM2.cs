...
namespace Temiang.Avicenna.ReportLibrary.RLib_Slip.Inventory.Procurement.RSUI
{
    ...
    /// </summary>
    public partial class PurchaseRequestSM2 : Telerik.Reporting.Report
    {
        public PurchaseRequestSM2(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
