...
namespace Temiang.Avicenna.ReportLibrary
{
    public class Helper
    {
        internal static Image ResizeImageForHTML(Image image, decimal percentage, InterpolationMode interpolationMode)
        {
            int newWidth;
            int newHeight;
        ...
        //internal static Image HtmlToImage(string html) {
        //    var converter = new HtmlConverter();
        //    using (MemoryStream memstr = new MemoryStream(converter.FromHtmlString(html)))
        //    {
        //        Image img = new Bitmap(Image.FromStream(memstr));
        //        return img;
        //    }
        //}
        ...
        internal static void InitializeLogoAndTextBottom(ReportSectionBase reportSection)
        {
            ...
            if (healthcare.HealthcareName.Contains("Rumah Sakit"))
                txtHealthcareInfo.Value = string.Format("{0}\r\n{1}", healthcare.HealthcareName.Substring(0, 11), healthcare.HealthcareName.Substring(12));
            else
                txtHealthcareInfo.Value = healthcare.HealthcareName;
        ...
        internal static void InitializeLogoOnlySizeModeNormal(ReportSectionBase reportSection)
        {
            ...
            picHealthcareLogo.MimeType = "image/bmp";
            picHealthcareLogo.Size = new SizeU(new Unit(4.39999997615814209, UnitType.Inch), new Unit(1.60000002384185791, UnitType.Inch));
        ...
        public static Bitmap ResourceLogo(string healthcareInitial)
        {
            ...
            if (hc.HealthcareLogo != null)
            {
                byte[] image = hc.HealthcareLogo;

                Bitmap bmp;
                using (var ms = new MemoryStream(image))
                {
                    bmp = new Bitmap(ScaleImage(Image.FromStream(ms), 48));
                }
            ...
            switch (healthcareInitial)
            {
                ...
                case "RSMB":
                    return Resources.LogoRSMB;
                case "RSUSKY":
                    return Resources.LogoRSUSKY;
                case "RSPM":
                    //return Resources.LogoEMC;
                ...
                case "EMC":
                    return Resources.LogoEMC;
                case "EMCS":
                    return Resources.LogoEmcSentul;
                case "RSSMCB":
                case "RSSMCS":
                case "RSSMCK":
                case "RSSMMU":
                    return Resources.LogoRSSMCB;
                case "RSSMHB":
                    return Resources.LogoHARBUN;
                case "RSMYRIA":
                    return Resources.LogoMyria;
                case "CHARITASHOSPITAL":
                case "RSPBN":
                case "RSKA":
                case "RSHANA":
                    return Resources.LogoRSHANA;
                case "GRHA":
                    return Resources.LogoGrhaMM2100;
                case "RSMM":
                    return Resources.LogoRSMM;
                case "RSI":
                    return Resources.LogoRSI;
                case "YBRSGKP":
                    return Resources.LogoYBRSGKP;
                case "RSHM":
                    return Resources.LogoRSHM;
                case "RSBK":
                    return Resources.LogoRSBK;
                case "RSRG":
                    return Resources.LogoRSRG;
                case "RSTJ":
                    return Resources.LogoRSTJ2; //Resources.LogoRSTJ;
                case "RSUTS":
                    return Resources.LogoRSUTS;
                case "RSJKT":
                    return Resources.LogoRSJKT;
                case "RSMMP":
                    return Resources.LogoRSMMP;
                case "KLUTAMA":
                    return Resources.KLUTAMA_Logo;
                case "RSJPR":
                    return Resources.LogoRSJPR;
                case "AVIAT":
                    return Resources.LogoAviat;
                case "RSYS":
                    return Resources.LogoRSYS; //rs yos sudarso
                case "RSEE":
                    return Resources.LogoRSEE2; //RS Efarina Etaham
                case "RSCDR":
                    return Resources.LogoRSCDR;
                case "RSRM":
                    return Resources.LogoRSRM2;
                default:
                    return Resources.DefaultLogo;
            }
        }
