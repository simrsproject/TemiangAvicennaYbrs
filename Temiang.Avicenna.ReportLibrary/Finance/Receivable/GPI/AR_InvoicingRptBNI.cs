...
namespace Temiang.Avicenna.ReportLibrary.Finance.Receivable.GPI
{
    ...
    /// <summary>
    /// Summary description for AR_InvoicingRptBNI.
    /// </summary>
    public partial class AR_InvoicingRptBNI : Telerik.Reporting.Report
    {
        public AR_InvoicingRptBNI(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
