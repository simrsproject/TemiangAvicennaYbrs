...
namespace Temiang.Avicenna.ReportLibrary.Finance.Receivable.GPI
{
    ...
    /// <summary>
    /// Summary description for AR_InvoicingRptBuk.
    /// </summary>
    public partial class AR_InvoicingRptBuk : Telerik.Reporting.Report
    {
        public AR_InvoicingRptBuk(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
