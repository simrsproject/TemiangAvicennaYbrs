...
namespace Temiang.Avicenna.ReportLibrary.Finance.Receivable.GPI
{
    ...
    /// <summary>
    /// Summary description for AR_InvoicingRptBca.
    /// </summary>
    public partial class AR_InvoicingRptBca : Telerik.Reporting.Report
    {
        public AR_InvoicingRptBca(string programID, PrintJobParameterCollection printJobParameters)
        {
            /// <summary>
