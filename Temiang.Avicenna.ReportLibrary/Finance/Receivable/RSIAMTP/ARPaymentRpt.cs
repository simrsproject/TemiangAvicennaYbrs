namespace Temiang.Avicenna.ReportLibrary.Finance.Receivable.RSIAMTP
{
    using System;
    ...
    /// </summary>
    public partial class ARPaymentRpt : Telerik.Reporting.Report
    {
        public ARPaymentRpt(string programID, PrintJobParameterCollection printJobParameters)
        {
            //
