...
namespace Temiang.Avicenna.ReportLibrary.Finance.Revenue
{
    ...
    public partial class HospitalRevenueByPaymentDate :Report
    {
        public HospitalRevenueByPaymentDate(string programID, PrintJobParameterCollection printJobParameters)
        {
